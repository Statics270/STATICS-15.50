...
static_assert(alignof(ImagePlateComponent_SetImagePlate) == 0x000008, "Wrong alinment on ImagePlateComponent_SetImagePlate");
...
static_assert(alignof(ImagePlateComponent_GetPlate) == 0x000008, "Wrong alinment on ImagePlateComponent_GetPlate");
