...
public:
	...
	void ExecuteUbergraph_MatchmakingInputIndicator(int32 EntryPoint, class UFortGlobalUIContext* CallFunc_GetLocalPlayerSubsystem_ReturnValue, ECommonInputType K2Node_Event_InputType, class UTexture2D* CallFunc_GetInputTypeIcon_ReturnValue, bool CallFunc_IsValid_ReturnValue);
...
static_assert(alignof(UMatchmakingInputIndicator_C) == 0x000008, "Wrong alinment on UMatchmakingInputIndicator_C");
