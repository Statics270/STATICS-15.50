...
{
public:
	uint8                                         Pad_4BC1[0x10];                                    // 0x0038(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool StartTrackingLiveLinkSubject(class FName LiveLinkSubject, struct FLiveStreamAnimationHandleWrapper& RegisteredName, struct FLSALiveLinkSourceOptions& Options, struct FLiveStreamAnimationHandleWrapper& TranslationProfile);
	void StopTrackingLiveLinkSubject(struct FLiveStreamAnimationHandleWrapper& RegisteredName);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LSALiveLinkDataHandler">();
	}
...
static_assert(alignof(ULSALiveLinkDataHandler) == 0x000008, "Wrong alinment on ULSALiveLinkDataHandler");
...
public:
	...
	uint8                                         Pad_4BC4[0x10];                                    // 0x0078(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LSALiveLinkFrameTranslator">();
	}
...
static_assert(alignof(ULSALiveLinkFrameTranslator) == 0x000008, "Wrong alinment on ULSALiveLinkFrameTranslator");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LSALiveLinkRole">();
	}
...
static_assert(alignof(ULSALiveLinkRole) == 0x000008, "Wrong alinment on ULSALiveLinkRole");
...
public:
	...
	uint8                                         Pad_4BC5[0x18];                                    // 0x0060(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LSALiveLinkSettings">();
	}
...
static_assert(alignof(ULSALiveLinkSettings) == 0x000008, "Wrong alinment on ULSALiveLinkSettings");
...
{
public:
	uint8                                         Pad_4BC6[0x8];                                     // 0x00B0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4BC7[0x80];                                    // 0x0100(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveLinkTestSkelMeshTrackerComponent">();
	}
...
static_assert(alignof(ULiveLinkTestSkelMeshTrackerComponent) == 0x000008, "Wrong alinment on ULiveLinkTestSkelMeshTrackerComponent");
