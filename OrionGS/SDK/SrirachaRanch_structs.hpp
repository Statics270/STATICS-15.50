...
static_assert(alignof(FAthenaRadioStation) == 0x000008, "Wrong alinment on FAthenaRadioStation");
...
static_assert(alignof(FSrirachaInputMappingData) == 0x000008, "Wrong alinment on FSrirachaInputMappingData");
...
public:
	...
	uint8                                         Pad_47A3[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47A4[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAthenaRadioStation                    SourceOverride;                                    // 0x0010(0x0038)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FStreamingRadioSourceData) == 0x000008, "Wrong alinment on FStreamingRadioSourceData");
...
static_assert(alignof(FSrirachaPerClassSpecialSeats) == 0x000008, "Wrong alinment on FSrirachaPerClassSpecialSeats");
