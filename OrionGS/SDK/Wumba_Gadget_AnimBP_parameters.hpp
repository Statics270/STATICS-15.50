...
static_assert(alignof(Wumba_Gadget_AnimBP_C_ExecuteUbergraph_Wumba_Gadget_AnimBP) == 0x000004, "Wrong alinment on Wumba_Gadget_AnimBP_C_ExecuteUbergraph_Wumba_Gadget_AnimBP");
...
static_assert(alignof(Wumba_Gadget_AnimBP_C_UpdateUpgradingVisuals) == 0x000001, "Wrong alinment on Wumba_Gadget_AnimBP_C_UpdateUpgradingVisuals");
...
static_assert(alignof(Wumba_Gadget_AnimBP_C_AnimGraph) == 0x000008, "Wrong alinment on Wumba_Gadget_AnimBP_C_AnimGraph");
static_assert(sizeof(Wumba_Gadget_AnimBP_C_AnimGraph) == 0x000010, "Wrong size on Wumba_Gadget_AnimBP_C_AnimGraph");
static_assert(offsetof(Wumba_Gadget_AnimBP_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'Wumba_Gadget_AnimBP_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
