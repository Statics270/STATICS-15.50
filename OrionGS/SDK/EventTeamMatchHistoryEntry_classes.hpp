...
public:
	...
	FMulticastInlineDelegateProperty_             Hovered;                                           // 0x0C20(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             Unhovered;                                         // 0x0C30(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(alignof(UEventTeamMatchHistoryEntry_C) == 0x000008, "Wrong alinment on UEventTeamMatchHistoryEntry_C");
