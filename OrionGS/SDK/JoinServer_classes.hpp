...
public:
	...
	void ExecuteUbergraph_JoinServer(int32 EntryPoint, EFortUIState K2Node_Event_PreviousUIState);
...
static_assert(alignof(UJoinServer_C) == 0x000008, "Wrong alinment on UJoinServer_C");
