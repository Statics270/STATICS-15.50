...
static_assert(alignof(FEngineServiceNotification) == 0x000008, "Wrong alinment on FEngineServiceNotification");
...
static_assert(alignof(FEngineServiceTerminate) == 0x000008, "Wrong alinment on FEngineServiceTerminate");
...
static_assert(alignof(FEngineServiceExecuteCommand) == 0x000008, "Wrong alinment on FEngineServiceExecuteCommand");
...
static_assert(alignof(FEngineServiceAuthGrant) == 0x000008, "Wrong alinment on FEngineServiceAuthGrant");
...
static_assert(alignof(FEngineServiceAuthDeny) == 0x000008, "Wrong alinment on FEngineServiceAuthDeny");
...
public:
	...
	uint8                                         Pad_5381[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5382[0x4];                                     // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEngineServicePong) == 0x000008, "Wrong alinment on FEngineServicePong");
...
{
public:
	uint8                                         Pad_5383[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEngineServicePing) == 0x000001, "Wrong alinment on FEngineServicePing");
