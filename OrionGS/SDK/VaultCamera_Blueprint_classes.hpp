...
{
public:
	uint8                                         Pad_6FBD[0x8];                                     // 0x07D8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(AVaultCamera_Blueprint_C) == 0x000010, "Wrong alinment on AVaultCamera_Blueprint_C");
