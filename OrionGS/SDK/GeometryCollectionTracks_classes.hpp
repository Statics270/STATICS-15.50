...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"MovieSceneGeometryCollectionSection">();
	}
...
static_assert(alignof(UMovieSceneGeometryCollectionSection) == 0x000008, "Wrong alinment on UMovieSceneGeometryCollectionSection");
...
{
public:
	uint8                                         Pad_4F4D[0x8];                                     // 0x0078(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneGeometryCollectionTrack">();
	}
...
static_assert(alignof(UMovieSceneGeometryCollectionTrack) == 0x000008, "Wrong alinment on UMovieSceneGeometryCollectionTrack");
