...
void AAthenaGoosePickup::SetStaticMesh(class UStaticMesh* NewStaticMesh, TArray<class UMaterialInterface*>& MaterialsToSwap, int32 InDisplayIndex)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaMutator_Goose::HandleClientPawnEnteredVehicle(TScriptInterface<class IFortVehicleInterface>& Vehicle, class AFortPawn* Pawn, int32 SeatIndex)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaMutator_Goose::HandleClientPawnExitedVehicle(TScriptInterface<class IFortVehicleInterface>& Vehicle, class AFortPawn* Pawn, int32 SeatIndex)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaMutator_Goose::KillPlayerPawns(TArray<TWeakObjectPtr<class AFortPlayerPawn>>& PawnsToKill, struct FGameplayTagContainer& DeathReasonTags, class AController* EventInstigator, class AActor* DamageCauser)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaMutator_Goose::OnVehicleDied(class AFortAthenaVehicle* DestroyedVehicle, struct FGameplayTagContainer& InTags, class AController* EventInstigator, class AActor* DamageCauser)
{
	static class UFunction* Func = nullptr;
...
void UFortCheatManager_Goose::GooseGivePlaneBoostGE(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFortCheatManager_Goose::GooseGivePlaneEffect(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFortCheatManager_Goose::GooseGivePlaneHealthGE(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFortCheatManager_Goose::GooseSetPlaneLives(int32 NewLives)
{
	static class UFunction* Func = nullptr;
...
void UFortCheatManager_Goose::GooseUpgradePlaneGuns(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
