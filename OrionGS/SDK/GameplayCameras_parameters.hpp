...
public:
	...
	uint8                                         Pad_45A8[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45A9[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(MatineeCameraShake_StartMatineeCameraShake) == 0x000008, "Wrong alinment on MatineeCameraShake_StartMatineeCameraShake");
...
public:
	...
	uint8                                         Pad_45AA[0x3];                                     // 0x001D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45AB[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(MatineeCameraShake_StartMatineeCameraShakeFromSource) == 0x000008, "Wrong alinment on MatineeCameraShake_StartMatineeCameraShakeFromSource");
...
static_assert(alignof(MatineeCameraShake_BlueprintUpdateCameraShake) == 0x000010, "Wrong alinment on MatineeCameraShake_BlueprintUpdateCameraShake");
...
static_assert(alignof(MatineeCameraShake_ReceivePlayShake) == 0x000004, "Wrong alinment on MatineeCameraShake_ReceivePlayShake");
...
static_assert(alignof(MatineeCameraShake_ReceiveStopShake) == 0x000001, "Wrong alinment on MatineeCameraShake_ReceiveStopShake");
...
static_assert(alignof(MatineeCameraShake_ReceiveIsFinished) == 0x000001, "Wrong alinment on MatineeCameraShake_ReceiveIsFinished");
...
static_assert(alignof(MatineeCameraShakeFunctionLibrary_Conv_MatineeCameraShake) == 0x000008, "Wrong alinment on MatineeCameraShakeFunctionLibrary_Conv_MatineeCameraShake");
