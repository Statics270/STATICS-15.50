...
{
public:
	uint8                                         Pad_1D44[0x4];                                     // 0x0000(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCurieContainerHandle) == 0x000004, "Wrong alinment on FCurieContainerHandle");
...
{
public:
	uint8                                         Pad_1D45[0x10];                                    // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCurieInteractParamsHandle) == 0x000008, "Wrong alinment on FCurieInteractParamsHandle");
...
{
public:
	uint8                                         Pad_1D46[0x4];                                     // 0x0000(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCurieInteractHandle) == 0x000004, "Wrong alinment on FCurieInteractHandle");
...
{
public:
	uint8                                         Pad_1D47[0x4];                                     // 0x0000(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCurieElementHandle) == 0x000004, "Wrong alinment on FCurieElementHandle");
...
{
public:
	uint8                                         Pad_1D48[0x4];                                     // 0x0000(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCurieStateHandle) == 0x000004, "Wrong alinment on FCurieStateHandle");
...
static_assert(alignof(FCurieEffectContainer) == 0x000008, "Wrong alinment on FCurieEffectContainer");
...
static_assert(alignof(FCurieEntityStateDefinitionBase) == 0x000008, "Wrong alinment on FCurieEntityStateDefinitionBase");
...
public:
	...
	uint8                                         Pad_1D4A[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCurieElementDefinitionBase) == 0x000008, "Wrong alinment on FCurieElementDefinitionBase");
...
static_assert(alignof(FCurieMaterialDefinitionBase) == 0x000008, "Wrong alinment on FCurieMaterialDefinitionBase");
