...
public:
	...
	uint8                                         Pad_4BAD[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FImagePlateParameters) == 0x000008, "Wrong alinment on FImagePlateParameters");
...
public:
	...
	uint8                                         Pad_4BAF[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneImagePlateSectionParams) == 0x000008, "Wrong alinment on FMovieSceneImagePlateSectionParams");
...
static_assert(alignof(FMovieSceneImagePlateSectionTemplate) == 0x000008, "Wrong alinment on FMovieSceneImagePlateSectionTemplate");
