...
{
public:
	uint8                                         Pad_6C57[0x8];                                     // 0x02B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6C58[0x7];                                     // 0x02C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6C59[0x8];                                     // 0x0328(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UFlopper_Gadget_AnimBP_C) == 0x000010, "Wrong alinment on UFlopper_Gadget_AnimBP_C");
