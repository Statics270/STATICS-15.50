...
public:
	...
	uint8                                         Pad_6B0A[0x3];                                     // 0x03A5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UAthenaMOTDSimpleNewsWidget_C) == 0x000008, "Wrong alinment on UAthenaMOTDSimpleNewsWidget_C");
