...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ClientPilotComponent">();
	}
...
static_assert(alignof(UClientPilotComponent) == 0x000008, "Wrong alinment on UClientPilotComponent");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ClientPilotBlackboardManager">();
	}
...
static_assert(alignof(UClientPilotBlackboardManager) == 0x000008, "Wrong alinment on UClientPilotBlackboardManager");
...
{
public:
	uint8                                         Pad_4FCC[0x50];                                    // 0x0028(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ClientPilotBlackboard">();
	}
...
static_assert(alignof(UClientPilotBlackboard) == 0x000008, "Wrong alinment on UClientPilotBlackboard");
