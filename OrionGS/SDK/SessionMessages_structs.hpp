...
{
public:
	uint8                                         Pad_53A6[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSessionServiceLogUnsubscribe) == 0x000001, "Wrong alinment on FSessionServiceLogUnsubscribe");
...
{
public:
	uint8                                         Pad_53A7[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSessionServiceLogSubscribe) == 0x000001, "Wrong alinment on FSessionServiceLogSubscribe");
...
public:
	...
	uint8                                         Pad_53A8[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSessionServiceLog) == 0x000008, "Wrong alinment on FSessionServiceLog");
...
public:
	...
	uint8                                         Pad_53AA[0x7];                                     // 0x0089(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSessionServicePong) == 0x000008, "Wrong alinment on FSessionServicePong");
...
static_assert(alignof(FSessionServicePing) == 0x000008, "Wrong alinment on FSessionServicePing");
