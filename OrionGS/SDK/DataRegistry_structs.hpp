...
{
public:
	uint8                                         Pad_1D1D[0x20];                                    // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDataRegistryLookup) == 0x000008, "Wrong alinment on FDataRegistryLookup");
...
static_assert(alignof(FDataRegistryType) == 0x000004, "Wrong alinment on FDataRegistryType");
...
static_assert(alignof(FDataRegistryId) == 0x000004, "Wrong alinment on FDataRegistryId");
...
static_assert(alignof(FDataRegistrySource_DataTableRules) == 0x000004, "Wrong alinment on FDataRegistrySource_DataTableRules");
...
{
public:
	uint8                                         Pad_1D1F[0x40];                                    // 0x0000(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDataRegistrySourceItemId) == 0x000008, "Wrong alinment on FDataRegistrySourceItemId");
...
public:
	...
	uint8                                         Pad_1D20[0x2];                                     // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FDataRegistryCachePolicy) == 0x000004, "Wrong alinment on FDataRegistryCachePolicy");
...
static_assert(alignof(FDataRegistryIdFormat) == 0x000004, "Wrong alinment on FDataRegistryIdFormat");
