...
public:
	...
	uint8                                         Pad_4AEB[0x10];                                    // 0x0140(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"MovieSceneLiveLinkSection">();
	}
...
static_assert(alignof(UMovieSceneLiveLinkSection) == 0x000008, "Wrong alinment on UMovieSceneLiveLinkSection");
...
public:
	...
	uint8                                         Pad_4AEC[0x10];                                    // 0x0040(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneLiveLinkSubSection">();
	}
...
static_assert(alignof(UMovieSceneLiveLinkSubSection) == 0x000008, "Wrong alinment on UMovieSceneLiveLinkSubSection");
...
{
public:
	uint8                                         Pad_4AED[0x10];                                    // 0x0050(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneLiveLinkSubSectionAnimation">();
	}
...
static_assert(alignof(UMovieSceneLiveLinkSubSectionAnimation) == 0x000008, "Wrong alinment on UMovieSceneLiveLinkSubSectionAnimation");
...
{
public:
	uint8                                         Pad_4AEE[0x10];                                    // 0x0050(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneLiveLinkSubSectionBasicRole">();
	}
...
static_assert(alignof(UMovieSceneLiveLinkSubSectionBasicRole) == 0x000008, "Wrong alinment on UMovieSceneLiveLinkSubSectionBasicRole");
...
{
public:
	uint8                                         Pad_4AEF[0x10];                                    // 0x0050(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneLiveLinkSubSectionProperties">();
	}
...
static_assert(alignof(UMovieSceneLiveLinkSubSectionProperties) == 0x000008, "Wrong alinment on UMovieSceneLiveLinkSubSectionProperties");
...
{
public:
	uint8                                         Pad_4AF0[0x8];                                     // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneLiveLinkTrack">();
	}
...
static_assert(alignof(UMovieSceneLiveLinkTrack) == 0x000008, "Wrong alinment on UMovieSceneLiveLinkTrack");
