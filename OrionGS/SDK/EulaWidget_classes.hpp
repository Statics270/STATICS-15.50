...
{
public:
	FMulticastInlineDelegateProperty_             OnEulaResponse;                                    // 0x0498(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(alignof(UEulaWidget_C) == 0x000008, "Wrong alinment on UEulaWidget_C");
