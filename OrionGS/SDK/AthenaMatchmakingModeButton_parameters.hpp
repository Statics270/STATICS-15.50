...
static_assert(alignof(AthenaMatchmakingModeButton_C_RefreshLimitedPoolWarning) == 0x000001, "Wrong alinment on AthenaMatchmakingModeButton_C_RefreshLimitedPoolWarning");
...
static_assert(alignof(AthenaMatchmakingModeButton_C_SetSquadFillText) == 0x000001, "Wrong alinment on AthenaMatchmakingModeButton_C_SetSquadFillText");
...
static_assert(alignof(AthenaMatchmakingModeButton_C_PlaylistChanged) == 0x000008, "Wrong alinment on AthenaMatchmakingModeButton_C_PlaylistChanged");
...
static_assert(alignof(AthenaMatchmakingModeButton_C_SetTabLabelInfo) == 0x000008, "Wrong alinment on AthenaMatchmakingModeButton_C_SetTabLabelInfo");
...
static_assert(alignof(AthenaMatchmakingModeButton_C_OnMouseEnter) == 0x000008, "Wrong alinment on AthenaMatchmakingModeButton_C_OnMouseEnter");
...
static_assert(alignof(AthenaMatchmakingModeButton_C_OnMouseLeave) == 0x000008, "Wrong alinment on AthenaMatchmakingModeButton_C_OnMouseLeave");
...
public:
	...
	uint8                                         Pad_766C[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(AthenaMatchmakingModeButton_C_ExecuteUbergraph_AthenaMatchmakingModeButton) == 0x000008, "Wrong alinment on AthenaMatchmakingModeButton_C_ExecuteUbergraph_AthenaMatchmakingModeButton");
