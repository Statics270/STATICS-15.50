...
public:
	...
	uint8                                         Pad_63E5[0x4];                                     // 0x029C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_63E6[0x7];                                     // 0x02A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_63E7[0x7];                                     // 0x02B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void PlaySpawnAnim(class UAnimationAsset* Temp_object_Variable, bool Temp_bool_Variable, class UAnimationAsset* Temp_object_Variable_1, class UAnimationAsset* Temp_object_Variable_2, bool Temp_bool_Variable_1, class UAnimInstance* CallFunc_GetAnimInstance_ReturnValue, class UAnimationAsset* K2Node_Select_Default, class UAnimationAsset* K2Node_Select_Default_1, TDelegate<void(class UAnimMontage* Montage, bool bInterrupted)> K2Node_CreateDelegate_OutputDelegate);
...
static_assert(alignof(ABP_TeleportationDrone_C) == 0x000008, "Wrong alinment on ABP_TeleportationDrone_C");
