...
static_assert(alignof(IPlayerSurveyMultipleChoiceListItemWidgetInterface_C) == 0x000008, "Wrong alinment on IPlayerSurveyMultipleChoiceListItemWidgetInterface_C");
