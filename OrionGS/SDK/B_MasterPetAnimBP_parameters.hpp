...
static_assert(alignof(B_MasterPetAnimBP_C_ExecuteUbergraph_B_MasterPetAnimBP) == 0x000004, "Wrong alinment on B_MasterPetAnimBP_C_ExecuteUbergraph_B_MasterPetAnimBP");
...
static_assert(alignof(B_MasterPetAnimBP_C_AnimGraph) == 0x000008, "Wrong alinment on B_MasterPetAnimBP_C_AnimGraph");
...
static_assert(alignof(B_MasterPetAnimBP_C_PetFullOverrideLayer) == 0x000008, "Wrong alinment on B_MasterPetAnimBP_C_PetFullOverrideLayer");
...
static_assert(alignof(B_MasterPetAnimBP_C_PetSkeletalControlLayer) == 0x000008, "Wrong alinment on B_MasterPetAnimBP_C_PetSkeletalControlLayer");
