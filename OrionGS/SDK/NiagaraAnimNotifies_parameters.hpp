...
static_assert(alignof(AnimNotify_PlayNiagaraEffect_GetSpawnedEffect) == 0x000008, "Wrong alinment on AnimNotify_PlayNiagaraEffect_GetSpawnedEffect");
...
static_assert(alignof(AnimNotifyState_TimedNiagaraEffect_GetSpawnedEffect) == 0x000008, "Wrong alinment on AnimNotifyState_TimedNiagaraEffect_GetSpawnedEffect");
...
public:
	...
	uint8                                         Pad_4415[0x4];                                     // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AnimNotifyState_TimedNiagaraEffectAdvanced_GetNotifyProgress) == 0x000008, "Wrong alinment on AnimNotifyState_TimedNiagaraEffectAdvanced_GetNotifyProgress");
