...
static_assert(alignof(FMediaPlayerTrackOptions) == 0x000004, "Wrong alinment on FMediaPlayerTrackOptions");
...
public:
	...
	uint8                                         Pad_5376[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5377[0x6];                                     // 0x002A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMediaPlayerOptions) == 0x000008, "Wrong alinment on FMediaPlayerOptions");
