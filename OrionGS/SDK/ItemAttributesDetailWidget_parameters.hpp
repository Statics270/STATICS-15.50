...
public:
	...
	uint8                                         Pad_76AA[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ItemAttributesDetailWidget_C_UpdateItemsForWidgets) == 0x000008, "Wrong alinment on ItemAttributesDetailWidget_C_UpdateItemsForWidgets");
...
static_assert(alignof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget) == 0x000004, "Wrong alinment on ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget");
