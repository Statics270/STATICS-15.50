...
static_assert(alignof(ABP_ProjectileTrajectory_SnapToGrid_BirthdayBox_C) == 0x000008, "Wrong alinment on ABP_ProjectileTrajectory_SnapToGrid_BirthdayBox_C");
