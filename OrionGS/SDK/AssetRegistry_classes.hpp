...
{
public:
	uint8                                         Pad_51E6[0x828];                                   // 0x0028(0x0828)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AssetRegistryImpl">();
	}
...
static_assert(alignof(UAssetRegistryImpl) == 0x000008, "Wrong alinment on UAssetRegistryImpl");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AssetRegistryHelpers">();
	}
...
static_assert(alignof(UAssetRegistryHelpers) == 0x000008, "Wrong alinment on UAssetRegistryHelpers");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AssetRegistry">();
	}
...
static_assert(alignof(IAssetRegistry) == 0x000008, "Wrong alinment on IAssetRegistry");
