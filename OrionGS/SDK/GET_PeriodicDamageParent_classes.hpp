...
static_assert(alignof(UGET_PeriodicDamageParent_C) == 0x000008, "Wrong alinment on UGET_PeriodicDamageParent_C");
static_assert(sizeof(UGET_PeriodicDamageParent_C) == 0x000800, "Wrong size on UGET_PeriodicDamageParent_C");
