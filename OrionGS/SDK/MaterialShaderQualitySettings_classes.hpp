...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"MaterialShaderQualitySettings">();
	}
...
static_assert(alignof(UMaterialShaderQualitySettings) == 0x000008, "Wrong alinment on UMaterialShaderQualitySettings");
...
public:
	...
	uint8                                         Pad_5083[0x14];                                    // 0x004C(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ShaderPlatformQualitySettings">();
	}
...
static_assert(alignof(UShaderPlatformQualitySettings) == 0x000008, "Wrong alinment on UShaderPlatformQualitySettings");
