...
public:
	...
	uint8                                         Pad_4800[0x4];                                     // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AmbisonicsEncodingSettings">();
	}
...
static_assert(alignof(UAmbisonicsEncodingSettings) == 0x000008, "Wrong alinment on UAmbisonicsEncodingSettings");
