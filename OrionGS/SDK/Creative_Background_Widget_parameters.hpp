...
static_assert(alignof(Creative_Background_Widget_C_SetText) == 0x000008, "Wrong alinment on Creative_Background_Widget_C_SetText");
...
static_assert(alignof(Creative_Background_Widget_C_SetBackgroundColor) == 0x000004, "Wrong alinment on Creative_Background_Widget_C_SetBackgroundColor");
...
static_assert(alignof(Creative_Background_Widget_C_SetTextScale) == 0x000008, "Wrong alinment on Creative_Background_Widget_C_SetTextScale");
...
static_assert(alignof(Creative_Background_Widget_C_SetTextAlignment) == 0x000001, "Wrong alinment on Creative_Background_Widget_C_SetTextAlignment");
...
static_assert(alignof(Creative_Background_Widget_C_SetTextColor) == 0x000008, "Wrong alinment on Creative_Background_Widget_C_SetTextColor");
...
public:
	...
	uint8                                         Pad_5872[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5873[0x4];                                     // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(Creative_Background_Widget_C_SetTextFont) == 0x000008, "Wrong alinment on Creative_Background_Widget_C_SetTextFont");
...
public:
	...
	uint8                                         Pad_5874[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5875[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5876[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              K2Node_Select_Default;                             // 0x004C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Creative_Background_Widget_C_SetShadow) == 0x000004, "Wrong alinment on Creative_Background_Widget_C_SetShadow");
