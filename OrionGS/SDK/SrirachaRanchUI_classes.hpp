...
public:
	...
	uint8                                         Pad_47F0[0x8];                                     // 0x0100(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FortMobileActionButtonBehavior_ToggleRadio">();
	}
...
static_assert(alignof(UFortMobileActionButtonBehavior_ToggleRadio) == 0x000008, "Wrong alinment on UFortMobileActionButtonBehavior_ToggleRadio");
...
{
public:
	uint8                                         Pad_47F1[0x40];                                    // 0x02C8(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortPrioritizedWidgetData             PriorityData;                                      // 0x0308(0x0002)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_47F2[0x6];                                     // 0x030A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"RadioPlayerWidgetBase">();
	}
...
static_assert(alignof(URadioPlayerWidgetBase) == 0x000008, "Wrong alinment on URadioPlayerWidgetBase");
