...
static_assert(alignof(SplashScreenWidget_C_OnInputMethodChanged) == 0x000001, "Wrong alinment on SplashScreenWidget_C_OnInputMethodChanged");
...
public:
	...
	uint8                                         Pad_6B6F[0x6];                                     // 0x0012(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(SplashScreenWidget_C_ExecuteUbergraph_SplashScreenWidget) == 0x000008, "Wrong alinment on SplashScreenWidget_C_ExecuteUbergraph_SplashScreenWidget");
