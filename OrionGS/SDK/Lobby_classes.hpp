...
public:
	...
	uint8                                         Pad_48A3[0x1];                                     // 0x02C0(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_48A4[0x76];                                    // 0x02C2(0x0076)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"LobbyBeaconClient">();
	}
...
static_assert(alignof(ALobbyBeaconClient) == 0x000008, "Wrong alinment on ALobbyBeaconClient");
...
{
public:
	uint8                                         Pad_48A6[0x8];                                     // 0x0248(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LobbyBeaconHost">();
	}
...
static_assert(alignof(ALobbyBeaconHost) == 0x000008, "Wrong alinment on ALobbyBeaconHost");
...
public:
	...
	uint8                                         Pad_48A7[0x7];                                     // 0x0289(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_48A8[0x48];                                    // 0x0298(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LobbyBeaconPlayerState">();
	}
...
static_assert(alignof(ALobbyBeaconPlayerState) == 0x000008, "Wrong alinment on ALobbyBeaconPlayerState");
...
public:
	...
	uint8                                         Pad_48A9[0x4];                                     // 0x0224(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_48AA[0x8];                                     // 0x0230(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_48AB[0x3];                                     // 0x0239(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_48AC[0x68];                                    // 0x0360(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LobbyBeaconState">();
	}
...
static_assert(alignof(ALobbyBeaconState) == 0x000008, "Wrong alinment on ALobbyBeaconState");
