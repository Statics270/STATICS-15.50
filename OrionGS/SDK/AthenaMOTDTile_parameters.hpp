...
static_assert(alignof(AthenaMOTDTile_C_UpdateDisplay) == 0x000001, "Wrong alinment on AthenaMOTDTile_C_UpdateDisplay");
...
static_assert(alignof(AthenaMOTDTile_C_ShowImageOnly) == 0x000001, "Wrong alinment on AthenaMOTDTile_C_ShowImageOnly");
...
static_assert(alignof(AthenaMOTDTile_C_OnMouseEnter) == 0x000008, "Wrong alinment on AthenaMOTDTile_C_OnMouseEnter");
...
static_assert(alignof(AthenaMOTDTile_C_OnMouseLeave) == 0x000008, "Wrong alinment on AthenaMOTDTile_C_OnMouseLeave");
...
static_assert(alignof(AthenaMOTDTile_C_PreConstruct) == 0x000001, "Wrong alinment on AthenaMOTDTile_C_PreConstruct");
...
public:
	...
	uint8                                         Pad_77D7[0x1];                                     // 0x0007(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(AthenaMOTDTile_C_ExecuteUbergraph_AthenaMOTDTile) == 0x000008, "Wrong alinment on AthenaMOTDTile_C_ExecuteUbergraph_AthenaMOTDTile");
...
static_assert(alignof(AthenaMOTDTile_C_OnHoveredChanged__DelegateSignature) == 0x000001, "Wrong alinment on AthenaMOTDTile_C_OnHoveredChanged__DelegateSignature");
