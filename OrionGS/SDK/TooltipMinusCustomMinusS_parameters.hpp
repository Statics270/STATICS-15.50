...
static_assert(alignof(TooltipMinusCustomMinusS_C_ExecuteUbergraph_TooltipMinusCustomMinusS) == 0x000008, "Wrong alinment on TooltipMinusCustomMinusS_C_ExecuteUbergraph_TooltipMinusCustomMinusS");
...
static_assert(alignof(TooltipMinusCustomMinusS_C_Get_Body_Text) == 0x000008, "Wrong alinment on TooltipMinusCustomMinusS_C_Get_Body_Text");
...
static_assert(alignof(TooltipMinusCustomMinusS_C_Get_Header_Text) == 0x000008, "Wrong alinment on TooltipMinusCustomMinusS_C_Get_Header_Text");
...
static_assert(alignof(TooltipMinusCustomMinusS_C_Get_Icon_Brush) == 0x000008, "Wrong alinment on TooltipMinusCustomMinusS_C_Get_Icon_Brush");
