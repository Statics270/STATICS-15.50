...
static_assert(alignof(VUIActor_OnDrawHUD) == 0x000008, "Wrong alinment on VUIActor_OnDrawHUD");
...
static_assert(alignof(VUIActor_OnPossessed) == 0x000008, "Wrong alinment on VUIActor_OnPossessed");
...
static_assert(alignof(VUIActor_OnRep_PlayerController) == 0x000008, "Wrong alinment on VUIActor_OnRep_PlayerController");
...
static_assert(alignof(VUIActor_OnUnPossessed) == 0x000008, "Wrong alinment on VUIActor_OnUnPossessed");
...
static_assert(alignof(VUIActor_ServerReceiveClientInput) == 0x000008, "Wrong alinment on VUIActor_ServerReceiveClientInput");
...
static_assert(alignof(VUIActor_GetController) == 0x000008, "Wrong alinment on VUIActor_GetController");
...
static_assert(alignof(VUIActor_GetVUIMode) == 0x000004, "Wrong alinment on VUIActor_GetVUIMode");
...
static_assert(alignof(VUIActor_K2_GetSpawnedBrainObject) == 0x000008, "Wrong alinment on VUIActor_K2_GetSpawnedBrainObject");
