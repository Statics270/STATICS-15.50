...
public:
	...
	uint8                                         Pad_774B[0x2];                                     // 0x0062(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_Select_Default;                             // 0x0064(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(OptionsMenuHeader_C_SetFontSize) == 0x000008, "Wrong alinment on OptionsMenuHeader_C_SetFontSize");
...
public:
	...
	uint8                                         Pad_774C[0x5];                                     // 0x0003(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(OptionsMenuHeader_C_HandlePawnSet) == 0x000008, "Wrong alinment on OptionsMenuHeader_C_HandlePawnSet");
...
public:
	...
	uint8                                         Pad_774D[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_774E[0x3];                                     // 0x0025(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              K2Node_Select_Default;                             // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(OptionsMenuHeader_C_UpdateSize) == 0x000004, "Wrong alinment on OptionsMenuHeader_C_UpdateSize");
...
static_assert(alignof(OptionsMenuHeader_C_BP_OnItemSelectionChanged) == 0x000001, "Wrong alinment on OptionsMenuHeader_C_BP_OnItemSelectionChanged");
...
static_assert(alignof(OptionsMenuHeader_C_OnMouseLeave) == 0x000008, "Wrong alinment on OptionsMenuHeader_C_OnMouseLeave");
...
static_assert(alignof(OptionsMenuHeader_C_OnMouseEnter) == 0x000008, "Wrong alinment on OptionsMenuHeader_C_OnMouseEnter");
...
static_assert(alignof(OptionsMenuHeader_C_OnListItemObjectSet) == 0x000008, "Wrong alinment on OptionsMenuHeader_C_OnListItemObjectSet");
...
static_assert(alignof(OptionsMenuHeader_C_BP_OnItemExpansionChanged) == 0x000001, "Wrong alinment on OptionsMenuHeader_C_BP_OnItemExpansionChanged");
...
public:
	...
	uint8                                         Pad_774F[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7750[0x2];                                     // 0x001A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x001C(0x0038)(IsPlainOldData, NoDestructor)
	uint8                                         Pad_7751[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7752[0x7];                                     // 0x0139(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader) == 0x000008, "Wrong alinment on OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader");
