...
static_assert(alignof(AmbientAudioStatics_AddAmbientEntry) == 0x000008, "Wrong alinment on AmbientAudioStatics_AddAmbientEntry");
...
static_assert(alignof(AmbientAudioStatics_AddAmbientGameplayTag) == 0x000008, "Wrong alinment on AmbientAudioStatics_AddAmbientGameplayTag");
...
static_assert(alignof(AmbientAudioStatics_CreateAudioComponent) == 0x000008, "Wrong alinment on AmbientAudioStatics_CreateAudioComponent");
...
public:
	...
	uint8                                         Pad_4D19[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AmbientAudioStatics_PlaySoundAtLocation) == 0x000008, "Wrong alinment on AmbientAudioStatics_PlaySoundAtLocation");
...
static_assert(alignof(AmbientAudioStatics_RemoveAmbientEntry) == 0x000008, "Wrong alinment on AmbientAudioStatics_RemoveAmbientEntry");
...
static_assert(alignof(AmbientAudioStatics_RemoveAmbientGameplayTag) == 0x000008, "Wrong alinment on AmbientAudioStatics_RemoveAmbientGameplayTag");
...
static_assert(alignof(AmbientAudioSubsystem_AddAmbientEntry) == 0x000008, "Wrong alinment on AmbientAudioSubsystem_AddAmbientEntry");
...
static_assert(alignof(AmbientAudioSubsystem_AddGameplayTag) == 0x000004, "Wrong alinment on AmbientAudioSubsystem_AddGameplayTag");
...
static_assert(alignof(AmbientAudioSubsystem_RemoveAmbientEntry) == 0x000004, "Wrong alinment on AmbientAudioSubsystem_RemoveAmbientEntry");
...
static_assert(alignof(AmbientAudioSubsystem_RemoveGameplayTag) == 0x000004, "Wrong alinment on AmbientAudioSubsystem_RemoveGameplayTag");
...
static_assert(alignof(AmbientVolume_SetAmbientAsset) == 0x000008, "Wrong alinment on AmbientVolume_SetAmbientAsset");
...
static_assert(alignof(AmbientVolume_SetCrossfadeTime) == 0x000004, "Wrong alinment on AmbientVolume_SetCrossfadeTime");
...
static_assert(alignof(AmbientVolume_SetEnabled) == 0x000001, "Wrong alinment on AmbientVolume_SetEnabled");
...
static_assert(alignof(AmbientVolume_SetPriority) == 0x000004, "Wrong alinment on AmbientVolume_SetPriority");
