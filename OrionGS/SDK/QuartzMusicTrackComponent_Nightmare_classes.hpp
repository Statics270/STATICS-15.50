...
{
public:
	uint8                                         Pad_5F78[0x7];                                     // 0x01B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void ExecuteUbergraph_QuartzMusicTrackComponent_Nightmare(int32 EntryPoint, float CallFunc_FMin_ReturnValue, float CallFunc_GetWorldDeltaSeconds_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, float CallFunc_SelectFloat_ReturnValue, float CallFunc_FInterpTo_ReturnValue, float CallFunc_FMin_ReturnValue_1, float CallFunc_FMin_ReturnValue_2, bool CallFunc_Greater_FloatFloat_ReturnValue_1, bool CallFunc_Greater_FloatFloat_ReturnValue_2, float CallFunc_SelectFloat_ReturnValue_1, float CallFunc_SelectFloat_ReturnValue_2, float CallFunc_FInterpTo_ReturnValue_1, float CallFunc_FInterpTo_ReturnValue_2, class UFortGameplayDataTrackerComponent* CallFunc_GetDataTrackerComponent_DataTracker, float CallFunc_GetEventValue_ReturnValue, float CallFunc_GetEventValue_ReturnValue_1, float CallFunc_GetEventValue_ReturnValue_2, float CallFunc_FMax_ReturnValue, float CallFunc_GetFloatValue_ReturnValue, float CallFunc_GetFloatValue_ReturnValue_1, float CallFunc_FMax_ReturnValue_1, float CallFunc_GetFloatValue_ReturnValue_2);
...
static_assert(alignof(UQuartzMusicTrackComponent_Nightmare_C) == 0x000008, "Wrong alinment on UQuartzMusicTrackComponent_Nightmare_C");
