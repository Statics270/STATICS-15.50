...
public:
	...
	uint8                                         Pad_48D6[0x8];                                     // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ImageWriteBlueprintLibrary_ExportToDisk) == 0x000010, "Wrong alinment on ImageWriteBlueprintLibrary_ExportToDisk");
