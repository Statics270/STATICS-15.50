...
{
public:
	uint8                                         Pad_487E[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FOnlinePartyRepDataBase) == 0x000008, "Wrong alinment on FOnlinePartyRepDataBase");
...
static_assert(alignof(FSocialPlatformDescription) == 0x000008, "Wrong alinment on FSocialPlatformDescription");
...
static_assert(alignof(FUserPlatform) == 0x000008, "Wrong alinment on FUserPlatform");
...
public:
	...
	uint8                                         Pad_4883[0x37];                                    // 0x0141(0x0037)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPartyMemberRepData) == 0x000008, "Wrong alinment on FPartyMemberRepData");
...
static_assert(alignof(FPartyPrivacySettings) == 0x000001, "Wrong alinment on FPartyPrivacySettings");
...
static_assert(alignof(FPartyPlatformSessionInfo) == 0x000008, "Wrong alinment on FPartyPlatformSessionInfo");
...
public:
	...
	uint8                                         Pad_4884[0x10];                                    // 0x0008(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4885[0x18];                                    // 0x0028(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSocialChatChannelConfig) == 0x000008, "Wrong alinment on FSocialChatChannelConfig");
...
{
public:
	uint8                                         Pad_4886[0x8];                                     // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyPrivacySettings                  PrivacySettings;                                   // 0x0020(0x0003)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_4887[0x35];                                    // 0x0023(0x0035)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4888[0x18];                                    // 0x0068(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPartyRepData) == 0x000008, "Wrong alinment on FPartyRepData");
