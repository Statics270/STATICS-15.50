...
void UVoteListenerComponent::OnVoteEnd(struct FGameplayTag& VoteSessionId, struct FGameplayTag& VoteId, struct FGameplayTag& WinningVoteSelectionId, EVoteState VoteState)
{
	static class UFunction* Func = nullptr;
...
void UVoteListenerComponent::OnVoteSessionSetup(struct FGameplayTag& VoteSessionId, struct FGameplayTag& StartingVoteId, EVoteSessionNetworkType NetworkType, EVoteSessionState SessionState)
{
	static class UFunction* Func = nullptr;
...
void UVoteListenerComponent::OnVoteSessionVoting(struct FGameplayTag& VoteSessionId, struct FGameplayTag& StartingVoteId, EVoteSessionState SessionState)
{
	static class UFunction* Func = nullptr;
...
void UVoteListenerComponent::OnVoteSetup(struct FGameplayTag& VoteSessionId, struct FGameplayTag& VoteId, EVoteState VoteState)
{
	static class UFunction* Func = nullptr;
...
void UVoteListenerComponent::OnVoteStart(struct FGameplayTag& VoteSessionId, struct FGameplayTag& VoteId, EVoteState VoteState)
{
	static class UFunction* Func = nullptr;
