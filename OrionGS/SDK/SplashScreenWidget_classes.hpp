...
public:
	...
	void ExecuteUbergraph_SplashScreenWidget(int32 EntryPoint, ECommonInputType K2Node_Event_InputType, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_IsMobileApp_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool Temp_bool_Variable, class UWidget* K2Node_Select_Default);
...
static_assert(alignof(USplashScreenWidget_C) == 0x000008, "Wrong alinment on USplashScreenWidget_C");
