...
void AFortAthenaMutator_Phosphorus::GetLeadingTeamNums(TArray<uint8>* LeadingTeamNums) const
{
	...
	if (LeadingTeamNums != nullptr)
		*LeadingTeamNums = Parms.LeadingTeamNums;
}
...
void AFortAthenaMutator_Phosphorus::GetTeamDataArray(TArray<struct FPhosphorusTeamData>* OutTeamDataArray, bool bMustBeValid, bool bMustBeAlive, bool bSortByScore) const
{
	static class UFunction* Func = nullptr;
	...
	if (OutTeamDataArray != nullptr)
		*OutTeamDataArray = Parms.OutTeamDataArray;
}
...
struct FPhosphorusTeamData AFortAthenaMutator_Phosphorus::GetTeamDataCopy(uint8 TeamNum) const
{
	static class UFunction* Func = nullptr;
...
int32 AFortAthenaMutator_Phosphorus::GetTeamSize(uint8 TeamNum) const
{
	static class UFunction* Func = nullptr;
...
bool AFortAthenaMutator_Phosphorus::IsOnWinningTeam(class AFortPlayerPawnAthena* Pawn) const
{
	static class UFunction* Func = nullptr;
...
bool AFortAthenaMutator_Phosphorus::IsTeamAlive(uint8 TeamNum) const
{
	static class UFunction* Func = nullptr;
...
bool AFortAthenaMutator_Phosphorus::IsTeamValid(uint8 TeamNum) const
{
	static class UFunction* Func = nullptr;
