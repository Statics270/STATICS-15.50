...
{
public:
	uint8                                         Pad_516A[0x40];                                    // 0x0000(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBreakEventCallbackWrapper) == 0x000010, "Wrong alinment on FBreakEventCallbackWrapper");
...
static_assert(alignof(FChaosBreakEvent) == 0x000008, "Wrong alinment on FChaosBreakEvent");
...
public:
	...
	uint8                                         Pad_516B[0x4];                                     // 0x006C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FChaosPhysicsCollisionInfo) == 0x000008, "Wrong alinment on FChaosPhysicsCollisionInfo");
...
{
public:
	uint8                                         Pad_516C[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class UObject*>                          ChaosHandlers;                                     // 0x0008(0x0050)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FChaosHandlerSet) == 0x000008, "Wrong alinment on FChaosHandlerSet");
...
static_assert(alignof(FChaosDebugSubstepControl) == 0x000001, "Wrong alinment on FChaosDebugSubstepControl");
