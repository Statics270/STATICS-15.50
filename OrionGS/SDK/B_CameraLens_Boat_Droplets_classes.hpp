...
public:
	...
	uint8                                         Pad_59DA[0x3];                                     // 0x02ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(AB_CameraLens_Boat_Droplets_C) == 0x000010, "Wrong alinment on AB_CameraLens_Boat_Droplets_C");
