...
{
public:
	uint8                                         Pad_526A[0x8];                                     // 0x00B0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"EasyAntiCheatNetComponent">();
	}
...
static_assert(alignof(UEasyAntiCheatNetComponent) == 0x000008, "Wrong alinment on UEasyAntiCheatNetComponent");
