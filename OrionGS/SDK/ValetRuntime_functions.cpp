...
void AFortDagwoodVehicle::ApplyTireMod(struct FGameplayTag& NewTireModTag)
{
	static class UFunction* Func = nullptr;
...
void AFortDagwoodVehicle::OnRep_MountedWeapon(struct FMountedGun& PrevMountedWeapon)
{
	static class UFunction* Func = nullptr;
...
void AFortDagwoodVehicle::OnRep_RuntimeModifiers(struct FVehicleRuntimeModifiers& PrevMods)
{
	static class UFunction* Func = nullptr;
...
void AFortDagwoodVehicle::ServerSetTireModTag(struct FGameplayTag& TireModTag)
{
	static class UFunction* Func = nullptr;
...
bool AFortDagwoodVehicle::IsTireSkidding(float MinSpeedForSkid, float AngleForSkid, float SpeedForPeelout, float SpeedForBraking) const
{
	static class UFunction* Func = nullptr;
...
void AFortValetAudioController::OnSuspensionCollision_Native(bool* OutResult, float* OutMagnitude)
{
	...
	if (OutMagnitude != nullptr)
		*OutMagnitude = std::move(Parms.OutMagnitude);
}
