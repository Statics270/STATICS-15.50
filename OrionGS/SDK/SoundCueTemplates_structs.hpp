...
public:
	...
	uint8                                         Pad_4D13[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FSoundCueCrossfadeInfo) == 0x000008, "Wrong alinment on FSoundCueCrossfadeInfo");
...
public:
	...
	uint8                                         Pad_4D14[0x4];                                     // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSoundCueTemplateQualitySettings) == 0x000008, "Wrong alinment on FSoundCueTemplateQualitySettings");
