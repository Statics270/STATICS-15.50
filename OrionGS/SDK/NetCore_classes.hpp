...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"NetAnalyticsAggregatorConfig">();
	}
...
static_assert(alignof(UNetAnalyticsAggregatorConfig) == 0x000008, "Wrong alinment on UNetAnalyticsAggregatorConfig");
