...
public:
	...
	uint8                                         Pad_615A[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GA_Athena_SnowmanFlopper_C_ExecuteUbergraph_GA_Athena_SnowmanFlopper) == 0x000004, "Wrong alinment on GA_Athena_SnowmanFlopper_C_ExecuteUbergraph_GA_Athena_SnowmanFlopper");
...
static_assert(offsetof(GA_Athena_SnowmanFlopper_C_ExecuteUbergraph_GA_Athena_SnowmanFlopper, K2Node_Event_bWasCancelled) == 0x000004, "Member 'GA_Athena_SnowmanFlopper_C_ExecuteUbergraph_GA_Athena_SnowmanFlopper::K2Node_Event_bWasCancelled' has a wrong offset!");
static_assert(offsetof(GA_Athena_SnowmanFlopper_C_ExecuteUbergraph_GA_Athena_SnowmanFlopper, CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue) == 0x000008, "Member 'GA_Athena_SnowmanFlopper_C_ExecuteUbergraph_GA_Athena_SnowmanFlopper::CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue' has a wrong offset!");
...
static_assert(alignof(GA_Athena_SnowmanFlopper_C_K2_OnEndAbility) == 0x000001, "Wrong alinment on GA_Athena_SnowmanFlopper_C_K2_OnEndAbility");
...
public:
	...
	uint8                                         Pad_615B[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GA_Athena_SnowmanFlopper_C_Is_Flying) == 0x000008, "Wrong alinment on GA_Athena_SnowmanFlopper_C_Is_Flying");
...
public:
	...
	uint8                                         Pad_615C[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_615D[0x7];                                     // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GA_Athena_SnowmanFlopper_C_K2_CanActivateAbility) == 0x000008, "Wrong alinment on GA_Athena_SnowmanFlopper_C_K2_CanActivateAbility");
