...
static_assert(alignof(AthenaGlobalCash_C_OnQueryCompletedSuccessfully) == 0x000004, "Wrong alinment on AthenaGlobalCash_C_OnQueryCompletedSuccessfully");
...
static_assert(alignof(AthenaGlobalCash_C_ExecuteUbergraph_AthenaGlobalCash) == 0x000004, "Wrong alinment on AthenaGlobalCash_C_ExecuteUbergraph_AthenaGlobalCash");
