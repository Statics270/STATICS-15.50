...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AnimNotify_PlayMontageNotifyWindow">();
	}
...
static_assert(alignof(UAnimNotify_PlayMontageNotifyWindow) == 0x000008, "Wrong alinment on UAnimNotify_PlayMontageNotifyWindow");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AnimSequencerInstance">();
	}
...
static_assert(alignof(UAnimSequencerInstance) == 0x000010, "Wrong alinment on UAnimSequencerInstance");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AnimNotify_PlayMontageNotify">();
	}
...
static_assert(alignof(UAnimNotify_PlayMontageNotify) == 0x000008, "Wrong alinment on UAnimNotify_PlayMontageNotify");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"KismetAnimationLibrary">();
	}
...
static_assert(alignof(UKismetAnimationLibrary) == 0x000008, "Wrong alinment on UKismetAnimationLibrary");
...
public:
	...
	uint8                                         Pad_4B93[0x30];                                    // 0x0078(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"PlayMontageCallbackProxy">();
	}
...
static_assert(alignof(UPlayMontageCallbackProxy) == 0x000008, "Wrong alinment on UPlayMontageCallbackProxy");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SequencerAnimationSupport">();
	}
...
static_assert(alignof(ISequencerAnimationSupport) == 0x000008, "Wrong alinment on ISequencerAnimationSupport");
