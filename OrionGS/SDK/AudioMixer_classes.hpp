...
{
public:
	uint8                                         Pad_455D[0x88];                                    // 0x0068(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"SubmixEffectDynamicsProcessorPreset">();
	}
...
static_assert(alignof(USubmixEffectDynamicsProcessorPreset) == 0x000008, "Wrong alinment on USubmixEffectDynamicsProcessorPreset");
...
public:
	...
	uint8                                         BitPad_82 : 4;                                     // 0x00F8(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_455E[0x3];                                     // 0x01F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_455F[0x3];                                     // 0x01FD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4560[0x3];                                     // 0x0649(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4561[0x4];                                     // 0x0654(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4562[0x20];                                    // 0x0668(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4563[0x38];                                    // 0x0698(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SynthComponent">();
	}
...
static_assert(alignof(USynthComponent) == 0x000010, "Wrong alinment on USynthComponent");
...
{
public:
	uint8                                         Pad_4565[0x80];                                    // 0x0028(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AudioGenerator">();
	}
...
static_assert(alignof(UAudioGenerator) == 0x000008, "Wrong alinment on UAudioGenerator");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AudioMixerBlueprintLibrary">();
	}
...
static_assert(alignof(UAudioMixerBlueprintLibrary) == 0x000008, "Wrong alinment on UAudioMixerBlueprintLibrary");
...
{
public:
	uint8                                         Pad_4577[0x168];                                   // 0x0028(0x0168)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetBeatsPerMinute(class UObject* WorldContextObject, struct FQuartzQuantizationBoundary& QuantizationBoundary, TDelegate<void(EQuartzCommandDelegateSubType EventType, class FName Name)>& Delegate, float BeatsPerMinute);
	void SetMillisecondsPerTick(class UObject* WorldContextObject, struct FQuartzQuantizationBoundary& QuantizationBoundary, TDelegate<void(EQuartzCommandDelegateSubType EventType, class FName Name)>& Delegate, float MillisecondsPerTick);
	void SetSecondsPerTick(class UObject* WorldContextObject, struct FQuartzQuantizationBoundary& QuantizationBoundary, TDelegate<void(EQuartzCommandDelegateSubType EventType, class FName Name)>& Delegate, float SecondsPerTick);
	void SetThirtySecondNotesPerMinute(class UObject* WorldContextObject, struct FQuartzQuantizationBoundary& QuantizationBoundary, TDelegate<void(EQuartzCommandDelegateSubType EventType, class FName Name)>& Delegate, float ThirtySecondsNotesPerMinute);
	void SetTicksPerSecond(class UObject* WorldContextObject, struct FQuartzQuantizationBoundary& QuantizationBoundary, TDelegate<void(EQuartzCommandDelegateSubType EventType, class FName Name)>& Delegate, float TicksPerSecond);
	void SubscribeToAllQuantizationEvents(class UObject* WorldContextObject, TDelegate<void(class FName ClockName, EQuartzCommandQuantization QuantizationType, int32 NumBars, int32 Beat, float BeatFraction)>& OnQuantizationEvent);
	void SubscribeToQuantizationEvent(class UObject* WorldContextObject, EQuartzCommandQuantization InQuantizationBoundary, TDelegate<void(class FName ClockName, EQuartzCommandQuantization QuantizationType, int32 NumBars, int32 Beat, float BeatFraction)>& OnQuantizationEvent);
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"QuartzClockHandle">();
	}
...
static_assert(alignof(UQuartzClockHandle) == 0x000008, "Wrong alinment on UQuartzClockHandle");
...
{
public:
	uint8                                         Pad_4580[0x38];                                    // 0x0068(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SubmixEffectSubmixEQPreset">();
	}
...
static_assert(alignof(USubmixEffectSubmixEQPreset) == 0x000008, "Wrong alinment on USubmixEffectSubmixEQPreset");
...
{
public:
	uint8                                         Pad_4581[0x5C];                                    // 0x0068(0x005C)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SubmixEffectReverbPreset">();
	}
...
static_assert(alignof(USubmixEffectReverbPreset) == 0x000008, "Wrong alinment on USubmixEffectReverbPreset");
...
{
public:
	uint8                                         Pad_4582[0x60];                                    // 0x0068(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SubmixEffectReverbFastPreset">();
	}
...
static_assert(alignof(USubmixEffectReverbFastPreset) == 0x000008, "Wrong alinment on USubmixEffectReverbFastPreset");
...
{
public:
	uint8                                         Pad_4583[0x50];                                    // 0x0030(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"QuartzSubsystem">();
	}
...
static_assert(alignof(UQuartzSubsystem) == 0x000008, "Wrong alinment on UQuartzSubsystem");
...
public:
	...
	uint8                                         Pad_458C[0x18];                                    // 0x03A8(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SynthSound">();
	}
...
static_assert(alignof(USynthSound) == 0x000010, "Wrong alinment on USynthSound");
