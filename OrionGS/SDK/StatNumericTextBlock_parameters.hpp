...
static_assert(alignof(StatNumericTextBlock_C_SetComparisonState) == 0x000001, "Wrong alinment on StatNumericTextBlock_C_SetComparisonState");
...
public:
	...
	uint8                                         Pad_7816[0x2];                                     // 0x0006(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7817[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7818[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateColor                            K2Node_MakeStruct_SlateColor;                      // 0x0050(0x0028)()
};
static_assert(alignof(StatNumericTextBlock_C_UpdateComparison) == 0x000008, "Wrong alinment on StatNumericTextBlock_C_UpdateComparison");
...
static_assert(alignof(StatNumericTextBlock_C_PreConstruct) == 0x000001, "Wrong alinment on StatNumericTextBlock_C_PreConstruct");
...
static_assert(alignof(StatNumericTextBlock_C_ExecuteUbergraph_StatNumericTextBlock) == 0x000004, "Wrong alinment on StatNumericTextBlock_C_ExecuteUbergraph_StatNumericTextBlock");
