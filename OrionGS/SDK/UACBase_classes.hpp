...
public:
	...
	uint8                                         Pad_4D3E[0x15C];                                   // 0x00B4(0x015C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"UACNetworkComponent">();
	}
...
static_assert(alignof(UUACNetworkComponent) == 0x000008, "Wrong alinment on UUACNetworkComponent");
