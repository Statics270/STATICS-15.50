...
static_assert(alignof(SkeletalMesh_V_Create) == 0x000008, "Wrong alinment on SkeletalMesh_V_Create");
...
static_assert(alignof(SkeletalMesh_V_CreateAndLoad) == 0x000008, "Wrong alinment on SkeletalMesh_V_CreateAndLoad");
