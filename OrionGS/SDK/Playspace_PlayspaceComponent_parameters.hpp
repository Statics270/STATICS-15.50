...
static_assert(alignof(Context_PlayspaceComponent_WaitForSetupComplete_Update) == 0x000004, "Wrong alinment on Context_PlayspaceComponent_WaitForSetupComplete_Update");
...
static_assert(alignof(Context_PlayspaceComponent_WaitForMatchEnd_Update) == 0x000004, "Wrong alinment on Context_PlayspaceComponent_WaitForMatchEnd_Update");
...
public:
	...
	uint8                                         Pad_5E3F[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RetVal;                                            // 0x0004(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(PlayspaceComponent_GetPlayerCount) == 0x000004, "Wrong alinment on PlayspaceComponent_GetPlayerCount");
...
public:
	EPlayerType                                   __verse_0x0F99A7FE_type;                           // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5E40[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UPlayerComponent*>               RetVal;                                            // 0x0008(0x0010)(Parm, OutParm, ReturnParm, HasGetValueTypeHash)
};
static_assert(alignof(PlayspaceComponent_GetPlayers) == 0x000008, "Wrong alinment on PlayspaceComponent_GetPlayers");
...
static_assert(alignof(PlayspaceComponent_SetQueueUserForRespawnWhenAdded) == 0x000001, "Wrong alinment on PlayspaceComponent_SetQueueUserForRespawnWhenAdded");
...
static_assert(alignof(Context_PlayspaceComponent_WaitForMatchStart_Update) == 0x000004, "Wrong alinment on Context_PlayspaceComponent_WaitForMatchStart_Update");
...
static_assert(alignof(Context_PlayspaceComponent_WaitForPlayerAdded_Update) == 0x000004, "Wrong alinment on Context_PlayspaceComponent_WaitForPlayerAdded_Update");
...
static_assert(alignof(Context_PlayspaceComponent_WaitForPlayerRemoved_Update) == 0x000004, "Wrong alinment on Context_PlayspaceComponent_WaitForPlayerRemoved_Update");
