...
public:
	...
	void ExecuteUbergraph_AthenaGlobalCash(int32 EntryPoint, int32 K2Node_Event_GlobalCashBalance);
...
static_assert(alignof(UAthenaGlobalCash_C) == 0x000008, "Wrong alinment on UAthenaGlobalCash_C");
