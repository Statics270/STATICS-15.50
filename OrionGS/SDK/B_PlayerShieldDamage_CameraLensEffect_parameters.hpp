...
static_assert(alignof(B_PlayerShieldDamage_CameraLensEffect_C_ExecuteUbergraph_B_PlayerShieldDamage_CameraLensEffect) == 0x000004, "Wrong alinment on B_PlayerShieldDamage_CameraLensEffect_C_ExecuteUbergraph_B_PlayerShieldDamage_CameraLensEffect");
...
static_assert(alignof(B_PlayerShieldDamage_CameraLensEffect_C_PassParticle_Parameter_Shield) == 0x000004, "Wrong alinment on B_PlayerShieldDamage_CameraLensEffect_C_PassParticle_Parameter_Shield");
