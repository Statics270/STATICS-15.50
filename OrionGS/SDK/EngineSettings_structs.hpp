...
public:
	...
	uint8                                         Pad_5084[0x8];                                     // 0x0020(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAutoCompleteCommand) == 0x000008, "Wrong alinment on FAutoCompleteCommand");
...
static_assert(alignof(FGameModeName) == 0x000008, "Wrong alinment on FGameModeName");
