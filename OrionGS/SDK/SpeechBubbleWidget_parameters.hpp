...
public:
	...
	uint8                                         Pad_5257[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetCurrentSentenceSpeechText_ReturnValue; // 0x0020(0x0018)()
};
static_assert(alignof(SpeechBubbleWidget_C_ExecuteUbergraph_SpeechBubbleWidget) == 0x000008, "Wrong alinment on SpeechBubbleWidget_C_ExecuteUbergraph_SpeechBubbleWidget");
...
static_assert(alignof(SpeechBubbleWidget_C_InitFromObject) == 0x000008, "Wrong alinment on SpeechBubbleWidget_C_InitFromObject");
