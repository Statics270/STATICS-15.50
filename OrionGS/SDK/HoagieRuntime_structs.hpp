...
{
public:
	uint8                                         Pad_4460[0x108];                                   // 0x0000(0x0108)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FFortHeliFlightModel) == 0x000008, "Wrong alinment on FFortHeliFlightModel");
...
static_assert(alignof(FReplicatedHeliControlState) == 0x000004, "Wrong alinment on FReplicatedHeliControlState");
...
public:
	...
	uint8                                         Pad_4461[0x3];                                     // 0x0005(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCachedSeatCollision) == 0x000004, "Wrong alinment on FCachedSeatCollision");
...
static_assert(alignof(FRotorHit) == 0x000004, "Wrong alinment on FRotorHit");
