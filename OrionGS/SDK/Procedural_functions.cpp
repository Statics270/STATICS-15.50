...
// Parameters:
// class UProceduralGenerator*             Param_Generator                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UProceduralGeneratorContext::GetOrCreateGeneratorContext(class UProceduralGenerator* Param_Generator, class UProceduralGeneratorContext** Context)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Generator = Param_Generator;
