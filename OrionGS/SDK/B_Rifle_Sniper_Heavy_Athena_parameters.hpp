...
static_assert(alignof(B_Rifle_Sniper_Heavy_Athena_C_ExecuteUbergraph_B_Rifle_Sniper_Heavy_Athena) == 0x000004, "Wrong alinment on B_Rifle_Sniper_Heavy_Athena_C_ExecuteUbergraph_B_Rifle_Sniper_Heavy_Athena");
...
static_assert(alignof(B_Rifle_Sniper_Heavy_Athena_C_ReceiveTick) == 0x000004, "Wrong alinment on B_Rifle_Sniper_Heavy_Athena_C_ReceiveTick");
...
static_assert(alignof(B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance) == 0x000008, "Wrong alinment on B_Rifle_Sniper_Heavy_Athena_C_CalculateTraceDistance");
