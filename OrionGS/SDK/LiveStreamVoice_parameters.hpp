...
static_assert(alignof(LiveStreamVoiceSubsystem_EnableLocalVoiceProcessing) == 0x000001, "Wrong alinment on LiveStreamVoiceSubsystem_EnableLocalVoiceProcessing");
...
static_assert(alignof(LiveStreamVoiceSubsystem_SetVoiceSettings) == 0x000008, "Wrong alinment on LiveStreamVoiceSubsystem_SetVoiceSettings");
