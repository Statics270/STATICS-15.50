...
static_assert(alignof(FFortConversationConditionalMessage) == 0x000008, "Wrong alinment on FFortConversationConditionalMessage");
...
static_assert(alignof(FFortConversationNodeConditionalMessages) == 0x000008, "Wrong alinment on FFortConversationNodeConditionalMessages");
