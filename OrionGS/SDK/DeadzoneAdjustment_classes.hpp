...
public:
	class UWidget* DoCustomNavigation_0(EUINavigation Param_Navigation, bool K2Node_SwitchEnum_CmpSuccess);
	void Construct();
...
static_assert(alignof(UDeadzoneAdjustment_C) == 0x000008, "Wrong alinment on UDeadzoneAdjustment_C");
