...
public:
	...
	uint8                                         Pad_1B02[0x10];                                    // 0x0238(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"DynamicHUDTestUIDirector">();
	}
...
static_assert(alignof(ADynamicHUDTestUIDirector) == 0x000008, "Wrong alinment on ADynamicHUDTestUIDirector");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"DynamicHUDTestWidget">();
	}
...
static_assert(alignof(UDynamicHUDTestWidget) == 0x000008, "Wrong alinment on UDynamicHUDTestWidget");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"DynamicHUDUIManager">();
	}
...
static_assert(alignof(UDynamicHUDUIManager) == 0x000008, "Wrong alinment on UDynamicHUDUIManager");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"DynamicHUDUIWidget">();
	}
...
static_assert(alignof(UDynamicHUDUIWidget) == 0x000008, "Wrong alinment on UDynamicHUDUIWidget");
