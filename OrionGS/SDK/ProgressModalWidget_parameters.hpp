...
static_assert(alignof(ProgressModalWidget_C_OnAnalogValueChanged) == 0x000008, "Wrong alinment on ProgressModalWidget_C_OnAnalogValueChanged");
...
static_assert(alignof(ProgressModalWidget_C_ExecuteUbergraph_ProgressModalWidget) == 0x000004, "Wrong alinment on ProgressModalWidget_C_ExecuteUbergraph_ProgressModalWidget");
