...
public:
	...
	uint8                                         Pad_4C0B[0x5];                                     // 0x0053(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GameplayState">();
	}
...
static_assert(alignof(UGameplayState) == 0x000008, "Wrong alinment on UGameplayState");
...
public:
	...
	uint8                                         Pad_4C0C[0x2];                                     // 0x007A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           StateMachineId;                                    // 0x007C(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, Net, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4C0D[0x4];                                     // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayStateMachine">();
	}
...
static_assert(alignof(UGameplayStateMachine) == 0x000008, "Wrong alinment on UGameplayStateMachine");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayStateMachineManager">();
	}
...
static_assert(alignof(UGameplayStateMachineManager) == 0x000008, "Wrong alinment on UGameplayStateMachineManager");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayStateMachineSubsystem">();
	}
...
static_assert(alignof(UGameplayStateMachineSubsystem) == 0x000008, "Wrong alinment on UGameplayStateMachineSubsystem");
