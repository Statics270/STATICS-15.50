...
void UScoreWidgetBase::OnTeamScoredPoints(struct FScoreLTMTeamDataEntry& TeamData)
{
	static class UFunction* Func = nullptr;
...
void UScoreBonusWindowWidget::OnBonusWindowPreviewStarted_BP(EScoreLTMBonusWindowCategory BonusCategory, class FText& BonusCategoryText, float ServerPreviewEndTime)
{
	static class UFunction* Func = nullptr;
	...
	Parms.BonusCategoryText = BonusCategoryText;
...
void UScoreBonusWindowWidget::OnBonusWindowStarted_BP(EScoreLTMBonusWindowCategory BonusCategory, class FText& BonusCategoryText, float Multiplier, float ServerEndTime)
{
	static class UFunction* Func = nullptr;
...
void UScoreTeamNotificationWidget::OnOwningTeamScoredPoints_BP(bool bWasOwningPlayer, int32 PointsScored, class FText& ScoreTypeText, int32 BigScoreThreshold, bool bWasBonus)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ScoreTypeText = ScoreTypeText;
...
void UScoreTeammateStatusNotificationWidget::OnTeammateScoredPoints_BP(int32 PointsScored, class FText& ScoreTypeText, bool bWasBonus)
{
	static class UFunction* Func = nullptr;
