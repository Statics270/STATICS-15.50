...
public:
	...
	uint8                                         Pad_4E09[0x7];                                     // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(SmartObjectBlueprintFunctionLibrary_K2_AddLooseGameplayTags) == 0x000008, "Wrong alinment on SmartObjectBlueprintFunctionLibrary_K2_AddLooseGameplayTags");
...
public:
	...
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x0008(0x0020)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0028(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4E0A[0x7];                                     // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(SmartObjectBlueprintFunctionLibrary_K2_RemoveLooseGameplayTags) == 0x000008, "Wrong alinment on SmartObjectBlueprintFunctionLibrary_K2_RemoveLooseGameplayTags");
...
public:
	...
	uint8                                         Pad_4E0B[0x6];                                     // 0x000A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(SmartObjectBlueprintFunctionLibrary_K2_SetSmartObjectEnabled) == 0x000008, "Wrong alinment on SmartObjectBlueprintFunctionLibrary_K2_SetSmartObjectEnabled");
...
public:
	...
	uint8                                         Pad_4E0C[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(SmartObjectBlueprintFunctionLibrary_K2_UseSmartObject) == 0x000008, "Wrong alinment on SmartObjectBlueprintFunctionLibrary_K2_UseSmartObject");
...
static_assert(alignof(AITask_UseSmartObject_UseSmartObject) == 0x000008, "Wrong alinment on AITask_UseSmartObject_UseSmartObject");
