...
public:
	...
	uint8                                         Pad_7BFD[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7BFE[0x5];                                     // 0x0013(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7BFF[0x6];                                     // 0x0032(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7C00[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(VBucksStoreScreen_C_ExecuteUbergraph_VBucksStoreScreen) == 0x000008, "Wrong alinment on VBucksStoreScreen_C_ExecuteUbergraph_VBucksStoreScreen");
...
static_assert(alignof(VBucksStoreScreen_C_PreConstruct) == 0x000001, "Wrong alinment on VBucksStoreScreen_C_PreConstruct");
...
public:
	...
	uint8                                         Pad_7C01[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CurrencyMessageLocText;                            // 0x0008(0x0018)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
static_assert(alignof(VBucksStoreScreen_C_OnUpdateOtherPlatformMTXMessage) == 0x000008, "Wrong alinment on VBucksStoreScreen_C_OnUpdateOtherPlatformMTXMessage");
...
public:
	...
	uint8                                         Pad_7C02[0x1];                                     // 0x0003(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMtxBreakdown                          CallFunc_GetMtxBreakdown_ReturnValue;              // 0x0004(0x0010)(NoDestructor)
	uint8                                         Pad_7C03[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7C04[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(VBucksStoreScreen_C_UpdateCurrencyNotification) == 0x000008, "Wrong alinment on VBucksStoreScreen_C_UpdateCurrencyNotification");
...
public:
	...
	uint8                                         Pad_7C05[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(VBucksStoreScreen_C_HandleRedeem) == 0x000008, "Wrong alinment on VBucksStoreScreen_C_HandleRedeem");
...
static_assert(alignof(VBucksStoreScreen_C_HandleBack) == 0x000001, "Wrong alinment on VBucksStoreScreen_C_HandleBack");
...
public:
	...
	uint8                                         Pad_7C07[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(VBucksStoreScreen_C_PlayEquippedLockerMusic) == 0x000008, "Wrong alinment on VBucksStoreScreen_C_PlayEquippedLockerMusic");
...
static_assert(alignof(VBucksStoreScreen_C_GetVisibilityByChildrenPresence) == 0x000008, "Wrong alinment on VBucksStoreScreen_C_GetVisibilityByChildrenPresence");
...
static_assert(alignof(VBucksStoreScreen_C_ApplyMobileLayout) == 0x000008, "Wrong alinment on VBucksStoreScreen_C_ApplyMobileLayout");
...
static_assert(alignof(VBucksStoreScreen_C_BP_GetDesiredFocusTarget) == 0x000008, "Wrong alinment on VBucksStoreScreen_C_BP_GetDesiredFocusTarget");
