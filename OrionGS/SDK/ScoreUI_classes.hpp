...
public:
	...
	void OnTeamScoredPoints(struct FScoreLTMTeamDataEntry& TeamData);
	void UnbindFromMutator_BP();

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ScoreWidgetBase">();
	}
...
static_assert(alignof(UScoreWidgetBase) == 0x000008, "Wrong alinment on UScoreWidgetBase");
...
public:
	...
	void OnBonusWindowPreviewStarted_BP(EScoreLTMBonusWindowCategory BonusCategory, class FText& BonusCategoryText, float ServerPreviewEndTime);
	void OnBonusWindowStarted_BP(EScoreLTMBonusWindowCategory BonusCategory, class FText& BonusCategoryText, float Multiplier, float ServerEndTime);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ScoreBonusWindowWidget">();
	}
...
static_assert(alignof(UScoreBonusWindowWidget) == 0x000008, "Wrong alinment on UScoreBonusWindowWidget");
...
{
public:
	void OnOwningTeamScoredPoints_BP(bool bWasOwningPlayer, int32 PointsScored, class FText& ScoreTypeText, int32 BigScoreThreshold, bool bWasBonus);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ScoreTeamNotificationWidget">();
	}
...
static_assert(alignof(UScoreTeamNotificationWidget) == 0x000008, "Wrong alinment on UScoreTeamNotificationWidget");
...
{
public:
	uint8                                         Pad_473E[0x10];                                    // 0x0320(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnTeammateScoredPoints_BP(int32 PointsScored, class FText& ScoreTypeText, bool bWasBonus);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ScoreTeammateStatusNotificationWidget">();
	}
...
static_assert(alignof(UScoreTeammateStatusNotificationWidget) == 0x000008, "Wrong alinment on UScoreTeammateStatusNotificationWidget");
