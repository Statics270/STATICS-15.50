...
static_assert(alignof(GAT_ActiveAbility_C_ExecuteUbergraph_GAT_ActiveAbility) == 0x000004, "Wrong alinment on GAT_ActiveAbility_C_ExecuteUbergraph_GAT_ActiveAbility");
...
public:
	...
	uint8                                         Pad_609D[0x2];                                     // 0x000A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GAT_ActiveAbility_C_SetPawnCollision) == 0x000008, "Wrong alinment on GAT_ActiveAbility_C_SetPawnCollision");
...
static_assert(alignof(GAT_ActiveAbility_C_SetKnockbackImmunity) == 0x000008, "Wrong alinment on GAT_ActiveAbility_C_SetKnockbackImmunity");
...
static_assert(alignof(GAT_ActiveAbility_C_ActiveAbilitySetup) == 0x000008, "Wrong alinment on GAT_ActiveAbility_C_ActiveAbilitySetup");
...
public:
	...
	uint8                                         Pad_609F[0x1];                                     // 0x000F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GAT_ActiveAbility_C_SetHolsterWeaponWithName) == 0x000008, "Wrong alinment on GAT_ActiveAbility_C_SetHolsterWeaponWithName");
...
static_assert(alignof(GAT_ActiveAbility_C_SendHeroAbilityActivationEvent) == 0x000004, "Wrong alinment on GAT_ActiveAbility_C_SendHeroAbilityActivationEvent");
...
static_assert(alignof(GAT_ActiveAbility_C_EndAbilityWithReason) == 0x000008, "Wrong alinment on GAT_ActiveAbility_C_EndAbilityWithReason");
...
static_assert(alignof(GAT_ActiveAbility_C_K2_ShouldAbilityRespondToEvent) == 0x000008, "Wrong alinment on GAT_ActiveAbility_C_K2_ShouldAbilityRespondToEvent");
