...
{
public:
	uint8                                         Pad_5E29[0x8];                                     // 0x0048(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UStormCameraModifier_C) == 0x000010, "Wrong alinment on UStormCameraModifier_C");
