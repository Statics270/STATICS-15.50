...
static_assert(alignof(Athena_GameState_C_ExecuteUbergraph_Athena_GameState) == 0x000004, "Wrong alinment on Athena_GameState_C_ExecuteUbergraph_Athena_GameState");
