...
static_assert(alignof(TT_Ninja_SwordHitsHeal_C_InitializeAbilityInstanceInternal) == 0x000008, "Wrong alinment on TT_Ninja_SwordHitsHeal_C_InitializeAbilityInstanceInternal");
...
public:
	...
	uint8                                         Pad_59E9[0x6];                                     // 0x003A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_59EA[0x2];                                     // 0x004A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_59EB[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Conv_FloatToText_ReturnValue;             // 0x0058(0x0018)()
};
static_assert(alignof(TT_Ninja_SwordHitsHeal_C_GetTextForTokenFromAbilityInstanceInternal) == 0x000008, "Wrong alinment on TT_Ninja_SwordHitsHeal_C_GetTextForTokenFromAbilityInstanceInternal");
