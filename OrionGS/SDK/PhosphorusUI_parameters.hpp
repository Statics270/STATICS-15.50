...
static_assert(alignof(PhosphorusWidgetBase_OnMutatorAvailable) == 0x000008, "Wrong alinment on PhosphorusWidgetBase_OnMutatorAvailable");
...
static_assert(alignof(PhosphorusWidgetBase_SetAvatarImageFromPlayerState) == 0x000008, "Wrong alinment on PhosphorusWidgetBase_SetAvatarImageFromPlayerState");
...
static_assert(alignof(PhosphorusWidgetBase_GetPhosphorusMutator) == 0x000008, "Wrong alinment on PhosphorusWidgetBase_GetPhosphorusMutator");
...
public:
	...
	uint8                                         Pad_4723[0x7];                                     // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(PhosphorusEndOfRoundWidget_OnPhosphorusPhaseChanged) == 0x000008, "Wrong alinment on PhosphorusEndOfRoundWidget_OnPhosphorusPhaseChanged");
...
static_assert(alignof(PhosphorusEndOfRoundWidget_SetWidgetVisibility) == 0x000001, "Wrong alinment on PhosphorusEndOfRoundWidget_SetWidgetVisibility");
...
static_assert(alignof(PhosphorusHUDWidget_OnPhosphorusPlayerEliminated_BP) == 0x000008, "Wrong alinment on PhosphorusHUDWidget_OnPhosphorusPlayerEliminated_BP");
...
static_assert(alignof(PhosphorusSquadWipedWidget_HandleSquadWipedVisibilityChanged) == 0x000001, "Wrong alinment on PhosphorusSquadWipedWidget_HandleSquadWipedVisibilityChanged");
