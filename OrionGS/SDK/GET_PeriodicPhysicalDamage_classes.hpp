...
static_assert(alignof(UGET_PeriodicPhysicalDamage_C) == 0x000008, "Wrong alinment on UGET_PeriodicPhysicalDamage_C");
static_assert(sizeof(UGET_PeriodicPhysicalDamage_C) == 0x000800, "Wrong size on UGET_PeriodicPhysicalDamage_C");
