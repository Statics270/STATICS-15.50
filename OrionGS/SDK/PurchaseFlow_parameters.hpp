...
static_assert(alignof(PurchaseFlowJSBridge_GetDefaultExternalBrowserID) == 0x000008, "Wrong alinment on PurchaseFlowJSBridge_GetDefaultExternalBrowserID");
...
static_assert(alignof(PurchaseFlowJSBridge_GetExternalBrowserName) == 0x000008, "Wrong alinment on PurchaseFlowJSBridge_GetExternalBrowserName");
...
static_assert(alignof(PurchaseFlowJSBridge_GetExternalBrowserPath) == 0x000008, "Wrong alinment on PurchaseFlowJSBridge_GetExternalBrowserPath");
...
public:
	...
	uint8                                         Pad_4CFB[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(PurchaseFlowJSBridge_LaunchExternalBrowserUrl) == 0x000008, "Wrong alinment on PurchaseFlowJSBridge_LaunchExternalBrowserUrl");
...
public:
	...
	uint8                                         Pad_4CFC[0x7];                                     // 0x0021(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(PurchaseFlowJSBridge_LaunchValidatedExternalBrowserUrl) == 0x000008, "Wrong alinment on PurchaseFlowJSBridge_LaunchValidatedExternalBrowserUrl");
...
static_assert(alignof(PurchaseFlowJSBridge_Receipt) == 0x000008, "Wrong alinment on PurchaseFlowJSBridge_Receipt");
...
static_assert(alignof(PurchaseFlowJSBridge_RequestClose) == 0x000008, "Wrong alinment on PurchaseFlowJSBridge_RequestClose");
