...
public:
	...
	uint8                                         Pad_1C86[0x2];                                     // 0x0038(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1C87[0x25];                                    // 0x003B(0x0025)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GameplayTask">();
	}
...
static_assert(alignof(UGameplayTask) == 0x000008, "Wrong alinment on UGameplayTask");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayTask_ClaimResource">();
	}
...
static_assert(alignof(UGameplayTask_ClaimResource) == 0x000008, "Wrong alinment on UGameplayTask_ClaimResource");
...
{
public:
	uint8                                         Pad_1C8C[0xC];                                     // 0x00B0(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_3F : 1;                                     // 0x00BC(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	...
	uint8                                         Pad_1C8D[0x3];                                     // 0x00BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1C8E[0x10];                                    // 0x00E0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayTasksComponent">();
	}
...
static_assert(alignof(UGameplayTasksComponent) == 0x000008, "Wrong alinment on UGameplayTasksComponent");
...
public:
	...
	uint8                                         Pad_1C91[0x3];                                     // 0x002D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1C92[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayTaskResource">();
	}
...
static_assert(alignof(UGameplayTaskResource) == 0x000008, "Wrong alinment on UGameplayTaskResource");
...
public:
	...
	uint8                                         Pad_1C93[0x18];                                    // 0x0088(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayTask_SpawnActor">();
	}
...
static_assert(alignof(UGameplayTask_SpawnActor) == 0x000008, "Wrong alinment on UGameplayTask_SpawnActor");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayTask_TimeLimitedExecution">();
	}
...
static_assert(alignof(UGameplayTask_TimeLimitedExecution) == 0x000008, "Wrong alinment on UGameplayTask_TimeLimitedExecution");
...
public:
	...
	uint8                                         Pad_1C97[0x8];                                     // 0x0078(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayTask_WaitDelay">();
	}
...
static_assert(alignof(UGameplayTask_WaitDelay) == 0x000008, "Wrong alinment on UGameplayTask_WaitDelay");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayTaskOwnerInterface">();
	}
...
static_assert(alignof(IGameplayTaskOwnerInterface) == 0x000008, "Wrong alinment on IGameplayTaskOwnerInterface");
