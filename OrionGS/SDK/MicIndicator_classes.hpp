...
public:
	...
	class UOverlay*                               Zero1MinusNotSpeaking;                             // 0x02B8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOverlay*                               Zero2MinusSpeaking;                                // 0x02C0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOverlay*                               Zero3MinusMuted;                                   // 0x02C8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(alignof(UMicIndicator_C) == 0x000008, "Wrong alinment on UMicIndicator_C");
...
static_assert(offsetof(UMicIndicator_C, Zero1MinusNotSpeaking) == 0x0002B8, "Member 'UMicIndicator_C::Zero1MinusNotSpeaking' has a wrong offset!");
static_assert(offsetof(UMicIndicator_C, Zero2MinusSpeaking) == 0x0002C0, "Member 'UMicIndicator_C::Zero2MinusSpeaking' has a wrong offset!");
static_assert(offsetof(UMicIndicator_C, Zero3MinusMuted) == 0x0002C8, "Member 'UMicIndicator_C::Zero3MinusMuted' has a wrong offset!");
