...
public:
	...
	uint8                                         Pad_761F[0x5];                                     // 0x0003(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7620[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           K2Node_Select_Default;                             // 0x0014(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_7621[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GameFeatureStatus_C_HandleStatusChanged) == 0x000008, "Wrong alinment on GameFeatureStatus_C_HandleStatusChanged");
...
static_assert(alignof(GameFeatureStatus_C_OnStatusChanged) == 0x000001, "Wrong alinment on GameFeatureStatus_C_OnStatusChanged");
...
static_assert(alignof(GameFeatureStatus_C_ExecuteUbergraph_GameFeatureStatus) == 0x000004, "Wrong alinment on GameFeatureStatus_C_ExecuteUbergraph_GameFeatureStatus");
