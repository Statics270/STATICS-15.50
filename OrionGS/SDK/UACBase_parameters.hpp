...
static_assert(alignof(UACNetworkComponent_SendClientHello) == 0x000004, "Wrong alinment on UACNetworkComponent_SendClientHello");
...
static_assert(alignof(UACNetworkComponent_SendPacketToClient) == 0x000008, "Wrong alinment on UACNetworkComponent_SendPacketToClient");
...
public:
	uint8                                         Type;                                              // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4D40[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<uint8>                                 Packet;                                            // 0x0008(0x0010)(ConstParm, Parm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(UACNetworkComponent_SendPacketToServer) == 0x000008, "Wrong alinment on UACNetworkComponent_SendPacketToServer");
