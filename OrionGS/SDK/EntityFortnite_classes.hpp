...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"EntityFortniteInterface">();
	}
...
static_assert(alignof(IEntityFortniteInterface) == 0x000008, "Wrong alinment on IEntityFortniteInterface");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"EntityFortnitePlayerComponent">();
	}
...
static_assert(alignof(UEntityFortnitePlayerComponent) == 0x000008, "Wrong alinment on UEntityFortnitePlayerComponent");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"EntityFortniteStormControllerComponent">();
	}
...
static_assert(alignof(UEntityFortniteStormControllerComponent) == 0x000008, "Wrong alinment on UEntityFortniteStormControllerComponent");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"EntityFortniteStormSpawner">();
	}
...
static_assert(alignof(AEntityFortniteStormSpawner) == 0x000008, "Wrong alinment on AEntityFortniteStormSpawner");
