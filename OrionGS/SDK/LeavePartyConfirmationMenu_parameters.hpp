...
public:
	...
	uint8                                         Pad_5EC6[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue;                // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(LeavePartyConfirmationMenu_C_ExecuteUbergraph_LeavePartyConfirmationMenu) == 0x000008, "Wrong alinment on LeavePartyConfirmationMenu_C_ExecuteUbergraph_LeavePartyConfirmationMenu");
