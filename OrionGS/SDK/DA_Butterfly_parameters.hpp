...
public:
	...
	uint8                                         Pad_7027[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(DA_Butterfly_C_ExecuteUbergraph_DA_Butterfly) == 0x000008, "Wrong alinment on DA_Butterfly_C_ExecuteUbergraph_DA_Butterfly");
...
static_assert(alignof(DA_Butterfly_C_BPReleaseSecondaryFire) == 0x000008, "Wrong alinment on DA_Butterfly_C_BPReleaseSecondaryFire");
...
static_assert(alignof(DA_Butterfly_C_BPPressTrigger) == 0x000008, "Wrong alinment on DA_Butterfly_C_BPPressTrigger");
...
static_assert(alignof(DA_Butterfly_C_BPPressSecondaryFire) == 0x000008, "Wrong alinment on DA_Butterfly_C_BPPressSecondaryFire");
