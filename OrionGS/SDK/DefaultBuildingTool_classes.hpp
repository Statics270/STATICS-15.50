...
static_assert(alignof(ADefaultBuildingTool_C) == 0x000008, "Wrong alinment on ADefaultBuildingTool_C");
static_assert(sizeof(ADefaultBuildingTool_C) == 0x000E70, "Wrong size on ADefaultBuildingTool_C");
