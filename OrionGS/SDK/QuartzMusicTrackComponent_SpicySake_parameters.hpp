...
public:
	...
	uint8                                         Pad_72C3[0x2];                                     // 0x0016(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(QuartzMusicTrackComponent_SpicySake_C_OnDataTrackerUpdate) == 0x000008, "Wrong alinment on QuartzMusicTrackComponent_SpicySake_C_OnDataTrackerUpdate");
...
public:
	...
	uint8                                         Pad_72C4[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(QuartzMusicTrackComponent_SpicySake_C_UpdateInterpValue) == 0x000008, "Wrong alinment on QuartzMusicTrackComponent_SpicySake_C_UpdateInterpValue");
...
static_assert(alignof(QuartzMusicTrackComponent_SpicySake_C_HandleMixState) == 0x000004, "Wrong alinment on QuartzMusicTrackComponent_SpicySake_C_HandleMixState");
