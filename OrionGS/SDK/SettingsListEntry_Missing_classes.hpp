...
public:
	void ExecuteUbergraph_SettingsListEntry_Missing(int32 EntryPoint, bool CallFunc_IsUsingTouch_ReturnValue, const struct FGeometry& K2Node_Event_MyGeometry, struct FPointerEvent& K2Node_Event_MouseEvent_1, class UUMGSequencePlayer* CallFunc_PlayAnimationReverse_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue, struct FPointerEvent& K2Node_Event_MouseEvent);
...
static_assert(alignof(USettingsListEntry_Missing_C) == 0x000008, "Wrong alinment on USettingsListEntry_Missing_C");
