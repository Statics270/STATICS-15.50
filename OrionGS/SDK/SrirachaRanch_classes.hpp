...
{
public:
	class FString                                 ResourceID;                                        // 0x03B8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortStreamMediaSource*                 MediaSource;                                       // 0x03C8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"RadioContentSourceItemDefinition">();
	}
...
static_assert(alignof(URadioContentSourceItemDefinition) == 0x000008, "Wrong alinment on URadioContentSourceItemDefinition");
static_assert(sizeof(URadioContentSourceItemDefinition) == 0x0003D0, "Wrong size on URadioContentSourceItemDefinition");
static_assert(offsetof(URadioContentSourceItemDefinition, ResourceID) == 0x0003B8, "Member 'URadioContentSourceItemDefinition::ResourceID' has a wrong offset!");
static_assert(offsetof(URadioContentSourceItemDefinition, MediaSource) == 0x0003C8, "Member 'URadioContentSourceItemDefinition::MediaSource' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_47A5[0x4];                                     // 0x0134(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47A6[0x28];                                    // 0x0140(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"StreamingRadioAudioShapeComponent">();
	}
...
static_assert(alignof(UStreamingRadioAudioShapeComponent) == 0x000008, "Wrong alinment on UStreamingRadioAudioShapeComponent");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SrirachaRanchComponentTemplateWrapper">();
	}
...
static_assert(alignof(USrirachaRanchComponentTemplateWrapper) == 0x000008, "Wrong alinment on USrirachaRanchComponentTemplateWrapper");
...
{
public:
	uint8                                         Pad_47A7[0x10];                                    // 0x00B0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47A8[0x4];                                     // 0x0164(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47A9[0x7];                                     // 0x0219(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47AA[0x6];                                     // 0x0232(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47AB[0x3];                                     // 0x0389(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47AC[0x4];                                     // 0x03B0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47AD[0x3C];                                    // 0x03EC(0x003C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"StreamingRadioPlayerComponent">();
	}
...
static_assert(alignof(UStreamingRadioPlayerComponent) == 0x000008, "Wrong alinment on UStreamingRadioPlayerComponent");
