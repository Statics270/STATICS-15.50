...
static_assert(alignof(TODM_Disabled_C_DisableLightAndFog) == 0x000001, "Wrong alinment on TODM_Disabled_C_DisableLightAndFog");
...
public:
	...
	uint8                                         Pad_78CC[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_78CD[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(TODM_Disabled_C_ExecuteUbergraph_TODM_Disabled) == 0x000008, "Wrong alinment on TODM_Disabled_C_ExecuteUbergraph_TODM_Disabled");
