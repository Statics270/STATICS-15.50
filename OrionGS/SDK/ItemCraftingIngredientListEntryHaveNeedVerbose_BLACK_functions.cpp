...
void UItemCraftingIngredientListEntryHaveNeedVerbose_BLACK_C::ShowHaveNeed(bool* HaveNeed, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsInZone_ReturnValue)
{
	...
	if (HaveNeed != nullptr)
		*HaveNeed = std::move(Parms.HaveNeed);
}
...
void UItemCraftingIngredientListEntryHaveNeedVerbose_BLACK_C::RefreshVisibility(bool Temp_bool_Variable, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable_1, bool CallFunc_ShowHaveNeed_HaveNeed, ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
