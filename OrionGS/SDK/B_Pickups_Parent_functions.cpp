...
// ESubGame                                CallFunc_GetSubGame_ReturnValue_2                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// EFortRarity                             CallFunc_GetClientCosmeticRarity_ReturnValue           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AB_Pickups_Parent_C::SetRarityColor(EFortRarity Temp_byte_Variable, bool CallFunc_IsValid_ReturnValue, int32 Temp_int_Variable, int32 Temp_int_Variable_1, int32 Temp_int_Variable_2, int32 Temp_int_Variable_3, int32 Temp_int_Variable_4, int32 Temp_int_Variable_5, int32 Temp_int_Variable_6, int32 Temp_int_Variable_7, class UFortItem* CallFunc_CreateTemporaryItemInstanceBP_ReturnValue, EFortRarity CallFunc_GetClientCosmeticRarity_ReturnValue, int32 K2Node_Select_Default, const struct FLinearColor& CallFunc_Array_Get_Item, const struct FLinearColor& CallFunc_Array_Get_Item_1, bool CallFunc_Array_IsValidIndex_ReturnValue, const struct FLinearColor& CallFunc_SelectColor_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Pickups_Parent_C_SetRarityColor Parms{};
	...
	Parms.CallFunc_GetClientCosmeticRarity_ReturnValue = CallFunc_GetClientCosmeticRarity_ReturnValue;
	Parms.K2Node_Select_Default = K2Node_Select_Default;
