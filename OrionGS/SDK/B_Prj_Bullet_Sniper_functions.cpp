...
void AB_Prj_Bullet_Sniper_C::OnSniperTraceWaterHit(struct FHitResult& Param_WaterHit, class AFortWaterBodyActor* WaterBody)
{
	static class UFunction* Func = nullptr;
...
void AB_Prj_Bullet_Sniper_C::UserConstructionScript(float CallFunc_GetValueAtLevel_ReturnValue)
{
	...
	Params::B_Prj_Bullet_Sniper_C_UserConstructionScript Parms{};
