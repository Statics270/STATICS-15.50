...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FortAthenaLivingWorldConfigData">();
	}
...
static_assert(alignof(UFortAthenaLivingWorldConfigData) == 0x000008, "Wrong alinment on UFortAthenaLivingWorldConfigData");
...
public:
	...
	uint8                                         Pad_1D5D[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortAthenaLivingWorldEventData">();
	}
...
static_assert(alignof(UFortAthenaLivingWorldEventData) == 0x000008, "Wrong alinment on UFortAthenaLivingWorldEventData");
...
public:
	...
	uint8                                         Pad_1D5E[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortCheatManager_LivingWorldManager">();
	}
...
static_assert(alignof(UFortCheatManager_LivingWorldManager) == 0x000008, "Wrong alinment on UFortCheatManager_LivingWorldManager");
...
public:
	...
	uint8                                         Pad_1D5F[0x108];                                   // 0x0278(0x0108)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D60[0x18];                                    // 0x03E0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D61[0x8];                                     // 0x0408(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	int32 QueryEventBudget(const struct FDataTableRowHandle& EventEntry, class AActor* SpawnLocation) const;

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortAthenaLivingWorldManager">();
	}
...
static_assert(alignof(UFortAthenaLivingWorldManager) == 0x000008, "Wrong alinment on UFortAthenaLivingWorldManager");
...
public:
	...
	bool GetValidLocation(struct FFortAthenaLivingWorldPointProviderFilterRules& PointFilter, struct FVector* OutPosition, struct FRotator* OutRotation) const;
	bool IsEnabled(struct FFortAthenaLivingWorldPointProviderFilterRules& PointFilter) const;

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortAthenaLivingWorldPointProviderInterface">();
	}
...
static_assert(alignof(IFortAthenaLivingWorldPointProviderInterface) == 0x000008, "Wrong alinment on IFortAthenaLivingWorldPointProviderInterface");
...
{
public:
	uint8                                         Pad_1D65[0x8];                                     // 0x0258(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D66[0x4];                                     // 0x02CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D67[0x40];                                    // 0x0330(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortAthenaLivingWorldVolume">();
	}
...
static_assert(alignof(AFortAthenaLivingWorldVolume) == 0x000008, "Wrong alinment on AFortAthenaLivingWorldVolume");
...
{
public:
	uint8                                         Pad_1D68[0x8];                                     // 0x0220(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D69[0x7];                                     // 0x0251(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnActorSpawnedResult;                              // 0x0258(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_1D6A[0x8];                                     // 0x0278(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortAthenaPatrolPathPointProvider">();
	}
...
static_assert(alignof(AFortAthenaPatrolPathPointProvider) == 0x000008, "Wrong alinment on AFortAthenaPatrolPathPointProvider");
