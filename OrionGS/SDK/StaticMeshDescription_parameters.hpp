...
static_assert(alignof(StaticMeshDescription_CreateCube) == 0x000004, "Wrong alinment on StaticMeshDescription_CreateCube");
...
static_assert(alignof(StaticMeshDescription_SetPolygonGroupMaterialSlotName) == 0x000004, "Wrong alinment on StaticMeshDescription_SetPolygonGroupMaterialSlotName");
...
static_assert(alignof(StaticMeshDescription_SetVertexInstanceUV) == 0x000004, "Wrong alinment on StaticMeshDescription_SetVertexInstanceUV");
...
static_assert(alignof(StaticMeshDescription_GetVertexInstanceUV) == 0x000004, "Wrong alinment on StaticMeshDescription_GetVertexInstanceUV");
