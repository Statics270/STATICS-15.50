...
public:
	...
	uint8                                         Pad_4D41[0x2];                                     // 0x000A(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTimeSynthEnvelopeFollowerSettings) == 0x000004, "Wrong alinment on FTimeSynthEnvelopeFollowerSettings");
...
public:
	...
	uint8                                         Pad_4D42[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FTimeSynthFilterSettings) == 0x000004, "Wrong alinment on FTimeSynthFilterSettings");
...
public:
	...
	uint8                                         Pad_4D43[0x4];                                     // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTimeSynthClipSound) == 0x000008, "Wrong alinment on FTimeSynthClipSound");
...
static_assert(alignof(FTimeSynthClipHandle) == 0x000004, "Wrong alinment on FTimeSynthClipHandle");
...
static_assert(alignof(FTimeSynthTimeDef) == 0x000004, "Wrong alinment on FTimeSynthTimeDef");
...
public:
	...
	uint8                                         Pad_4D44[0x3];                                     // 0x0009(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4D45[0x3];                                     // 0x0011(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTimeSynthQuantizationSettings) == 0x000004, "Wrong alinment on FTimeSynthQuantizationSettings");
...
static_assert(alignof(FTimeSynthSpectralData) == 0x000004, "Wrong alinment on FTimeSynthSpectralData");
