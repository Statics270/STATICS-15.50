...
{
public:
	uint8                                         Pad_4BBA[0x10];                                    // 0x0068(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveStreamAnimationChannel">();
	}
...
static_assert(alignof(ULiveStreamAnimationChannel) == 0x000008, "Wrong alinment on ULiveStreamAnimationChannel");
...
public:
	...
	uint8                                         Pad_4BBB[0x8];                                     // 0x0030(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveStreamAnimationDataHandler">();
	}
...
static_assert(alignof(ULiveStreamAnimationDataHandler) == 0x000008, "Wrong alinment on ULiveStreamAnimationDataHandler");
...
public:
	...
	uint8                                         Pad_4BBC[0x18];                                    // 0x0058(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveStreamAnimationSettings">();
	}
...
static_assert(alignof(ULiveStreamAnimationSettings) == 0x000008, "Wrong alinment on ULiveStreamAnimationSettings");
...
{
public:
	uint8                                         Pad_4BBD[0x20];                                    // 0x0030(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4BBE[0x17];                                    // 0x0051(0x0017)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveStreamAnimationSubsystem">();
	}
...
static_assert(alignof(ULiveStreamAnimationSubsystem) == 0x000008, "Wrong alinment on ULiveStreamAnimationSubsystem");
