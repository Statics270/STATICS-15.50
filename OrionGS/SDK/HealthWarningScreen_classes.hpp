...
public:
	...
	FMulticastInlineDelegateProperty_             HealthWarningCompleted;                            // 0x04A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(alignof(UHealthWarningScreen_C) == 0x000008, "Wrong alinment on UHealthWarningScreen_C");
