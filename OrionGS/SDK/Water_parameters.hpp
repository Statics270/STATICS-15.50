...
static_assert(alignof(BuoyancyComponent_GetLastWaterSurfaceInfo) == 0x000004, "Wrong alinment on BuoyancyComponent_GetLastWaterSurfaceInfo");
...
static_assert(alignof(BuoyancyComponent_OnPontoonEnteredWater) == 0x000010, "Wrong alinment on BuoyancyComponent_OnPontoonEnteredWater");
...
static_assert(alignof(BuoyancyComponent_OnPontoonExitedWater) == 0x000010, "Wrong alinment on BuoyancyComponent_OnPontoonExitedWater");
...
static_assert(alignof(BuoyancyComponent_IsInWaterBody) == 0x000001, "Wrong alinment on BuoyancyComponent_IsInWaterBody");
...
public:
	...
	uint8                                         Pad_4217[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(BuoyancyManager_GetBuoyancyComponentManager) == 0x000008, "Wrong alinment on BuoyancyManager_GetBuoyancyComponentManager");
...
static_assert(alignof(NiagaraWaterFunctionLibrary_SetWaterBody) == 0x000008, "Wrong alinment on NiagaraWaterFunctionLibrary_SetWaterBody");
...
static_assert(alignof(WaterBody_GetRiverToLakeTransitionMaterialInstance) == 0x000008, "Wrong alinment on WaterBody_GetRiverToLakeTransitionMaterialInstance");
...
static_assert(alignof(WaterBody_GetRiverToOceanTransitionMaterialInstance) == 0x000008, "Wrong alinment on WaterBody_GetRiverToOceanTransitionMaterialInstance");
...
static_assert(alignof(WaterBody_GetUnderwaterPostProcessMaterialInstance) == 0x000008, "Wrong alinment on WaterBody_GetUnderwaterPostProcessMaterialInstance");
...
static_assert(alignof(WaterBody_GetWaterMaterialInstance) == 0x000008, "Wrong alinment on WaterBody_GetWaterMaterialInstance");
...
static_assert(alignof(WaterBody_OnWaterBodyChanged) == 0x000001, "Wrong alinment on WaterBody_OnWaterBodyChanged");
...
static_assert(alignof(WaterBody_GetExclusionVolumes) == 0x000008, "Wrong alinment on WaterBody_GetExclusionVolumes");
...
static_assert(alignof(WaterBody_GetIslands) == 0x000008, "Wrong alinment on WaterBody_GetIslands");
...
static_assert(alignof(WaterBody_GetWaterMeshComponents) == 0x000008, "Wrong alinment on WaterBody_GetWaterMeshComponents");
...
static_assert(alignof(WaterBody_GetWaterSpline) == 0x000008, "Wrong alinment on WaterBody_GetWaterSpline");
...
static_assert(alignof(WaterBodyIsland_GetWaterSpline) == 0x000008, "Wrong alinment on WaterBodyIsland_GetWaterSpline");
...
static_assert(alignof(WaterMeshComponent_IsEnabled) == 0x000001, "Wrong alinment on WaterMeshComponent_IsEnabled");
...
static_assert(alignof(WaterSubsystem_GetShallowWaterMaxDynamicForces) == 0x000004, "Wrong alinment on WaterSubsystem_GetShallowWaterMaxDynamicForces");
...
static_assert(alignof(WaterSubsystem_GetShallowWaterMaxImpulseForces) == 0x000004, "Wrong alinment on WaterSubsystem_GetShallowWaterMaxImpulseForces");
...
static_assert(alignof(WaterSubsystem_GetShallowWaterSimulationRenderTargetSize) == 0x000004, "Wrong alinment on WaterSubsystem_GetShallowWaterSimulationRenderTargetSize");
...
public:
	...
	uint8                                         Pad_4227[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(WaterSubsystem_PrintToWaterLog) == 0x000008, "Wrong alinment on WaterSubsystem_PrintToWaterLog");
...
static_assert(alignof(WaterSubsystem_SetOceanFloodHeight) == 0x000004, "Wrong alinment on WaterSubsystem_SetOceanFloodHeight");
...
static_assert(alignof(WaterSubsystem_GetCameraUnderwaterDepth) == 0x000004, "Wrong alinment on WaterSubsystem_GetCameraUnderwaterDepth");
...
static_assert(alignof(WaterSubsystem_GetOceanBaseHeight) == 0x000004, "Wrong alinment on WaterSubsystem_GetOceanBaseHeight");
...
static_assert(alignof(WaterSubsystem_GetOceanFloodHeight) == 0x000004, "Wrong alinment on WaterSubsystem_GetOceanFloodHeight");
...
static_assert(alignof(WaterSubsystem_GetOceanTotalHeight) == 0x000004, "Wrong alinment on WaterSubsystem_GetOceanTotalHeight");
...
static_assert(alignof(WaterSubsystem_GetSmoothedWorldTimeSeconds) == 0x000004, "Wrong alinment on WaterSubsystem_GetSmoothedWorldTimeSeconds");
...
static_assert(alignof(WaterSubsystem_IsShallowWaterSimulationEnabled) == 0x000001, "Wrong alinment on WaterSubsystem_IsShallowWaterSimulationEnabled");
...
static_assert(alignof(WaterSubsystem_IsUnderwaterPostProcessEnabled) == 0x000001, "Wrong alinment on WaterSubsystem_IsUnderwaterPostProcessEnabled");
...
static_assert(alignof(WaterSubsystem_IsWaterRenderingEnabled) == 0x000001, "Wrong alinment on WaterSubsystem_IsWaterRenderingEnabled");
