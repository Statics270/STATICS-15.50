...
public:
	...
	uint8                                         Pad_4A4B[0x4];                                     // 0x0204(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControlRigSequence">();
	}
...
static_assert(alignof(UControlRigSequence) == 0x000008, "Wrong alinment on UControlRigSequence");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControlRigComponent">();
	}
...
static_assert(alignof(UControlRigComponent) == 0x000008, "Wrong alinment on UControlRigComponent");
...
{
public:
	uint8                                         Pad_4A4C[0x4C];                                    // 0x0028(0x004C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A4D[0x3];                                     // 0x0075(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A4E[0x10];                                    // 0x0258(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A4F[0x8];                                     // 0x0320(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A50[0x38];                                    // 0x0330(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControlRig">();
	}
...
static_assert(alignof(UControlRig) == 0x000008, "Wrong alinment on UControlRig");
...
{
public:
	uint8                                         Pad_4A51[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A52[0x10];                                    // 0x00D0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControlRigGizmoLibrary">();
	}
...
static_assert(alignof(UControlRigGizmoLibrary) == 0x000010, "Wrong alinment on UControlRigGizmoLibrary");
...
{
public:
	uint8                                         Pad_4A53[0x10];                                    // 0x0368(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AdditiveControlRig">();
	}
...
static_assert(alignof(UAdditiveControlRig) == 0x000008, "Wrong alinment on UAdditiveControlRig");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControlRigBlueprintGeneratedClass">();
	}
...
static_assert(alignof(UControlRigBlueprintGeneratedClass) == 0x000008, "Wrong alinment on UControlRigBlueprintGeneratedClass");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControlRigLayerInstance">();
	}
...
static_assert(alignof(UControlRigLayerInstance) == 0x000010, "Wrong alinment on UControlRigLayerInstance");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControlRigObjectHolder">();
	}
...
static_assert(alignof(UControlRigObjectHolder) == 0x000008, "Wrong alinment on UControlRigObjectHolder");
...
{
public:
	uint8                                         Pad_4A54[0x10];                                    // 0x02C0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControlRigSequencerAnimInstance">();
	}
...
static_assert(alignof(UControlRigSequencerAnimInstance) == 0x000010, "Wrong alinment on UControlRigSequencerAnimInstance");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControlRigSettings">();
	}
...
static_assert(alignof(UControlRigSettings) == 0x000008, "Wrong alinment on UControlRigSettings");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControlRigManipulatable">();
	}
...
static_assert(alignof(IControlRigManipulatable) == 0x000008, "Wrong alinment on IControlRigManipulatable");
...
public:
	...
	uint8                                         Pad_4A55[0x2];                                     // 0x0166(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A56[0x18];                                    // 0x0268(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneControlRigParameterSection">();
	}
...
static_assert(alignof(UMovieSceneControlRigParameterSection) == 0x000008, "Wrong alinment on UMovieSceneControlRigParameterSection");
...
{
public:
	uint8                                         Pad_4A57[0x8];                                     // 0x0078(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneControlRigParameterTrack">();
	}
...
static_assert(alignof(UMovieSceneControlRigParameterTrack) == 0x000008, "Wrong alinment on UMovieSceneControlRigParameterTrack");
...
public:
	...
	uint8                                         Pad_4A58[0x6];                                     // 0x016A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneControlRigSection">();
	}
...
static_assert(alignof(UMovieSceneControlRigSection) == 0x000008, "Wrong alinment on UMovieSceneControlRigSection");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneControlRigTrack">();
	}
...
static_assert(alignof(UMovieSceneControlRigTrack) == 0x000008, "Wrong alinment on UMovieSceneControlRigTrack");
