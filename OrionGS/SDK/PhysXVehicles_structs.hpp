...
{
public:
	uint8                                         Pad_4C31[0x18];                                    // 0x00C8(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_WheelHandler) == 0x000008, "Wrong alinment on FAnimNode_WheelHandler");
...
static_assert(alignof(FVehicleGearData) == 0x000004, "Wrong alinment on FVehicleGearData");
...
public:
	...
	uint8                                         Pad_4C32[0x4];                                     // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTireConfigMaterialFriction) == 0x000008, "Wrong alinment on FTireConfigMaterialFriction");
...
{
public:
	uint8                                         Pad_4C33[0x10];                                    // 0x06E0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVehicleAnimInstanceProxy) == 0x000010, "Wrong alinment on FVehicleAnimInstanceProxy");
...
static_assert(alignof(FVehicleInputRate) == 0x000004, "Wrong alinment on FVehicleInputRate");
...
static_assert(alignof(FReplicatedVehicleState) == 0x000004, "Wrong alinment on FReplicatedVehicleState");
...
public:
	...
	uint8                                         Pad_4C34[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C35[0x4];                                     // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVehicleTransmissionData) == 0x000008, "Wrong alinment on FVehicleTransmissionData");
...
public:
	...
	uint8                                         Pad_4C36[0x3];                                     // 0x001D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWheelSetup) == 0x000008, "Wrong alinment on FWheelSetup");
...
public:
	...
	uint8                                         Pad_4C37[0x4];                                     // 0x009C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVehicleEngineData) == 0x000008, "Wrong alinment on FVehicleEngineData");
...
public:
	...
	uint8                                         Pad_4C38[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FVehicleDifferential4WData) == 0x000004, "Wrong alinment on FVehicleDifferential4WData");
