...
static_assert(alignof(FEyeTrackerStereoGazeData) == 0x000004, "Wrong alinment on FEyeTrackerStereoGazeData");
...
static_assert(alignof(FEyeTrackerGazeData) == 0x000004, "Wrong alinment on FEyeTrackerGazeData");
