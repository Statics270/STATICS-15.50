...
public:
	...
	uint8                                         Pad_7B96[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(LeaderboardTab_C_ExecuteUbergraph_LeaderboardTab) == 0x000008, "Wrong alinment on LeaderboardTab_C_ExecuteUbergraph_LeaderboardTab");
...
static_assert(alignof(LeaderboardTab_C_Set_Event) == 0x000008, "Wrong alinment on LeaderboardTab_C_Set_Event");
...
static_assert(alignof(LeaderboardTab_C_Colorize) == 0x000008, "Wrong alinment on LeaderboardTab_C_Colorize");
