...
public:
	...
	uint8                                         Pad_4D57[0x6];                                     // 0x001A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMIDIDeviceInfo) == 0x000008, "Wrong alinment on FMIDIDeviceInfo");
...
public:
	...
	uint8                                         Pad_4D59[0x3];                                     // 0x001D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFoundMIDIDevice) == 0x000008, "Wrong alinment on FFoundMIDIDevice");
