...
{
public:
	uint8                                         Pad_CFE[0xB8];                                     // 0x0000(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEventReply) == 0x000008, "Wrong alinment on FEventReply");
...
static_assert(alignof(FAnchorData) == 0x000004, "Wrong alinment on FAnchorData");
...
public:
	...
	uint8                                         Pad_CFF[0x3];                                      // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_D00[0x4];                                      // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimationEventBinding) == 0x000008, "Wrong alinment on FAnimationEventBinding");
...
static_assert(alignof(FWidgetTransform) == 0x000004, "Wrong alinment on FWidgetTransform");
...
{
public:
	uint8                                         Pad_D01[0x30];                                     // 0x0000(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPaintContext) == 0x000008, "Wrong alinment on FPaintContext");
...
public:
	...
	uint8                                         Pad_D02[0x60];                                     // 0x0020(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FUserWidgetPool) == 0x000008, "Wrong alinment on FUserWidgetPool");
...
static_assert(alignof(FShapedTextOptions) == 0x000001, "Wrong alinment on FShapedTextOptions");
...
static_assert(alignof(FRichImageRow) == 0x000008, "Wrong alinment on FRichImageRow");
...
static_assert(alignof(FNamedSlotBinding) == 0x000008, "Wrong alinment on FNamedSlotBinding");
...
static_assert(alignof(FDynamicPropertyPath) == 0x000008, "Wrong alinment on FDynamicPropertyPath");
...
static_assert(alignof(FMovieScene2DTransformMask) == 0x000004, "Wrong alinment on FMovieScene2DTransformMask");
...
public:
	...
	uint8                                         Pad_D03[0x7];                                      // 0x02B9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneMarginSectionTemplate) == 0x000008, "Wrong alinment on FMovieSceneMarginSectionTemplate");
...
static_assert(alignof(FMovieSceneWidgetMaterialSectionTemplate) == 0x000008, "Wrong alinment on FMovieSceneWidgetMaterialSectionTemplate");
...
public:
	...
	uint8                                         Pad_D04[0x3];                                      // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FRadialBoxSettings) == 0x000004, "Wrong alinment on FRadialBoxSettings");
...
static_assert(alignof(FRichTextStyleRow) == 0x000008, "Wrong alinment on FRichTextStyleRow");
...
static_assert(alignof(FSlateMeshVertex) == 0x000004, "Wrong alinment on FSlateMeshVertex");
...
public:
	...
	uint8                                         Pad_D05[0x3];                                      // 0x0005(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSlateChildSize) == 0x000004, "Wrong alinment on FSlateChildSize");
...
public:
	...
	uint8                                         Pad_D06[0x3];                                      // 0x0021(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWidgetAnimationBinding) == 0x000004, "Wrong alinment on FWidgetAnimationBinding");
...
public:
	...
	uint8                                         Pad_D07[0x3];                                      // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FBlueprintWidgetAnimationDelegateBinding) == 0x000004, "Wrong alinment on FBlueprintWidgetAnimationDelegateBinding");
...
public:
	...
	uint8                                         Pad_D08[0x7];                                      // 0x0049(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDelegateRuntimeBinding) == 0x000008, "Wrong alinment on FDelegateRuntimeBinding");
...
{
public:
	uint8                                         Pad_D09[0x10];                                     // 0x00A8(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWidgetComponentInstanceData) == 0x000008, "Wrong alinment on FWidgetComponentInstanceData");
...
public:
	...
	uint8                                         Pad_D0A[0x3];                                      // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FWidgetNavigationData) == 0x000004, "Wrong alinment on FWidgetNavigationData");
