...
public:
	...
	uint8                                         Pad_48B6[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FInAppPurchaseProductInfo) == 0x000008, "Wrong alinment on FInAppPurchaseProductInfo");
...
static_assert(alignof(FNamedInterfaceDef) == 0x000008, "Wrong alinment on FNamedInterfaceDef");
...
static_assert(alignof(FInAppPurchaseRestoreInfo) == 0x000008, "Wrong alinment on FInAppPurchaseRestoreInfo");
...
static_assert(alignof(FNamedInterface) == 0x000008, "Wrong alinment on FNamedInterface");
...
public:
	...
	uint8                                         Pad_48B7[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FInAppPurchaseProductRequest) == 0x000008, "Wrong alinment on FInAppPurchaseProductRequest");
