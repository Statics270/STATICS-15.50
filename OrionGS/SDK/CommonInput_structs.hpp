...
public:
	...
	uint8                                         Pad_1D39[0x1];                                     // 0x0007(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FCommonInputPlatformData) == 0x000008, "Wrong alinment on FCommonInputPlatformData");
...
static_assert(alignof(FCommonInputKeySetBrushConfiguration) == 0x000008, "Wrong alinment on FCommonInputKeySetBrushConfiguration");
...
static_assert(alignof(FCommonInputKeyBrushConfiguration) == 0x000008, "Wrong alinment on FCommonInputKeyBrushConfiguration");
