...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FortniteUserInterfaceSettings">();
	}
...
static_assert(alignof(UFortniteUserInterfaceSettings) == 0x000008, "Wrong alinment on UFortniteUserInterfaceSettings");
