...
public:
	...
	uint8                                         Pad_5975[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayEventData                     K2Node_Event_EventData;                            // 0x0008(0x00B0)(ConstParm)
};
static_assert(alignof(GA_Ninja_SwordHitsHeal_C_ExecuteUbergraph_GA_Ninja_SwordHitsHeal) == 0x000008, "Wrong alinment on GA_Ninja_SwordHitsHeal_C_ExecuteUbergraph_GA_Ninja_SwordHitsHeal");
...
static_assert(alignof(GA_Ninja_SwordHitsHeal_C_K2_ActivateAbilityFromEvent) == 0x000008, "Wrong alinment on GA_Ninja_SwordHitsHeal_C_K2_ActivateAbilityFromEvent");
...
static_assert(alignof(GA_Ninja_SwordHitsHeal_C_SetupAbility) == 0x000008, "Wrong alinment on GA_Ninja_SwordHitsHeal_C_SetupAbility");
...
static_assert(alignof(GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent) == 0x000008, "Wrong alinment on GA_Ninja_SwordHitsHeal_C_K2_ShouldAbilityRespondToEvent");
