...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ExternalAccountProvider">();
	}
...
static_assert(alignof(UExternalAccountProvider) == 0x000008, "Wrong alinment on UExternalAccountProvider");
...
{
public:
	uint8                                         Pad_47F5[0x10];                                    // 0x0028(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47F6[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47F7[0x7];                                     // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47F8[0x36];                                    // 0x00CA(0x0036)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47F9[0x1];                                     // 0x0136(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47FA[0x29F];                                   // 0x0139(0x029F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47FB[0x4];                                     // 0x03DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47FC[0x330];                                   // 0x03E8(0x0330)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47FD[0x37];                                    // 0x0719(0x0037)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"OnlineAccountCommon">();
	}
...
static_assert(alignof(UOnlineAccountCommon) == 0x000008, "Wrong alinment on UOnlineAccountCommon");
...
{
public:
	uint8                                         Pad_47FE[0x34];                                    // 0x0028(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47FF[0x28];                                    // 0x0060(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"WaitingRoomState">();
	}
...
static_assert(alignof(UWaitingRoomState) == 0x000008, "Wrong alinment on UWaitingRoomState");
