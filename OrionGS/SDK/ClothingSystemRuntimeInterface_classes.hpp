...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ClothSharedSimConfigBase">();
	}
...
static_assert(alignof(UClothSharedSimConfigBase) == 0x000008, "Wrong alinment on UClothSharedSimConfigBase");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ClothConfigBase">();
	}
...
static_assert(alignof(UClothConfigBase) == 0x000008, "Wrong alinment on UClothConfigBase");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ClothingSimulationFactory">();
	}
...
static_assert(alignof(UClothingSimulationFactory) == 0x000008, "Wrong alinment on UClothingSimulationFactory");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ClothingAssetBase">();
	}
...
static_assert(alignof(UClothingAssetBase) == 0x000008, "Wrong alinment on UClothingAssetBase");
...
{
public:
	uint8                                         Pad_4EF4[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ClothingSimulationInteractor">();
	}
...
static_assert(alignof(UClothingSimulationInteractor) == 0x000008, "Wrong alinment on UClothingSimulationInteractor");
...
public:
	...
	uint8                                         Pad_4EF5[0x50];                                    // 0x0090(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ClothPhysicalMeshDataBase_Legacy">();
	}
...
static_assert(alignof(UClothPhysicalMeshDataBase_Legacy) == 0x000008, "Wrong alinment on UClothPhysicalMeshDataBase_Legacy");
