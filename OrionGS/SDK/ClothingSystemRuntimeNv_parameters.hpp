...
static_assert(alignof(ClothingSimulationInteractorNv_SetAnimDriveDamperStiffness) == 0x000004, "Wrong alinment on ClothingSimulationInteractorNv_SetAnimDriveDamperStiffness");
