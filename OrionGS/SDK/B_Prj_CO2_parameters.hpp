...
public:
	...
	uint8                                         Pad_6D10[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6D11[0x3];                                     // 0x0095(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6D12[0x3];                                     // 0x00B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(B_Prj_CO2_C_ExecuteUbergraph_B_Prj_CO2) == 0x000008, "Wrong alinment on B_Prj_CO2_C_ExecuteUbergraph_B_Prj_CO2");
...
public:
	...
	uint8                                         Pad_6D13[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(B_Prj_CO2_C_ReceiveHit) == 0x000008, "Wrong alinment on B_Prj_CO2_C_ReceiveHit");
...
static_assert(offsetof(B_Prj_CO2_C_ReceiveHit, Param_HitLocation) == 0x00001C, "Member 'B_Prj_CO2_C_ReceiveHit::Param_HitLocation' has a wrong offset!");
static_assert(offsetof(B_Prj_CO2_C_ReceiveHit, Param_HitNormal) == 0x000028, "Member 'B_Prj_CO2_C_ReceiveHit::Param_HitNormal' has a wrong offset!");
...
static_assert(alignof(B_Prj_CO2_C_OnStop) == 0x000004, "Wrong alinment on B_Prj_CO2_C_OnStop");
...
public:
	...
	uint8                                         Pad_6D14[0x3];                                     // 0x008D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6D15[0x4];                                     // 0x009C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6D16[0x3];                                     // 0x00C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6D17[0x7];                                     // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(B_Prj_CO2_C_ApplyWaterInRadiusIfCurieEnabled) == 0x000008, "Wrong alinment on B_Prj_CO2_C_ApplyWaterInRadiusIfCurieEnabled");
