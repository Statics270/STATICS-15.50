...
public:
	void KnockBackFromAllPlayersReceivedEvent(struct FPhosphorusWipeoutKnockBackData& KnockBackData);
	void PhosphorusPhaseChangedEvent(class AFortAthenaMutator_Phosphorus* Mutator, EPhosphorusPhase Phase);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"PhosphorusKnockBackWidget">();
	}
...
static_assert(alignof(UPhosphorusKnockBackWidget) == 0x000008, "Wrong alinment on UPhosphorusKnockBackWidget");
