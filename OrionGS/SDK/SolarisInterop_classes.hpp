...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"VerseAsset">();
	}
...
static_assert(alignof(UVerseAsset) == 0x000008, "Wrong alinment on UVerseAsset");
...
{
public:
	uint8                                         Pad_4DCF[0xF0];                                    // 0x0028(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"CoroutineContextPlaceholder">();
	}
...
static_assert(alignof(UCoroutineContextPlaceholder) == 0x000008, "Wrong alinment on UCoroutineContextPlaceholder");
