...
public:
	...
	uint8                                         Pad_EA2[0x7];                                      // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortEventLeaderboardEntryData*         K2Node_Event_EntryData;                            // 0x0010(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable_1;                              // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_EA3[0x7];                                      // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EA4[0x7];                                      // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EA5[0x7];                                      // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EA6[0x6];                                      // 0x0072(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EA7[0x7];                                      // 0x0081(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EA8[0x3];                                      // 0x0091(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class UObject* Item)>          K2Node_CreateDelegate_OutputDelegate;              // 0x0094(0x0010)(ZeroConstructor, NoDestructor)
	uint8                                         Pad_EA9[0x4];                                      // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EAA[0x3];                                      // 0x00D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EAB[0x4];                                      // 0x00E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EAC[0x6];                                      // 0x0292(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(EventLeaderboardScreen_C_ExecuteUbergraph_EventLeaderboardScreen) == 0x000008, "Wrong alinment on EventLeaderboardScreen_C_ExecuteUbergraph_EventLeaderboardScreen");
...
static_assert(alignof(EventLeaderboardScreen_C_BndEvt__Button_Back2_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature) == 0x000008, "Wrong alinment on EventLeaderboardScreen_C_BndEvt__Button_Back2_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature");
...
static_assert(alignof(EventLeaderboardScreen_C_OnDetailsPanelUpdate) == 0x000001, "Wrong alinment on EventLeaderboardScreen_C_OnDetailsPanelUpdate");
...
static_assert(alignof(EventLeaderboardScreen_C_EventColorize) == 0x000008, "Wrong alinment on EventLeaderboardScreen_C_EventColorize");
...
static_assert(alignof(EventLeaderboardScreen_C_InitializeTabButton) == 0x000008, "Wrong alinment on EventLeaderboardScreen_C_InitializeTabButton");
...
static_assert(alignof(EventLeaderboardScreen_C_BndEvt__LiveGames_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature) == 0x000008, "Wrong alinment on EventLeaderboardScreen_C_BndEvt__LiveGames_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
static_assert(alignof(EventLeaderboardScreen_C_OnTabVisibilityChange) == 0x000001, "Wrong alinment on EventLeaderboardScreen_C_OnTabVisibilityChange");
...
static_assert(alignof(EventLeaderboardScreen_C_Item_DoubleMinusClicked) == 0x000008, "Wrong alinment on EventLeaderboardScreen_C_Item_DoubleMinusClicked");
...
static_assert(alignof(EventLeaderboardScreen_C_BndEvt__CloseButton_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature) == 0x000008, "Wrong alinment on EventLeaderboardScreen_C_BndEvt__CloseButton_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature");
...
static_assert(alignof(EventLeaderboardScreen_C_ShowMyStats) == 0x000008, "Wrong alinment on EventLeaderboardScreen_C_ShowMyStats");
...
{
public:
	class UFortEventLeaderboardEntryData*         EntryData;                                         // 0x0000(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(EventLeaderboardScreen_C_OnLeaderboardEntrySelected) == 0x000008, "Wrong alinment on EventLeaderboardScreen_C_OnLeaderboardEntrySelected");
...
public:
	...
	uint8                                         Pad_EAD[0x6];                                      // 0x0022(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(EventLeaderboardScreen_C_Init) == 0x000008, "Wrong alinment on EventLeaderboardScreen_C_Init");
