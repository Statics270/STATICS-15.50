...
static_assert(alignof(PlayerRankEmblem_C_SetBannerInfo) == 0x000008, "Wrong alinment on PlayerRankEmblem_C_SetBannerInfo");
...
public:
	...
	uint8                                         Pad_627D[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue;                // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(PlayerRankEmblem_C_SetBannerSurroundLevel) == 0x000008, "Wrong alinment on PlayerRankEmblem_C_SetBannerSurroundLevel");
...
static_assert(alignof(PlayerRankEmblem_C_SetBannerOwner) == 0x000008, "Wrong alinment on PlayerRankEmblem_C_SetBannerOwner");
...
static_assert(alignof(PlayerRankEmblem_C_PreConstruct) == 0x000001, "Wrong alinment on PlayerRankEmblem_C_PreConstruct");
...
public:
	...
	uint8                                         Pad_627F[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(PlayerRankEmblem_C_ExecuteUbergraph_PlayerRankEmblem) == 0x000008, "Wrong alinment on PlayerRankEmblem_C_ExecuteUbergraph_PlayerRankEmblem");
