...
static_assert(alignof(UGA_Athena_TillLandFallDamageImmunity_NoFX_Parent_C) == 0x000008, "Wrong alinment on UGA_Athena_TillLandFallDamageImmunity_NoFX_Parent_C");
