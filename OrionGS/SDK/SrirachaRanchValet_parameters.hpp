...
static_assert(alignof(StreamingRadioPlayerComponent_Valet_ValetVehicleExploded) == 0x000008, "Wrong alinment on StreamingRadioPlayerComponent_Valet_ValetVehicleExploded");
