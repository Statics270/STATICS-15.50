...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AutomationUtilsBlueprintLibrary">();
	}
...
static_assert(alignof(UAutomationUtilsBlueprintLibrary) == 0x000008, "Wrong alinment on UAutomationUtilsBlueprintLibrary");
