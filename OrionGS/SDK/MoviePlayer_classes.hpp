...
public:
	...
	uint8                                         Pad_5263[0x6];                                     // 0x002A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"MoviePlayerSettings">();
	}
...
static_assert(alignof(UMoviePlayerSettings) == 0x000008, "Wrong alinment on UMoviePlayerSettings");
