...
void AB_Prj_Petrol_C::OnExploded(TArray<class AActor*>& Param_HitActors, TArray<struct FHitResult>& HitResults)
{
	static class UFunction* Func = nullptr;
...
void AB_Prj_Petrol_C::UserConstructionScript(float CallFunc_GetValueAtLevel_ReturnValue)
{
	...
	Params::B_Prj_Petrol_C_UserConstructionScript Parms{};
