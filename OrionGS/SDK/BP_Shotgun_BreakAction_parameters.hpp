...
static_assert(alignof(BP_Shotgun_BreakAction_C_ExecuteUbergraph_BP_Shotgun_BreakAction) == 0x000004, "Wrong alinment on BP_Shotgun_BreakAction_C_ExecuteUbergraph_BP_Shotgun_BreakAction");
...
static_assert(alignof(BP_Shotgun_BreakAction_C_AnimGraph) == 0x000008, "Wrong alinment on BP_Shotgun_BreakAction_C_AnimGraph");
static_assert(sizeof(BP_Shotgun_BreakAction_C_AnimGraph) == 0x000010, "Wrong size on BP_Shotgun_BreakAction_C_AnimGraph");
static_assert(offsetof(BP_Shotgun_BreakAction_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'BP_Shotgun_BreakAction_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
