...
public:
	...
	uint8                                         Pad_5254[0x3];                                     // 0x0029(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(EyeTrackerFunctionLibrary_GetGazeData) == 0x000004, "Wrong alinment on EyeTrackerFunctionLibrary_GetGazeData");
...
public:
	...
	uint8                                         Pad_5255[0x3];                                     // 0x0041(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(EyeTrackerFunctionLibrary_GetStereoGazeData) == 0x000004, "Wrong alinment on EyeTrackerFunctionLibrary_GetStereoGazeData");
...
static_assert(alignof(EyeTrackerFunctionLibrary_IsEyeTrackerConnected) == 0x000001, "Wrong alinment on EyeTrackerFunctionLibrary_IsEyeTrackerConnected");
...
static_assert(alignof(EyeTrackerFunctionLibrary_IsStereoGazeDataAvailable) == 0x000001, "Wrong alinment on EyeTrackerFunctionLibrary_IsStereoGazeDataAvailable");
...
static_assert(alignof(EyeTrackerFunctionLibrary_SetEyeTrackedPlayer) == 0x000008, "Wrong alinment on EyeTrackerFunctionLibrary_SetEyeTrackedPlayer");
