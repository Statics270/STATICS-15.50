...
void UHUDMapComponentBase::HandleMapBoundsChanged(struct FBox& NewBounds)
{
	static class UFunction* Func = nullptr;
...
void UVerseFortniteInputComponentBase::ServerTriggerAction(class FName& ActionName)
{
	static class UFunction* Func = nullptr;
