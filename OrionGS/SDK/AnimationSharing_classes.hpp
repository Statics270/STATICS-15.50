...
public:
	...
	uint8                                         Pad_4A72[0x7];                                     // 0x02C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A73[0x8];                                     // 0x02D8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AnimSharingStateInstance">();
	}
...
static_assert(alignof(UAnimSharingStateInstance) == 0x000010, "Wrong alinment on UAnimSharingStateInstance");
...
public:
	...
	uint8                                         Pad_4A74[0x3];                                     // 0x02CD(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AnimSharingTransitionInstance">();
	}
...
static_assert(alignof(UAnimSharingTransitionInstance) == 0x000010, "Wrong alinment on UAnimSharingTransitionInstance");
...
public:
	...
	uint8                                         Pad_4A75[0x3];                                     // 0x02CD(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AnimSharingAdditiveInstance">();
	}
...
static_assert(alignof(UAnimSharingAdditiveInstance) == 0x000010, "Wrong alinment on UAnimSharingAdditiveInstance");
...
public:
	...
	uint8                                         Pad_4A76[0x70];                                    // 0x0038(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A77[0x38];                                    // 0x00B0(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A78[0x10];                                    // 0x00F8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A79[0x20];                                    // 0x0118(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AnimSharingInstance">();
	}
...
static_assert(alignof(UAnimSharingInstance) == 0x000008, "Wrong alinment on UAnimSharingInstance");
...
public:
	...
	uint8                                         Pad_4A7A[0x40];                                    // 0x0048(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AnimationSharingManager">();
	}
...
static_assert(alignof(UAnimationSharingManager) == 0x000008, "Wrong alinment on UAnimationSharingManager");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AnimationSharingSetup">();
	}
...
static_assert(alignof(UAnimationSharingSetup) == 0x000008, "Wrong alinment on UAnimationSharingSetup");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AnimationSharingStateProcessor">();
	}
...
static_assert(alignof(UAnimationSharingStateProcessor) == 0x000008, "Wrong alinment on UAnimationSharingStateProcessor");
