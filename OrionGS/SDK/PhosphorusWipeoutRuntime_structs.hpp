...
public:
	...
	uint8                                         Pad_4703[0x4];                                     // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPhosphorusWipeoutKnockBackData) == 0x000008, "Wrong alinment on FPhosphorusWipeoutKnockBackData");
...
static_assert(alignof(FModifyIncomingPawnDamageDefinition) == 0x000008, "Wrong alinment on FModifyIncomingPawnDamageDefinition");
...
{
public:
	uint8                                         Pad_4704[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayEventData                     GameplayEventData;                                 // 0x0008(0x00B0)(NativeAccessSpecifierPublic)
	uint8                                         Pad_4705[0x8];                                     // 0x00B8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FReroutePlayerEventQueueEntry) == 0x000008, "Wrong alinment on FReroutePlayerEventQueueEntry");
...
static_assert(alignof(FReroutePlayerEventDefinition) == 0x000008, "Wrong alinment on FReroutePlayerEventDefinition");
