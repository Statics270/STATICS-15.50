...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"SidecarDss">();
	}
...
static_assert(alignof(USidecarDss) == 0x000008, "Wrong alinment on USidecarDss");
...
public:
	...
	uint8                                         Pad_4804[0x78];                                    // 0x0068(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SidecarInventorySys">();
	}
...
static_assert(alignof(USidecarInventorySys) == 0x000010, "Wrong alinment on USidecarInventorySys");
...
{
public:
	uint8                                         Pad_4805[0x10];                                    // 0x0028(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4806[0x10];                                    // 0x0048(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SidecarSys">();
	}
...
static_assert(alignof(USidecarSys) == 0x000008, "Wrong alinment on USidecarSys");
