...
public:
	...
	uint8                                         Pad_79EF[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_79F0[0x2];                                     // 0x001A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_79F1[0x8];                                     // 0x0058(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(VaultCharacterPlacementHelper_C_UpdatePosition_For_Camera) == 0x000010, "Wrong alinment on VaultCharacterPlacementHelper_C_UpdatePosition_For_Camera");
...
static_assert(alignof(VaultCharacterPlacementHelper_C_UserConstructionScript) == 0x000010, "Wrong alinment on VaultCharacterPlacementHelper_C_UserConstructionScript");
...
static_assert(alignof(VaultCharacterPlacementHelper_C_SubGameChanged_Event_0) == 0x000001, "Wrong alinment on VaultCharacterPlacementHelper_C_SubGameChanged_Event_0");
...
static_assert(alignof(VaultCharacterPlacementHelper_C_OnFrontEndCameraChanged) == 0x000001, "Wrong alinment on VaultCharacterPlacementHelper_C_OnFrontEndCameraChanged");
...
public:
	...
	uint8                                         Pad_79F2[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_79F3[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_79F4[0x3];                                     // 0x0025(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_79F5[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_79F6[0x3];                                     // 0x00C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_79F7[0x2];                                     // 0x00D2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(ESubGame SubGame)>             K2Node_CreateDelegate_OutputDelegate_1;            // 0x00D4(0x0010)(ZeroConstructor, NoDestructor)
	uint8                                         Pad_79F8[0xC];                                     // 0x00E4(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             CallFunc_GetTransform_ReturnValue;                 // 0x00F0(0x0030)(ConstParm, IsPlainOldData, NoDestructor)
};
static_assert(alignof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper) == 0x000010, "Wrong alinment on VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper");
...
static_assert(alignof(VaultCharacterPlacementHelper_C_OnZoomLevelUpdated__DelegateSignature) == 0x000004, "Wrong alinment on VaultCharacterPlacementHelper_C_OnZoomLevelUpdated__DelegateSignature");
