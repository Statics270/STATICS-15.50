...
public:
	...
	uint8                                         Pad_4ED2[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature) == 0x000008, "Wrong alinment on PlayerPawn_Generic_Parent_C_OnOverlapWaterVolume__DelegateSignature");
...
public:
	...
	uint8                                         Pad_4ED3[0xC];                                     // 0x0004(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4ED4[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4ED5[0xF];                                     // 0x0051(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             K2Node_CustomEvent_NewTransform;                   // 0x0060(0x0030)(ConstParm, IsPlainOldData, NoDestructor)
};
static_assert(alignof(PlayerPawn_Generic_Parent_C_ExecuteUbergraph_PlayerPawn_Generic_Parent) == 0x000010, "Wrong alinment on PlayerPawn_Generic_Parent_C_ExecuteUbergraph_PlayerPawn_Generic_Parent");
...
static_assert(alignof(PlayerPawn_Generic_Parent_C_Player_Creates_a_Splash) == 0x000010, "Wrong alinment on PlayerPawn_Generic_Parent_C_Player_Creates_a_Splash");
