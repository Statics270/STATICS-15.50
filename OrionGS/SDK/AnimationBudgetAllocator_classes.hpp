...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AnimationBudgetBlueprintLibrary">();
	}
...
static_assert(alignof(UAnimationBudgetBlueprintLibrary) == 0x000008, "Wrong alinment on UAnimationBudgetBlueprintLibrary");
...
{
public:
	uint8                                         Pad_4A60[0x20];                                    // 0x0B58(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A61[0x7];                                     // 0x0B79(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SkeletalMeshComponentBudgeted">();
	}
...
static_assert(alignof(USkeletalMeshComponentBudgeted) == 0x000010, "Wrong alinment on USkeletalMeshComponentBudgeted");
