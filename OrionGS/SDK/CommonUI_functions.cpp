...
struct FSlateBrush UCommonUISubsystem::GetInputActionButtonIcon(struct FDataTableRowHandle& InputActionRowHandle, ECommonInputType InputType, ECommonGamepadType GamepadType) const
{
	static class UFunction* Func = nullptr;
...
// int32                                   Param_ActiveWidgetIndex                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCommonVisibilitySwitcher::OnActiveWidgetChangedLegacy__DelegateSignature(class UWidget* ActiveWidget, int32 Param_ActiveWidgetIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonVisibilitySwitcher", "OnActiveWidgetChangedLegacy__DelegateSignature");

	Params::CommonVisibilitySwitcher_OnActiveWidgetChangedLegacy__DelegateSignature Parms{};

	Parms.ActiveWidget = ActiveWidget;
	Parms.Param_ActiveWidgetIndex = Param_ActiveWidgetIndex;
