...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ImagePlate">();
	}
...
static_assert(alignof(AImagePlate) == 0x000008, "Wrong alinment on AImagePlate");
...
public:
	...
	uint8                                         Pad_4BB0[0x90];                                    // 0x0480(0x0090)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ImagePlateComponent">();
	}
...
static_assert(alignof(UImagePlateComponent) == 0x000010, "Wrong alinment on UImagePlateComponent");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ImagePlateSettings">();
	}
...
static_assert(alignof(UImagePlateSettings) == 0x000008, "Wrong alinment on UImagePlateSettings");
...
public:
	...
	uint8                                         Pad_4BB1[0x4];                                     // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ImagePlateFileSequence">();
	}
...
static_assert(alignof(UImagePlateFileSequence) == 0x000008, "Wrong alinment on UImagePlateFileSequence");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ImagePlateFrustumComponent">();
	}
...
static_assert(alignof(UImagePlateFrustumComponent) == 0x000010, "Wrong alinment on UImagePlateFrustumComponent");
...
public:
	...
	uint8                                         Pad_4BB2[0x7];                                     // 0x00F1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneImagePlateSection">();
	}
...
static_assert(alignof(UMovieSceneImagePlateSection) == 0x000008, "Wrong alinment on UMovieSceneImagePlateSection");
...
{
public:
	uint8                                         Pad_4BB3[0x8];                                     // 0x00A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneImagePlateTrack">();
	}
...
static_assert(alignof(UMovieSceneImagePlateTrack) == 0x000008, "Wrong alinment on UMovieSceneImagePlateTrack");
