...
public:
	...
	uint8                                         Pad_57AA[0x3];                                     // 0x056D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UEnableMultiFactorAuthModalBP_C) == 0x000008, "Wrong alinment on UEnableMultiFactorAuthModalBP_C");
