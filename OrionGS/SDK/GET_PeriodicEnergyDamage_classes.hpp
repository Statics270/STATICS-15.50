...
static_assert(alignof(UGET_PeriodicEnergyDamage_C) == 0x000008, "Wrong alinment on UGET_PeriodicEnergyDamage_C");
static_assert(sizeof(UGET_PeriodicEnergyDamage_C) == 0x000800, "Wrong size on UGET_PeriodicEnergyDamage_C");
