...
public:
	...
	uint8                                         Pad_5171[0x4];                                     // 0x00FC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(ChaosSolverEngineBlueprintLibrary_ConvertPhysicsCollisionToHitResult) == 0x000008, "Wrong alinment on ChaosSolverEngineBlueprintLibrary_ConvertPhysicsCollisionToHitResult");
...
static_assert(alignof(ChaosSolverActor_SetSolverActive) == 0x000001, "Wrong alinment on ChaosSolverActor_SetSolverActive");
