...
static_assert(alignof(FKairosSnippetPlayRecord) == 0x000008, "Wrong alinment on FKairosSnippetPlayRecord");
...
public:
	class FString                                 PlayerId;                                          // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPause;                                            // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4A7F[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FKairosSnippetParams) == 0x000008, "Wrong alinment on FKairosSnippetParams");
...
static_assert(alignof(FKairosAvatarAttributesMcpData) == 0x000008, "Wrong alinment on FKairosAvatarAttributesMcpData");
...
static_assert(alignof(FKairosAvatarItemMcpData) == 0x000008, "Wrong alinment on FKairosAvatarItemMcpData");
...
public:
	...
	uint8                                         Pad_4A80[0x6];                                     // 0x0022(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FKairosAvatarMcpData) == 0x000008, "Wrong alinment on FKairosAvatarMcpData");
...
static_assert(alignof(FKairosCaptureAvatarParams) == 0x000008, "Wrong alinment on FKairosCaptureAvatarParams");
...
static_assert(alignof(FKairosBobbleTimeParams) == 0x000008, "Wrong alinment on FKairosBobbleTimeParams");
...
public:
	...
	uint8                                         Pad_4A81[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A82[0xD8];                                    // 0x0028(0x00D8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FKairosCaptureParams) == 0x000010, "Wrong alinment on FKairosCaptureParams");
...
public:
	...
	uint8                                         Pad_4A83[0xE];                                     // 0x0002(0x000E)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A84[0x30];                                    // 0x00D8(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A85[0x10];                                    // 0x0210(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A86[0x8];                                     // 0x0228(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A87[0x7];                                     // 0x0351(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A88[0x8];                                     // 0x0368(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A89[0x6];                                     // 0x03A2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A8A[0xF];                                     // 0x03B1(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FKairosAvatarDisplayInfo) == 0x000010, "Wrong alinment on FKairosAvatarDisplayInfo");
...
public:
	...
	uint8                                         Pad_4A8C[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FKairosSceneInfo) == 0x000008, "Wrong alinment on FKairosSceneInfo");
...
public:
	...
	uint8                                         Pad_4A8D[0xE];                                     // 0x0012(0x000E)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FKairosAnimationFramingInfo) == 0x000010, "Wrong alinment on FKairosAnimationFramingInfo");
