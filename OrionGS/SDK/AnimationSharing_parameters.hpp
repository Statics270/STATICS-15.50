...
static_assert(alignof(AnimSharingStateInstance_GetInstancedActors) == 0x000008, "Wrong alinment on AnimSharingStateInstance_GetInstancedActors");
...
static_assert(alignof(AnimationSharingManager_AnimationSharingEnabled) == 0x000001, "Wrong alinment on AnimationSharingManager_AnimationSharingEnabled");
...
public:
	...
	uint8                                         Pad_4A7B[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AnimationSharingManager_CreateAnimationSharingManager) == 0x000008, "Wrong alinment on AnimationSharingManager_CreateAnimationSharingManager");
...
static_assert(alignof(AnimationSharingManager_GetAnimationSharingManager) == 0x000008, "Wrong alinment on AnimationSharingManager_GetAnimationSharingManager");
...
static_assert(alignof(AnimationSharingManager_RegisterActorWithSkeletonBP) == 0x000008, "Wrong alinment on AnimationSharingManager_RegisterActorWithSkeletonBP");
...
static_assert(alignof(AnimationSharingStateProcessor_GetAnimationStateEnum) == 0x000008, "Wrong alinment on AnimationSharingStateProcessor_GetAnimationStateEnum");
...
public:
	...
	uint8                                         Pad_4A7C[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A7D[0x5];                                     // 0x0013(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AnimationSharingStateProcessor_ProcessActorState) == 0x000008, "Wrong alinment on AnimationSharingStateProcessor_ProcessActorState");
