...
static_assert(alignof(FCustomizedToolMenuNameArray) == 0x000008, "Wrong alinment on FCustomizedToolMenuNameArray");
...
static_assert(alignof(FVirtualKeyboardOptions) == 0x000001, "Wrong alinment on FVirtualKeyboardOptions");
...
public:
	...
	uint8                                         Pad_5080[0x7];                                     // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FInputChord) == 0x000008, "Wrong alinment on FInputChord");
...
static_assert(alignof(FCustomizedToolMenuSection) == 0x000004, "Wrong alinment on FCustomizedToolMenuSection");
...
static_assert(alignof(FAnchors) == 0x000004, "Wrong alinment on FAnchors");
...
static_assert(alignof(FCustomizedToolMenuEntry) == 0x000004, "Wrong alinment on FCustomizedToolMenuEntry");
...
public:
	...
	uint8                                         Pad_5081[0xE0];                                    // 0x0108(0x00E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCustomizedToolMenu) == 0x000008, "Wrong alinment on FCustomizedToolMenu");
