...
{
public:
	uint8                                         Pad_4418[0x60];                                    // 0x00B0(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4419[0x8];                                     // 0x01A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_441A[0x8];                                     // 0x01F0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FortGameFrameworkComponent_EventMode">();
	}
...
static_assert(alignof(UFortGameFrameworkComponent_EventMode) == 0x000008, "Wrong alinment on UFortGameFrameworkComponent_EventMode");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortWeapon_EventMode">();
	}
...
static_assert(alignof(AFortWeapon_EventMode) == 0x000008, "Wrong alinment on AFortWeapon_EventMode");
static_assert(sizeof(AFortWeapon_EventMode) == 0x000D28, "Wrong size on AFortWeapon_EventMode");
