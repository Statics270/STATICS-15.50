...
void UGA_Ninja_SwordHitsHeal_C::ExecuteUbergraph_GA_Ninja_SwordHitsHeal(int32 EntryPoint, struct FGameplayEventData& K2Node_Event_EventData)
{
...
void UGA_Ninja_SwordHitsHeal_C::K2_ActivateAbilityFromEvent(struct FGameplayEventData& Param_EventData)
{
	static class UFunction* Func = nullptr;
...
bool UGA_Ninja_SwordHitsHeal_C::K2_ShouldAbilityRespondToEvent(const struct FGameplayAbilityActorInfo& ActorInfo, const struct FGameplayEventData& Payload, bool CallFunc_ShouldSwordHitsHealRespondToEvent_ReturnValue) const
{
	static class UFunction* Func = nullptr;
