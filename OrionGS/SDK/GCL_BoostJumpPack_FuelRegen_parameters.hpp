...
public:
	...
	uint8                                         Pad_63CA[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GCL_BoostJumpPack_FuelRegen_C_ExecuteUbergraph_GCL_BoostJumpPack_FuelRegen) == 0x000008, "Wrong alinment on GCL_BoostJumpPack_FuelRegen_C_ExecuteUbergraph_GCL_BoostJumpPack_FuelRegen");
...
static_assert(alignof(GCL_BoostJumpPack_FuelRegen_C_ResetBlink) == 0x000008, "Wrong alinment on GCL_BoostJumpPack_FuelRegen_C_ResetBlink");
