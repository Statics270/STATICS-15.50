...
public:
	...
	uint8                                         Pad_6153[0x7];                                     // 0x0D01(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6154[0x3];                                     // 0x0D91(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void Construct();
	void HandleActiveStateChanged(bool CosmeticAvailable, bool Active, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable_1, bool Temp_bool_Variable, bool CallFunc_IsSlotFilled_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, ESlateVisibility K2Node_Select_Default);
...
static_assert(alignof(UAthenaCustomizationSlotButton_C) == 0x000008, "Wrong alinment on UAthenaCustomizationSlotButton_C");
