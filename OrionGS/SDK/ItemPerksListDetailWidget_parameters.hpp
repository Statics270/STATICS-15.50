...
public:
	...
	uint8                                         Pad_6990[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ItemPerksListDetailWidget_C_SetState) == 0x000008, "Wrong alinment on ItemPerksListDetailWidget_C_SetState");
...
static_assert(alignof(ItemPerksListDetailWidget_C_ExecuteUbergraph_ItemPerksListDetailWidget) == 0x000008, "Wrong alinment on ItemPerksListDetailWidget_C_ExecuteUbergraph_ItemPerksListDetailWidget");
