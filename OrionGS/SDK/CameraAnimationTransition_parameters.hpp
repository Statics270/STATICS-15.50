...
public:
	...
	uint8                                         Pad_793A[0xB];                                     // 0x0005(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_793B[0xE];                                     // 0x0042(0x000E)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             CallFunc_GetTransform_ReturnValue_1;               // 0x0050(0x0030)(ConstParm, IsPlainOldData, NoDestructor)
};
static_assert(alignof(CameraAnimationTransition_C_UserConstructionScript) == 0x000010, "Wrong alinment on CameraAnimationTransition_C_UserConstructionScript");
...
public:
	...
	uint8                                         Pad_793C[0xC];                                     // 0x0004(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             CallFunc_GetTransform_ReturnValue;                 // 0x0010(0x0030)(ConstParm, IsPlainOldData, NoDestructor)
	...
	uint8                                         Pad_793D[0x3];                                     // 0x012D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(CameraAnimationTransition_C_ExecuteUbergraph_CameraAnimationTransition) == 0x000010, "Wrong alinment on CameraAnimationTransition_C_ExecuteUbergraph_CameraAnimationTransition");
