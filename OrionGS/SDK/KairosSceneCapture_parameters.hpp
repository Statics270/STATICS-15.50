...
static_assert(alignof(KairosCaptureStatics_GetSceneManager) == 0x000008, "Wrong alinment on KairosCaptureStatics_GetSceneManager");
...
static_assert(alignof(KairosCaptureStatics_ToggleAutoRotate) == 0x000001, "Wrong alinment on KairosCaptureStatics_ToggleAutoRotate");
...
static_assert(alignof(KairosCaptureStatics_PauseOrResumeSnippet) == 0x000008, "Wrong alinment on KairosCaptureStatics_PauseOrResumeSnippet");
...
static_assert(alignof(KairosGameModeBase_GetDefaultConfig) == 0x000008, "Wrong alinment on KairosGameModeBase_GetDefaultConfig");
...
public:
	...
	uint8                                         Pad_4A91[0xF];                                     // 0x0151(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(KairosHeroBase_BeginCapture) == 0x000010, "Wrong alinment on KairosHeroBase_BeginCapture");
...
static_assert(alignof(KairosHeroBase_EndCapture) == 0x000001, "Wrong alinment on KairosHeroBase_EndCapture");
...
static_assert(alignof(KairosSceneManagerActor_BeginEmotePlaybackForPlayer) == 0x000008, "Wrong alinment on KairosSceneManagerActor_BeginEmotePlaybackForPlayer");
...
static_assert(alignof(KairosSceneManagerActor_GetSceneInfo) == 0x000008, "Wrong alinment on KairosSceneManagerActor_GetSceneInfo");
...
static_assert(alignof(KairosSceneManagerActor_OLD_OnSceneSetupComplete) == 0x000008, "Wrong alinment on KairosSceneManagerActor_OLD_OnSceneSetupComplete");
...
public:
	...
	uint8                                         Pad_4A94[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(KairosSceneManagerActor_PauseOrResumeSnippet) == 0x000008, "Wrong alinment on KairosSceneManagerActor_PauseOrResumeSnippet");
