...
{
public:
	uint8                                         Pad_6ECB[0x8];                                     // 0x02B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6ECC[0x7];                                     // 0x02C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UWumba_Gadget_AnimBP_C) == 0x000010, "Wrong alinment on UWumba_Gadget_AnimBP_C");
