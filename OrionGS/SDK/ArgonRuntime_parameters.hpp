...
static_assert(alignof(ArgonPlayerComponent_OnRacePhaseChanged) == 0x000001, "Wrong alinment on ArgonPlayerComponent_OnRacePhaseChanged");
...
static_assert(alignof(ArgonTicketComponent_GetArgonMutator) == 0x000008, "Wrong alinment on ArgonTicketComponent_GetArgonMutator");
...
static_assert(alignof(ArgonTicketComponent_IsNearToPlayer) == 0x000001, "Wrong alinment on ArgonTicketComponent_IsNearToPlayer");
...
static_assert(alignof(ArgonTraversePoint_ClientSpawnMarkerActor) == 0x000010, "Wrong alinment on ArgonTraversePoint_ClientSpawnMarkerActor");
...
public:
	...
	uint8                                         Pad_4493[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FortAthenaMutator_Argon_GetProgressBarUIInfo) == 0x000008, "Wrong alinment on FortAthenaMutator_Argon_GetProgressBarUIInfo");
...
static_assert(alignof(FortAthenaMutator_Argon_HandlePlayerTeleportComplete) == 0x000008, "Wrong alinment on FortAthenaMutator_Argon_HandlePlayerTeleportComplete");
...
static_assert(alignof(FortAthenaMutator_Argon_OnEndTraversePointTouched) == 0x000008, "Wrong alinment on FortAthenaMutator_Argon_OnEndTraversePointTouched");
...
public:
	...
	uint8                                         Pad_4494[0x7];                                     // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Argon_DidPlayerCrossFinishLine) == 0x000008, "Wrong alinment on FortAthenaMutator_Argon_DidPlayerCrossFinishLine");
...
static_assert(alignof(FortAthenaMutator_Argon_FindSpawnLocationInSafeZone) == 0x000004, "Wrong alinment on FortAthenaMutator_Argon_FindSpawnLocationInSafeZone");
...
static_assert(alignof(FortAthenaMutator_Argon_GetEndTraversePoint) == 0x000008, "Wrong alinment on FortAthenaMutator_Argon_GetEndTraversePoint");
...
static_assert(alignof(FortAthenaMutator_Argon_GetNumberOfTicketsNeededToFinishRace) == 0x000004, "Wrong alinment on FortAthenaMutator_Argon_GetNumberOfTicketsNeededToFinishRace");
...
public:
	...
	uint8                                         Pad_4495[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         ReturnValue;                                       // 0x0004(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortAthenaMutator_Argon_GetNumberOfTicketsTeamHasAcquired) == 0x000004, "Wrong alinment on FortAthenaMutator_Argon_GetNumberOfTicketsTeamHasAcquired");
...
public:
	...
	uint8                                         Pad_4496[0x4];                                     // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Argon_GetPlayerTeamPlacement) == 0x000008, "Wrong alinment on FortAthenaMutator_Argon_GetPlayerTeamPlacement");
...
static_assert(alignof(FortAthenaMutator_Argon_GetRaceTimeElapsed) == 0x000004, "Wrong alinment on FortAthenaMutator_Argon_GetRaceTimeElapsed");
...
static_assert(alignof(FortAthenaMutator_Argon_GetRandomStartingLineEmotePlayRate) == 0x000004, "Wrong alinment on FortAthenaMutator_Argon_GetRandomStartingLineEmotePlayRate");
...
static_assert(alignof(FortAthenaMutator_Argon_GetTicketItemDefinition) == 0x000008, "Wrong alinment on FortAthenaMutator_Argon_GetTicketItemDefinition");
...
public:
	class AFortPlayerStateAthena*                 PlayerState;                                       // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0008(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4497[0x7];                                     // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Argon_HasPlayerFinishedRace) == 0x000008, "Wrong alinment on FortAthenaMutator_Argon_HasPlayerFinishedRace");
...
static_assert(alignof(FortAthenaMutator_Argon_HasTeamFinishedRace) == 0x000001, "Wrong alinment on FortAthenaMutator_Argon_HasTeamFinishedRace");
...
public:
	...
	uint8                                         Pad_4498[0x3];                                     // 0x000D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Argon_IsInSafeZone) == 0x000004, "Wrong alinment on FortAthenaMutator_Argon_IsInSafeZone");
...
static_assert(alignof(FortAthenaMutator_Argon_IsUsingRespawnAndSpectateSelectMutator) == 0x000001, "Wrong alinment on FortAthenaMutator_Argon_IsUsingRespawnAndSpectateSelectMutator");
...
static_assert(alignof(FortAthenaMutator_Argon_ShouldShowNearbyTicketIndicators) == 0x000001, "Wrong alinment on FortAthenaMutator_Argon_ShouldShowNearbyTicketIndicators");
