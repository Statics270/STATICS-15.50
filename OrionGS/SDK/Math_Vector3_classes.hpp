...
public:
	...
	uint8                                         Pad_7A48[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Vector3">();
	}
...
static_assert(alignof(UVector3) == 0x000008, "Wrong alinment on UVector3");
