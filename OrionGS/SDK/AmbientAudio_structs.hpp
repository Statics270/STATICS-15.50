...
{
public:
	uint8                                         Pad_4D17[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAmbientProxy) == 0x000008, "Wrong alinment on FAmbientProxy");
...
static_assert(alignof(FAmbientAudioBase) == 0x000008, "Wrong alinment on FAmbientAudioBase");
...
static_assert(alignof(FAmbientAudioOneShot) == 0x000008, "Wrong alinment on FAmbientAudioOneShot");
...
static_assert(alignof(FAmbientAudioLoop) == 0x000008, "Wrong alinment on FAmbientAudioLoop");
