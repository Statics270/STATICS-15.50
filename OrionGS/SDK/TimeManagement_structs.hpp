...
static_assert(alignof(FTimedDataInputEvaluationData) == 0x000004, "Wrong alinment on FTimedDataInputEvaluationData");
...
{
public:
	uint8                                         Pad_4AE1[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTimedDataChannelSampleTime) == 0x000008, "Wrong alinment on FTimedDataChannelSampleTime");
