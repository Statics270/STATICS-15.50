...
static_assert(alignof(FTagAndValue) == 0x000008, "Wrong alinment on FTagAndValue");
...
static_assert(alignof(FAssetRegistryDependencyOptions) == 0x000001, "Wrong alinment on FAssetRegistryDependencyOptions");
