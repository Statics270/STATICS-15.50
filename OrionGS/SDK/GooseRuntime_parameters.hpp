...
static_assert(alignof(AthenaGoosePickup_OnCollide) == 0x000008, "Wrong alinment on AthenaGoosePickup_OnCollide");
...
public:
	...
	uint8                                         Pad_464A[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AthenaGoosePickup_SetStaticMesh) == 0x000008, "Wrong alinment on AthenaGoosePickup_SetStaticMesh");
...
public:
	...
	uint8                                         Pad_4650[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Goose_HandleClientPawnEnteredVehicle) == 0x000008, "Wrong alinment on FortAthenaMutator_Goose_HandleClientPawnEnteredVehicle");
...
public:
	...
	class AFortPawn*                              Pawn;                                              // 0x0010(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SeatIndex;                                         // 0x0018(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4651[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Goose_HandleClientPawnExitedVehicle) == 0x000008, "Wrong alinment on FortAthenaMutator_Goose_HandleClientPawnExitedVehicle");
...
static_assert(alignof(FortAthenaMutator_Goose_HandleClientVehicleDestroyed) == 0x000008, "Wrong alinment on FortAthenaMutator_Goose_HandleClientVehicleDestroyed");
...
static_assert(alignof(FortAthenaMutator_Goose_KillPlayerPawns) == 0x000008, "Wrong alinment on FortAthenaMutator_Goose_KillPlayerPawns");
...
static_assert(alignof(FortAthenaMutator_Goose_OnPawnDied) == 0x000008, "Wrong alinment on FortAthenaMutator_Goose_OnPawnDied");
...
static_assert(alignof(FortAthenaMutator_Goose_OnVehicleDied) == 0x000008, "Wrong alinment on FortAthenaMutator_Goose_OnVehicleDied");
...
static_assert(alignof(FortAthenaMutator_Goose_OnVehicleStolen) == 0x000001, "Wrong alinment on FortAthenaMutator_Goose_OnVehicleStolen");
...
static_assert(alignof(FortCheatManager_Goose_GooseGivePlaneBoostGE) == 0x000004, "Wrong alinment on FortCheatManager_Goose_GooseGivePlaneBoostGE");
...
static_assert(offsetof(FortCheatManager_Goose_GooseGivePlaneBoostGE, Param_Index) == 0x000000, "Member 'FortCheatManager_Goose_GooseGivePlaneBoostGE::Param_Index' has a wrong offset!");
...
static_assert(alignof(FortCheatManager_Goose_GooseGivePlaneEffect) == 0x000004, "Wrong alinment on FortCheatManager_Goose_GooseGivePlaneEffect");
...
static_assert(offsetof(FortCheatManager_Goose_GooseGivePlaneEffect, Param_Index) == 0x000000, "Member 'FortCheatManager_Goose_GooseGivePlaneEffect::Param_Index' has a wrong offset!");
...
static_assert(alignof(FortCheatManager_Goose_GooseGivePlaneHealthGE) == 0x000004, "Wrong alinment on FortCheatManager_Goose_GooseGivePlaneHealthGE");
...
static_assert(offsetof(FortCheatManager_Goose_GooseGivePlaneHealthGE, Param_Index) == 0x000000, "Member 'FortCheatManager_Goose_GooseGivePlaneHealthGE::Param_Index' has a wrong offset!");
...
static_assert(alignof(FortCheatManager_Goose_GooseSetPlaneHealthPercent) == 0x000004, "Wrong alinment on FortCheatManager_Goose_GooseSetPlaneHealthPercent");
...
static_assert(alignof(FortCheatManager_Goose_GooseSetPlaneLives) == 0x000004, "Wrong alinment on FortCheatManager_Goose_GooseSetPlaneLives");
...
static_assert(alignof(FortCheatManager_Goose_GooseToggleDrops) == 0x000001, "Wrong alinment on FortCheatManager_Goose_GooseToggleDrops");
...
static_assert(alignof(FortCheatManager_Goose_GooseUpgradePlaneGuns) == 0x000004, "Wrong alinment on FortCheatManager_Goose_GooseUpgradePlaneGuns");
...
static_assert(offsetof(FortCheatManager_Goose_GooseUpgradePlaneGuns, Param_Index) == 0x000000, "Member 'FortCheatManager_Goose_GooseUpgradePlaneGuns::Param_Index' has a wrong offset!");
