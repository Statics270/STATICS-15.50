...
static_assert(alignof(Trap_Athena_WallSpikes_C_ExecuteUbergraph_Trap_Athena_WallSpikes) == 0x000004, "Wrong alinment on Trap_Athena_WallSpikes_C_ExecuteUbergraph_Trap_Athena_WallSpikes");
...
static_assert(alignof(Trap_Athena_WallSpikes_C_SetSpikePosition) == 0x000004, "Wrong alinment on Trap_Athena_WallSpikes_C_SetSpikePosition");
