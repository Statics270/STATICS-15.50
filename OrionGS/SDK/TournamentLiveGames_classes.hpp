...
public:
	...
	FMulticastInlineDelegateProperty_             CallEventLiveGamesBack;                            // 0x0450(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(alignof(UTournamentLiveGames_C) == 0x000008, "Wrong alinment on UTournamentLiveGames_C");
