...
public:
	...
	class UCommonRichTextBlock*                   Name_StoreMain_OfferDetailsAttribute_C;            // 0x0298(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(alignof(UStoreMain_OfferDetailsAttribute_C) == 0x000008, "Wrong alinment on UStoreMain_OfferDetailsAttribute_C");
...
static_assert(offsetof(UStoreMain_OfferDetailsAttribute_C, Name_StoreMain_OfferDetailsAttribute_C) == 0x000298, "Member 'UStoreMain_OfferDetailsAttribute_C::Name_StoreMain_OfferDetailsAttribute_C' has a wrong offset!");
