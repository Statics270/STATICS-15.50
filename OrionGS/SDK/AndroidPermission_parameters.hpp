...
static_assert(alignof(AndroidPermissionFunctionLibrary_AcquirePermissions) == 0x000008, "Wrong alinment on AndroidPermissionFunctionLibrary_AcquirePermissions");
...
public:
	...
	uint8                                         Pad_4A5A[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AndroidPermissionFunctionLibrary_CheckPermission) == 0x000008, "Wrong alinment on AndroidPermissionFunctionLibrary_CheckPermission");
