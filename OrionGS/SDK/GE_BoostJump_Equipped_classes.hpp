...
static_assert(alignof(UGE_BoostJump_Equipped_C) == 0x000008, "Wrong alinment on UGE_BoostJump_Equipped_C");
static_assert(sizeof(UGE_BoostJump_Equipped_C) == 0x000800, "Wrong size on UGE_BoostJump_Equipped_C");
