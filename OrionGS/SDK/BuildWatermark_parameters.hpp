...
public:
	...
	uint8                                         Pad_6987[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(BuildWatermark_C_ExecuteUbergraph_BuildWatermark) == 0x000008, "Wrong alinment on BuildWatermark_C_ExecuteUbergraph_BuildWatermark");
...
static_assert(alignof(BuildWatermark_C_HandlePlayerStateChanged) == 0x000008, "Wrong alinment on BuildWatermark_C_HandlePlayerStateChanged");
