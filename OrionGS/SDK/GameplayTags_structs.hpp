...
public:
	...
	bool operator==(FGameplayTag& Other) { return TagName.ComparisonIndex == Other.TagName.ComparisonIndex; }
	bool operator!=(FGameplayTag& Other) { return TagName.ComparisonIndex != Other.TagName.ComparisonIndex; }
};
static_assert(alignof(FGameplayTag) == 0x000004, "Wrong alinment on FGameplayTag");
...
static_assert(alignof(FGameplayTagContainer) == 0x000008, "Wrong alinment on FGameplayTagContainer");
...
{
public:
	uint8                                         Pad_520A[0x50];                                    // 0x0000(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayTagNode) == 0x000008, "Wrong alinment on FGameplayTagNode");
...
static_assert(alignof(FGameplayTagQuery) == 0x000008, "Wrong alinment on FGameplayTagQuery");
...
{
public:
	uint8                                         Pad_520C[0x10];                                    // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayTagReferenceHelper) == 0x000008, "Wrong alinment on FGameplayTagReferenceHelper");
...
{
public:
	uint8                                         Pad_520D[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayTagCreationWidgetHelper) == 0x000001, "Wrong alinment on FGameplayTagCreationWidgetHelper");
...
public:
	...
	uint8                                         Pad_520E[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FGameplayTagSource) == 0x000008, "Wrong alinment on FGameplayTagSource");
...
static_assert(alignof(FGameplayTagTableRow) == 0x000008, "Wrong alinment on FGameplayTagTableRow");
...
public:
	...
	uint8                                         Pad_520F[0x7];                                     // 0x0021(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRestrictedGameplayTagTableRow) == 0x000008, "Wrong alinment on FRestrictedGameplayTagTableRow");
...
static_assert(alignof(FRestrictedConfigInfo) == 0x000008, "Wrong alinment on FRestrictedConfigInfo");
...
static_assert(alignof(FGameplayTagCategoryRemap) == 0x000008, "Wrong alinment on FGameplayTagCategoryRemap");
...
static_assert(alignof(FGameplayTagRedirect) == 0x000004, "Wrong alinment on FGameplayTagRedirect");
