...
static_assert(alignof(Athena_IGiveSneakySnowman_C_MovePlayer) == 0x000008, "Wrong alinment on Athena_IGiveSneakySnowman_C_MovePlayer");
...
static_assert(alignof(Athena_IGiveSneakySnowman_C_GetNewSnowmanTransform) == 0x000010, "Wrong alinment on Athena_IGiveSneakySnowman_C_GetNewSnowmanTransform");
...
static_assert(alignof(Athena_IGiveSneakySnowman_C_GetMaterialInt) == 0x000004, "Wrong alinment on Athena_IGiveSneakySnowman_C_GetMaterialInt");
