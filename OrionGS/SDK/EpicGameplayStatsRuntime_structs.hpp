...
public:
	...
	uint8                                         Pad_4EE2[0x1];                                     // 0x0043(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4EE3[0x6];                                     // 0x004A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagReferenceHelper            ReferenceHelper;                                   // 0x0050(0x0010)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayStatMetadataTableRow) == 0x000008, "Wrong alinment on FGameplayStatMetadataTableRow");
...
static_assert(alignof(FGameplayStatTag) == 0x000004, "Wrong alinment on FGameplayStatTag");
...
static_assert(alignof(FManagedGameplayTagDataTableItem) == 0x000008, "Wrong alinment on FManagedGameplayTagDataTableItem");
...
{
public:
	uint8                                         Pad_4EE4[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTagTableManagerHelper) == 0x000001, "Wrong alinment on FTagTableManagerHelper");
