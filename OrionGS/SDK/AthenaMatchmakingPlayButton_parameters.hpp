...
static_assert(alignof(AthenaMatchmakingPlayButton_C_SetButtonText) == 0x000008, "Wrong alinment on AthenaMatchmakingPlayButton_C_SetButtonText");
...
static_assert(alignof(AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton) == 0x000008, "Wrong alinment on AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton");
