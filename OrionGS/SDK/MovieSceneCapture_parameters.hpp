...
static_assert(alignof(MovieSceneCaptureProtocolBase_GetState) == 0x000001, "Wrong alinment on MovieSceneCaptureProtocolBase_GetState");
...
static_assert(alignof(MovieSceneCaptureProtocolBase_IsCapturing) == 0x000001, "Wrong alinment on MovieSceneCaptureProtocolBase_IsCapturing");
...
static_assert(alignof(MovieSceneCapture_GetAudioCaptureProtocol) == 0x000008, "Wrong alinment on MovieSceneCapture_GetAudioCaptureProtocol");
...
static_assert(alignof(MovieSceneCapture_GetImageCaptureProtocol) == 0x000008, "Wrong alinment on MovieSceneCapture_GetImageCaptureProtocol");
...
static_assert(alignof(MovieSceneCapture_SetAudioCaptureProtocolType) == 0x000008, "Wrong alinment on MovieSceneCapture_SetAudioCaptureProtocolType");
...
static_assert(alignof(MovieSceneCapture_SetImageCaptureProtocolType) == 0x000008, "Wrong alinment on MovieSceneCapture_SetImageCaptureProtocolType");
...
static_assert(alignof(MovieSceneCaptureEnvironment_FindAudioCaptureProtocol) == 0x000008, "Wrong alinment on MovieSceneCaptureEnvironment_FindAudioCaptureProtocol");
...
static_assert(alignof(MovieSceneCaptureEnvironment_FindImageCaptureProtocol) == 0x000008, "Wrong alinment on MovieSceneCaptureEnvironment_FindImageCaptureProtocol");
...
static_assert(alignof(MovieSceneCaptureEnvironment_GetCaptureElapsedTime) == 0x000004, "Wrong alinment on MovieSceneCaptureEnvironment_GetCaptureElapsedTime");
...
static_assert(alignof(MovieSceneCaptureEnvironment_GetCaptureFrameNumber) == 0x000004, "Wrong alinment on MovieSceneCaptureEnvironment_GetCaptureFrameNumber");
...
static_assert(alignof(MovieSceneCaptureEnvironment_IsCaptureInProgress) == 0x000001, "Wrong alinment on MovieSceneCaptureEnvironment_IsCaptureInProgress");
...
static_assert(alignof(UserDefinedCaptureProtocol_OnPixelsReceived) == 0x000008, "Wrong alinment on UserDefinedCaptureProtocol_OnPixelsReceived");
...
static_assert(alignof(UserDefinedCaptureProtocol_OnSetup) == 0x000001, "Wrong alinment on UserDefinedCaptureProtocol_OnSetup");
...
static_assert(alignof(UserDefinedCaptureProtocol_ResolveBuffer) == 0x000008, "Wrong alinment on UserDefinedCaptureProtocol_ResolveBuffer");
...
static_assert(alignof(UserDefinedCaptureProtocol_StartCapturingFinalPixels) == 0x000008, "Wrong alinment on UserDefinedCaptureProtocol_StartCapturingFinalPixels");
...
static_assert(alignof(UserDefinedCaptureProtocol_GenerateFilename) == 0x000008, "Wrong alinment on UserDefinedCaptureProtocol_GenerateFilename");
...
static_assert(alignof(UserDefinedCaptureProtocol_GetCurrentFrameMetrics) == 0x000004, "Wrong alinment on UserDefinedCaptureProtocol_GetCurrentFrameMetrics");
...
static_assert(alignof(UserDefinedCaptureProtocol_OnCanFinalize) == 0x000001, "Wrong alinment on UserDefinedCaptureProtocol_OnCanFinalize");
...
static_assert(alignof(UserDefinedImageCaptureProtocol_GenerateFilenameForBuffer) == 0x000008, "Wrong alinment on UserDefinedImageCaptureProtocol_GenerateFilenameForBuffer");
...
static_assert(alignof(UserDefinedImageCaptureProtocol_GenerateFilenameForCurrentFrame) == 0x000008, "Wrong alinment on UserDefinedImageCaptureProtocol_GenerateFilenameForCurrentFrame");
...
public:
	...
	uint8                                         Pad_4EC0[0x7];                                     // 0x0071(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(UserDefinedImageCaptureProtocol_WriteImageToDisk) == 0x000008, "Wrong alinment on UserDefinedImageCaptureProtocol_WriteImageToDisk");
