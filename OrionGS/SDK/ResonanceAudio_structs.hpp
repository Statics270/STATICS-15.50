...
public:
	...
	uint8                                         Pad_4DF9[0x2];                                     // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4DFA[0x2];                                     // 0x0032(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4DFB[0xC];                                     // 0x0044(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FResonanceAudioReverbPluginSettings) == 0x000010, "Wrong alinment on FResonanceAudioReverbPluginSettings");
