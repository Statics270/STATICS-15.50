...
{
public:
	uint8                                         Pad_4683[0xE0];                                    // 0x0028(0x00E0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4684[0x28];                                    // 0x0120(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SignificanceManager">();
	}
...
static_assert(alignof(USignificanceManager) == 0x000008, "Wrong alinment on USignificanceManager");
