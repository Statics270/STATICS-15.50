...
static_assert(alignof(NPCStatusWidgetBar_C_ExecuteUbergraph_NPCStatusWidgetBar) == 0x000004, "Wrong alinment on NPCStatusWidgetBar_C_ExecuteUbergraph_NPCStatusWidgetBar");
...
static_assert(alignof(NPCStatusWidgetBar_C_SetPercent) == 0x000004, "Wrong alinment on NPCStatusWidgetBar_C_SetPercent");
...
static_assert(alignof(NPCStatusWidgetBar_C_PreConstruct) == 0x000001, "Wrong alinment on NPCStatusWidgetBar_C_PreConstruct");
