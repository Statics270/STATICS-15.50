...
{
public:
	uint8                                         Pad_4688[0x70];                                    // 0x0000(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FHydrogenCompassIcon) == 0x000008, "Wrong alinment on FHydrogenCompassIcon");
...
static_assert(alignof(FTeamPlayerCountEntry) == 0x000004, "Wrong alinment on FTeamPlayerCountEntry");
...
static_assert(alignof(FHydrogenPathNames) == 0x000008, "Wrong alinment on FHydrogenPathNames");
...
static_assert(alignof(FVictoryPointIncreasesEntry) == 0x000004, "Wrong alinment on FVictoryPointIncreasesEntry");
...
public:
	uint8                                         Team;                                              // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_468A[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_468B[0x3];                                     // 0x0011(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTeamPointsEntry) == 0x000004, "Wrong alinment on FTeamPointsEntry");
