...
static_assert(alignof(TournamentPayoutThresholdEntry_C_OnAddedToFocusPath) == 0x000004, "Wrong alinment on TournamentPayoutThresholdEntry_C_OnAddedToFocusPath");
...
static_assert(alignof(TournamentPayoutThresholdEntry_C_OnRemovedFromFocusPath) == 0x000004, "Wrong alinment on TournamentPayoutThresholdEntry_C_OnRemovedFromFocusPath");
...
static_assert(alignof(TournamentPayoutThresholdEntry_C_OnPayoutDataSet) == 0x000004, "Wrong alinment on TournamentPayoutThresholdEntry_C_OnPayoutDataSet");
...
public:
	...
	uint8                                         Pad_7879[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_787A[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_787B[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_787C[0x3];                                     // 0x0059(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           K2Node_Select_Default;                             // 0x005C(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry) == 0x000008, "Wrong alinment on TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry");
