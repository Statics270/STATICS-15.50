...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"EditableMeshAdapter">();
	}
...
static_assert(alignof(UEditableMeshAdapter) == 0x000008, "Wrong alinment on UEditableMeshAdapter");
...
public:
	...
	uint8                                         Pad_4F1F[0x9C];                                    // 0x003C(0x009C)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"EditableGeometryCollectionAdapter">();
	}
...
static_assert(alignof(UEditableGeometryCollectionAdapter) == 0x000008, "Wrong alinment on UEditableGeometryCollectionAdapter");
...
{
public:
	uint8                                         Pad_4F20[0x390];                                   // 0x0028(0x0390)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UEditableMeshAdapter*>           Adapters;                                          // 0x03B8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4F21[0x8];                                     // 0x03C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4F22[0x148];                                   // 0x03D4(0x0148)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4F23[0x1E4];                                   // 0x0524(0x01E4)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"EditableMesh">();
	}
...
static_assert(alignof(UEditableMesh) == 0x000008, "Wrong alinment on UEditableMesh");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"EditableMeshFactory">();
	}
...
static_assert(alignof(UEditableMeshFactory) == 0x000008, "Wrong alinment on UEditableMeshFactory");
...
public:
	...
	uint8                                         Pad_4F49[0xA4];                                    // 0x003C(0x00A4)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"EditableStaticMeshAdapter">();
	}
...
static_assert(alignof(UEditableStaticMeshAdapter) == 0x000008, "Wrong alinment on UEditableStaticMeshAdapter");
