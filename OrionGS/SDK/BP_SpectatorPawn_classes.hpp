...
public:
	...
	uint8                                         Pad_6C50[0x5];                                     // 0x0343(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ABP_SpectatorPawn_C) == 0x000008, "Wrong alinment on ABP_SpectatorPawn_C");
