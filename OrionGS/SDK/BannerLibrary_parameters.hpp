...
static_assert(alignof(BannerLibrary_C_GenericUpdateMaterial) == 0x000008, "Wrong alinment on BannerLibrary_C_GenericUpdateMaterial");
...
static_assert(alignof(BannerLibrary_C_UpdateBannerColorOnMaterial) == 0x000008, "Wrong alinment on BannerLibrary_C_UpdateBannerColorOnMaterial");
...
static_assert(alignof(BannerLibrary_C_UpdateBannerIconOnMaterial) == 0x000008, "Wrong alinment on BannerLibrary_C_UpdateBannerIconOnMaterial");
