...
public:
	...
	uint8                                         Pad_63EE[0x4];                                     // 0x05CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(AAOE_Commando_KeepOutExplosion_C) == 0x000008, "Wrong alinment on AAOE_Commando_KeepOutExplosion_C");
