...
public:
	void ExecuteUbergraph_BuildingContainer_Physics_Parent(int32 EntryPoint, bool CallFunc_PerformLinkingCheck_ReturnValue, class UPrimitiveComponent* K2Node_ComponentBoundEvent_SimulatingComponent, bool K2Node_ComponentBoundEvent_bIsAwake, bool CallFunc_IsAwake_ReturnValue, bool CallFunc_PerformLinkingCheck_ReturnValue_1);
...
static_assert(alignof(ABuildingContainer_Physics_Parent_C) == 0x000008, "Wrong alinment on ABuildingContainer_Physics_Parent_C");
