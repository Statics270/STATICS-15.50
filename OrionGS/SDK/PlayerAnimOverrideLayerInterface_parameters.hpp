...
static_assert(alignof(PlayerAnimOverrideLayerInterface_C_FullBodyOverride) == 0x000008, "Wrong alinment on PlayerAnimOverrideLayerInterface_C_FullBodyOverride");
...
static_assert(alignof(PlayerAnimOverrideLayerInterface_C_CharacterSkeletalControlPostLegIK) == 0x000008, "Wrong alinment on PlayerAnimOverrideLayerInterface_C_CharacterSkeletalControlPostLegIK");
