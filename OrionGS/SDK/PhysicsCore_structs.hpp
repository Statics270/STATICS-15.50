...
{
public:
	uint8                                         Pad_508E[0x10];                                    // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_508F[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBodyInstanceCore) == 0x000008, "Wrong alinment on FBodyInstanceCore");
