...
static_assert(alignof(ItemCardWidget_C_OnFocusReceived) == 0x000008, "Wrong alinment on ItemCardWidget_C_OnFocusReceived");
...
static_assert(alignof(ItemCardWidget_C_PlayShow) == 0x000004, "Wrong alinment on ItemCardWidget_C_PlayShow");
...
static_assert(alignof(ItemCardWidget_C_OnFocusLost) == 0x000004, "Wrong alinment on ItemCardWidget_C_OnFocusLost");
...
public:
	...
	uint8                                         Pad_5042[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFocusEvent                            K2Node_Event_InFocusEvent;                         // 0x0018(0x0008)(NoDestructor)
};
static_assert(alignof(ItemCardWidget_C_ExecuteUbergraph_ItemCardWidget) == 0x000008, "Wrong alinment on ItemCardWidget_C_ExecuteUbergraph_ItemCardWidget");
...
static_assert(alignof(ItemCardWidget_C_OnHoveredEvent__DelegateSignature) == 0x000008, "Wrong alinment on ItemCardWidget_C_OnHoveredEvent__DelegateSignature");
