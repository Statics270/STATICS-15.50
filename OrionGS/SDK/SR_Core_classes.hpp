...
public:
	...
	void HandleWeaponStateUpdated(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon, TDelegate<void(bool bIsTargeting)> K2Node_CreateDelegate_OutputDelegate);
...
static_assert(alignof(USR_Core_C) == 0x000008, "Wrong alinment on USR_Core_C");
