...
static_assert(alignof(Creative_Device_Effects_Interface_C_Get_Creative_Effect_Data) == 0x000004, "Wrong alinment on Creative_Device_Effects_Interface_C_Get_Creative_Effect_Data");
