...
{
public:
	uint8                                         Pad_447B[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FArgonSupplyDropInfo) == 0x000004, "Wrong alinment on FArgonSupplyDropInfo");
...
public:
	...
	uint8                                         Pad_447C[0x3];                                     // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_447D[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_447E[0x7];                                     // 0x0059(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FArgonFinishedPlayerInfo) == 0x000008, "Wrong alinment on FArgonFinishedPlayerInfo");
...
static_assert(alignof(FArgonTeamProgressBarInfo) == 0x000004, "Wrong alinment on FArgonTeamProgressBarInfo");
...
public:
	...
	uint8                                         Pad_4480[0x6];                                     // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FArgonTeamTicketCount) == 0x000008, "Wrong alinment on FArgonTeamTicketCount");
...
static_assert(alignof(FArgonRaceStateInfo) == 0x000008, "Wrong alinment on FArgonRaceStateInfo");
...
public:
	...
	uint8                                         Pad_4482[0x8];                                     // 0x0008(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FArgonPlayerInfo) == 0x000008, "Wrong alinment on FArgonPlayerInfo");
...
public:
	...
	uint8                                         Pad_4483[0x68];                                    // 0x0230(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FArgonSupplyDropPointData) == 0x000008, "Wrong alinment on FArgonSupplyDropPointData");
...
static_assert(alignof(FArgonRoute) == 0x000008, "Wrong alinment on FArgonRoute");
...
static_assert(alignof(FArgonVehicleOption) == 0x000008, "Wrong alinment on FArgonVehicleOption");
