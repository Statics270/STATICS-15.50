...
static_assert(alignof(FVUIRuntimeInputMapping) == 0x000008, "Wrong alinment on FVUIRuntimeInputMapping");
...
static_assert(alignof(FVUIRuntimeEventMapping) == 0x000008, "Wrong alinment on FVUIRuntimeEventMapping");
...
public:
	...
	uint8                                         Pad_4EC3[0x28];                                    // 0x0008(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVUIRuntimeMapping) == 0x000008, "Wrong alinment on FVUIRuntimeMapping");
...
static_assert(alignof(FVUIDynamicEventBindingData) == 0x000008, "Wrong alinment on FVUIDynamicEventBindingData");
