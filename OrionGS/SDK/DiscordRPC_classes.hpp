...
public:
	...
	uint8                                         Pad_4B96[0x7];                                     // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"DiscordRuntimeSettings">();
	}
...
static_assert(alignof(UDiscordRuntimeSettings) == 0x000008, "Wrong alinment on UDiscordRuntimeSettings");
