...
{
public:
	uint8                                         Pad_4AE6[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveLinkControllerBase">();
	}
...
static_assert(alignof(ULiveLinkControllerBase) == 0x000008, "Wrong alinment on ULiveLinkControllerBase");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveLinkCameraController">();
	}
...
static_assert(alignof(ULiveLinkCameraController) == 0x000008, "Wrong alinment on ULiveLinkCameraController");
...
public:
	...
	uint8                                         Pad_4AE7[0x7];                                     // 0x0111(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4AE8[0x8];                                     // 0x0150(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveLinkComponentController">();
	}
...
static_assert(alignof(ULiveLinkComponentController) == 0x000008, "Wrong alinment on ULiveLinkComponentController");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveLinkComponentSettings">();
	}
...
static_assert(alignof(ULiveLinkComponentSettings) == 0x000008, "Wrong alinment on ULiveLinkComponentSettings");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveLinkLightController">();
	}
...
static_assert(alignof(ULiveLinkLightController) == 0x000008, "Wrong alinment on ULiveLinkLightController");
...
public:
	...
	uint8                                         Pad_4AE9[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LiveLinkTransformController">();
	}
...
static_assert(alignof(ULiveLinkTransformController) == 0x000008, "Wrong alinment on ULiveLinkTransformController");
