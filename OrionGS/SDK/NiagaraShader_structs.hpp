...
static_assert(alignof(FSimulationStageMetaData) == 0x000008, "Wrong alinment on FSimulationStageMetaData");
...
{
public:
	uint8                                         Pad_440E[0x28];                                    // 0x0000(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNiagaraDataInterfaceGeneratedFunction) == 0x000008, "Wrong alinment on FNiagaraDataInterfaceGeneratedFunction");
...
static_assert(alignof(FNiagaraDataInterfaceGPUParamInfo) == 0x000008, "Wrong alinment on FNiagaraDataInterfaceGPUParamInfo");
...
static_assert(alignof(FNiagaraCompileEvent) == 0x000008, "Wrong alinment on FNiagaraCompileEvent");
