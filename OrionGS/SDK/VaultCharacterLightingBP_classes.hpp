...
public:
	...
	uint8                                         Pad_7A3A[0x3];                                     // 0x02CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FLinearColor                           MPCMinusManualSunlightColor;                       // 0x02E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void ExecuteUbergraph_VaultCharacterLightingBP(int32 EntryPoint, bool CallFunc_IsMobilePlatform_ReturnValue, class UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue, int32 CallFunc_GetShadowQuality_ReturnValue, bool CallFunc_IsMobilePlatform_ReturnValue_1, bool CallFunc_EqualEqual_IntInt_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, class UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue_1, int32 CallFunc_GetShadowQuality_ReturnValue_1, bool CallFunc_EqualEqual_IntInt_ReturnValue_1, bool CallFunc_BooleanOR_ReturnValue_1, bool K2Node_CustomEvent_NewParam, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsErebus_ReturnValue, bool CallFunc_BooleanOR_ReturnValue_2, bool CallFunc_IsErebus_ReturnValue_1, bool CallFunc_BooleanOR_ReturnValue_3);
...
static_assert(alignof(AVaultCharacterLightingBP_C) == 0x000008, "Wrong alinment on AVaultCharacterLightingBP_C");
...
static_assert(offsetof(AVaultCharacterLightingBP_C, MPCMinusManualSunlightColor) == 0x0002E0, "Member 'AVaultCharacterLightingBP_C::MPCMinusManualSunlightColor' has a wrong offset!");
