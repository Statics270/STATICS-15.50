...
public:
	...
	uint8                                         Pad_48B8[0x18];                                    // 0x0048(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"NamedInterfaces">();
	}
...
static_assert(alignof(UNamedInterfaces) == 0x000008, "Wrong alinment on UNamedInterfaces");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"TurnBasedMatchInterface">();
	}
...
static_assert(alignof(ITurnBasedMatchInterface) == 0x000008, "Wrong alinment on ITurnBasedMatchInterface");
