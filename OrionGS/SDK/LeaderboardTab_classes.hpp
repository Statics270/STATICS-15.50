...
public:
	void ExecuteUbergraph_LeaderboardTab(int32 EntryPoint, class ULeaderboardListViewWrapper_C* K2Node_DynamicCast_AsLeaderboard_List_View_Wrapper, bool K2Node_DynamicCast_bSuccess, const class FString& K2Node_CustomEvent_EventId, const class FString& K2Node_CustomEvent_EventWindowId, struct FFortTournamentDisplayInfo& K2Node_CustomEvent_Color_Info, const struct FLinearColor& K2Node_MakeStruct_LinearColor, class ULeaderboardListViewWrapper_C* K2Node_DynamicCast_AsLeaderboard_List_View_Wrapper_1, bool K2Node_DynamicCast_bSuccess_1);
	void Set_Event(const class FString& EventId, const class FString& EventWindowId);
	void Colorize(struct FFortTournamentDisplayInfo& Color_Info);
...
static_assert(alignof(ULeaderboardTab_C) == 0x000008, "Wrong alinment on ULeaderboardTab_C");
