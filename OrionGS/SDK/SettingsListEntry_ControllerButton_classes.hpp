...
public:
	void ExecuteUbergraph_SettingsListEntry_ControllerButton(int32 EntryPoint, class FText K2Node_Event_ActionText, class UCommonButton* K2Node_ComponentBoundEvent_Button);
...
static_assert(alignof(USettingsListEntry_ControllerButton_C) == 0x000008, "Wrong alinment on USettingsListEntry_ControllerButton_C");
