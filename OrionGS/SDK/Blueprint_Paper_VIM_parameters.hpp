...
static_assert(alignof(Blueprint_Paper_VIM_C_ExecuteUbergraph_Blueprint_Paper_VIM) == 0x000004, "Wrong alinment on Blueprint_Paper_VIM_C_ExecuteUbergraph_Blueprint_Paper_VIM");
...
static_assert(alignof(Blueprint_Paper_VIM_C_AnimGraph) == 0x000008, "Wrong alinment on Blueprint_Paper_VIM_C_AnimGraph");
