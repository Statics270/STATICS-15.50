...
public:
	...
	uint8                                         Pad_4803[0x6];                                     // 0x0052(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CheckoutGuid;                                      // 0x0058(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSidecarFileInfo) == 0x000008, "Wrong alinment on FSidecarFileInfo");
...
static_assert(alignof(FInventoryFlushPayload) == 0x000008, "Wrong alinment on FInventoryFlushPayload");
