...
public:
	...
	uint8                                         Pad_557C[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortPawn*                              AttachedPawn;                                      // 0x0008(0x0008)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(EnemyPawn_Interface_C_Orphaned) == 0x000008, "Wrong alinment on EnemyPawn_Interface_C_Orphaned");
