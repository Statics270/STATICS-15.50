...
{
public:
	uint8                                         Pad_4F4B[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4F4C[0x4];                                     // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneGeometryCollectionParams) == 0x000008, "Wrong alinment on FMovieSceneGeometryCollectionParams");
...
static_assert(alignof(FMovieSceneGeometryCollectionSectionTemplateParameters) == 0x000008, "Wrong alinment on FMovieSceneGeometryCollectionSectionTemplateParameters");
...
static_assert(alignof(FMovieSceneGeometryCollectionSectionTemplate) == 0x000008, "Wrong alinment on FMovieSceneGeometryCollectionSectionTemplate");
