...
static_assert(alignof(XpBarToolTip_C_GetHeaderText) == 0x000008, "Wrong alinment on XpBarToolTip_C_GetHeaderText");
...
static_assert(alignof(XpBarToolTip_C_GetCommanderXPText) == 0x000008, "Wrong alinment on XpBarToolTip_C_GetCommanderXPText");
...
static_assert(alignof(XpBarToolTip_C_GetBoostXPText) == 0x000008, "Wrong alinment on XpBarToolTip_C_GetBoostXPText");
...
static_assert(alignof(XpBarToolTip_C_GetRestedXPText) == 0x000008, "Wrong alinment on XpBarToolTip_C_GetRestedXPText");
...
static_assert(alignof(XpBarToolTip_C_GetBodyText) == 0x000008, "Wrong alinment on XpBarToolTip_C_GetBodyText");
