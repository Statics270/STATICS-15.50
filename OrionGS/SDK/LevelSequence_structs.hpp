...
static_assert(alignof(FLevelSequenceCameraSettings) == 0x000001, "Wrong alinment on FLevelSequenceCameraSettings");
...
{
public:
	uint8                                         Pad_4AF8[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBoundActorProxy) == 0x000001, "Wrong alinment on FBoundActorProxy");
...
static_assert(alignof(FLevelSequenceBindingReference) == 0x000008, "Wrong alinment on FLevelSequenceBindingReference");
...
static_assert(alignof(FLevelSequenceBindingReferenceArray) == 0x000008, "Wrong alinment on FLevelSequenceBindingReferenceArray");
...
static_assert(alignof(FLevelSequenceBindingReferences) == 0x000008, "Wrong alinment on FLevelSequenceBindingReferences");
...
{
public:
	uint8                                         Pad_4AF9[0x50];                                    // 0x0000(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLevelSequenceObjectReferenceMap) == 0x000008, "Wrong alinment on FLevelSequenceObjectReferenceMap");
...
{
public:
	uint8                                         Pad_4AFA[0x20];                                    // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLevelSequenceLegacyObjectReference) == 0x000008, "Wrong alinment on FLevelSequenceLegacyObjectReference");
...
public:
	...
	uint8                                         Pad_4AFB[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FLevelSequenceObject) == 0x000008, "Wrong alinment on FLevelSequenceObject");
...
public:
	...
	uint8                                         Pad_4AFC[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FLevelSequenceSnapshotSettings) == 0x000004, "Wrong alinment on FLevelSequenceSnapshotSettings");
...
public:
	...
	uint8                                         Pad_4AFD[0x4];                                     // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4AFE[0x4];                                     // 0x00B4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLevelSequencePlayerSnapshot) == 0x000008, "Wrong alinment on FLevelSequencePlayerSnapshot");
