...
{
public:
	uint8                                         Pad_1D6C[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FPlayspaceUser) == 0x000008, "Wrong alinment on FPlayspaceUser");
...
static_assert(alignof(FReplicatedSpawnInfo) == 0x000004, "Wrong alinment on FReplicatedSpawnInfo");
...
public:
	...
	uint8                                         Pad_1D6D[0x4];                                     // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPlayspaceSpawningInfo) == 0x000008, "Wrong alinment on FPlayspaceSpawningInfo");
...
{
public:
	uint8                                         Pad_1D6E[0x10];                                    // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FActorOverlapEvent) == 0x000008, "Wrong alinment on FActorOverlapEvent");
...
public:
	...
	uint8                                         Pad_1D6F[0x7];                                     // 0x0119(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FPlayspaceUserList) == 0x000008, "Wrong alinment on FPlayspaceUserList");
