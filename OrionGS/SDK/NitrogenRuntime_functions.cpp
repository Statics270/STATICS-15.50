...
void UFortCheatManager_Nitrogen::TeleportToNitrogenRespawnActor(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFortCheatManager_Nitrogen::TeleportToNitrogenSpawnActor(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFortCheatManager_Nitrogen::TeleportToSquadStartAtIndex(int32 Param_Index, struct FFortSquadStartSearchParamData& SearchParam, class FString* TeleportReasonString)
{
	static class UFunction* Func = nullptr;
	...
	if (TeleportReasonString != nullptr)
		*TeleportReasonString = Parms.TeleportReasonString;
}
...
void ANitrogenTraversePoint::OnVehicleDriverChanged(class AFortPlayerControllerAthena* NewController, class AFortAthenaVehicle* Vehicle)
{
	static class UFunction* Func = nullptr;
