...
static_assert(alignof(GameMapsSettings_GetGameMapsSettings) == 0x000008, "Wrong alinment on GameMapsSettings_GetGameMapsSettings");
...
static_assert(alignof(GameMapsSettings_SetSkipAssigningGamepadToPlayer1) == 0x000001, "Wrong alinment on GameMapsSettings_SetSkipAssigningGamepadToPlayer1");
...
static_assert(alignof(GameMapsSettings_GetSkipAssigningGamepadToPlayer1) == 0x000001, "Wrong alinment on GameMapsSettings_GetSkipAssigningGamepadToPlayer1");
