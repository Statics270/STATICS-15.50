...
static_assert(alignof(FLiveLinkRoleProjectSetting) == 0x000008, "Wrong alinment on FLiveLinkRoleProjectSetting");
...
public:
	...
	uint8                                         Pad_4A95[0x18];                                    // 0x0038(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_LiveLinkPose) == 0x000008, "Wrong alinment on FAnimNode_LiveLinkPose");
...
static_assert(alignof(FLiveLinkInstanceProxy) == 0x000010, "Wrong alinment on FLiveLinkInstanceProxy");
...
{
public:
	uint8                                         Pad_4A96[0x10];                                    // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FProviderPollResult) == 0x000008, "Wrong alinment on FProviderPollResult");
...
{
public:
	uint8                                         Pad_4A97[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLiveLinkRetargetAssetReference) == 0x000001, "Wrong alinment on FLiveLinkRetargetAssetReference");
