...
static_assert(alignof(TooltipLibrary_C_Create_Basic_Tooltip) == 0x000008, "Wrong alinment on TooltipLibrary_C_Create_Basic_Tooltip");
...
static_assert(alignof(TooltipLibrary_C_Create_Custom_Tooltip) == 0x000008, "Wrong alinment on TooltipLibrary_C_Create_Custom_Tooltip");
...
public:
	...
	uint8                                         Pad_6760[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(TooltipLibrary_C_Set_Enabled_And_Tooltip_Text) == 0x000008, "Wrong alinment on TooltipLibrary_C_Set_Enabled_And_Tooltip_Text");
...
public:
	...
	uint8                                         Pad_6761[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(TooltipLibrary_C_Create_Item_Tooltip) == 0x000008, "Wrong alinment on TooltipLibrary_C_Create_Item_Tooltip");
...
static_assert(alignof(TooltipLibrary_C_Create_Compare_Item_Tooltip) == 0x000008, "Wrong alinment on TooltipLibrary_C_Create_Compare_Item_Tooltip");
...
static_assert(alignof(TooltipLibrary_C_CreateXPTooltip) == 0x000008, "Wrong alinment on TooltipLibrary_C_CreateXPTooltip");
