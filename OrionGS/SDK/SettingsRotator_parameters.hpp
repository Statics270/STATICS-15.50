...
static_assert(alignof(SettingsRotator_C_BP_OnOptionsPopulated) == 0x000004, "Wrong alinment on SettingsRotator_C_BP_OnOptionsPopulated");
...
static_assert(alignof(SettingsRotator_C_BP_OnOptionSelected) == 0x000004, "Wrong alinment on SettingsRotator_C_BP_OnOptionSelected");
...
static_assert(alignof(SettingsRotator_C_BP_OnDefaultOptionSpecified) == 0x000004, "Wrong alinment on SettingsRotator_C_BP_OnDefaultOptionSpecified");
...
public:
	...
	uint8                                         Pad_786E[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_786F[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator) == 0x000008, "Wrong alinment on SettingsRotator_C_ExecuteUbergraph_SettingsRotator");
