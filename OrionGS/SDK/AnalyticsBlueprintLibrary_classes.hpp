...
public:
	...
	static void RecordCurrencyGivenWithAttributes(const class FString& GameCurrencyType, int32 GameCurrencyAmount, TArray<struct FAnalyticsEventAttr>& Attributes);
	...
	static void RecordErrorWithAttributes(const class FString& Error, TArray<struct FAnalyticsEventAttr>& Attributes);
	...
	static void RecordEventWithAttributes(const class FString& EventName, TArray<struct FAnalyticsEventAttr>& Attributes);
	...
	static void RecordProgressWithAttributes(const class FString& ProgressType, const class FString& ProgressName, TArray<struct FAnalyticsEventAttr>& Attributes);
	static void RecordProgressWithFullHierarchyAndAttributes(const class FString& ProgressType, TArray<class FString>& ProgressNames, TArray<struct FAnalyticsEventAttr>& Attributes);
	static void RecordSimpleCurrencyPurchase(const class FString& GameCurrencyType, int32 GameCurrencyAmount);
	static void RecordSimpleCurrencyPurchaseWithAttributes(const class FString& GameCurrencyType, int32 GameCurrencyAmount, TArray<struct FAnalyticsEventAttr>& Attributes);
	static void RecordSimpleItemPurchase(const class FString& ItemId, int32 ItemQuantity);
	static void RecordSimpleItemPurchaseWithAttributes(const class FString& ItemId, int32 ItemQuantity, TArray<struct FAnalyticsEventAttr>& Attributes);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AnalyticsBlueprintLibrary">();
	}
...
static_assert(alignof(UAnalyticsBlueprintLibrary) == 0x000008, "Wrong alinment on UAnalyticsBlueprintLibrary");
