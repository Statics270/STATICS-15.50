...
static_assert(alignof(CableComponent_SetAttachEndTo) == 0x000008, "Wrong alinment on CableComponent_SetAttachEndTo");
...
static_assert(alignof(CableComponent_SetAttachEndToComponent) == 0x000008, "Wrong alinment on CableComponent_SetAttachEndToComponent");
...
static_assert(alignof(CableComponent_GetAttachedActor) == 0x000008, "Wrong alinment on CableComponent_GetAttachedActor");
...
static_assert(alignof(CableComponent_GetAttachedComponent) == 0x000008, "Wrong alinment on CableComponent_GetAttachedComponent");
...
static_assert(alignof(CableComponent_GetCableParticleLocations) == 0x000008, "Wrong alinment on CableComponent_GetCableParticleLocations");
