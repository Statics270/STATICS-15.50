...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FortNightmareGameCueNotifyLoop_Cloak">();
	}
...
static_assert(alignof(AFortNightmareGameCueNotifyLoop_Cloak) == 0x000008, "Wrong alinment on AFortNightmareGameCueNotifyLoop_Cloak");
