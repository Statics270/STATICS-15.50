...
static_assert(alignof(UGET_AfflictedParent_C) == 0x000008, "Wrong alinment on UGET_AfflictedParent_C");
static_assert(sizeof(UGET_AfflictedParent_C) == 0x000800, "Wrong size on UGET_AfflictedParent_C");
