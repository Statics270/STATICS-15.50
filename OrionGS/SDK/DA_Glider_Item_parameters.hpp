...
public:
	...
	uint8                                         Pad_6B4A[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(DA_Glider_Item_C_ExecuteUbergraph_DA_Glider_Item) == 0x000008, "Wrong alinment on DA_Glider_Item_C_ExecuteUbergraph_DA_Glider_Item");
...
static_assert(alignof(DA_Glider_Item_C_BPPressTrigger) == 0x000008, "Wrong alinment on DA_Glider_Item_C_BPPressTrigger");
...
static_assert(alignof(DA_Glider_Item_C_RaiseUsageError) == 0x000008, "Wrong alinment on DA_Glider_Item_C_RaiseUsageError");
...
public:
	...
	uint8                                         Pad_6B4B[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(DA_Glider_Item_C_IsOnGround) == 0x000008, "Wrong alinment on DA_Glider_Item_C_IsOnGround");
