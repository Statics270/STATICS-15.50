...
EGooglePADDownloadStatus UGooglePADFunctionLibrary::GetDownloadStatus(int32 State)
{
	static class UFunction* Func = nullptr;
...
EGooglePADStorageMethod UGooglePADFunctionLibrary::GetStorageMethod(int32 Location)
{
	static class UFunction* Func = nullptr;
