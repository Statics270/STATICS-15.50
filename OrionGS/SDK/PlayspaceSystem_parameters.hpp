...
static_assert(alignof(GameplayVolume_UpdateSize) == 0x000004, "Wrong alinment on GameplayVolume_UpdateSize");
...
public:
	...
	uint8                                         Pad_1D7E[0x3];                                     // 0x001D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D7F[0x4];                                     // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(OverlapComponent_OnBeginActorOverlap) == 0x000008, "Wrong alinment on OverlapComponent_OnBeginActorOverlap");
...
public:
	...
	class UPrimitiveComponent*                    OtherComp;                                         // 0x0010(0x0008)(Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         OtherBodyIndex;                                    // 0x0018(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D80[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(OverlapComponent_OnEndActorOverlap) == 0x000008, "Wrong alinment on OverlapComponent_OnEndActorOverlap");
...
static_assert(alignof(PlayspaceControllerComponent_PlayerSpawning_GetSpawnInfo) == 0x000004, "Wrong alinment on PlayspaceControllerComponent_PlayerSpawning_GetSpawnInfo");
...
static_assert(alignof(PlayspaceManagerComponent_OnPlayerBeginOverlapGameplayVolume) == 0x000008, "Wrong alinment on PlayspaceManagerComponent_OnPlayerBeginOverlapGameplayVolume");
...
static_assert(alignof(PlayspaceManagerComponent_OnPlayerEndOverlapGameplayVolume) == 0x000008, "Wrong alinment on PlayspaceManagerComponent_OnPlayerEndOverlapGameplayVolume");
...
static_assert(alignof(PlayspaceManagerComponent_ProcessOverlapEvents) == 0x000004, "Wrong alinment on PlayspaceManagerComponent_ProcessOverlapEvents");
