...
static_assert(alignof(ErrorLlama_C_HandleInputTypeChanged) == 0x000001, "Wrong alinment on ErrorLlama_C_HandleInputTypeChanged");
...
static_assert(alignof(ErrorLlama_C_Tick) == 0x000004, "Wrong alinment on ErrorLlama_C_Tick");
...
static_assert(alignof(ErrorLlama_C_HandleNormalizedInputDirection) == 0x000004, "Wrong alinment on ErrorLlama_C_HandleNormalizedInputDirection");
...
public:
	...
	uint8                                         Pad_7875[0x3];                                     // 0x002D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7876[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7877[0x3];                                     // 0x00D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7878[0x3];                                     // 0x0125(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ErrorLlama_C_ExecuteUbergraph_ErrorLlama) == 0x000008, "Wrong alinment on ErrorLlama_C_ExecuteUbergraph_ErrorLlama");
