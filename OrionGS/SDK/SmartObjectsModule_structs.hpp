...
static_assert(alignof(FSmartObjectSlot) == 0x000008, "Wrong alinment on FSmartObjectSlot");
...
static_assert(alignof(FSmartObjectUseConfig) == 0x000008, "Wrong alinment on FSmartObjectUseConfig");
...
public:
	...
	uint8                                         Pad_4E05[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSmartObjectExecutionSlot) == 0x000008, "Wrong alinment on FSmartObjectExecutionSlot");
...
{
public:
	uint8                                         Pad_4E06[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSmartObjectExecutionSlot              Slot;                                              // 0x0008(0x0020)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_4E07[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSmartObjectUse) == 0x000008, "Wrong alinment on FSmartObjectUse");
...
static_assert(alignof(FSmartObjectRuntime) == 0x000008, "Wrong alinment on FSmartObjectRuntime");
...
{
public:
	uint8                                         Pad_4E08[0x4];                                     // 0x0000(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSmartObjectID) == 0x000004, "Wrong alinment on FSmartObjectID");
