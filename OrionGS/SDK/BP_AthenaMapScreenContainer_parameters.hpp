...
static_assert(alignof(BP_AthenaMapScreenContainer_C_PreConstruct) == 0x000001, "Wrong alinment on BP_AthenaMapScreenContainer_C_PreConstruct");
...
static_assert(alignof(BP_AthenaMapScreenContainer_C_BP_OnShowTabsSet) == 0x000001, "Wrong alinment on BP_AthenaMapScreenContainer_C_BP_OnShowTabsSet");
...
static_assert(alignof(BP_AthenaMapScreenContainer_C_OnShowOrHideCreativeScoreboard) == 0x000001, "Wrong alinment on BP_AthenaMapScreenContainer_C_OnShowOrHideCreativeScoreboard");
...
static_assert(alignof(BP_AthenaMapScreenContainer_C_OnCreativeScoreboardWidgetCreated) == 0x000008, "Wrong alinment on BP_AthenaMapScreenContainer_C_OnCreativeScoreboardWidgetCreated");
...
public:
	...
	uint8                                         Pad_4AF6[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(BP_AthenaMapScreenContainer_C_ExecuteUbergraph_BP_AthenaMapScreenContainer) == 0x000008, "Wrong alinment on BP_AthenaMapScreenContainer_C_ExecuteUbergraph_BP_AthenaMapScreenContainer");
