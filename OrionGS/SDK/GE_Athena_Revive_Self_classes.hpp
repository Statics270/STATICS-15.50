...
static_assert(alignof(UGE_Athena_Revive_Self_C) == 0x000008, "Wrong alinment on UGE_Athena_Revive_Self_C");
static_assert(sizeof(UGE_Athena_Revive_Self_C) == 0x000800, "Wrong size on UGE_Athena_Revive_Self_C");
