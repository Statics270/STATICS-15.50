...
static_assert(alignof(GA_Shotgun_DoubleDouble_Damage_C_ExecuteUbergraph_GA_Shotgun_DoubleDouble_Damage) == 0x000004, "Wrong alinment on GA_Shotgun_DoubleDouble_Damage_C_ExecuteUbergraph_GA_Shotgun_DoubleDouble_Damage");
