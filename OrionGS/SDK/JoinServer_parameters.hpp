...
static_assert(alignof(JoinServer_C_OnEnterState) == 0x000001, "Wrong alinment on JoinServer_C_OnEnterState");
...
static_assert(alignof(JoinServer_C_ExecuteUbergraph_JoinServer) == 0x000004, "Wrong alinment on JoinServer_C_ExecuteUbergraph_JoinServer");
