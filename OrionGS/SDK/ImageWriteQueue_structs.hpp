...
public:
	...
	uint8                                         Pad_48D4[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_48D5[0x46];                                    // 0x001A(0x0046)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FImageWriteOptions) == 0x000010, "Wrong alinment on FImageWriteOptions");
