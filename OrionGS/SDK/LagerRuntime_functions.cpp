...
int32 UFortAthenaLivingWorldManager::QueryEventBudget(const struct FDataTableRowHandle& EventEntry, class AActor* SpawnLocation) const
{
	static class UFunction* Func = nullptr;
...
bool IFortAthenaLivingWorldPointProviderInterface::GetValidLocation(struct FFortAthenaLivingWorldPointProviderFilterRules& PointFilter, struct FVector* OutPosition, struct FRotator* OutRotation) const
{
	static class UFunction* Func = nullptr;
...
bool IFortAthenaLivingWorldPointProviderInterface::IsEnabled(struct FFortAthenaLivingWorldPointProviderFilterRules& PointFilter) const
{
	static class UFunction* Func = nullptr;
