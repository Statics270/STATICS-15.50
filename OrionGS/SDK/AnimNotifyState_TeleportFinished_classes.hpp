...
{
public:
	bool Received_NotifyBegin(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float TotalDuration, class AActor* CallFunc_GetOwner_ReturnValue, class ABP_VictoryDrone_C* K2Node_DynamicCast_AsBP_Victory_Drone, bool K2Node_DynamicCast_bSuccess) const;
...
static_assert(alignof(UAnimNotifyState_TeleportFinished_C) == 0x000008, "Wrong alinment on UAnimNotifyState_TeleportFinished_C");
