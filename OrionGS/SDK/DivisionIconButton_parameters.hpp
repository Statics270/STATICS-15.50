...
static_assert(alignof(DivisionIconButton_C_OnRankButtonSelected) == 0x000001, "Wrong alinment on DivisionIconButton_C_OnRankButtonSelected");
...
public:
	...
	uint8                                         Pad_767A[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue;                // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bIsSelected;                          // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(DivisionIconButton_C_ExecuteUbergraph_DivisionIconButton) == 0x000008, "Wrong alinment on DivisionIconButton_C_ExecuteUbergraph_DivisionIconButton");
