...
public:
	...
	uint8                                         Pad_4E7B[0x18];                                    // 0x0288(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LatencyGraph">();
	}
...
static_assert(alignof(ULatencyGraph) == 0x000008, "Wrong alinment on ULatencyGraph");
...
{
public:
	uint8                                         Pad_4E7C[0x8];                                     // 0x0260(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E7D[0xB8];                                    // 0x02A0(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LatencyWidget">();
	}
...
static_assert(alignof(ULatencyWidget) == 0x000008, "Wrong alinment on ULatencyWidget");
