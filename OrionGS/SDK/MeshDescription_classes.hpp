...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"MeshDescription">();
	}
...
static_assert(alignof(UMeshDescription) == 0x000008, "Wrong alinment on UMeshDescription");
...
{
public:
	uint8                                         Pad_522C[0x368];                                   // 0x0028(0x0368)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MeshDescriptionBase">();
	}
...
static_assert(alignof(UMeshDescriptionBase) == 0x000008, "Wrong alinment on UMeshDescriptionBase");
