...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GooglePADFunctionLibrary">();
	}
...
static_assert(alignof(UGooglePADFunctionLibrary) == 0x000008, "Wrong alinment on UGooglePADFunctionLibrary");
