...
static_assert(alignof(FortAthenaMutator_Score_OnAIPawnKilled) == 0x000008, "Wrong alinment on FortAthenaMutator_Score_OnAIPawnKilled");
...
public:
	...
	uint8                                         Pad_4736[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Score_OnGamePhaseStepChanged) == 0x000008, "Wrong alinment on FortAthenaMutator_Score_OnGamePhaseStepChanged");
...
static_assert(alignof(FortAthenaMutator_Score_OnMutatorGameplayEvent) == 0x000004, "Wrong alinment on FortAthenaMutator_Score_OnMutatorGameplayEvent");
...
static_assert(alignof(FortAthenaMutator_Score_OnRep_CurrentBonusWindow) == 0x000004, "Wrong alinment on FortAthenaMutator_Score_OnRep_CurrentBonusWindow");
...
static_assert(alignof(FortCheatManager_Score_ScoreLTMCheatScoreEvent) == 0x000004, "Wrong alinment on FortCheatManager_Score_ScoreLTMCheatScoreEvent");
