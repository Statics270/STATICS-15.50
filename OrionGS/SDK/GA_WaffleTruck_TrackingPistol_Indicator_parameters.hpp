...
public:
	...
	uint8                                         Pad_6C13[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6C14[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6C15[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6C16[0x3];                                     // 0x00F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6C17[0x7];                                     // 0x00F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6C18[0x7];                                     // 0x0111(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FIndicatedActorData                    CallFunc_MakeIndicatedActorData_ReturnValue;       // 0x0148(0x0090)()
};
static_assert(alignof(GA_WaffleTruck_TrackingPistol_Indicator_C_ExecuteUbergraph_GA_WaffleTruck_TrackingPistol_Indicator) == 0x000008, "Wrong alinment on GA_WaffleTruck_TrackingPistol_Indicator_C_ExecuteUbergraph_GA_WaffleTruck_TrackingPistol_Indicator");
static_assert(sizeof(GA_WaffleTruck_TrackingPistol_Indicator_C_ExecuteUbergraph_GA_WaffleTruck_TrackingPistol_Indicator) == 0x0001D8, "Wrong size on GA_WaffleTruck_TrackingPistol_Indicator_C_ExecuteUbergraph_GA_WaffleTruck_TrackingPistol_Indicator");
...
static_assert(alignof(GA_WaffleTruck_TrackingPistol_Indicator_C_K2_ActivateAbilityFromEvent) == 0x000008, "Wrong alinment on GA_WaffleTruck_TrackingPistol_Indicator_C_K2_ActivateAbilityFromEvent");
...
static_assert(alignof(GA_WaffleTruck_TrackingPistol_Indicator_C_GetAvatarAsFortPawn) == 0x000008, "Wrong alinment on GA_WaffleTruck_TrackingPistol_Indicator_C_GetAvatarAsFortPawn");
...
public:
	...
	uint8                                         Pad_6C19[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GA_WaffleTruck_TrackingPistol_Indicator_C_GetAvatarAsFortPlayerController) == 0x000008, "Wrong alinment on GA_WaffleTruck_TrackingPistol_Indicator_C_GetAvatarAsFortPlayerController");
...
public:
	...
	uint8                                         Pad_6C1A[0x7];                                     // 0x00D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GA_WaffleTruck_TrackingPistol_Indicator_C_GetHitActorsFromEventData) == 0x000008, "Wrong alinment on GA_WaffleTruck_TrackingPistol_Indicator_C_GetHitActorsFromEventData");
...
{
public:
	class AActor*                                 OwningController;                                  // 0x0000(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 HitActor;                                          // 0x0008(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_6C1B[0x6];                                     // 0x0012(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GA_WaffleTruck_TrackingPistol_Indicator_C_IsPawnAndNotFriendly) == 0x000008, "Wrong alinment on GA_WaffleTruck_TrackingPistol_Indicator_C_IsPawnAndNotFriendly");
...
public:
	...
	uint8                                         Pad_6C1C[0x7];                                     // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GA_WaffleTruck_TrackingPistol_Indicator_C_IsDamgeFromSourceWeapon) == 0x000008, "Wrong alinment on GA_WaffleTruck_TrackingPistol_Indicator_C_IsDamgeFromSourceWeapon");
