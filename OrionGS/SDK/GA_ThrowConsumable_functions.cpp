...
void UGA_ThrowConsumable_C::PrethrowSetup(const struct FActiveGameplayEffectHandle& CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue, const struct FGameplayAbilityActorInfo& CallFunc_GetActorInfo_ReturnValue, class AFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess)
{
	...
	Params::GA_ThrowConsumable_C_PrethrowSetup Parms{};
...
void UGA_ThrowConsumable_C::SetupDummyProjectile(class AFortPlayerPawn* CallFunc_GetOwningPlayer_Player_Pawn, struct FTransform& CallFunc_GetTransform_ReturnValue, bool CallFunc_IsValidClass_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class AFortProjectileTrajectory* CallFunc_FinishSpawningActor_ReturnValue, class ABP_ProjectileTrajectory_C* K2Node_DynamicCast_AsBP_Projectile_Trajectory, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;
	...
	Params::GA_ThrowConsumable_C_SetupDummyProjectile Parms{};
...
void UGA_ThrowConsumable_C::UpdateTrajectorySpline(TArray<struct FVector>& CallFunc_GetProjectileTrajectoryPoints_OutSplinePoints, TArray<struct FVector>& CallFunc_GetProjectileTrajectoryPoints_OutSplineTangents, const struct FHitResult& CallFunc_GetProjectileTrajectoryPoints_OutHitResult, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::GA_ThrowConsumable_C_UpdateTrajectorySpline Parms{};
...
void UGA_ThrowConsumable_C::PostThrowCleanup(bool CallFunc_Not_PreBool_ReturnValue)
{
	...
	Params::GA_ThrowConsumable_C_PostThrowCleanup Parms{};
...
// float                                   CallFunc_GetProjectileAdditionalThrowAngleToUse_AdditionalThrowAngleToUse(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    Temp_bool_Variable                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UGA_ThrowConsumable_C::GetOwningPlayer(class AFortPlayerPawn** Player_Pawn, bool CallFunc_IsValid_ReturnValue, const struct FGameplayAbilityActorInfo& CallFunc_GetActorInfo_ReturnValue, class AFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess) const
{
	static class UFunction* Func = nullptr;
...
// class AFortWeapon*                      AbilitySourceWeapon                                    (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UGA_ThrowConsumable_C::GetProjectileAdditionalThrowAngleToUse(float* AdditionalThrowAngleToUse, class AFortWeapon* AbilitySourceWeapon, float CallFunc_GetProjectilePitchOffset_ReturnValue, bool CallFunc_NotEqual_FloatFloat_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_SelectFloat_ReturnValue, class AFortWeapon* CallFunc_GetCurrentSourceWeapon_ReturnValue) const
{
	static class UFunction* Func = nullptr;
	...
	if (AdditionalThrowAngleToUse != nullptr)
		*AdditionalThrowAngleToUse = std::move(Parms.AdditionalThrowAngleToUse);
}
