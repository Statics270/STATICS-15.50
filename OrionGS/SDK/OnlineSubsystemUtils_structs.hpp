...
public:
	...
	uint8                                         Pad_480F[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FInAppPurchaseProductInfo2) == 0x000008, "Wrong alinment on FInAppPurchaseProductInfo2");
...
{
public:
	uint8                                         Pad_4810[0x108];                                   // 0x0000(0x0108)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBlueprintSessionResult) == 0x000008, "Wrong alinment on FBlueprintSessionResult");
...
static_assert(alignof(FInAppPurchaseReceiptInfo2) == 0x000008, "Wrong alinment on FInAppPurchaseReceiptInfo2");
...
static_assert(alignof(FInAppPurchaseReceiptInfo) == 0x000008, "Wrong alinment on FInAppPurchaseReceiptInfo");
...
public:
	...
	uint8                                         Pad_4811[0x4];                                     // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4812[0x4];                                     // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4813[0x7];                                     // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FOnlineProxyStoreOffer) == 0x000008, "Wrong alinment on FOnlineProxyStoreOffer");
...
static_assert(alignof(FInAppPurchaseRestoreInfo2) == 0x000008, "Wrong alinment on FInAppPurchaseRestoreInfo2");
...
public:
	...
	uint8                                         Pad_4814[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FInAppPurchaseProductRequest2) == 0x000008, "Wrong alinment on FInAppPurchaseProductRequest2");
...
public:
	...
	uint8                                         Pad_4815[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FPlayerReservation) == 0x000008, "Wrong alinment on FPlayerReservation");
...
static_assert(alignof(FPIELoginSettingsInternal) == 0x000008, "Wrong alinment on FPIELoginSettingsInternal");
...
static_assert(alignof(FPartyBeaconCrossplayPlatformMapping) == 0x000008, "Wrong alinment on FPartyBeaconCrossplayPlatformMapping");
...
public:
	...
	uint8                                         Pad_4816[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FPartyReservation) == 0x000008, "Wrong alinment on FPartyReservation");
...
static_assert(alignof(FSpectatorReservation) == 0x000008, "Wrong alinment on FSpectatorReservation");
