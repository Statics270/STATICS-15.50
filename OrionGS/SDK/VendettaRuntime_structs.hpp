...
{
public:
	uint8                                         Pad_4743[0x10];                                    // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWaxPickupSpawnRequestData) == 0x000008, "Wrong alinment on FWaxPickupSpawnRequestData");
...
static_assert(alignof(FVendettaEQSQueryData) == 0x000008, "Wrong alinment on FVendettaEQSQueryData");
...
static_assert(alignof(FVendettaReplicatedUIMessage) == 0x000008, "Wrong alinment on FVendettaReplicatedUIMessage");
...
public:
	...
	uint8                                         Pad_4745[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4746[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FVendettaBountyPuckTargetData) == 0x000008, "Wrong alinment on FVendettaBountyPuckTargetData");
...
static_assert(alignof(FVendettaBountyPuckTargetingDataArray) == 0x000008, "Wrong alinment on FVendettaBountyPuckTargetingDataArray");
...
public:
	...
	uint8                                         Pad_4747[0x7];                                     // 0x0051(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVendettaBountyPuckRarityData) == 0x000008, "Wrong alinment on FVendettaBountyPuckRarityData");
...
public:
	...
	uint8                                         Pad_4748[0x4];                                     // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVendettaPlayerData) == 0x000008, "Wrong alinment on FVendettaPlayerData");
...
{
public:
	uint8                                         Pad_4749[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FVendettaActiveBountyTargetData) == 0x000008, "Wrong alinment on FVendettaActiveBountyTargetData");
...
static_assert(alignof(FVendettaActiveBountyTargetDataArray) == 0x000008, "Wrong alinment on FVendettaActiveBountyTargetDataArray");
...
static_assert(alignof(FVendettaTargetMarkedStatusData) == 0x000001, "Wrong alinment on FVendettaTargetMarkedStatusData");
...
{
public:
	uint8                                         Pad_474A[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_474B[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVendettaPlayerHuntedStatus) == 0x000008, "Wrong alinment on FVendettaPlayerHuntedStatus");
...
static_assert(alignof(FVendettaPlayerHuntedStatusArray) == 0x000008, "Wrong alinment on FVendettaPlayerHuntedStatusArray");
