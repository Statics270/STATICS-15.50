...
static_assert(alignof(FClothConstraintSetup_Legacy) == 0x000004, "Wrong alinment on FClothConstraintSetup_Legacy");
...
public:
	...
	uint8                                         Pad_4EF7[0x3];                                     // 0x00BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FClothConfig_Legacy) == 0x000004, "Wrong alinment on FClothConfig_Legacy");
...
static_assert(alignof(FPointWeightMap) == 0x000008, "Wrong alinment on FPointWeightMap");
...
static_assert(alignof(FClothPhysicalMeshData) == 0x000008, "Wrong alinment on FClothPhysicalMeshData");
...
public:
	...
	uint8                                         Pad_4EF8[0x20];                                    // 0x0138(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FClothLODDataCommon) == 0x000008, "Wrong alinment on FClothLODDataCommon");
...
public:
	...
	uint8                                         Pad_4EF9[0x3];                                     // 0x0009(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4EFA[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4EFB[0x7];                                     // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FClothParameterMask_Legacy) == 0x000008, "Wrong alinment on FClothParameterMask_Legacy");
