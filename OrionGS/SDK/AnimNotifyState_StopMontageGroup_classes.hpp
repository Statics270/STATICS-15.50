...
public:
	bool Received_NotifyBegin(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float TotalDuration, class UAnimInstance* CallFunc_GetAnimInstance_ReturnValue) const;
...
static_assert(alignof(UAnimNotifyState_StopMontageGroup_C) == 0x000008, "Wrong alinment on UAnimNotifyState_StopMontageGroup_C");
