...
static_assert(alignof(PetAnimLayerInterface_C_PetFullOverrideLayer) == 0x000008, "Wrong alinment on PetAnimLayerInterface_C_PetFullOverrideLayer");
...
static_assert(offsetof(PetAnimLayerInterface_C_PetFullOverrideLayer, Param_PetFullOverrideLayer) == 0x000010, "Member 'PetAnimLayerInterface_C_PetFullOverrideLayer::Param_PetFullOverrideLayer' has a wrong offset!");
...
static_assert(alignof(PetAnimLayerInterface_C_PetSkeletalControlLayer) == 0x000008, "Wrong alinment on PetAnimLayerInterface_C_PetSkeletalControlLayer");
...
static_assert(offsetof(PetAnimLayerInterface_C_PetSkeletalControlLayer, Param_PetSkeletalControlLayer) == 0x000028, "Member 'PetAnimLayerInterface_C_PetSkeletalControlLayer::Param_PetSkeletalControlLayer' has a wrong offset!");
