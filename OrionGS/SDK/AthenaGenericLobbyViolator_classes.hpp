...
public:
	void SetGamemodeName(class FText Param_Name, class FText Param_SubText, class FText CallFunc_TextToUpper_ReturnValue, bool CallFunc_TextIsEmpty_ReturnValue, class FText CallFunc_TextToUpper_ReturnValue_1);
...
static_assert(alignof(UAthenaGenericLobbyViolator_C) == 0x000008, "Wrong alinment on UAthenaGenericLobbyViolator_C");
