...
public:
	...
	uint8                                         Pad_4870[0x5];                                     // 0x002B(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FQosRegionInfo) == 0x000008, "Wrong alinment on FQosRegionInfo");
...
public:
	...
	uint8                                         Pad_4871[0x4];                                     // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FQosPingServerInfo) == 0x000008, "Wrong alinment on FQosPingServerInfo");
...
public:
	...
	uint8                                         Pad_4872[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FQosPingServerInfo>             Servers;                                           // 0x0028(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FQosDatacenterInfo) == 0x000008, "Wrong alinment on FQosDatacenterInfo");
...
public:
	...
	uint8                                         Pad_4873[0x3];                                     // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4874[0x8];                                     // 0x0050(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4875[0x7];                                     // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDatacenterQosInstance) == 0x000008, "Wrong alinment on FDatacenterQosInstance");
...
static_assert(alignof(FRegionQosInstance) == 0x000008, "Wrong alinment on FRegionQosInstance");
