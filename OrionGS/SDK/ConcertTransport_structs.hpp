...
static_assert(alignof(FConcertLocalIdentifierState) == 0x000008, "Wrong alinment on FConcertLocalIdentifierState");
...
{
public:
	uint8                                         Pad_4B0F[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4B10[0x4];                                     // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FConcertMessageData) == 0x000008, "Wrong alinment on FConcertMessageData");
...
static_assert(alignof(FConcertKeepAlive) == 0x000008, "Wrong alinment on FConcertKeepAlive");
...
static_assert(alignof(FConcertAckData) == 0x000008, "Wrong alinment on FConcertAckData");
...
static_assert(alignof(FConcertEventData) == 0x000008, "Wrong alinment on FConcertEventData");
...
static_assert(alignof(FConcertEndpointDiscoveryEvent) == 0x000008, "Wrong alinment on FConcertEndpointDiscoveryEvent");
...
public:
	...
	uint8                                         Pad_4B11[0x1];                                     // 0x0031(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4B12[0x2];                                     // 0x0036(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FConcertReliableHandshakeData) == 0x000008, "Wrong alinment on FConcertReliableHandshakeData");
...
static_assert(alignof(FConcertEndpointClosedData) == 0x000008, "Wrong alinment on FConcertEndpointClosedData");
...
public:
	...
	uint8                                         Pad_4B13[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   Reason;                                            // 0x0048(0x0018)(Edit, EditConst, AdvancedDisplay, NativeAccessSpecifierPublic)
};
static_assert(alignof(FConcertResponseData) == 0x000008, "Wrong alinment on FConcertResponseData");
...
static_assert(alignof(FConcertRequestData) == 0x000008, "Wrong alinment on FConcertRequestData");
...
public:
	...
	uint8                                         Pad_4B14[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FConcertEndpointSettings) == 0x000004, "Wrong alinment on FConcertEndpointSettings");
