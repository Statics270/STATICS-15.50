...
static_assert(alignof(NPCStatusWidget_C_VisibilityChanged__DelegateSignature) == 0x000001, "Wrong alinment on NPCStatusWidget_C_VisibilityChanged__DelegateSignature");
...
public:
	...
	uint8                                         Pad_5AC3[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           CallFunc_K2_SetTimerDelegate_ReturnValue;          // 0x0020(0x0008)(NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(NPCStatusWidget_C_ExecuteUbergraph_NPCStatusWidget) == 0x000008, "Wrong alinment on NPCStatusWidget_C_ExecuteUbergraph_NPCStatusWidget");
...
{
public:
	float                                         Param_StatusWidgetVisibleDuration;                 // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(NPCStatusWidget_C_ChangeWidgetVisibleDuration) == 0x000004, "Wrong alinment on NPCStatusWidget_C_ChangeWidgetVisibleDuration");
...
static_assert(offsetof(NPCStatusWidget_C_ChangeWidgetVisibleDuration, Param_StatusWidgetVisibleDuration) == 0x000000, "Member 'NPCStatusWidget_C_ChangeWidgetVisibleDuration::Param_StatusWidgetVisibleDuration' has a wrong offset!");
...
static_assert(alignof(NPCStatusWidget_C_EventUpdateStatus) == 0x000004, "Wrong alinment on NPCStatusWidget_C_EventUpdateStatus");
