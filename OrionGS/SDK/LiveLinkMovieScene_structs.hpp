...
static_assert(alignof(FLiveLinkPropertyData) == 0x000008, "Wrong alinment on FLiveLinkPropertyData");
...
static_assert(alignof(FLiveLinkSubSectionData) == 0x000008, "Wrong alinment on FLiveLinkSubSectionData");
...
public:
	...
	uint8                                         Pad_4AEA[0x28];                                    // 0x0090(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneLiveLinkSectionTemplate) == 0x000008, "Wrong alinment on FMovieSceneLiveLinkSectionTemplate");
