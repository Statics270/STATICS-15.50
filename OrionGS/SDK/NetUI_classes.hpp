...
public:
	...
	uint8                                         Pad_4C2B[0x3];                                     // 0x0261(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C2C[0x18];                                    // 0x0270(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BadNetworkIndicator">();
	}
...
static_assert(alignof(UBadNetworkIndicator) == 0x000008, "Wrong alinment on UBadNetworkIndicator");
...
public:
	...
	uint8                                         Pad_4C2D[0xB0];                                    // 0x0298(0x00B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"NetDebugWidget">();
	}
...
static_assert(alignof(UNetDebugWidget) == 0x000008, "Wrong alinment on UNetDebugWidget");
...
public:
	...
	uint8                                         Pad_4C2E[0x14];                                    // 0x027C(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"NetGraph">();
	}
...
static_assert(alignof(UNetGraph) == 0x000008, "Wrong alinment on UNetGraph");
