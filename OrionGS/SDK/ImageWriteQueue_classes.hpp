...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ImageWriteBlueprintLibrary">();
	}
...
static_assert(alignof(UImageWriteBlueprintLibrary) == 0x000008, "Wrong alinment on UImageWriteBlueprintLibrary");
