...
public:
	...
	uint8                                         Pad_67BD[0x7];                                     // 0x0BD1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(USocialConfirmationButton_C) == 0x000008, "Wrong alinment on USocialConfirmationButton_C");
