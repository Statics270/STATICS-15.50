...
public:
	...
	uint8                                         Pad_792F[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(WebPurchase_C_HandleBack) == 0x000008, "Wrong alinment on WebPurchase_C_HandleBack");
...
static_assert(alignof(WebPurchase_C_ExecuteUbergraph_WebPurchase) == 0x000004, "Wrong alinment on WebPurchase_C_ExecuteUbergraph_WebPurchase");
