...
void UFrontEnd_RockyRidgeV2_Final_New_C::UpdateCountdown(bool Temp_bool_Variable, const struct FTimespan& CallFunc_MakeTimespan_ReturnValue, const struct FTimespan& CallFunc_MakeTimespan_ReturnValue_1, const struct FDateTime& CallFunc_UtcNow_ReturnValue, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, const struct FTimespan& CallFunc_Subtract_DateTimeDateTime_ReturnValue, bool CallFunc_GreaterEqual_TimespanTimespan_ReturnValue, struct FTimespan& K2Node_Select_Default, class FText CallFunc_GetTimespanAsText_ReturnValue)
{
	...
	Params::FrontEnd_RockyRidgeV2_Final_New_C_UpdateCountdown Parms{};

	Parms.Temp_bool_Variable = Temp_bool_Variable;
	Parms.CallFunc_MakeTimespan_ReturnValue = std::move(CallFunc_MakeTimespan_ReturnValue);
	Parms.CallFunc_MakeTimespan_ReturnValue_1 = std::move(CallFunc_MakeTimespan_ReturnValue_1);
...
void UFrontEnd_RockyRidgeV2_Final_New_C::SoundMaybe(int32 Param_Index, class USoundBase* Sound, int32 CallFunc_Array_LastIndex_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue_1, bool CallFunc_BooleanOR_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// TDelegate<void(EFortDialogResult Result, class FName ResultName)>K2Node_CreateDelegate_OutputDelegate_4                 (ZeroConstructor, NoDestructor)
