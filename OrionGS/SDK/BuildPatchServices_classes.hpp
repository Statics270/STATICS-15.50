...
public:
	...
	uint8                                         Pad_5104[0x2];                                     // 0x002A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BuildPatchManifest">();
	}
...
static_assert(alignof(UBuildPatchManifest) == 0x000008, "Wrong alinment on UBuildPatchManifest");
