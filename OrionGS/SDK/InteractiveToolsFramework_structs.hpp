...
{
public:
	uint8                                         Pad_52E8[0xAC];                                    // 0x0000(0x00AC)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBrushStampData) == 0x000004, "Wrong alinment on FBrushStampData");
...
public:
	...
	uint8                                         Pad_52E9[0x18];                                    // 0x0008(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBehaviorInfo) == 0x000008, "Wrong alinment on FBehaviorInfo");
...
{
public:
	uint8                                         Pad_52EA[0x28];                                    // 0x0000(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FInputRayHit) == 0x000008, "Wrong alinment on FInputRayHit");
...
{
public:
	uint8                                         Pad_52EB[0x30];                                    // 0x0000(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FActiveGizmo) == 0x000008, "Wrong alinment on FActiveGizmo");
...
static_assert(alignof(FGizmoFloatParameterChange) == 0x000004, "Wrong alinment on FGizmoFloatParameterChange");
...
static_assert(alignof(FGizmoVec2ParameterChange) == 0x000004, "Wrong alinment on FGizmoVec2ParameterChange");
