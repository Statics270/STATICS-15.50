...
void UMIDIDeviceManager::GetMIDIInputDeviceIDByName(class FString& DeviceName, int32* DeviceID)
{
	static class UFunction* Func = nullptr;
...
void UMIDIDeviceManager::GetMIDIOutputDeviceIDByName(class FString& DeviceName, int32* DeviceID)
{
	static class UFunction* Func = nullptr;
