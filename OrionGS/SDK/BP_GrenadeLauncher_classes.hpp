...
{
public:
	uint8                                         Pad_54DA[0x8];                                     // 0x02B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_54DB[0x7];                                     // 0x02C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UBP_GrenadeLauncher_C) == 0x000010, "Wrong alinment on UBP_GrenadeLauncher_C");
