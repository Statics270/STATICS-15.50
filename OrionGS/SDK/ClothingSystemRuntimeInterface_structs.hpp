...
static_assert(alignof(FClothCollisionPrim_Sphere) == 0x000004, "Wrong alinment on FClothCollisionPrim_Sphere");
...
static_assert(alignof(FClothCollisionPrim_SphereConnection) == 0x000004, "Wrong alinment on FClothCollisionPrim_SphereConnection");
...
public:
	...
	uint8                                         Pad_4EF2[0x4];                                     // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FClothCollisionPrim_Convex) == 0x000008, "Wrong alinment on FClothCollisionPrim_Convex");
...
static_assert(alignof(FClothCollisionPrim_Box) == 0x000010, "Wrong alinment on FClothCollisionPrim_Box");
...
static_assert(alignof(FClothCollisionData) == 0x000008, "Wrong alinment on FClothCollisionData");
...
static_assert(alignof(FClothVertBoneData) == 0x000004, "Wrong alinment on FClothVertBoneData");
