...
static_assert(alignof(FActiveSoundInfo) == 0x000004, "Wrong alinment on FActiveSoundInfo");
...
public:
	...
	uint8                                         Pad_4E8D[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 ValueData;                                         // 0x0018(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDatastoreEntry) == 0x000008, "Wrong alinment on FDatastoreEntry");
...
{
public:
	uint8                                         Pad_4E8E[0x8];                                     // 0x0108(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FDatastoreState) == 0x000008, "Wrong alinment on FDatastoreState");
...
public:
	...
	uint8                                         Pad_4E8F[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPlayerScore) == 0x000008, "Wrong alinment on FPlayerScore");
...
{
public:
	uint8                                         Pad_4E90[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVMessage) == 0x000008, "Wrong alinment on FVMessage");
...
public:
	...
	uint8                                         Pad_4E91[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FVerseActionMapping) == 0x000008, "Wrong alinment on FVerseActionMapping");
...
static_assert(alignof(FVerseActionMappingArray) == 0x000008, "Wrong alinment on FVerseActionMappingArray");
