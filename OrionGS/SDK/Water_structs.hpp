...
public:
	...
	uint8                                         Pad_4201[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4202[0x178];                                   // 0x0090(0x0178)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4203[0x10];                                    // 0x0210(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSphericalPontoon) == 0x000010, "Wrong alinment on FSphericalPontoon");
...
static_assert(alignof(FWaterBrushEffectSmoothBlending) == 0x000004, "Wrong alinment on FWaterBrushEffectSmoothBlending");
...
public:
	...
	uint8                                         Pad_4204[0x7];                                     // 0x0049(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBuoyancyData) == 0x000008, "Wrong alinment on FBuoyancyData");
...
static_assert(alignof(FWaterBrushEffectDisplacement) == 0x000008, "Wrong alinment on FWaterBrushEffectDisplacement");
...
public:
	...
	uint8                                         Pad_4205[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4206[0x8];                                     // 0x0568(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FUnderwaterPostProcessSettings) == 0x000010, "Wrong alinment on FUnderwaterPostProcessSettings");
...
public:
	...
	uint8                                         Pad_4207[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FWaterFalloffSettings) == 0x000004, "Wrong alinment on FWaterFalloffSettings");
...
public:
	...
	uint8                                         Pad_4208[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FWaterBrushEffectBlurring) == 0x000004, "Wrong alinment on FWaterBrushEffectBlurring");
...
static_assert(alignof(FWaterBrushEffectCurlNoise) == 0x000004, "Wrong alinment on FWaterBrushEffectCurlNoise");
...
static_assert(alignof(FWaterBrushEffectTerracing) == 0x000004, "Wrong alinment on FWaterBrushEffectTerracing");
...
public:
	...
	uint8                                         Pad_4209[0x4];                                     // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWaterBrushEffects) == 0x000008, "Wrong alinment on FWaterBrushEffects");
...
public:
	...
	uint8                                         Pad_420B[0x4];                                     // 0x007C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWaterBodyHeightmapSettings) == 0x000008, "Wrong alinment on FWaterBodyHeightmapSettings");
...
public:
	...
	uint8                                         Pad_420C[0x14];                                    // 0x0018(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWaterWaveParams) == 0x000004, "Wrong alinment on FWaterWaveParams");
...
static_assert(alignof(FWaterBodyWeightmapSettings) == 0x000008, "Wrong alinment on FWaterBodyWeightmapSettings");
...
public:
	...
	uint8                                         Pad_420E[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWaterBrushEffectCurves) == 0x000008, "Wrong alinment on FWaterBrushEffectCurves");
...
public:
	...
	float                                         ChannelDepth;                                      // 0x0014(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CurveRampWidth;                                    // 0x0018(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4210[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWaterCurveSettings) == 0x000008, "Wrong alinment on FWaterCurveSettings");
...
public:
	...
	uint8                                         Pad_4211[0x4];                                     // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWaterStreamingCell) == 0x000008, "Wrong alinment on FWaterStreamingCell");
...
static_assert(alignof(FWaterStreamingGrid) == 0x000008, "Wrong alinment on FWaterStreamingGrid");
...
static_assert(alignof(FWaterSplineCurveDefaults) == 0x000004, "Wrong alinment on FWaterSplineCurveDefaults");
