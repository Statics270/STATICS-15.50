...
static_assert(alignof(FNavCollisionBox) == 0x000004, "Wrong alinment on FNavCollisionBox");
...
static_assert(alignof(FNavCollisionCylinder) == 0x000004, "Wrong alinment on FNavCollisionCylinder");
...
public:
	...
	uint8                                         Pad_4F6B[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FSupportedAreaData) == 0x000008, "Wrong alinment on FSupportedAreaData");
...
public:
	...
	uint8                                         Pad_4F6C[0x10];                                    // 0x0008(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNavGraphNode) == 0x000008, "Wrong alinment on FNavGraphNode");
...
{
public:
	uint8                                         Pad_4F6D[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNavGraphEdge) == 0x000008, "Wrong alinment on FNavGraphEdge");
...
public:
	...
	uint8                                         Pad_4F6E[0x2];                                     // 0x0002(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNavigationFilterFlags) == 0x000004, "Wrong alinment on FNavigationFilterFlags");
...
public:
	...
	uint8                                         Pad_4F6F[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNavigationFilterArea) == 0x000008, "Wrong alinment on FNavigationFilterArea");
...
public:
	...
	uint8                                         Pad_4F70[0x4];                                     // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNavLinkCustomInstanceData) == 0x000008, "Wrong alinment on FNavLinkCustomInstanceData");
...
public:
	...
	uint8                                         Pad_4F71[0x2];                                     // 0x0032(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4F72[0x3];                                     // 0x003D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRecastNavMeshGenerationProperties) == 0x000004, "Wrong alinment on FRecastNavMeshGenerationProperties");
