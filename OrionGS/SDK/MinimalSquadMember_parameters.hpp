...
static_assert(alignof(MinimalSquadMember_C_SetEmptyVisuals) == 0x000008, "Wrong alinment on MinimalSquadMember_C_SetEmptyVisuals");
...
static_assert(alignof(MinimalSquadMember_C_SetSitOutVisuals) == 0x000008, "Wrong alinment on MinimalSquadMember_C_SetSitOutVisuals");
...
static_assert(alignof(MinimalSquadMember_C_SetNotReadyVisuals) == 0x000008, "Wrong alinment on MinimalSquadMember_C_SetNotReadyVisuals");
...
static_assert(alignof(MinimalSquadMember_C_OnMemberGameReadinessChanged) == 0x000001, "Wrong alinment on MinimalSquadMember_C_OnMemberGameReadinessChanged");
...
static_assert(alignof(MinimalSquadMember_C_BP_OnTeamMemberEstablished) == 0x000001, "Wrong alinment on MinimalSquadMember_C_BP_OnTeamMemberEstablished");
...
public:
	...
	uint8                                         Pad_76AF[0x5];                                     // 0x000B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember) == 0x000008, "Wrong alinment on MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember");
