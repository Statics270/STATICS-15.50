...
static_assert(alignof(UGET_DirectEnvironmentDamage_C) == 0x000008, "Wrong alinment on UGET_DirectEnvironmentDamage_C");
static_assert(sizeof(UGET_DirectEnvironmentDamage_C) == 0x000800, "Wrong size on UGET_DirectEnvironmentDamage_C");
