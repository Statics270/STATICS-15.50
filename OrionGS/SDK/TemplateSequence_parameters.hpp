...
static_assert(alignof(TemplateSequenceActor_SetBinding) == 0x000008, "Wrong alinment on TemplateSequenceActor_SetBinding");
...
static_assert(alignof(TemplateSequenceActor_SetSequence) == 0x000008, "Wrong alinment on TemplateSequenceActor_SetSequence");
...
static_assert(alignof(TemplateSequenceActor_GetSequence) == 0x000008, "Wrong alinment on TemplateSequenceActor_GetSequence");
...
static_assert(alignof(TemplateSequenceActor_GetSequencePlayer) == 0x000008, "Wrong alinment on TemplateSequenceActor_GetSequencePlayer");
...
static_assert(alignof(TemplateSequenceActor_LoadSequence) == 0x000008, "Wrong alinment on TemplateSequenceActor_LoadSequence");
...
public:
	...
	uint8                                         Pad_4629[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(TemplateSequencePlayer_CreateTemplateSequencePlayer) == 0x000008, "Wrong alinment on TemplateSequencePlayer_CreateTemplateSequencePlayer");
