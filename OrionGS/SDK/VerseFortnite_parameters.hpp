...
public:
	...
	uint8                                         Pad_4E95[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortControllerStateHandlerComponent_NotifyOfStateChange) == 0x000008, "Wrong alinment on FortControllerStateHandlerComponent_NotifyOfStateChange");
...
static_assert(alignof(FortPlayspaceComponentHelper_HandlePlayerDied) == 0x000008, "Wrong alinment on FortPlayspaceComponentHelper_HandlePlayerDied");
...
static_assert(alignof(FortPlayspaceComponentHelper_HandlePlayerPawnPossessed) == 0x000008, "Wrong alinment on FortPlayspaceComponentHelper_HandlePlayerPawnPossessed");
...
static_assert(alignof(HUDGameOverComponentBase_GetIsDraw) == 0x000001, "Wrong alinment on HUDGameOverComponentBase_GetIsDraw");
...
static_assert(alignof(HUDGameOverComponentBase_GetWinningTeam) == 0x000004, "Wrong alinment on HUDGameOverComponentBase_GetWinningTeam");
...
static_assert(alignof(HUDMapComponentBase_HandleMapBoundsChanged) == 0x000004, "Wrong alinment on HUDMapComponentBase_HandleMapBoundsChanged");
...
static_assert(alignof(VerseFortniteInputComponentBase_ServerTriggerAction) == 0x000004, "Wrong alinment on VerseFortniteInputComponentBase_ServerTriggerAction");
