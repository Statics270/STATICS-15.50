...
public:
	...
	uint8                                         Pad_7ACB[0x1];                                     // 0x0007(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_7ACC[0x4];                                     // 0x01D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(LeaderboardListViewWrapper_C_ExecuteUbergraph_LeaderboardListViewWrapper) == 0x000008, "Wrong alinment on LeaderboardListViewWrapper_C_ExecuteUbergraph_LeaderboardListViewWrapper");
...
static_assert(alignof(LeaderboardListViewWrapper_C_OnLeaderboardDisplayTypeChanged) == 0x000001, "Wrong alinment on LeaderboardListViewWrapper_C_OnLeaderboardDisplayTypeChanged");
...
static_assert(alignof(LeaderboardListViewWrapper_C_Set_Event) == 0x000008, "Wrong alinment on LeaderboardListViewWrapper_C_Set_Event");
...
{
public:
	struct FFortTournamentDisplayInfo             Param_DisplayInfo;                                 // 0x0000(0x01A8)(BlueprintVisible, BlueprintReadOnly, Parm)
};
static_assert(alignof(LeaderboardListViewWrapper_C_Set_Display_Info) == 0x000008, "Wrong alinment on LeaderboardListViewWrapper_C_Set_Display_Info");
...
static_assert(offsetof(LeaderboardListViewWrapper_C_Set_Display_Info, Param_DisplayInfo) == 0x000000, "Member 'LeaderboardListViewWrapper_C_Set_Display_Info::Param_DisplayInfo' has a wrong offset!");
