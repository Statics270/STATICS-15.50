...
public:
	...
	uint8                                         Pad_6A6C[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(SR_Core_C_ExecuteUbergraph_SR_Core) == 0x000008, "Wrong alinment on SR_Core_C_ExecuteUbergraph_SR_Core");
...
static_assert(alignof(SR_Core_C_OnPawnExitSeat) == 0x000008, "Wrong alinment on SR_Core_C_OnPawnExitSeat");
...
static_assert(alignof(SR_Core_C_OnPawnEnterSeat) == 0x000008, "Wrong alinment on SR_Core_C_OnPawnEnterSeat");
...
public:
	...
	uint8                                         Pad_6A6D[0x3];                                     // 0x0009(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6A6E[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(SR_Core_C_HandleSeatStateUpdated) == 0x000008, "Wrong alinment on SR_Core_C_HandleSeatStateUpdated");
...
static_assert(alignof(SR_Core_C_HandleWeaponStateUpdated) == 0x000008, "Wrong alinment on SR_Core_C_HandleWeaponStateUpdated");
...
static_assert(alignof(SR_Core_C_HandleADSStateUpdated) == 0x000001, "Wrong alinment on SR_Core_C_HandleADSStateUpdated");
...
static_assert(alignof(SR_Core_C_HandleOnSourcePlayed) == 0x000008, "Wrong alinment on SR_Core_C_HandleOnSourcePlayed");
...
static_assert(alignof(SR_Core_C_UpdateMixState) == 0x000001, "Wrong alinment on SR_Core_C_UpdateMixState");
...
static_assert(alignof(SR_Core_C_GetIsMixAllowed) == 0x000001, "Wrong alinment on SR_Core_C_GetIsMixAllowed");
