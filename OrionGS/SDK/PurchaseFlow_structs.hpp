...
static_assert(alignof(FPurchaseFlowItem) == 0x000008, "Wrong alinment on FPurchaseFlowItem");
...
public:
	...
	uint8                                         Pad_4CF9[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FPurchaseFlowItem>              Items;                                             // 0x0028(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPurchaseFlowOffer) == 0x000008, "Wrong alinment on FPurchaseFlowOffer");
...
static_assert(alignof(FPurchaseFlowReceiptParam) == 0x000008, "Wrong alinment on FPurchaseFlowReceiptParam");
