...
static_assert(alignof(FDownloadCacheEntry) == 0x000008, "Wrong alinment on FDownloadCacheEntry");
...
{
public:
	uint8                                         Pad_537B[0x4];                                     // 0x0000(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FDownloadCache) == 0x000008, "Wrong alinment on FDownloadCache");
