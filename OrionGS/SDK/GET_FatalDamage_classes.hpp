...
static_assert(alignof(UGET_FatalDamage_C) == 0x000008, "Wrong alinment on UGET_FatalDamage_C");
static_assert(sizeof(UGET_FatalDamage_C) == 0x000800, "Wrong size on UGET_FatalDamage_C");
