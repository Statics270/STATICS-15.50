...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"McpItemDefinitionBase">();
	}
...
static_assert(alignof(UMcpItemDefinitionBase) == 0x000008, "Wrong alinment on UMcpItemDefinitionBase");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"McpItemAware">();
	}
...
static_assert(alignof(IMcpItemAware) == 0x000008, "Wrong alinment on IMcpItemAware");
...
public:
	...
	uint8                                         Pad_4791[0x57];                                    // 0x0029(0x0057)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4792[0x15];                                    // 0x0093(0x0015)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4793[0x3];                                     // 0x00CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4794[0x38];                                    // 0x00D8(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"McpProfile">();
	}
...
static_assert(alignof(UMcpProfile) == 0x000008, "Wrong alinment on UMcpProfile");
...
{
public:
	uint8                                         Pad_4796[0xB4];                                    // 0x0028(0x00B4)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4797[0x4];                                     // 0x00E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FProfileEntry>                  ProfileList;                                       // 0x00E8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_4798[0x8];                                     // 0x00F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4799[0x7];                                     // 0x0111(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_479A[0x40];                                    // 0x0128(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_479B[0x8];                                     // 0x01A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_479C[0x3];                                     // 0x01DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 ApplyStashEndPoint;                                // 0x01E0(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_479D[0x8];                                     // 0x01F0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_479E[0x56];                                    // 0x01FA(0x0056)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_479F[0x8];                                     // 0x0258(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"McpProfileGroup">();
	}
...
static_assert(alignof(UMcpProfileGroup) == 0x000010, "Wrong alinment on UMcpProfileGroup");
...
{
public:
	uint8                                         Pad_47A0[0x10];                                    // 0x0028(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47A1[0x8];                                     // 0x0058(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47A2[0x4];                                     // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"McpProfileManager">();
	}
...
static_assert(alignof(UMcpProfileManager) == 0x000008, "Wrong alinment on UMcpProfileManager");
