...
public:
	void ExecuteUbergraph_GA_DefaultPlayer_Death(int32 EntryPoint, ESubGame CallFunc_GetSubGame_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess);
...
static_assert(alignof(UGA_DefaultPlayer_Death_C) == 0x000008, "Wrong alinment on UGA_DefaultPlayer_Death_C");
