...
public:
	...
	uint8                                         Pad_1D57[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  RequirePlaylistTags;                               // 0x0040(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FFortAthenaLivingWorldCategory) == 0x000008, "Wrong alinment on FFortAthenaLivingWorldCategory");
...
public:
	...
	uint8                                         Pad_1D58[0x4];                                     // 0x007C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D59[0x2];                                     // 0x00A2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D5A[0x7];                                     // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  RequirePlaylistTags;                               // 0x00B8(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FFortAthenaLivingWorldEvent) == 0x000008, "Wrong alinment on FFortAthenaLivingWorldEvent");
...
public:
	...
	uint8                                         Pad_1D5B[0x7];                                     // 0x0099(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FFortAthenaLivingWorldEventDataActorSpawnDescription) == 0x000008, "Wrong alinment on FFortAthenaLivingWorldEventDataActorSpawnDescription");
...
static_assert(alignof(FPointProviderFilterEntry) == 0x000008, "Wrong alinment on FPointProviderFilterEntry");
...
static_assert(alignof(FFortLivingWorldConfigOverride) == 0x000008, "Wrong alinment on FFortLivingWorldConfigOverride");
...
{
public:
	uint8                                         Pad_1D5C[0x2];                                     // 0x0000(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAthenaLivingWorldPointProviderFilterRules) == 0x000001, "Wrong alinment on FFortAthenaLivingWorldPointProviderFilterRules");
