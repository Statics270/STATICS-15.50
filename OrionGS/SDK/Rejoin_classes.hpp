...
public:
	...
	uint8                                         Pad_48B5[0x145];                                   // 0x002B(0x0145)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"RejoinCheck">();
	}
...
static_assert(alignof(URejoinCheck) == 0x000008, "Wrong alinment on URejoinCheck");
