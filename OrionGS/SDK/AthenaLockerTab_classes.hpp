...
public:
	...
	class UWidgetAnimation*                       LoopingRandomEnabled_1;                            // 0x0C40(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       LoopingRandomEnabled;                              // 0x0C48(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       PresetAppliedToast_1;                              // 0x0C50(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       PresetAppliedToast_2;                              // 0x0C58(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       PresetAppliedToast;                                // 0x0C60(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       RandomDisabledDisclaimer;                          // 0x0C68(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       RandomEnabledDisclaimer;                           // 0x0C70(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWidgetAnimation*                       ItemInfoIntroOutro;                                // 0x0C78(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UAthenaCustomizationSlotButton_C*       BackpackButton;                                    // 0x0C80(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class USoloButton_C*                          Button_ChangeName;                                 // 0x0C88(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UAthenaCustomizationSlotButton_C*       CharacterButton;                                   // 0x0C90(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class ULoadoutSaveConfirmation_C*             Confirmation_Save;                                 // 0x0C98(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UAthenaCustomizationSlotButton_C*       DanceButton1;                                      // 0x0CA0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UAthenaCustomizationSlotButton_C*       DanceButton2;                                      // 0x0CA8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UAthenaCustomizationSlotButton_C*       DanceButton3;                                      // 0x0CB0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UAthenaCustomizationSlotButton_C*       DanceButton4;                                      // 0x0CB8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UAthenaCustomizationSlotButton_C*       DanceButton5;                                      // 0x0CC0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UAthenaCustomizationSlotButton_C*       DanceButton6;                                      // 0x0CC8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	uint8                                         Pad_7BE8[0x3];                                     // 0x0DB1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void BeginPickingCustomization(class UCommonButton* WidgetToReturnFocusTo, const struct FAthenaCustomizationParams& Param_CustomizationParams, class UAthenaCustomizationSlotButton_C* SlotButton, bool CallFunc_NotEqual_ObjectObject_ReturnValue, bool CallFunc_NotEqual_ObjectObject_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_NotEqual_ObjectObject_ReturnValue_2, bool CallFunc_GetCustomizationSlotActiveState_bOutAttachableCosmeticAvailable, bool CallFunc_GetCustomizationSlotActiveState_bOutActive, class UAthenaCustomizationSlotButton_C* K2Node_DynamicCast_AsAthena_Customization_Slot_Button, bool K2Node_DynamicCast_bSuccess, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
	...
	void PlayEquippedLockerMusic_STW(ESubGame CallFunc_GetSubGame_ReturnValue, TArray<class AFort_Entry_Music_Controller_BP_C*>& CallFunc_GetAllActorsOfClass_OutActors, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class AFort_Entry_Music_Controller_BP_C* CallFunc_Array_Get_Item);
	...
	void UpdatePresetButtonStyles(ECommonInputType InputPin, EHorizontalAlignment Temp_byte_Variable, EHorizontalAlignment Temp_byte_Variable_1, EHorizontalAlignment Temp_byte_Variable_2, EHorizontalAlignment Temp_byte_Variable_3, ECommonInputType Temp_byte_Variable_4, class UIconTextButton_C* K2Node_DynamicCast_AsIcon_Text_Button, bool K2Node_DynamicCast_bSuccess, EHorizontalAlignment K2Node_Select_Default, class UIconTextButton_C* K2Node_DynamicCast_AsIcon_Text_Button_1, bool K2Node_DynamicCast_bSuccess_1);
	void AnimShowRandomDisclaimerEnabled(bool Show, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1);
...
static_assert(alignof(UAthenaLockerTab_C) == 0x000008, "Wrong alinment on UAthenaLockerTab_C");
static_assert(sizeof(UAthenaLockerTab_C) == 0x000DF0, "Wrong size on UAthenaLockerTab_C");
static_assert(offsetof(UAthenaLockerTab_C, UberGraphFrame) == 0x000C38, "Member 'UAthenaLockerTab_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, LoopingRandomEnabled_1) == 0x000C40, "Member 'UAthenaLockerTab_C::LoopingRandomEnabled_1' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, LoopingRandomEnabled) == 0x000C48, "Member 'UAthenaLockerTab_C::LoopingRandomEnabled' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, PresetAppliedToast_1) == 0x000C50, "Member 'UAthenaLockerTab_C::PresetAppliedToast_1' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, PresetAppliedToast_2) == 0x000C58, "Member 'UAthenaLockerTab_C::PresetAppliedToast_2' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, PresetAppliedToast) == 0x000C60, "Member 'UAthenaLockerTab_C::PresetAppliedToast' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, RandomDisabledDisclaimer) == 0x000C68, "Member 'UAthenaLockerTab_C::RandomDisabledDisclaimer' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, RandomEnabledDisclaimer) == 0x000C70, "Member 'UAthenaLockerTab_C::RandomEnabledDisclaimer' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, ItemInfoIntroOutro) == 0x000C78, "Member 'UAthenaLockerTab_C::ItemInfoIntroOutro' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, BackpackButton) == 0x000C80, "Member 'UAthenaLockerTab_C::BackpackButton' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, Button_ChangeName) == 0x000C88, "Member 'UAthenaLockerTab_C::Button_ChangeName' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, CharacterButton) == 0x000C90, "Member 'UAthenaLockerTab_C::CharacterButton' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, Confirmation_Save) == 0x000C98, "Member 'UAthenaLockerTab_C::Confirmation_Save' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, DanceButton1) == 0x000CA0, "Member 'UAthenaLockerTab_C::DanceButton1' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, DanceButton2) == 0x000CA8, "Member 'UAthenaLockerTab_C::DanceButton2' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, DanceButton3) == 0x000CB0, "Member 'UAthenaLockerTab_C::DanceButton3' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, DanceButton4) == 0x000CB8, "Member 'UAthenaLockerTab_C::DanceButton4' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, DanceButton5) == 0x000CC0, "Member 'UAthenaLockerTab_C::DanceButton5' has a wrong offset!");
static_assert(offsetof(UAthenaLockerTab_C, DanceButton6) == 0x000CC8, "Member 'UAthenaLockerTab_C::DanceButton6' has a wrong offset!");
