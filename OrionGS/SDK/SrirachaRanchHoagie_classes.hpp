...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"StreamingRadioPlayerComponent_Hoagie">();
	}
...
static_assert(alignof(UStreamingRadioPlayerComponent_Hoagie) == 0x000008, "Wrong alinment on UStreamingRadioPlayerComponent_Hoagie");
