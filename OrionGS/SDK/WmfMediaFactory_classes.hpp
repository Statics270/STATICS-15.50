...
public:
	...
	uint8                                         Pad_4F5F[0x4];                                     // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"WmfMediaSettings">();
	}
...
static_assert(alignof(UWmfMediaSettings) == 0x000008, "Wrong alinment on UWmfMediaSettings");
