...
public:
	...
	uint8                                         Pad_5ED2[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5ED3[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint_C_ExecuteUbergraph_Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint) == 0x000008, "Wrong alinment on Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint_C_ExecuteUbergraph_Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint");
...
static_assert(alignof(Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint_C_BlueprintUpdateAnimation) == 0x000004, "Wrong alinment on Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint_C_BlueprintUpdateAnimation");
...
static_assert(alignof(Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint_C_AnimGraph) == 0x000008, "Wrong alinment on Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint_C_AnimGraph");
...
static_assert(offsetof(Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint_C_AnimGraph, Param_AnimGraph) == 0x000010, "Member 'Flopping_Rabbit_Gadget_Skeleton_AnimBlueprint_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
