...
static_assert(alignof(FEventRecord) == 0x000008, "Wrong alinment on FEventRecord");
...
static_assert(alignof(FEventChannelState) == 0x000008, "Wrong alinment on FEventChannelState");
...
static_assert(alignof(FEventsTimeline) == 0x000008, "Wrong alinment on FEventsTimeline");
...
static_assert(alignof(FCalendarDownload) == 0x000008, "Wrong alinment on FCalendarDownload");
