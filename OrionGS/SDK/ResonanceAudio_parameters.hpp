...
static_assert(alignof(ResonanceAudioBlueprintFunctionLibrary_GetGlobalReverbPreset) == 0x000008, "Wrong alinment on ResonanceAudioBlueprintFunctionLibrary_GetGlobalReverbPreset");
...
static_assert(alignof(ResonanceAudioBlueprintFunctionLibrary_SetGlobalReverbPreset) == 0x000008, "Wrong alinment on ResonanceAudioBlueprintFunctionLibrary_SetGlobalReverbPreset");
...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetEnableRoomEffects) == 0x000001, "Wrong alinment on ResonanceAudioReverbPluginPreset_SetEnableRoomEffects");
...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetReflectionScalar) == 0x000004, "Wrong alinment on ResonanceAudioReverbPluginPreset_SetReflectionScalar");
...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetReverbBrightness) == 0x000004, "Wrong alinment on ResonanceAudioReverbPluginPreset_SetReverbBrightness");
...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetReverbGain) == 0x000004, "Wrong alinment on ResonanceAudioReverbPluginPreset_SetReverbGain");
...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetReverbTimeModifier) == 0x000004, "Wrong alinment on ResonanceAudioReverbPluginPreset_SetReverbTimeModifier");
...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetRoomDimensions) == 0x000004, "Wrong alinment on ResonanceAudioReverbPluginPreset_SetRoomDimensions");
...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetRoomMaterials) == 0x000008, "Wrong alinment on ResonanceAudioReverbPluginPreset_SetRoomMaterials");
...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetRoomPosition) == 0x000004, "Wrong alinment on ResonanceAudioReverbPluginPreset_SetRoomPosition");
...
static_assert(alignof(ResonanceAudioReverbPluginPreset_SetRoomRotation) == 0x000010, "Wrong alinment on ResonanceAudioReverbPluginPreset_SetRoomRotation");
...
static_assert(alignof(ResonanceAudioSpatializationSourceSettings_SetSoundSourceDirectivity) == 0x000004, "Wrong alinment on ResonanceAudioSpatializationSourceSettings_SetSoundSourceDirectivity");
...
static_assert(alignof(ResonanceAudioSpatializationSourceSettings_SetSoundSourceSpread) == 0x000004, "Wrong alinment on ResonanceAudioSpatializationSourceSettings_SetSoundSourceSpread");
