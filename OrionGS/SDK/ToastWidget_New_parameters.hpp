...
static_assert(alignof(ToastWidget_New_C_SetupAnimBindings) == 0x000004, "Wrong alinment on ToastWidget_New_C_SetupAnimBindings");
...
public:
	...
	uint8                                         Pad_6091[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6092[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6093[0x6];                                     // 0x0042(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ToastWidget_New_C_ApplyAdditionalStyling) == 0x000008, "Wrong alinment on ToastWidget_New_C_ApplyAdditionalStyling");
...
public:
	...
	uint8                                         Pad_6094[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ToastWidget_New_C_SetImage) == 0x000008, "Wrong alinment on ToastWidget_New_C_SetImage");
...
public:
	...
	uint8                                         Pad_6095[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ToastWidget_New_C_GetOpenButtonVisibility) == 0x000008, "Wrong alinment on ToastWidget_New_C_GetOpenButtonVisibility");
...
static_assert(alignof(ToastWidget_New_C_StartIntro) == 0x000008, "Wrong alinment on ToastWidget_New_C_StartIntro");
...
static_assert(alignof(ToastWidget_New_C_ShowText) == 0x000008, "Wrong alinment on ToastWidget_New_C_ShowText");
...
public:
	...
	uint8                                         Pad_6096[0x6];                                     // 0x0052(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6097[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ToastWidget_New_C_SetToast) == 0x000008, "Wrong alinment on ToastWidget_New_C_SetToast");
...
static_assert(alignof(ToastWidget_New_C_OnMouseEnter) == 0x000008, "Wrong alinment on ToastWidget_New_C_OnMouseEnter");
...
static_assert(alignof(ToastWidget_New_C_OnMouseLeave) == 0x000008, "Wrong alinment on ToastWidget_New_C_OnMouseLeave");
...
static_assert(alignof(ToastWidget_New_C_BndEvt__OpenButton_K2Node_ComponentBoundEvent_5_CommonButtonClicked__DelegateSignature) == 0x000008, "Wrong alinment on ToastWidget_New_C_BndEvt__OpenButton_K2Node_ComponentBoundEvent_5_CommonButtonClicked__DelegateSignature");
...
static_assert(alignof(ToastWidget_New_C_OnSetToast) == 0x000008, "Wrong alinment on ToastWidget_New_C_OnSetToast");
static_assert(sizeof(ToastWidget_New_C_OnSetToast) == 0x000008, "Wrong size on ToastWidget_New_C_OnSetToast");
static_assert(offsetof(ToastWidget_New_C_OnSetToast, Param_ToastNotification) == 0x000000, "Member 'ToastWidget_New_C_OnSetToast::Param_ToastNotification' has a wrong offset!");
...
public:
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate;              // 0x0004(0x0010)(ZeroConstructor, NoDestructor)
	uint8                                         Pad_6098[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New) == 0x000008, "Wrong alinment on ToastWidget_New_C_ExecuteUbergraph_ToastWidget_New");
