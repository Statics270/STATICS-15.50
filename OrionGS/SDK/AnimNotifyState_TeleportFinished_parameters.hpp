...
public:
	...
	uint8                                         Pad_6305[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(AnimNotifyState_TeleportFinished_C_Received_NotifyBegin) == 0x000008, "Wrong alinment on AnimNotifyState_TeleportFinished_C_Received_NotifyBegin");
...
static_assert(alignof(AnimNotifyState_TeleportFinished_C_Received_NotifyEnd) == 0x000008, "Wrong alinment on AnimNotifyState_TeleportFinished_C_Received_NotifyEnd");
