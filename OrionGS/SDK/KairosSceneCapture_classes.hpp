...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"KairosCaptureStatics">();
	}
...
static_assert(alignof(UKairosCaptureStatics) == 0x000008, "Wrong alinment on UKairosCaptureStatics");
...
public:
	...
	uint8                                         Pad_4A8E[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"KairosConfig">();
	}
...
static_assert(alignof(UKairosConfig) == 0x000008, "Wrong alinment on UKairosConfig");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"KairosGameModeBase">();
	}
...
static_assert(alignof(AKairosGameModeBase) == 0x000008, "Wrong alinment on AKairosGameModeBase");
...
public:
	...
	uint8                                         Pad_4A8F[0x7];                                     // 0x0231(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A90[0x6];                                     // 0x0242(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"KairosHeroBase">();
	}
...
static_assert(alignof(AKairosHeroBase) == 0x000008, "Wrong alinment on AKairosHeroBase");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"KairosPawn">();
	}
...
static_assert(alignof(AKairosPawn) == 0x000008, "Wrong alinment on AKairosPawn");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"KairosPlayerController">();
	}
...
static_assert(alignof(AKairosPlayerController) == 0x000008, "Wrong alinment on AKairosPlayerController");
...
public:
	...
	uint8                                         Pad_4A92[0x1F];                                    // 0x02B1(0x001F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FKairosSceneInfo                       ActiveSceneInfo;                                   // 0x02D0(0x0020)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_4A93[0xB0];                                    // 0x02F0(0x00B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"KairosSceneManagerActor">();
	}
...
static_assert(alignof(AKairosSceneManagerActor) == 0x000010, "Wrong alinment on AKairosSceneManagerActor");
