...
public:
	...
	uint8                                         Pad_4EE5[0x3];                                     // 0x0021(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(BlueprintGameplayStatsLibrary_EqualEqual_GameplayStatTagGameplayStatTag) == 0x000004, "Wrong alinment on BlueprintGameplayStatsLibrary_EqualEqual_GameplayStatTagGameplayStatTag");
...
public:
	...
	struct FGameplayStatTag                       B;                                                 // 0x0010(0x0010)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0020(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4EE6[0x3];                                     // 0x0021(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(BlueprintGameplayStatsLibrary_NotEqual_GameplayStatTagGameplayStatTag) == 0x000004, "Wrong alinment on BlueprintGameplayStatsLibrary_NotEqual_GameplayStatTagGameplayStatTag");
