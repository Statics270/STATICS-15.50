...
static_assert(alignof(FElementID) == 0x000004, "Wrong alinment on FElementID");
...
static_assert(alignof(FEdgeID) == 0x000004, "Wrong alinment on FEdgeID");
...
static_assert(alignof(FVertexID) == 0x000004, "Wrong alinment on FVertexID");
...
static_assert(alignof(FPolygonGroupID) == 0x000004, "Wrong alinment on FPolygonGroupID");
...
static_assert(alignof(FPolygonID) == 0x000004, "Wrong alinment on FPolygonID");
...
static_assert(alignof(FVertexInstanceID) == 0x000004, "Wrong alinment on FVertexInstanceID");
...
static_assert(alignof(FTriangleID) == 0x000004, "Wrong alinment on FTriangleID");
