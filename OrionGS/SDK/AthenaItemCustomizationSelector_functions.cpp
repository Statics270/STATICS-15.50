...
// TDelegate<void(bool bIsSelected)>       K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor)
...
// TDelegate<void(class FText NewText)>    K2Node_CreateDelegate_OutputDelegate_2                 (ZeroConstructor, NoDestructor)
...
// struct FMcpVariantChannelInfo           K2Node_Event_InVariant                                 (ConstParm, HasGetValueTypeHash)
...
void UAthenaItemCustomizationSelector_C::ExecuteUbergraph_AthenaItemCustomizationSelector(int32 EntryPoint, TDelegate<void(bool* bPassThrough)> K2Node_CreateDelegate_OutputDelegate, bool CallFunc_HandleBack_PassThrough, class FName K2Node_ComponentBoundEvent_TabId, class UCommonButton* K2Node_ComponentBoundEvent_TabButton, class UIconTabButton_C* K2Node_DynamicCast_AsIcon_Tab_Button, bool K2Node_DynamicCast_bSuccess, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsValid_ReturnValue, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, bool K2Node_Event_bShowingVariants, class UFortItem* K2Node_Event_SelectedItem, bool CallFunc_IsValid_ReturnValue_1, class UAthenaCosmeticAccountItem* K2Node_DynamicCast_AsAthena_Cosmetic_Account_Item, bool K2Node_DynamicCast_bSuccess_1, class UFortItemDefinition* CallFunc_GetItemDefinitionBP_ReturnValue, class FText CallFunc_GetLockerItemTypeText_ReturnValue, class UAthenaCosmeticItemDefinition* K2Node_DynamicCast_AsAthena_Cosmetic_Item_Definition, bool K2Node_DynamicCast_bSuccess_2, class FText CallFunc_GetLockerDescriptionText_ReturnValue, bool CallFunc_IsOwnedByCampaignHero_ReturnValue, class UFortHero* CallFunc_GetHero_ReturnValue, bool CallFunc_IsValid_ReturnValue_2, EFortRarity CallFunc_GetRarity_ReturnValue, class FText CallFunc_GetDisplayName_ReturnValue, bool CallFunc_IsValid_ReturnValue_3, class UItemInfoHeaderWidget_C* K2Node_DynamicCast_AsItem_Info_Header_Widget, bool K2Node_DynamicCast_bSuccess_3, bool CallFunc_HandleBack_PassThrough_1, class FText K2Node_Event_CategoryDisplayName, class FText K2Node_Event_ItemDisplayTypeName, EAthenaCustomizationCategory K2Node_Event_SelectedCategory, class UMaterialInstance* K2Node_Event_OverrideSlotImage, class UAthenaCustomizationPicker_C* K2Node_DynamicCast_AsAthena_Customization_Picker, bool K2Node_DynamicCast_bSuccess_4, bool Temp_bool_IsClosed_Variable, class UItemInfoHeaderWidget_C* K2Node_DynamicCast_AsItem_Info_Header_Widget_1, bool K2Node_DynamicCast_bSuccess_5, class UFortFrontEndContext* CallFunc_GetLocalPlayerSubsystem_ReturnValue, bool K2Node_CustomEvent_bIsSelected, class UAthenaCustomizationPicker_C* K2Node_DynamicCast_AsAthena_Customization_Picker_1, bool K2Node_DynamicCast_bSuccess_6, TDelegate<void(bool bIsSelected)> K2Node_CreateDelegate_OutputDelegate_1, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue_1, ESlateVisibility Temp_byte_Variable, class FText K2Node_CustomEvent_NewText, TDelegate<void(class FText NewText)> K2Node_CreateDelegate_OutputDelegate_2, class UCommonButton* K2Node_ComponentBoundEvent_Button, bool K2Node_Event_bShouldHide, bool Temp_bool_Has_Been_Initd_Variable, bool CallFunc_IsMobileGame_ReturnValue, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, const struct FMargin& K2Node_MakeStruct_Margin, ESlateVisibility Temp_byte_Variable_1, bool CallFunc_BooleanAND_ReturnValue, class UVerticalBoxSlot* CallFunc_SlotAsVerticalBoxSlot_ReturnValue, bool K2Node_Event_bShouldShow, class FText K2Node_Event_CalloutText, bool Temp_bool_Variable, ESlateVisibility K2Node_Select_Default, struct FMcpVariantChannelInfo& K2Node_Event_InVariant, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class UFortItem* K2Node_CustomEvent_SelectedItem, bool CallFunc_IsValid_ReturnValue_4, ESlateVisibility Temp_byte_Variable_2, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_3, ESlateVisibility Temp_byte_Variable_3, bool Temp_bool_Variable_1, bool CallFunc_Not_PreBool_ReturnValue, ESlateVisibility K2Node_Select_Default_1, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue)
{
	...
	Parms.K2Node_Event_InVariant = std::move(K2Node_Event_InVariant);
...
// Parameters:
// struct FMcpVariantChannelInfo           InVariant                                              (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
...
void UAthenaItemCustomizationSelector_C::OnFinishedItemSetup(class FText& CategoryDisplayName, class FText& ItemDisplayTypeName, EAthenaCustomizationCategory SelectedCategory, class UMaterialInstance* OverrideSlotImage)
{
	static class UFunction* Func = nullptr;
...
void UAthenaItemCustomizationSelector_C::GetCurrentItemCosmeticDefinition(class UAthenaCosmeticItemDefinition** Cosmetic_Item_Definition, class UFortItem* CallFunc_GetCurrentItem_ReturnValue, class UAthenaCosmeticAccountItem* K2Node_DynamicCast_AsAthena_Cosmetic_Account_Item, bool K2Node_DynamicCast_bSuccess, class UFortItemDefinition* CallFunc_GetItemDefinitionBP_ReturnValue, class UAthenaCosmeticItemDefinition* K2Node_DynamicCast_AsAthena_Cosmetic_Item_Definition, bool K2Node_DynamicCast_bSuccess_1)
{
	...
	if (Cosmetic_Item_Definition != nullptr)
		*Cosmetic_Item_Definition = std::move(Parms.Cosmetic_Item_Definition);
}
...
// EAthenaCustomizationCategory            Temp_byte_Variable                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
