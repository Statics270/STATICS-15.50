...
public:
	...
	uint8                                         Pad_4EC4[0x28];                                    // 0x0040(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"VerseAssetPtr">();
	}
...
static_assert(alignof(UVerseAssetPtr) == 0x000008, "Wrong alinment on UVerseAssetPtr");
...
public:
	...
	uint8                                         Pad_4EC5[0x20];                                    // 0x00C0(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ControllerStateComponent">();
	}
...
static_assert(alignof(UControllerStateComponent) == 0x000008, "Wrong alinment on UControllerStateComponent");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ObjectHack">();
	}
...
static_assert(alignof(UObjectHack) == 0x000008, "Wrong alinment on UObjectHack");
...
{
public:
	uint8                                         Pad_4EC6[0x18];                                    // 0x0030(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"VerseWorldSubsystem">();
	}
...
static_assert(alignof(UVerseWorldSubsystem) == 0x000008, "Wrong alinment on UVerseWorldSubsystem");
...
public:
	...
	uint8                                         Pad_4EC7[0x8];                                     // 0x0260(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4EC8[0x20];                                    // 0x0270(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4EC9[0x50];                                    // 0x0390(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4ECA[0x8];                                     // 0x03E8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4ECB[0x10];                                    // 0x04E0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"VUIActor">();
	}
...
static_assert(alignof(AVUIActor) == 0x000010, "Wrong alinment on AVUIActor");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"VUIDynamicEventBinding">();
	}
...
static_assert(alignof(UVUIDynamicEventBinding) == 0x000008, "Wrong alinment on UVUIDynamicEventBinding");
