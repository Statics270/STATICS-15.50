...
static_assert(alignof(AB_Athena_Bucket_Old_Weap_C) == 0x000008, "Wrong alinment on AB_Athena_Bucket_Old_Weap_C");
static_assert(sizeof(AB_Athena_Bucket_Old_Weap_C) == 0x000D38, "Wrong size on AB_Athena_Bucket_Old_Weap_C");
