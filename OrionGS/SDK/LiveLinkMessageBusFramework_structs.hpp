...
static_assert(alignof(FLiveLinkSubjectFrameMessage) == 0x000008, "Wrong alinment on FLiveLinkSubjectFrameMessage");
...
static_assert(alignof(FLiveLinkSubjectDataMessage) == 0x000008, "Wrong alinment on FLiveLinkSubjectDataMessage");
...
static_assert(alignof(FLiveLinkClearSubject) == 0x000004, "Wrong alinment on FLiveLinkClearSubject");
...
{
public:
	uint8                                         Pad_53DB[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLiveLinkHeartbeatMessage) == 0x000001, "Wrong alinment on FLiveLinkHeartbeatMessage");
...
static_assert(alignof(FLiveLinkConnectMessage) == 0x000004, "Wrong alinment on FLiveLinkConnectMessage");
...
public:
	...
	uint8                                         Pad_53DC[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FLiveLinkPongMessage) == 0x000008, "Wrong alinment on FLiveLinkPongMessage");
...
static_assert(alignof(FLiveLinkPingMessage) == 0x000004, "Wrong alinment on FLiveLinkPingMessage");
