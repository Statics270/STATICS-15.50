...
static_assert(alignof(MIDIDeviceManager_CreateMIDIDeviceController) == 0x000008, "Wrong alinment on MIDIDeviceManager_CreateMIDIDeviceController");
...
static_assert(alignof(MIDIDeviceManager_CreateMIDIDeviceInputController) == 0x000008, "Wrong alinment on MIDIDeviceManager_CreateMIDIDeviceInputController");
...
static_assert(alignof(MIDIDeviceManager_CreateMIDIDeviceOutputController) == 0x000008, "Wrong alinment on MIDIDeviceManager_CreateMIDIDeviceOutputController");
...
static_assert(alignof(MIDIDeviceManager_FindAllMIDIDeviceInfo) == 0x000008, "Wrong alinment on MIDIDeviceManager_FindAllMIDIDeviceInfo");
...
static_assert(alignof(MIDIDeviceManager_FindMIDIDevices) == 0x000008, "Wrong alinment on MIDIDeviceManager_FindMIDIDevices");
...
static_assert(alignof(MIDIDeviceManager_GetDefaultIMIDIInputDeviceID) == 0x000004, "Wrong alinment on MIDIDeviceManager_GetDefaultIMIDIInputDeviceID");
...
static_assert(alignof(MIDIDeviceManager_GetDefaultIMIDIOutputDeviceID) == 0x000004, "Wrong alinment on MIDIDeviceManager_GetDefaultIMIDIOutputDeviceID");
...
public:
	...
	uint8                                         Pad_4D5F[0x4];                                     // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(MIDIDeviceManager_GetMIDIInputDeviceIDByName) == 0x000008, "Wrong alinment on MIDIDeviceManager_GetMIDIInputDeviceIDByName");
...
public:
	class FString                                 DeviceName;                                        // 0x0000(0x0010)(ConstParm, Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         DeviceID;                                          // 0x0010(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4D60[0x4];                                     // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(MIDIDeviceManager_GetMIDIOutputDeviceIDByName) == 0x000008, "Wrong alinment on MIDIDeviceManager_GetMIDIOutputDeviceIDByName");
...
static_assert(alignof(MIDIDeviceOutputController_SendMIDIChannelAftertouch) == 0x000004, "Wrong alinment on MIDIDeviceOutputController_SendMIDIChannelAftertouch");
...
static_assert(alignof(MIDIDeviceOutputController_SendMIDIControlChange) == 0x000004, "Wrong alinment on MIDIDeviceOutputController_SendMIDIControlChange");
...
public:
	...
	uint8                                         Pad_4D63[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(MIDIDeviceOutputController_SendMIDIEvent) == 0x000004, "Wrong alinment on MIDIDeviceOutputController_SendMIDIEvent");
...
static_assert(alignof(MIDIDeviceOutputController_SendMIDINoteAftertouch) == 0x000004, "Wrong alinment on MIDIDeviceOutputController_SendMIDINoteAftertouch");
...
static_assert(alignof(MIDIDeviceOutputController_SendMIDINoteOff) == 0x000004, "Wrong alinment on MIDIDeviceOutputController_SendMIDINoteOff");
...
static_assert(alignof(MIDIDeviceOutputController_SendMIDINoteOn) == 0x000004, "Wrong alinment on MIDIDeviceOutputController_SendMIDINoteOn");
...
static_assert(alignof(MIDIDeviceOutputController_SendMIDIPitchBend) == 0x000004, "Wrong alinment on MIDIDeviceOutputController_SendMIDIPitchBend");
...
static_assert(alignof(MIDIDeviceOutputController_SendMIDIProgramChange) == 0x000004, "Wrong alinment on MIDIDeviceOutputController_SendMIDIProgramChange");
