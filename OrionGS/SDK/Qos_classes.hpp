...
{
public:
	uint8                                         Pad_4876[0x38];                                    // 0x02B0(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"QosBeaconClient">();
	}
...
static_assert(alignof(AQosBeaconClient) == 0x000008, "Wrong alinment on AQosBeaconClient");
...
{
public:
	uint8                                         Pad_4877[0x10];                                    // 0x0248(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"QosBeaconHost">();
	}
...
static_assert(alignof(AQosBeaconHost) == 0x000008, "Wrong alinment on AQosBeaconHost");
...
{
public:
	uint8                                         Pad_4878[0x20];                                    // 0x0028(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4879[0x6];                                     // 0x004A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_487A[0x20];                                    // 0x0060(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"QosEvaluator">();
	}
...
static_assert(alignof(UQosEvaluator) == 0x000008, "Wrong alinment on UQosEvaluator");
...
public:
	...
	uint8                                         Pad_487B[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_487C[0x7];                                     // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 SelectedRegionId;                                  // 0x0090(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_487D[0x20];                                    // 0x00A0(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"QosRegionManager">();
	}
...
static_assert(alignof(UQosRegionManager) == 0x000008, "Wrong alinment on UQosRegionManager");
