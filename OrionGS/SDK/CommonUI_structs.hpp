...
public:
	...
	uint8                                         Pad_E12[0x4];                                      // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FUIActionKeyMapping) == 0x000008, "Wrong alinment on FUIActionKeyMapping");
...
public:
	...
	uint8                                         Pad_E13[0x2];                                      // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FCommonNumberFormattingOptions) == 0x000004, "Wrong alinment on FCommonNumberFormattingOptions");
...
public:
	...
	uint8                                         Pad_E14[0x4];                                      // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FCommonRegisteredTabInfo) == 0x000008, "Wrong alinment on FCommonRegisteredTabInfo");
...
static_assert(alignof(FUITag) == 0x000004, "Wrong alinment on FUITag");
...
static_assert(alignof(FUIActionTag) == 0x000004, "Wrong alinment on FUIActionTag");
...
static_assert(alignof(FUIInputAction) == 0x000008, "Wrong alinment on FUIInputAction");
...
public:
	...
	uint8                                         Pad_E15[0xF];                                      // 0x0011(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCommonInputActionHandlerData) == 0x000008, "Wrong alinment on FCommonInputActionHandlerData");
...
public:
	...
	uint8                                         Pad_E16[0x7];                                      // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateSound                            Sound;                                             // 0x0008(0x0018)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCommonButtonStyleOptionalSlateSound) == 0x000008, "Wrong alinment on FCommonButtonStyleOptionalSlateSound");
...
public:
	...
	uint8                                         Pad_E18[0x15];                                     // 0x0013(0x0015)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FOperation) == 0x000008, "Wrong alinment on FOperation");
...
public:
	...
	uint8                                         Pad_E19[0x3];                                      // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FCommonAnalogCursorSettings) == 0x000004, "Wrong alinment on FCommonAnalogCursorSettings");
...
static_assert(alignof(FRichTextIconData) == 0x000008, "Wrong alinment on FRichTextIconData");
...
public:
	...
	uint8                                         Pad_E1A[0x2];                                      // 0x001A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FCommonInputTypeInfo) == 0x000008, "Wrong alinment on FCommonInputTypeInfo");
...
static_assert(alignof(FCommonInputActionData) == 0x000008, "Wrong alinment on FCommonInputActionData");
