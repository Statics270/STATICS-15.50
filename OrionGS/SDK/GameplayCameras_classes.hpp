...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"TestCameraShake">();
	}
...
static_assert(alignof(UTestCameraShake) == 0x000010, "Wrong alinment on UTestCameraShake");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MovieSceneMatineeCameraShakeEvaluator">();
	}
...
static_assert(alignof(UMovieSceneMatineeCameraShakeEvaluator) == 0x000008, "Wrong alinment on UMovieSceneMatineeCameraShakeEvaluator");
...
public:
	...
	uint8                                         Pad_45A2[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SimpleCameraShakePattern">();
	}
...
static_assert(alignof(USimpleCameraShakePattern) == 0x000008, "Wrong alinment on USimpleCameraShakePattern");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ConstantCameraShakePattern">();
	}
...
static_assert(alignof(UConstantCameraShakePattern) == 0x000008, "Wrong alinment on UConstantCameraShakePattern");
...
public:
	...
	uint8                                         Pad_45A3[0x10];                                    // 0x0038(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"CompositeCameraShakePattern">();
	}
...
static_assert(alignof(UCompositeCameraShakePattern) == 0x000008, "Wrong alinment on UCompositeCameraShakePattern");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"DefaultCameraShakeBase">();
	}
...
static_assert(alignof(UDefaultCameraShakeBase) == 0x000010, "Wrong alinment on UDefaultCameraShakeBase");
...
public:
	...
	uint8                                         Pad_45A4[0x4];                                     // 0x011C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45A5[0x3];                                     // 0x0131(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45A6[0x40];                                    // 0x0140(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45A7[0x28];                                    // 0x0188(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MatineeCameraShake">();
	}
...
static_assert(alignof(UMatineeCameraShake) == 0x000010, "Wrong alinment on UMatineeCameraShake");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MatineeCameraShakePattern">();
	}
...
static_assert(alignof(UMatineeCameraShakePattern) == 0x000008, "Wrong alinment on UMatineeCameraShakePattern");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MatineeCameraShakeFunctionLibrary">();
	}
...
static_assert(alignof(UMatineeCameraShakeFunctionLibrary) == 0x000008, "Wrong alinment on UMatineeCameraShakeFunctionLibrary");
...
public:
	...
	uint8                                         Pad_45AD[0x38];                                    // 0x0080(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"PerlinNoiseCameraShakePattern">();
	}
...
static_assert(alignof(UPerlinNoiseCameraShakePattern) == 0x000008, "Wrong alinment on UPerlinNoiseCameraShakePattern");
...
public:
	...
	uint8                                         Pad_45AE[0x3C];                                    // 0x009C(0x003C)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"WaveOscillatorCameraShakePattern">();
	}
...
static_assert(alignof(UWaveOscillatorCameraShakePattern) == 0x000008, "Wrong alinment on UWaveOscillatorCameraShakePattern");
