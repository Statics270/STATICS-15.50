...
public:
	...
	uint8                                         Pad_5F64[0x4];                                     // 0x00BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GA_Athena_HidingProp_LandedOn_C_ExecuteUbergraph_GA_Athena_HidingProp_LandedOn) == 0x000008, "Wrong alinment on GA_Athena_HidingProp_LandedOn_C_ExecuteUbergraph_GA_Athena_HidingProp_LandedOn");
...
static_assert(alignof(GA_Athena_HidingProp_LandedOn_C_K2_ActivateAbilityFromEvent) == 0x000008, "Wrong alinment on GA_Athena_HidingProp_LandedOn_C_K2_ActivateAbilityFromEvent");
