...
public:
	...
	uint8                                         Pad_45A0[0x2];                                     // 0x000A(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFOscillator) == 0x000004, "Wrong alinment on FFOscillator");
...
static_assert(alignof(FVOscillator) == 0x000004, "Wrong alinment on FVOscillator");
...
static_assert(alignof(FROscillator) == 0x000004, "Wrong alinment on FROscillator");
...
static_assert(alignof(FPerlinNoiseShaker) == 0x000004, "Wrong alinment on FPerlinNoiseShaker");
...
public:
	...
	uint8                                         Pad_45A1[0x3];                                     // 0x0009(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWaveOscillator) == 0x000004, "Wrong alinment on FWaveOscillator");
