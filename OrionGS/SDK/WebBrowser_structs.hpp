...
{
public:
	uint8                                         Pad_53DA[0x20];                                    // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWebJSCallbackBase) == 0x000008, "Wrong alinment on FWebJSCallbackBase");
...
static_assert(alignof(FWebJSResponse) == 0x000008, "Wrong alinment on FWebJSResponse");
...
static_assert(alignof(FWebJSFunction) == 0x000008, "Wrong alinment on FWebJSFunction");
