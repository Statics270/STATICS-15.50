...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"StreamingRadioPlayerComponent_Valet">();
	}
...
static_assert(alignof(UStreamingRadioPlayerComponent_Valet) == 0x000008, "Wrong alinment on UStreamingRadioPlayerComponent_Valet");
