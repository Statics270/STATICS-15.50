...
public:
	...
	uint8                                         Pad_6C03[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(B_HeldObject_Parent_C_ExecuteUbergraph_B_HeldObject_Parent) == 0x000008, "Wrong alinment on B_HeldObject_Parent_C_ExecuteUbergraph_B_HeldObject_Parent");
...
static_assert(alignof(B_HeldObject_Parent_C_BlueprintOnInteract) == 0x000008, "Wrong alinment on B_HeldObject_Parent_C_BlueprintOnInteract");
...
static_assert(alignof(B_HeldObject_Parent_C_OnRep_IsHeld) == 0x000004, "Wrong alinment on B_HeldObject_Parent_C_OnRep_IsHeld");
...
static_assert(alignof(B_HeldObject_Parent_C_OnRep_IsSocketed) == 0x000001, "Wrong alinment on B_HeldObject_Parent_C_OnRep_IsSocketed");
...
static_assert(alignof(B_HeldObject_Parent_C_BlueprintCanInteract) == 0x000008, "Wrong alinment on B_HeldObject_Parent_C_BlueprintCanInteract");
...
public:
	class AFortPawn*                              InteractingPawn;                                   // 0x0000(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EInteractionBeingAttempted                    InteractionBeingAttempted;                         // 0x0008(0x0001)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_6C04[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   ReturnValue;                                       // 0x0010(0x0018)(Parm, OutParm, ReturnParm)
};
static_assert(alignof(B_HeldObject_Parent_C_BlueprintGetInteractionString) == 0x000008, "Wrong alinment on B_HeldObject_Parent_C_BlueprintGetInteractionString");
