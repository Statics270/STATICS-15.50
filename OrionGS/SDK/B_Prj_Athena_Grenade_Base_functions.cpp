...
// TDelegate<void(class AFortWaterBodyActor* WaterBody, class UFortWaterInteractionComponent* WaterInteractionComponent, bool bIsFirstBody)>K2Node_CreateDelegate_OutputDelegate_3                 (ZeroConstructor, NoDestructor)
...
void AB_Prj_Athena_Grenade_Base_C::GetExplosion(bool InWater, class UFXSystemAsset** FX_System, bool Temp_bool_Variable, class UFXSystemAsset* K2Node_Select_Default) const
{
	static class UFunction* Func = nullptr;
	...
	if (FX_System != nullptr)
		*FX_System = std::move(Parms.FX_System);
}
