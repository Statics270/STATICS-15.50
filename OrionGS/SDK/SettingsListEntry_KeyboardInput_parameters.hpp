...
public:
	...
	uint8                                         Pad_55BE[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_55BF[0x3];                                     // 0x0051(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x0054(0x0038)(IsPlainOldData, NoDestructor)
	uint8                                         Pad_55C0[0x4];                                     // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(SettingsListEntry_KeyboardInput_C_ExecuteUbergraph_SettingsListEntry_KeyboardInput) == 0x000008, "Wrong alinment on SettingsListEntry_KeyboardInput_C_ExecuteUbergraph_SettingsListEntry_KeyboardInput");
...
static_assert(alignof(SettingsListEntry_KeyboardInput_C_OnMouseLeave) == 0x000008, "Wrong alinment on SettingsListEntry_KeyboardInput_C_OnMouseLeave");
...
static_assert(alignof(SettingsListEntry_KeyboardInput_C_OnMouseEnter) == 0x000008, "Wrong alinment on SettingsListEntry_KeyboardInput_C_OnMouseEnter");
...
static_assert(alignof(SettingsListEntry_KeyboardInput_C_OnUpdateKeyText) == 0x000008, "Wrong alinment on SettingsListEntry_KeyboardInput_C_OnUpdateKeyText");
