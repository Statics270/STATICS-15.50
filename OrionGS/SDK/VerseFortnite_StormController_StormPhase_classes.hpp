...
public:
	...
	uint8                                         Pad_7622[0x3];                                     // 0x003D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"StormPhase">();
	}
...
static_assert(alignof(UStormPhase) == 0x000008, "Wrong alinment on UStormPhase");
