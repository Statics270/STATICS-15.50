...
public:
	...
	uint8                                         Pad_54E6[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayEventData                     K2Node_Event_EventData;                            // 0x0008(0x00B0)(ConstParm)
};
static_assert(alignof(GAT_TriggeredAbility_C_ExecuteUbergraph_GAT_TriggeredAbility) == 0x000008, "Wrong alinment on GAT_TriggeredAbility_C_ExecuteUbergraph_GAT_TriggeredAbility");
...
static_assert(alignof(GAT_TriggeredAbility_C_K2_ActivateAbilityFromEvent) == 0x000008, "Wrong alinment on GAT_TriggeredAbility_C_K2_ActivateAbilityFromEvent");
...
static_assert(alignof(GAT_TriggeredAbility_C_TriggeredAbilitySetup) == 0x000008, "Wrong alinment on GAT_TriggeredAbility_C_TriggeredAbilitySetup");
...
public:
	...
	uint8                                         Pad_54E7[0x1];                                     // 0x000F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GAT_TriggeredAbility_C_SetHolsterWeaponWithName) == 0x000008, "Wrong alinment on GAT_TriggeredAbility_C_SetHolsterWeaponWithName");
...
static_assert(alignof(GAT_TriggeredAbility_C_EndAbilityWithReason) == 0x000008, "Wrong alinment on GAT_TriggeredAbility_C_EndAbilityWithReason");
