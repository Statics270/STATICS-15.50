...
public:
	...
	uint8                                         Pad_4C[0x7];                                       // 0x0039(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortConversationContextCondition_DoesContextPass) == 0x000008, "Wrong alinment on FortConversationContextCondition_DoesContextPass");
...
public:
	...
	uint8                                         Pad_4D[0x7];                                       // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortConversationContextConditionHelpers_GetMessageForContext) == 0x000008, "Wrong alinment on FortConversationContextConditionHelpers_GetMessageForContext");
...
static_assert(alignof(FortPlayerConversationComponent_HandleWaponEquipped) == 0x000008, "Wrong alinment on FortPlayerConversationComponent_HandleWaponEquipped");
