...
public:
	...
	uint8                                         Pad_4E19[0x7];                                     // 0x0089(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayBehaviorManager">();
	}
...
static_assert(alignof(UGameplayBehaviorManager) == 0x000008, "Wrong alinment on UGameplayBehaviorManager");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"BTTask_StopGameplayBehavior">();
	}
...
static_assert(alignof(UBTTask_StopGameplayBehavior) == 0x000008, "Wrong alinment on UBTTask_StopGameplayBehavior");
...
{
public:
	uint8                                         Pad_4E1A[0x14];                                    // 0x0028(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E1B[0x1C];                                    // 0x0044(0x001C)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayBehavior">();
	}
...
static_assert(alignof(UGameplayBehavior) == 0x000008, "Wrong alinment on UGameplayBehavior");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayBehavior_AnimationBased">();
	}
...
static_assert(alignof(UGameplayBehavior_AnimationBased) == 0x000008, "Wrong alinment on UGameplayBehavior_AnimationBased");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayBehavior_BehaviorTree">();
	}
...
static_assert(alignof(UGameplayBehavior_BehaviorTree) == 0x000008, "Wrong alinment on UGameplayBehavior_BehaviorTree");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayBehaviorConfig">();
	}
...
static_assert(alignof(UGameplayBehaviorConfig) == 0x000008, "Wrong alinment on UGameplayBehaviorConfig");
...
public:
	...
	uint8                                         Pad_4E20[0x3];                                     // 0x0065(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayBehaviorConfig_Animation">();
	}
...
static_assert(alignof(UGameplayBehaviorConfig_Animation) == 0x000008, "Wrong alinment on UGameplayBehaviorConfig_Animation");
...
public:
	...
	uint8                                         Pad_4E21[0x7];                                     // 0x0059(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayBehaviorConfig_BehaviorTree">();
	}
...
static_assert(alignof(UGameplayBehaviorConfig_BehaviorTree) == 0x000008, "Wrong alinment on UGameplayBehaviorConfig_BehaviorTree");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayBehaviorsBlueprintFunctionLibrary">();
	}
...
static_assert(alignof(UGameplayBehaviorsBlueprintFunctionLibrary) == 0x000008, "Wrong alinment on UGameplayBehaviorsBlueprintFunctionLibrary");
