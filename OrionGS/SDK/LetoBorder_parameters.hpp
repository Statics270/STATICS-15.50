...
static_assert(alignof(LetoBorder_C_UpdateBorderWidth) == 0x000004, "Wrong alinment on LetoBorder_C_UpdateBorderWidth");
...
static_assert(alignof(LetoBorder_C_ExecuteUbergraph_LetoBorder) == 0x000004, "Wrong alinment on LetoBorder_C_ExecuteUbergraph_LetoBorder");
