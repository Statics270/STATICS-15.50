...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"VoteBroadcasterComponent">();
	}
...
static_assert(alignof(UVoteBroadcasterComponent) == 0x000008, "Wrong alinment on UVoteBroadcasterComponent");
...
{
public:
	uint8                                         Pad_4CA7[0x90];                                    // 0x0030(0x0090)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"VoteDispatchSubsystem">();
	}
...
static_assert(alignof(UVoteDispatchSubsystem) == 0x000008, "Wrong alinment on UVoteDispatchSubsystem");
...
{
public:
	uint8                                         Pad_4CA8[0x8];                                     // 0x0220(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"VoteInitiationActor">();
	}
...
static_assert(alignof(AVoteInitiationActor) == 0x000008, "Wrong alinment on AVoteInitiationActor");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"VoteListenerComponent">();
	}
...
static_assert(alignof(UVoteListenerComponent) == 0x000008, "Wrong alinment on UVoteListenerComponent");
...
public:
	...
	uint8                                         Pad_4CAE[0x7];                                     // 0x01A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"VoteResponderComponent">();
	}
...
static_assert(alignof(UVoteResponderComponent) == 0x000008, "Wrong alinment on UVoteResponderComponent");
