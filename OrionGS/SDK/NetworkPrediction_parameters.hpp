...
static_assert(alignof(NetworkPredictionComponent_ServerReceiveClientInput) == 0x000008, "Wrong alinment on NetworkPredictionComponent_ServerReceiveClientInput");
