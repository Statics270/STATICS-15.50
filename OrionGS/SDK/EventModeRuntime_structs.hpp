...
public:
	...
	uint8                                         Pad_4416[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FEventModeWidgetCachedData) == 0x000004, "Wrong alinment on FEventModeWidgetCachedData");
...
public:
	...
	uint8                                         Pad_4417[0x4];                                     // 0x003C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEventModeFocusActor) == 0x000008, "Wrong alinment on FEventModeFocusActor");
