...
public:
	...
	FMulticastInlineDelegateProperty_             Hovered;                                           // 0x0BD8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             Unhovered;                                         // 0x0BE8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(alignof(UEventPlayerStatProfileSelectorEntry_C) == 0x000008, "Wrong alinment on UEventPlayerStatProfileSelectorEntry_C");
