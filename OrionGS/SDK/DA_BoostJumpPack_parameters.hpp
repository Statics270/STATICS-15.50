...
public:
	...
	uint8                                         Pad_477E[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_477F[0x5];                                     // 0x0023(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  K2Node_Select_Default;                             // 0x0028(0x0020)(ConstParm)
};
static_assert(alignof(DA_BoostJumpPack_C_ExecuteUbergraph_DA_BoostJumpPack) == 0x000008, "Wrong alinment on DA_BoostJumpPack_C_ExecuteUbergraph_DA_BoostJumpPack");
...
static_assert(alignof(DA_BoostJumpPack_C_BPPressTrigger) == 0x000008, "Wrong alinment on DA_BoostJumpPack_C_BPPressTrigger");
...
static_assert(alignof(DA_BoostJumpPack_C_RaiseUsageError) == 0x000008, "Wrong alinment on DA_BoostJumpPack_C_RaiseUsageError");
...
static_assert(alignof(DA_BoostJumpPack_C_IsOnGround) == 0x000008, "Wrong alinment on DA_BoostJumpPack_C_IsOnGround");
