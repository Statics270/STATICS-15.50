...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"CableActor">();
	}
...
static_assert(alignof(ACableActor) == 0x000008, "Wrong alinment on ACableActor");
...
public:
	...
	uint8                                         Pad_4AF2[0x6];                                     // 0x0472(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4AF3[0x3];                                     // 0x04C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4AF4[0x14];                                    // 0x04EC(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"CableComponent">();
	}
...
static_assert(alignof(UCableComponent) == 0x000010, "Wrong alinment on UCableComponent");
