...
public:
	void ExecuteUbergraph_GA_Athena_RemoveIceFeetOnWater(int32 EntryPoint, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate, class UAbilityTask_WaitGameplayTagAdded* CallFunc_WaitGameplayTagAdd_ReturnValue, bool CallFunc_IsValid_ReturnValue);
...
static_assert(alignof(UGA_Athena_RemoveIceFeetOnWater_C) == 0x000008, "Wrong alinment on UGA_Athena_RemoveIceFeetOnWater_C");
