...
{
public:
	uint8                                         Pad_4CFA[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"PurchaseFlowJSBridge">();
	}
...
static_assert(alignof(UPurchaseFlowJSBridge) == 0x000008, "Wrong alinment on UPurchaseFlowJSBridge");
