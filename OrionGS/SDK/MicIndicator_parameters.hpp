...
static_assert(alignof(MicIndicator_C_ExecuteUbergraph_MicIndicator) == 0x000004, "Wrong alinment on MicIndicator_C_ExecuteUbergraph_MicIndicator");
...
static_assert(alignof(MicIndicator_C_OnPlayerMuted) == 0x000001, "Wrong alinment on MicIndicator_C_OnPlayerMuted");
...
static_assert(alignof(MicIndicator_C_OnPlayerTalkingChanged) == 0x000001, "Wrong alinment on MicIndicator_C_OnPlayerTalkingChanged");
