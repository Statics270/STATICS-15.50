...
static_assert(alignof(FSHAHashData) == 0x000001, "Wrong alinment on FSHAHashData");
...
static_assert(alignof(FChunkPartData) == 0x000004, "Wrong alinment on FChunkPartData");
...
public:
	...
	uint8                                         Pad_50FF[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5100[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5101[0x6];                                     // 0x0062(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFileManifestData) == 0x000008, "Wrong alinment on FFileManifestData");
...
public:
	...
	uint8                                         Pad_5103[0x7];                                     // 0x0039(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FChunkInfoData) == 0x000008, "Wrong alinment on FChunkInfoData");
...
static_assert(alignof(FCustomFieldData) == 0x000008, "Wrong alinment on FCustomFieldData");
