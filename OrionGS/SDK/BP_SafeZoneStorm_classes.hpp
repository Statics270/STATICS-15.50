...
public:
	...
	uint8                                         Pad_67F9[0x2];                                     // 0x037A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ABP_SafeZoneStorm_C) == 0x000008, "Wrong alinment on ABP_SafeZoneStorm_C");
