...
public:
	...
	class UWidgetAnimation*                       AnimMinusHover;                                    // 0x0300(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(UFortCosmeticItemCard_C) == 0x000008, "Wrong alinment on UFortCosmeticItemCard_C");
...
static_assert(offsetof(UFortCosmeticItemCard_C, AnimMinusHover) == 0x000300, "Member 'UFortCosmeticItemCard_C::AnimMinusHover' has a wrong offset!");
