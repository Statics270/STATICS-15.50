...
public:
	...
	uint8                                         Pad_787D[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Conv_IntToText_ReturnValue;               // 0x0020(0x0018)()
};
static_assert(alignof(EventScoreRow_C_SetData) == 0x000008, "Wrong alinment on EventScoreRow_C_SetData");
...
static_assert(alignof(EventScoreRow_C_PreConstruct) == 0x000001, "Wrong alinment on EventScoreRow_C_PreConstruct");
...
static_assert(alignof(EventScoreRow_C_ExecuteUbergraph_EventScoreRow) == 0x000004, "Wrong alinment on EventScoreRow_C_ExecuteUbergraph_EventScoreRow");
