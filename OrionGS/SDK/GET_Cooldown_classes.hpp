...
static_assert(alignof(UGET_Cooldown_C) == 0x000008, "Wrong alinment on UGET_Cooldown_C");
static_assert(sizeof(UGET_Cooldown_C) == 0x000800, "Wrong size on UGET_Cooldown_C");
