...
public:
	...
	uint8                                         Pad_54E0[0x3];                                     // 0x0009(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(B_PlayerHealthDamage_CameraLensEffect_C_ExecuteUbergraph_B_PlayerHealthDamage_CameraLensEffect) == 0x000004, "Wrong alinment on B_PlayerHealthDamage_CameraLensEffect_C_ExecuteUbergraph_B_PlayerHealthDamage_CameraLensEffect");
...
static_assert(alignof(B_PlayerHealthDamage_CameraLensEffect_C_PassParticle_Parameter) == 0x000004, "Wrong alinment on B_PlayerHealthDamage_CameraLensEffect_C_PassParticle_Parameter");
