...
public:
	...
	uint8                                         Pad_7CF5[0x4];                                     // 0x0B74(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UGA_FlintlockPistol_Knockback_C) == 0x000008, "Wrong alinment on UGA_FlintlockPistol_Knockback_C");
static_assert(sizeof(UGA_FlintlockPistol_Knockback_C) == 0x000C00, "Wrong size on UGA_FlintlockPistol_Knockback_C");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, UberGraphFrame) == 0x000AB8, "Member 'UGA_FlintlockPistol_Knockback_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, Distance) == 0x000AC0, "Member 'UGA_FlintlockPistol_Knockback_C::Distance' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, DistanceMagMod) == 0x000AC4, "Member 'UGA_FlintlockPistol_Knockback_C::DistanceMagMod' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, Row_ZAdd) == 0x000AC8, "Member 'UGA_FlintlockPistol_Knockback_C::Row_ZAdd' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, Row_KnockMag) == 0x000AF0, "Member 'UGA_FlintlockPistol_Knockback_C::Row_KnockMag' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, Row_MaxDistance) == 0x000B18, "Member 'UGA_FlintlockPistol_Knockback_C::Row_MaxDistance' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, Row_ResetFall) == 0x000B40, "Member 'UGA_FlintlockPistol_Knockback_C::Row_ResetFall' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, FinalLaunchVel) == 0x000B68, "Member 'UGA_FlintlockPistol_Knockback_C::FinalLaunchVel' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, Row_ZStartOffset) == 0x000B78, "Member 'UGA_FlintlockPistol_Knockback_C::Row_ZStartOffset' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, Row_ZVelMult) == 0x000BA0, "Member 'UGA_FlintlockPistol_Knockback_C::Row_ZVelMult' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, DefaultTags) == 0x000BC8, "Member 'UGA_FlintlockPistol_Knockback_C::DefaultTags' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, Launcher) == 0x000BE8, "Member 'UGA_FlintlockPistol_Knockback_C::Launcher' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, VelocityForFX) == 0x000BF0, "Member 'UGA_FlintlockPistol_Knockback_C::VelocityForFX' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, FX_Delay) == 0x000BF4, "Member 'UGA_FlintlockPistol_Knockback_C::FX_Delay' has a wrong offset!");
static_assert(offsetof(UGA_FlintlockPistol_Knockback_C, KnockbackCue) == 0x000BF8, "Member 'UGA_FlintlockPistol_Knockback_C::KnockbackCue' has a wrong offset!");
