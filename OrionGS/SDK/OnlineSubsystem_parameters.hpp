...
static_assert(alignof(TurnBasedMatchInterface_OnMatchEnded) == 0x000008, "Wrong alinment on TurnBasedMatchInterface_OnMatchEnded");
...
static_assert(alignof(TurnBasedMatchInterface_OnMatchReceivedTurn) == 0x000008, "Wrong alinment on TurnBasedMatchInterface_OnMatchReceivedTurn");
