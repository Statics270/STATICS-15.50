...
static_assert(alignof(ADefaultEditingTool_C) == 0x000008, "Wrong alinment on ADefaultEditingTool_C");
static_assert(sizeof(ADefaultEditingTool_C) == 0x000D70, "Wrong size on ADefaultEditingTool_C");
