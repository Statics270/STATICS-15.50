...
{
public:
	uint8                                         Pad_4595[0xA0];                                    // 0x0000(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4596[0x8];                                     // 0x00A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNetworkPredictionProxy) == 0x000010, "Wrong alinment on FNetworkPredictionProxy");
...
static_assert(alignof(FSharedPackageMapItem) == 0x000008, "Wrong alinment on FSharedPackageMapItem");
...
static_assert(alignof(FSharedPackageMap) == 0x000008, "Wrong alinment on FSharedPackageMap");
...
{
public:
	uint8                                         Pad_4597[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FServerReplicationRPCParameter) == 0x000008, "Wrong alinment on FServerReplicationRPCParameter");
...
{
public:
	uint8                                         Pad_4598[0x50];                                    // 0x0000(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FReplicationProxy) == 0x000010, "Wrong alinment on FReplicationProxy");
...
public:
	...
	uint8                                         Pad_4599[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_459A[0x2];                                     // 0x0016(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_459B[0x4];                                     // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNetworkPredictionSettings) == 0x000008, "Wrong alinment on FNetworkPredictionSettings");
