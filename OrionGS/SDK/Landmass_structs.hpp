...
static_assert(alignof(FBrushEffectBlurring) == 0x000004, "Wrong alinment on FBrushEffectBlurring");
...
static_assert(alignof(FBrushEffectCurlNoise) == 0x000004, "Wrong alinment on FBrushEffectCurlNoise");
...
static_assert(alignof(FBrushEffectDisplacement) == 0x000008, "Wrong alinment on FBrushEffectDisplacement");
...
static_assert(alignof(FBrushEffectSmoothBlending) == 0x000004, "Wrong alinment on FBrushEffectSmoothBlending");
...
static_assert(alignof(FBrushEffectTerracing) == 0x000004, "Wrong alinment on FBrushEffectTerracing");
...
public:
	...
	uint8                                         Pad_534E[0x4];                                     // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLandmassBrushEffectsList) == 0x000008, "Wrong alinment on FLandmassBrushEffectsList");
...
public:
	...
	uint8                                         Pad_5350[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBrushEffectCurves) == 0x000008, "Wrong alinment on FBrushEffectCurves");
...
public:
	...
	uint8                                         Pad_5351[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FLandmassFalloffSettings) == 0x000004, "Wrong alinment on FLandmassFalloffSettings");
...
public:
	...
	uint8                                         Pad_5352[0x2];                                     // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5353[0x4];                                     // 0x007C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLandmassTerrainCarvingSettings) == 0x000008, "Wrong alinment on FLandmassTerrainCarvingSettings");
