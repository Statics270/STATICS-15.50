...
static_assert(alignof(Fringe_Plank_AnimBP_C_ExecuteUbergraph_Fringe_Plank_AnimBP) == 0x000004, "Wrong alinment on Fringe_Plank_AnimBP_C_ExecuteUbergraph_Fringe_Plank_AnimBP");
...
static_assert(alignof(Fringe_Plank_AnimBP_C_AnimGraph) == 0x000008, "Wrong alinment on Fringe_Plank_AnimBP_C_AnimGraph");
...
static_assert(offsetof(Fringe_Plank_AnimBP_C_AnimGraph, Param_AnimGraph) == 0x000010, "Member 'Fringe_Plank_AnimBP_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
