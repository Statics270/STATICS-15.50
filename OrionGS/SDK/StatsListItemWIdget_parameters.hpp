...
static_assert(alignof(StatsListItemWIdget_C_Initial_Reset) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_Initial_Reset");
...
static_assert(alignof(StatsListItemWIdget_C_PopulateMinusUpdate) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_PopulateMinusUpdate");
...
public:
	...
	uint8                                         Pad_5BA3[0x5];                                     // 0x0003(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(StatsListItemWIdget_C_SetTextAndBorderHighlight) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_SetTextAndBorderHighlight");
...
public:
	...
	uint8                                         Pad_5BA4[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5BA5[0x7];                                     // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(StatsListItemWIdget_C_GetListItemTooltipWidget) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_GetListItemTooltipWidget");
...
static_assert(alignof(StatsListItemWIdget_C_SetStatIcon) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_SetStatIcon");
...
public:
	...
	uint8                                         Pad_5BA6[0x3];                                     // 0x0121(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5BA7[0x3];                                     // 0x0135(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5BA8[0x1];                                     // 0x0143(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         K2Node_Select_Default_3;                           // 0x0144(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(StatsListItemWIdget_C_UpdateBuffArrows) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_UpdateBuffArrows");
...
static_assert(alignof(StatsListItemWIdget_C_UpdateBasicPairLabel) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_UpdateBasicPairLabel");
...
static_assert(alignof(StatsListItemWIdget_C_UpdateValueText) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_UpdateValueText");
...
public:
	...
	uint8                                         Pad_5BA9[0x7];                                     // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(StatsListItemWIdget_C_UpdateType) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_UpdateType");
...
public:
	...
	uint8                                         Pad_5BAA[0x6];                                     // 0x014A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5BAB[0x1];                                     // 0x017B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5BAC[0x4];                                     // 0x018C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(StatsListItemWIdget_C_UpdateColors) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_UpdateColors");
...
static_assert(alignof(StatsListItemWIdget_C_Update) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_Update");
...
static_assert(alignof(StatsListItemWIdget_C_ValueChanged) == 0x000004, "Wrong alinment on StatsListItemWIdget_C_ValueChanged");
...
static_assert(alignof(StatsListItemWIdget_C_ExecuteUbergraph_StatsListItemWIdget) == 0x000008, "Wrong alinment on StatsListItemWIdget_C_ExecuteUbergraph_StatsListItemWIdget");
