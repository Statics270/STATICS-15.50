...
static_assert(alignof(FortGameFrameworkComponent_EventMode_OnPlayerPawnPossessed) == 0x000008, "Wrong alinment on FortGameFrameworkComponent_EventMode_OnPlayerPawnPossessed");
...
static_assert(alignof(FortGameFrameworkComponent_EventMode_GetIsEventModeActive) == 0x000001, "Wrong alinment on FortGameFrameworkComponent_EventMode_GetIsEventModeActive");
...
static_assert(alignof(FortGameFrameworkComponent_EventMode_GetIsFocusAvailable) == 0x000001, "Wrong alinment on FortGameFrameworkComponent_EventMode_GetIsFocusAvailable");
...
static_assert(alignof(FortGameFrameworkComponent_EventMode_GetIsFocusing) == 0x000001, "Wrong alinment on FortGameFrameworkComponent_EventMode_GetIsFocusing");
