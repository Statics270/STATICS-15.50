...
static_assert(alignof(FDataAssetDirectoryTestSimpleStruct) == 0x000004, "Wrong alinment on FDataAssetDirectoryTestSimpleStruct");
...
public:
	...
	uint8                                         Pad_4808[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FDataAssetDirectoryTestPODStruct) == 0x000008, "Wrong alinment on FDataAssetDirectoryTestPODStruct");
