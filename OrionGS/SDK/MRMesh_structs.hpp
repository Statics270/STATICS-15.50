...
{
public:
	uint8                                         Pad_5099[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMRMeshConfiguration) == 0x000001, "Wrong alinment on FMRMeshConfiguration");
