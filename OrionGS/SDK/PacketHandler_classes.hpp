...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"HandlerComponentFactory">();
	}
...
static_assert(alignof(UHandlerComponentFactory) == 0x000008, "Wrong alinment on UHandlerComponentFactory");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"PacketHandlerProfileConfig">();
	}
...
static_assert(alignof(UPacketHandlerProfileConfig) == 0x000008, "Wrong alinment on UPacketHandlerProfileConfig");
