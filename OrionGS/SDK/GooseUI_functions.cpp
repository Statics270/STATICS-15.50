...
// Parameters:
// TArray<struct FGooseLeaderboardData>    SortedLeaderboardInfo                                  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UGoosePlanePickupWidget::OpenWidget(int32 DisplayIndex, class FName ChestName, class FText& DisplayText)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// int32                                   DisplayIndex                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FGooseWeaponDisplayData          InDisplayData                                          (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// float                                   StartTime                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UGoosePlaneWeaponWidget::OpenWidget(int32 DisplayIndex, struct FGooseWeaponDisplayData& InDisplayData, float StartTime)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// TArray<class AFortAthenaVehicle*>       Planes                                                 (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Function GooseUI.GooseTargetLeadingWidget.UpdateAimAtLocation
// (Final, Native, Private)

void UGooseTargetLeadingWidget::UpdateAimAtLocation()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GooseTargetLeadingWidget", "UpdateAimAtLocation");
