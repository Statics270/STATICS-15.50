...
public:
	...
	uint8                                         Pad_4ECE[0x7];                                     // 0x0379(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnEnteredChat;                                     // 0x0380(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(alignof(UAthenaChatWidget_C) == 0x000008, "Wrong alinment on UAthenaChatWidget_C");
