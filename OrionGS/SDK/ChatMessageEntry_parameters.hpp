...
public:
	...
	uint8                                         Pad_4F6A[0x2];                                     // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ChatMessageEntry_C_HandleSelectionStatusChanged) == 0x000004, "Wrong alinment on ChatMessageEntry_C_HandleSelectionStatusChanged");
...
static_assert(alignof(ChatMessageEntry_C_OnFocusedChanged) == 0x000001, "Wrong alinment on ChatMessageEntry_C_OnFocusedChanged");
...
static_assert(alignof(ChatMessageEntry_C_ExecuteUbergraph_ChatMessageEntry) == 0x000004, "Wrong alinment on ChatMessageEntry_C_ExecuteUbergraph_ChatMessageEntry");
