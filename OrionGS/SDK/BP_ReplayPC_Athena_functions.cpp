...
// EHudVisibilityState                     Temp_byte_Variable                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// TArray<class USoundMix*>                CallFunc_Map_Values_Values                             (ReferenceParm, HasGetValueTypeHash)
...
// EHudVisibilityState                     K2Node_CustomEvent_IsVisible                           (ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// TDelegate<void(EHudVisibilityState IsVisible)>K2Node_CreateDelegate_OutputDelegate                   (ZeroConstructor, NoDestructor)
...
// TDelegate<void(bool bPaused)>           K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor)
...
void ABP_ReplayPC_Athena_C::UserConstructionScript(class UAthenaMarkerComponent* CallFunc_GetMarkerComponent_ReturnValue)
{
	...
	Params::BP_ReplayPC_Athena_C_UserConstructionScript Parms{};
...
void ABP_ReplayPC_Athena_C::IsGameplayCamera(bool* Param_IsGameplayCamera, bool NewLocalVar_0, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_IsGameplayCamera != nullptr)
		*Param_IsGameplayCamera = std::move(Parms.Param_IsGameplayCamera);
}
