...
static_assert(alignof(UButtonStyleMinusEmpty_C) == 0x000008, "Wrong alinment on UButtonStyleMinusEmpty_C");
static_assert(sizeof(UButtonStyleMinusEmpty_C) == 0x000570, "Wrong size on UButtonStyleMinusEmpty_C");
