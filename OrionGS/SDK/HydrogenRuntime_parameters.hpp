...
static_assert(alignof(FortAthenaMutator_Hydrogen_AddBonusVictoryPointsForLockedCapturePoints) == 0x000001, "Wrong alinment on FortAthenaMutator_Hydrogen_AddBonusVictoryPointsForLockedCapturePoints");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_CheckVictoryPoints) == 0x000004, "Wrong alinment on FortAthenaMutator_Hydrogen_CheckVictoryPoints");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_EndGame) == 0x000001, "Wrong alinment on FortAthenaMutator_Hydrogen_EndGame");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_GetActorOnPathLocation) == 0x000004, "Wrong alinment on FortAthenaMutator_Hydrogen_GetActorOnPathLocation");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_GetNextActorOnPathLocation) == 0x000004, "Wrong alinment on FortAthenaMutator_Hydrogen_GetNextActorOnPathLocation");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_GetOwnedCapturePointCount) == 0x000004, "Wrong alinment on FortAthenaMutator_Hydrogen_GetOwnedCapturePointCount");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_GetTimeToNextNode) == 0x000004, "Wrong alinment on FortAthenaMutator_Hydrogen_GetTimeToNextNode");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_GiveObjectiveAccolade) == 0x000008, "Wrong alinment on FortAthenaMutator_Hydrogen_GiveObjectiveAccolade");
...
public:
	...
	uint8                                         Pad_4699[0x6];                                     // 0x000A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Hydrogen_OwningTeamChange) == 0x000008, "Wrong alinment on FortAthenaMutator_Hydrogen_OwningTeamChange");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_SetupSafeZoneRoute) == 0x000004, "Wrong alinment on FortAthenaMutator_Hydrogen_SetupSafeZoneRoute");
...
public:
	...
	uint8                                         Pad_469A[0x3];                                     // 0x0005(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Hydrogen_TickHydrogenStormShield) == 0x000004, "Wrong alinment on FortAthenaMutator_Hydrogen_TickHydrogenStormShield");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_bHasStormStarted) == 0x000001, "Wrong alinment on FortAthenaMutator_Hydrogen_bHasStormStarted");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_bHasWinnerBeenDeclared) == 0x000001, "Wrong alinment on FortAthenaMutator_Hydrogen_bHasWinnerBeenDeclared");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_GetAllCapturePoints) == 0x000008, "Wrong alinment on FortAthenaMutator_Hydrogen_GetAllCapturePoints");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_GetSortedActivePointIndices) == 0x000008, "Wrong alinment on FortAthenaMutator_Hydrogen_GetSortedActivePointIndices");
...
static_assert(alignof(FortAthenaMutator_Hydrogen_GetStormSpeed) == 0x000004, "Wrong alinment on FortAthenaMutator_Hydrogen_GetStormSpeed");
...
public:
	...
	uint8                                         Pad_469B[0x3];                                     // 0x000D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Hydrogen_IsInStormShield) == 0x000004, "Wrong alinment on FortAthenaMutator_Hydrogen_IsInStormShield");
...
public:
	...
	uint8                                         Pad_469C[0x7];                                     // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAthenaMutator_Hydrogen_SetCapturePointFillAmount) == 0x000008, "Wrong alinment on FortAthenaMutator_Hydrogen_SetCapturePointFillAmount");
...
static_assert(alignof(HydrogenObjectiveActor_OnComponentBeginOverlap) == 0x000008, "Wrong alinment on HydrogenObjectiveActor_OnComponentBeginOverlap");
...
public:
	...
	uint8                                         Pad_46A7[0x3];                                     // 0x001D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_46A8[0x4];                                     // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(HydrogenObjectiveActor_OnOverlapBegin) == 0x000008, "Wrong alinment on HydrogenObjectiveActor_OnOverlapBegin");
...
static_assert(alignof(HydrogenObjectiveActor_OnTimelineFlashing) == 0x000004, "Wrong alinment on HydrogenObjectiveActor_OnTimelineFlashing");
...
static_assert(alignof(HydrogenObjectiveActor_ProcessOverlap) == 0x000008, "Wrong alinment on HydrogenObjectiveActor_ProcessOverlap");
...
static_assert(alignof(HydrogenObjectiveActor_SetActive) == 0x000001, "Wrong alinment on HydrogenObjectiveActor_SetActive");
...
static_assert(alignof(HydrogenObjectiveActor_SetUpMaterialInstanceDynamic) == 0x000008, "Wrong alinment on HydrogenObjectiveActor_SetUpMaterialInstanceDynamic");
...
static_assert(alignof(HydrogenObjectiveActor_GetIsActive) == 0x000001, "Wrong alinment on HydrogenObjectiveActor_GetIsActive");
