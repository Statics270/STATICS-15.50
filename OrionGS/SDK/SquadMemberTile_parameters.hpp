...
public:
	...
	uint8                                         Pad_74C4[0x6];                                     // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_74C5[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_74C6[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_74C7[0x7];                                     // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(SquadMemberTile_C_SetVisuals) == 0x000008, "Wrong alinment on SquadMemberTile_C_SetVisuals");
...
static_assert(alignof(SquadMemberTile_C_SetEmptyVisuals) == 0x000008, "Wrong alinment on SquadMemberTile_C_SetEmptyVisuals");
...
static_assert(alignof(SquadMemberTile_C_SetSitOutVisuals) == 0x000008, "Wrong alinment on SquadMemberTile_C_SetSitOutVisuals");
...
static_assert(alignof(SquadMemberTile_C_SetReadyVisuals) == 0x000008, "Wrong alinment on SquadMemberTile_C_SetReadyVisuals");
...
static_assert(alignof(SquadMemberTile_C_SetNotReadyVisuals) == 0x000008, "Wrong alinment on SquadMemberTile_C_SetNotReadyVisuals");
...
static_assert(alignof(SquadMemberTile_C_OnLoaded_A3B69DDA4214DBAA66546FAB9F43D5E7) == 0x000008, "Wrong alinment on SquadMemberTile_C_OnLoaded_A3B69DDA4214DBAA66546FAB9F43D5E7");
...
static_assert(alignof(SquadMemberTile_C_PreConstruct) == 0x000001, "Wrong alinment on SquadMemberTile_C_PreConstruct");
...
static_assert(alignof(SquadMemberTile_C_OnMemberGameReadinessChanged) == 0x000001, "Wrong alinment on SquadMemberTile_C_OnMemberGameReadinessChanged");
...
static_assert(alignof(SquadMemberTile_C_BP_OnTeamMemberEstablished) == 0x000001, "Wrong alinment on SquadMemberTile_C_BP_OnTeamMemberEstablished");
...
static_assert(alignof(SquadMemberTile_C_OnMemberIsInFrontendChanged) == 0x000001, "Wrong alinment on SquadMemberTile_C_OnMemberIsInFrontendChanged");
...
public:
	...
	uint8                                         Pad_74C8[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_74C9[0x4];                                     // 0x00B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_74CA[0x3];                                     // 0x00E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile) == 0x000008, "Wrong alinment on SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile");
