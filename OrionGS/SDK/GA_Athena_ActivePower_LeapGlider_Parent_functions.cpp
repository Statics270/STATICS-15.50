...
// TDelegate<void(class UFortWorldItem* ItemDropped)>K2Node_CreateDelegate_OutputDelegate_2                 (ZeroConstructor, NoDestructor)
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::InitAbility(bool CallFunc_IsValidClass_ReturnValue, class AEmitterCameraLensEffectBase* CallFunc_SpawnCameraLensEffect_ReturnValue)
{
	...
	Params::GA_Athena_ActivePower_LeapGlider_Parent_C_InitAbility Parms{};
