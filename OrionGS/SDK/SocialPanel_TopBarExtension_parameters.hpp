...
public:
	...
	uint8                                         Pad_5E22[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue;                // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue_1;              // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(SocialPanel_TopBarExtension_C_ExecuteUbergraph_SocialPanel_TopBarExtension) == 0x000008, "Wrong alinment on SocialPanel_TopBarExtension_C_ExecuteUbergraph_SocialPanel_TopBarExtension");
