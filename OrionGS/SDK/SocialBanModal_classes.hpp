...
public:
	...
	FMulticastInlineDelegateProperty_             OnCloseSucceeded;                                  // 0x04E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(alignof(USocialBanModal_C) == 0x000008, "Wrong alinment on USocialBanModal_C");
