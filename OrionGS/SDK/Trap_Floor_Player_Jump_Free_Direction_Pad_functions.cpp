...
// TArray<class AActor*>                   LocalTouching                                          (Edit, BlueprintVisible, DisableEditOnTemplate, HasGetValueTypeHash)

bool ATrap_Floor_Player_Jump_Free_Direction_Pad_C::BP_ShouldTrigger(TArray<class AActor*>& TouchingActors, const TArray<class AActor*>& LocalTouching) const
{
	static class UFunction* Func = nullptr;
	...
	Parms.LocalTouching = std::move(LocalTouching);
