...
{
public:
	uint8                                         Pad_63A3[0x3];                                     // 0x01B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UQuartzMusicTrackComponent_Cosmos_C) == 0x000008, "Wrong alinment on UQuartzMusicTrackComponent_Cosmos_C");
