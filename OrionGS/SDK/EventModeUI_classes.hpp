...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FocusButton">();
	}
...
static_assert(alignof(UFocusButton) == 0x000008, "Wrong alinment on UFocusButton");
...
public:
	...
	uint8                                         Pad_441B[0x8];                                     // 0x0350(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortEventModeEmotesWidget">();
	}
...
static_assert(alignof(UFortEventModeEmotesWidget) == 0x000008, "Wrong alinment on UFortEventModeEmotesWidget");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortMobileActionButtonBehavior_Focus">();
	}
...
static_assert(alignof(UFortMobileActionButtonBehavior_Focus) == 0x000008, "Wrong alinment on UFortMobileActionButtonBehavior_Focus");
