...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"NetworkPredictionComponent">();
	}
...
static_assert(alignof(UNetworkPredictionComponent) == 0x000010, "Wrong alinment on UNetworkPredictionComponent");
...
public:
	...
	uint8                                         Pad_459C[0x8];                                     // 0x0168(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FReplicationProxy                      ReplicationProxy;                                  // 0x0170(0x0050)(Net, Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_459D[0x10];                                    // 0x01C0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"NetworkPredictionPhysicsComponent">();
	}
...
static_assert(alignof(UNetworkPredictionPhysicsComponent) == 0x000010, "Wrong alinment on UNetworkPredictionPhysicsComponent");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"NetworkPredictionReplicatedManager">();
	}
...
static_assert(alignof(ANetworkPredictionReplicatedManager) == 0x000008, "Wrong alinment on ANetworkPredictionReplicatedManager");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"NetworkPredictionSettingsObject">();
	}
...
static_assert(alignof(UNetworkPredictionSettingsObject) == 0x000008, "Wrong alinment on UNetworkPredictionSettingsObject");
...
public:
	...
	uint8                                         Pad_459E[0x630];                                   // 0x0038(0x0630)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"NetworkPredictionWorldManager">();
	}
...
static_assert(alignof(UNetworkPredictionWorldManager) == 0x000008, "Wrong alinment on UNetworkPredictionWorldManager");
