...
public:
	...
	uint8                                         Pad_67D7[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ItemPreviewPedestal_C_Remove_Floor) == 0x000008, "Wrong alinment on ItemPreviewPedestal_C_Remove_Floor");
...
static_assert(alignof(ItemPreviewPedestal_C_OnItemDisplayed) == 0x000001, "Wrong alinment on ItemPreviewPedestal_C_OnItemDisplayed");
...
static_assert(alignof(ItemPreviewPedestal_C_ExecuteUbergraph_ItemPreviewPedestal) == 0x000004, "Wrong alinment on ItemPreviewPedestal_C_ExecuteUbergraph_ItemPreviewPedestal");
