...
public:
	...
	uint8                                         Pad_78C0[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ItemCount_C_SetBrushAndTextStyle) == 0x000008, "Wrong alinment on ItemCount_C_SetBrushAndTextStyle");
...
static_assert(alignof(ItemCount_C_UpdateOverrideState) == 0x000001, "Wrong alinment on ItemCount_C_UpdateOverrideState");
...
static_assert(alignof(ItemCount_C_SetOverrideValue) == 0x000004, "Wrong alinment on ItemCount_C_SetOverrideValue");
...
static_assert(alignof(ItemCount_C_SetIsBeingPreviewed) == 0x000001, "Wrong alinment on ItemCount_C_SetIsBeingPreviewed");
...
static_assert(alignof(ItemCount_C_SetItemDefinition) == 0x000008, "Wrong alinment on ItemCount_C_SetItemDefinition");
...
static_assert(alignof(ItemCount_C_PreConstruct) == 0x000001, "Wrong alinment on ItemCount_C_PreConstruct");
...
static_assert(alignof(ItemCount_C_ExecuteUbergraph_ItemCount) == 0x000008, "Wrong alinment on ItemCount_C_ExecuteUbergraph_ItemCount");
