...
public:
	...
	uint8                                         Pad_6193[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue;                // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(RebootVanIndicator_C_ExecuteUbergraph_RebootVanIndicator) == 0x000008, "Wrong alinment on RebootVanIndicator_C_ExecuteUbergraph_RebootVanIndicator");
