...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"NiagaraMergeable">();
	}
...
static_assert(alignof(UNiagaraMergeable) == 0x000008, "Wrong alinment on UNiagaraMergeable");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"NiagaraDataInterfaceBase">();
	}
...
static_assert(alignof(UNiagaraDataInterfaceBase) == 0x000008, "Wrong alinment on UNiagaraDataInterfaceBase");
