...
public:
	...
	uint8                                         Pad_78DB[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(CosmeticLoadoutSelector_C_ExecuteUbergraph_CosmeticLoadoutSelector) == 0x000008, "Wrong alinment on CosmeticLoadoutSelector_C_ExecuteUbergraph_CosmeticLoadoutSelector");
...
static_assert(alignof(CosmeticLoadoutSelector_C_OnNumLoadoutsFound) == 0x000004, "Wrong alinment on CosmeticLoadoutSelector_C_OnNumLoadoutsFound");
...
static_assert(alignof(CosmeticLoadoutSelector_C_OnLoadoutSet) == 0x000004, "Wrong alinment on CosmeticLoadoutSelector_C_OnLoadoutSet");
