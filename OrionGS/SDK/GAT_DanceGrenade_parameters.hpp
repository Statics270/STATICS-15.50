...
static_assert(alignof(GAT_DanceGrenade_C_ExecuteUbergraph_GAT_DanceGrenade) == 0x000004, "Wrong alinment on GAT_DanceGrenade_C_ExecuteUbergraph_GAT_DanceGrenade");
