...
static_assert(alignof(FTargetingTaskSet) == 0x000008, "Wrong alinment on FTargetingTaskSet");
...
{
public:
	uint8                                         Pad_4BF4[0x4];                                     // 0x0000(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTargetingRequestHandle) == 0x000004, "Wrong alinment on FTargetingRequestHandle");
...
{
public:
	uint8                                         Pad_4BF5[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTargetingDebugData) == 0x000001, "Wrong alinment on FTargetingDebugData");
...
{
public:
	uint8                                         Pad_4BF6[0x8];                                     // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTargetingAsyncTaskData) == 0x000004, "Wrong alinment on FTargetingAsyncTaskData");
...
{
public:
	uint8                                         Pad_4BF7[0x18];                                    // 0x0000(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FTargetingRequestData) == 0x000008, "Wrong alinment on FTargetingRequestData");
...
public:
	...
	uint8                                         Pad_4BF8[0x4];                                     // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTargetingSourceContext) == 0x000008, "Wrong alinment on FTargetingSourceContext");
...
public:
	...
	uint8                                         Pad_4BF9[0x4];                                     // 0x008C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTargetingDefaultResultData) == 0x000004, "Wrong alinment on FTargetingDefaultResultData");
...
static_assert(alignof(FTargetingDefaultResultsSet) == 0x000008, "Wrong alinment on FTargetingDefaultResultsSet");
