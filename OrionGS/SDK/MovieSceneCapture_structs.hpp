...
static_assert(alignof(FCompositionGraphCapturePasses) == 0x000008, "Wrong alinment on FCompositionGraphCapturePasses");
...
static_assert(alignof(FFrameMetrics) == 0x000004, "Wrong alinment on FFrameMetrics");
...
static_assert(alignof(FCaptureResolution) == 0x000004, "Wrong alinment on FCaptureResolution");
...
public:
	...
	uint8                                         Pad_4EA9[0x2];                                     // 0x002A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4EAA[0x3];                                     // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4EAB[0x3];                                     // 0x004D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4EAC[0x4];                                     // 0x006C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneCaptureSettings) == 0x000008, "Wrong alinment on FMovieSceneCaptureSettings");
...
{
public:
	uint8                                         Pad_4EAD[0x10];                                    // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCapturedPixels) == 0x000008, "Wrong alinment on FCapturedPixels");
...
static_assert(alignof(FCapturedPixelsID) == 0x000008, "Wrong alinment on FCapturedPixelsID");
