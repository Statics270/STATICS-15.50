...
public:
	...
	uint8                                         Pad_5B85[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5B86[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5B87[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Conv_IntToText_ReturnValue;               // 0x0030(0x0018)()
};
static_assert(alignof(NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper) == 0x000008, "Wrong alinment on NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper");
...
public:
	...
	uint8                                         Pad_5B88[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(NormalBangWrapper_C_OnBangStateChanged) == 0x000004, "Wrong alinment on NormalBangWrapper_C_OnBangStateChanged");
...
static_assert(alignof(NormalBangWrapper_C_PreConstruct) == 0x000001, "Wrong alinment on NormalBangWrapper_C_PreConstruct");
...
static_assert(alignof(NormalBangWrapper_C_OnStartCallout) == 0x000004, "Wrong alinment on NormalBangWrapper_C_OnStartCallout");
...
static_assert(alignof(NormalBangWrapper_C_SetTutorialBorderStyle) == 0x000008, "Wrong alinment on NormalBangWrapper_C_SetTutorialBorderStyle");
...
public:
	...
	bool                                          Temp_bool_Variable;                                // 0x000C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_5B89[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5B8A[0x1];                                     // 0x001B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(NormalBangWrapper_C_Update_Bang_Icon_Version) == 0x000004, "Wrong alinment on NormalBangWrapper_C_Update_Bang_Icon_Version");
...
static_assert(alignof(NormalBangWrapper_C_Adjust_Bang_Image_Translation) == 0x000004, "Wrong alinment on NormalBangWrapper_C_Adjust_Bang_Image_Translation");
...
static_assert(alignof(NormalBangWrapper_C_TriggerIntro) == 0x000008, "Wrong alinment on NormalBangWrapper_C_TriggerIntro");
...
static_assert(alignof(NormalBangWrapper_C_InitialReset) == 0x000008, "Wrong alinment on NormalBangWrapper_C_InitialReset");
...
static_assert(alignof(NormalBangWrapper_C_SetShouldSuppressBang) == 0x000001, "Wrong alinment on NormalBangWrapper_C_SetShouldSuppressBang");
