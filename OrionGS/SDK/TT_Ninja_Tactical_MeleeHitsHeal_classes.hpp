...
{
public:
	void InitializeAbilityInstanceInternal(class UGameplayAbility* AbilityInstance, class UFortTooltipContext* Context, class UGA_Ninja_Tactical_MeleeHitsHeal_C* K2Node_DynamicCast_AsGA_Ninja_Tactical_Melee_Hits_Heal, bool K2Node_DynamicCast_bSuccess) const;
...
static_assert(alignof(UTT_Ninja_Tactical_MeleeHitsHeal_C) == 0x000008, "Wrong alinment on UTT_Ninja_Tactical_MeleeHitsHeal_C");
