...
{
public:
	uint8                                         Pad_72C2[0x3];                                     // 0x01B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UQuartzMusicTrackComponent_SpicySake_C) == 0x000008, "Wrong alinment on UQuartzMusicTrackComponent_SpicySake_C");
