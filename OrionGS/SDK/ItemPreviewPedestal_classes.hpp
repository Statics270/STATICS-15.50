...
public:
	...
	void ExecuteUbergraph_ItemPreviewPedestal(int32 EntryPoint, EFortItemType K2Node_Event_ItemType);
...
static_assert(alignof(AItemPreviewPedestal_C) == 0x000008, "Wrong alinment on AItemPreviewPedestal_C");
