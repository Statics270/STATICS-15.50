...
public:
	...
	uint8                                         Pad_4787[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FMcpLootEntry) == 0x000008, "Wrong alinment on FMcpLootEntry");
...
{
public:
	uint8                                         Pad_4788[0x80];                                    // 0x0000(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBaseUrlContext) == 0x000010, "Wrong alinment on FBaseUrlContext");
...
static_assert(alignof(FGiftBoxInfo) == 0x000008, "Wrong alinment on FGiftBoxInfo");
...
public:
	...
	uint8                                         Pad_4789[0x4];                                     // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FProfileUpdateSingle) == 0x000008, "Wrong alinment on FProfileUpdateSingle");
...
static_assert(alignof(FMcpAddItemRequest) == 0x000008, "Wrong alinment on FMcpAddItemRequest");
...
static_assert(alignof(FMcpRemoveItemRequest) == 0x000008, "Wrong alinment on FMcpRemoveItemRequest");
...
public:
	...
	uint8                                         Pad_478B[0x4];                                     // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMcpChangeQuantityRequest) == 0x000008, "Wrong alinment on FMcpChangeQuantityRequest");
...
static_assert(alignof(FMcpChangeAttributesRequest) == 0x000008, "Wrong alinment on FMcpChangeAttributesRequest");
...
public:
	...
	uint8                                         Pad_478C[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FMcpProfileChangeRequest) == 0x000008, "Wrong alinment on FMcpProfileChangeRequest");
...
static_assert(alignof(FMcpItemIdAndQuantity) == 0x000008, "Wrong alinment on FMcpItemIdAndQuantity");
...
static_assert(alignof(FClientUrlContext) == 0x000010, "Wrong alinment on FClientUrlContext");
...
static_assert(alignof(FDedicatedServerUrlContext) == 0x000010, "Wrong alinment on FDedicatedServerUrlContext");
...
static_assert(alignof(FPublicUrlContext) == 0x000010, "Wrong alinment on FPublicUrlContext");
...
{
public:
	uint8                                         Pad_478D[0x18];                                    // 0x0000(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FProfileGroupEntry) == 0x000008, "Wrong alinment on FProfileGroupEntry");
...
public:
	...
	uint8                                         Pad_478E[0x6];                                     // 0x001A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FProfileEntry) == 0x000008, "Wrong alinment on FProfileEntry");
...
public:
	...
	uint8                                         Pad_478F[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int64                                         Revision;                                          // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FProfileUpdateNotification) == 0x000008, "Wrong alinment on FProfileUpdateNotification");
...
public:
	...
	uint8                                         Pad_4790[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FProfileUpdate) == 0x000008, "Wrong alinment on FProfileUpdate");
...
static_assert(alignof(FAccountIdAndProfileResponse) == 0x000008, "Wrong alinment on FAccountIdAndProfileResponse");
...
static_assert(alignof(FMcpLootResult) == 0x000008, "Wrong alinment on FMcpLootResult");
