...
public:
	...
	uint8                                         Pad_585E[0x7];                                     // 0x0259(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void IsEnabledForCurrentSubgame(bool* bEnabled, ESubGame CallFunc_GetSubGame_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue);
...
static_assert(alignof(ATVPostProcessBPAthena_C) == 0x000008, "Wrong alinment on ATVPostProcessBPAthena_C");
