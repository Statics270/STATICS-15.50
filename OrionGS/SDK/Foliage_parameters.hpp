...
static_assert(alignof(FoliageStatistics_FoliageOverlappingBoxCount) == 0x000008, "Wrong alinment on FoliageStatistics_FoliageOverlappingBoxCount");
...
public:
	...
	uint8                                         Pad_5037[0x4];                                     // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FoliageStatistics_FoliageOverlappingSphereCount) == 0x000008, "Wrong alinment on FoliageStatistics_FoliageOverlappingSphereCount");
...
public:
	...
	uint8                                         Pad_503B[0x3];                                     // 0x001D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_503C[0x4];                                     // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(InteractiveFoliageActor_CapsuleTouched) == 0x000008, "Wrong alinment on InteractiveFoliageActor_CapsuleTouched");
...
static_assert(alignof(ProceduralFoliageSpawner_Simulate) == 0x000004, "Wrong alinment on ProceduralFoliageSpawner_Simulate");
