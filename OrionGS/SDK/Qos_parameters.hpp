...
static_assert(alignof(QosBeaconClient_ClientQosResponse) == 0x000001, "Wrong alinment on QosBeaconClient_ClientQosResponse");
...
static_assert(alignof(QosBeaconClient_ServerQosRequest) == 0x000008, "Wrong alinment on QosBeaconClient_ServerQosRequest");
