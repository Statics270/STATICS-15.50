...
static_assert(alignof(FFortDagwoodDerived) == 0x000008, "Wrong alinment on FFortDagwoodDerived");
...
static_assert(alignof(FVehicleAttachment) == 0x000008, "Wrong alinment on FVehicleAttachment");
...
public:
	...
	uint8                                         Pad_449E[0x3];                                     // 0x0019(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortDagwoodCmd) == 0x000004, "Wrong alinment on FFortDagwoodCmd");
...
{
public:
	struct FWeaponSeatDefinition                  SeatDefinition;                                    // 0x0000(0x0030)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	class USkeletalMesh*                          SkeletalMesh;                                      // 0x0030(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UAnimInstance>              AnimInstanceWeapon;                                // 0x0038(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SocketNameMuzzle;                                  // 0x0040(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SocketNameWeaponPawnAttach;                        // 0x0048(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_449F[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          bHasApplied;                                       // 0x0068(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_44A0[0x7];                                     // 0x0069(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMountedGun) == 0x000008, "Wrong alinment on FMountedGun");
static_assert(sizeof(FMountedGun) == 0x000070, "Wrong size on FMountedGun");
static_assert(offsetof(FMountedGun, SeatDefinition) == 0x000000, "Member 'FMountedGun::SeatDefinition' has a wrong offset!");
static_assert(offsetof(FMountedGun, SkeletalMesh) == 0x000030, "Member 'FMountedGun::SkeletalMesh' has a wrong offset!");
static_assert(offsetof(FMountedGun, AnimInstanceWeapon) == 0x000038, "Member 'FMountedGun::AnimInstanceWeapon' has a wrong offset!");
static_assert(offsetof(FMountedGun, SocketNameMuzzle) == 0x000040, "Member 'FMountedGun::SocketNameMuzzle' has a wrong offset!");
static_assert(offsetof(FMountedGun, SocketNameWeaponPawnAttach) == 0x000048, "Member 'FMountedGun::SocketNameWeaponPawnAttach' has a wrong offset!");
...
static_assert(offsetof(FMountedGun, bHasApplied) == 0x000068, "Member 'FMountedGun::bHasApplied' has a wrong offset!");
...
static_assert(alignof(FRuntimeTerrainHandlingInfo) == 0x000004, "Wrong alinment on FRuntimeTerrainHandlingInfo");
...
// 0x0124 (0x01A8 - 0x0084)
struct alignas(0x08) FFortDagwoodAux final  : public FVehicleSimAux
{
public:
	uint8                                         Pad_44A1[0x124];                                   // 0x0084(0x0124)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortDagwoodAux) == 0x000008, "Wrong alinment on FFortDagwoodAux");
static_assert(sizeof(FFortDagwoodAux) == 0x0001A8, "Wrong size on FFortDagwoodAux");
...
static_assert(alignof(FCachedWaterData) == 0x000004, "Wrong alinment on FCachedWaterData");
...
static_assert(alignof(FRuntimeSpringsInfo) == 0x000004, "Wrong alinment on FRuntimeSpringsInfo");
...
public:
	...
	uint8                                         Pad_44A2[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_44A3[0x4];                                     // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTireInfo) == 0x000010, "Wrong alinment on FTireInfo");
...
public:
	...
	uint8                                         Pad_44A4[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FRuntimeBoostInfo) == 0x000004, "Wrong alinment on FRuntimeBoostInfo");
...
static_assert(alignof(FRuntimeFuelInfo) == 0x000004, "Wrong alinment on FRuntimeFuelInfo");
...
static_assert(alignof(FRuntimeGearInfo) == 0x000004, "Wrong alinment on FRuntimeGearInfo");
...
public:
	...
	uint8                                         DataVersion;                                       // 0x0050(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_44A5[0x7];                                     // 0x0051(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVehicleRuntimeModifiers) == 0x000008, "Wrong alinment on FVehicleRuntimeModifiers");
static_assert(sizeof(FVehicleRuntimeModifiers) == 0x000058, "Wrong size on FVehicleRuntimeModifiers");
...
static_assert(offsetof(FVehicleRuntimeModifiers, DataVersion) == 0x000050, "Member 'FVehicleRuntimeModifiers::DataVersion' has a wrong offset!");
...
static_assert(alignof(FTireSimulationRuntimeData) == 0x000004, "Wrong alinment on FTireSimulationRuntimeData");
...
{
public:
	uint8                                         Pad_44A6[0x14];                                    // 0x0000(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FValetUpdateContext) == 0x000004, "Wrong alinment on FValetUpdateContext");
...
static_assert(alignof(FVehiclePropReplacementData) == 0x000008, "Wrong alinment on FVehiclePropReplacementData");
