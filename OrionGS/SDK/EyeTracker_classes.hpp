...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"EyeTrackerFunctionLibrary">();
	}
...
static_assert(alignof(UEyeTrackerFunctionLibrary) == 0x000008, "Wrong alinment on UEyeTrackerFunctionLibrary");
