...
static_assert(alignof(TabMouseAndKeyboardOptions_New_C_ExecuteUbergraph_TabMouseAndKeyboardOptions_New) == 0x000004, "Wrong alinment on TabMouseAndKeyboardOptions_New_C_ExecuteUbergraph_TabMouseAndKeyboardOptions_New");
...
static_assert(alignof(TabMouseAndKeyboardOptions_New_C_SettingValueChanged) == 0x000004, "Wrong alinment on TabMouseAndKeyboardOptions_New_C_SettingValueChanged");
