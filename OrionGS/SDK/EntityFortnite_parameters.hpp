...
static_assert(alignof(EntityFortniteStormSpawner_Start) == 0x000008, "Wrong alinment on EntityFortniteStormSpawner_Start");
...
static_assert(alignof(EntityFortniteStormSpawner_Exists) == 0x000001, "Wrong alinment on EntityFortniteStormSpawner_Exists");
