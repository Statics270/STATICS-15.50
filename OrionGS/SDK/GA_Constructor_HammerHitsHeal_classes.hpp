...
public:
	void ExecuteUbergraph_GA_Constructor_HammerHitsHeal(int32 EntryPoint, struct FGameplayEventData& K2Node_Event_EventData);
	...
	bool K2_ShouldAbilityRespondToEvent(const struct FGameplayAbilityActorInfo& ActorInfo, const struct FGameplayEventData& Payload, bool CallFunc_ShouldHammerHitsHealRespondToEvent_ReturnValue) const;
...
static_assert(alignof(UGA_Constructor_HammerHitsHeal_C) == 0x000008, "Wrong alinment on UGA_Constructor_HammerHitsHeal_C");
