...
public:
	...
	uint8                                         Pad_4DFC[0x7];                                     // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ResonanceAudioSoundfieldSettings">();
	}
...
static_assert(alignof(UResonanceAudioSoundfieldSettings) == 0x000008, "Wrong alinment on UResonanceAudioSoundfieldSettings");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ResonanceAudioBlueprintFunctionLibrary">();
	}
...
static_assert(alignof(UResonanceAudioBlueprintFunctionLibrary) == 0x000008, "Wrong alinment on UResonanceAudioBlueprintFunctionLibrary");
...
{
public:
	uint8                                         Pad_4DFD[0x70];                                    // 0x0220(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ResonanceAudioDirectivityVisualizer">();
	}
...
static_assert(alignof(AResonanceAudioDirectivityVisualizer) == 0x000008, "Wrong alinment on AResonanceAudioDirectivityVisualizer");
...
{
public:
	uint8                                         Pad_4DFE[0x78];                                    // 0x0068(0x0078)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ResonanceAudioReverbPluginPreset">();
	}
...
static_assert(alignof(UResonanceAudioReverbPluginPreset) == 0x000010, "Wrong alinment on UResonanceAudioReverbPluginPreset");
...
public:
	...
	uint8                                         Pad_4DFF[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ResonanceAudioSettings">();
	}
...
static_assert(alignof(UResonanceAudioSettings) == 0x000008, "Wrong alinment on UResonanceAudioSettings");
...
public:
	...
	uint8                                         Pad_4E01[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E02[0x3];                                     // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E03[0x4];                                     // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"ResonanceAudioSpatializationSourceSettings">();
	}
...
static_assert(alignof(UResonanceAudioSpatializationSourceSettings) == 0x000008, "Wrong alinment on UResonanceAudioSpatializationSourceSettings");
