...
public:
	...
	uint8                                         Pad_4410[0x1B];                                    // 0x0065(0x001B)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4411[0x3];                                     // 0x0081(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4412[0x4];                                     // 0x008C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AnimNotify_PlayNiagaraEffect">();
	}
...
static_assert(alignof(UAnimNotify_PlayNiagaraEffect) == 0x000010, "Wrong alinment on UAnimNotify_PlayNiagaraEffect");
...
public:
	...
	uint8                                         Pad_4413[0x7];                                     // 0x0059(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AnimNotifyState_TimedNiagaraEffect">();
	}
...
static_assert(alignof(UAnimNotifyState_TimedNiagaraEffect) == 0x000008, "Wrong alinment on UAnimNotifyState_TimedNiagaraEffect");
...
{
public:
	uint8                                         Pad_4414[0x50];                                    // 0x0060(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AnimNotifyState_TimedNiagaraEffectAdvanced">();
	}
...
static_assert(alignof(UAnimNotifyState_TimedNiagaraEffectAdvanced) == 0x000008, "Wrong alinment on UAnimNotifyState_TimedNiagaraEffectAdvanced");
