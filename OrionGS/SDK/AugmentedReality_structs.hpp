...
static_assert(alignof(FARSharedWorldReplicationState) == 0x000004, "Wrong alinment on FARSharedWorldReplicationState");
...
public:
	...
	uint8                                         Pad_50A1[0xB];                                     // 0x0005(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_50A2[0x18];                                    // 0x0048(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FARTraceResult) == 0x000010, "Wrong alinment on FARTraceResult");
...
static_assert(alignof(FARSkeletonDefinition) == 0x000008, "Wrong alinment on FARSkeletonDefinition");
...
public:
	...
	uint8                                         Pad_50A4[0x7];                                     // 0x0049(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FARPose3D) == 0x000008, "Wrong alinment on FARPose3D");
...
static_assert(alignof(FARPose2D) == 0x000008, "Wrong alinment on FARPose2D");
...
static_assert(alignof(FARVideoFormat) == 0x000004, "Wrong alinment on FARVideoFormat");
...
public:
	...
	uint8                                         Pad_50A5[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FARSessionStatus) == 0x000008, "Wrong alinment on FARSessionStatus");
