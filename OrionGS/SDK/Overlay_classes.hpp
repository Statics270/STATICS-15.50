...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Overlays">();
	}
...
static_assert(alignof(UOverlays) == 0x000008, "Wrong alinment on UOverlays");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"LocalizedOverlays">();
	}
...
static_assert(alignof(ULocalizedOverlays) == 0x000008, "Wrong alinment on ULocalizedOverlays");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"BasicOverlays">();
	}
...
static_assert(alignof(UBasicOverlays) == 0x000008, "Wrong alinment on UBasicOverlays");
