...
void ICustomLocomotionLayerInterface_C::CustomLocomotionFullBodyAdditive(const struct FPoseLink& InPoseFullBodyAdditive, struct FPoseLink* Param_CustomLocomotionFullBodyAdditive)
{
	static class UFunction* Func = nullptr;
