...
public:
	...
	uint8                                         Pad_4664[0x7];                                     // 0x0021(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGooseLeaderboardData) == 0x000008, "Wrong alinment on FGooseLeaderboardData");
...
static_assert(alignof(FGoosePickupDisplayData) == 0x000008, "Wrong alinment on FGoosePickupDisplayData");
...
static_assert(alignof(FGooseWeaponDisplayData) == 0x000008, "Wrong alinment on FGooseWeaponDisplayData");
