...
{
public:
	uint8                                         Pad_547B[0x8];                                     // 0x07D8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ALoginCamera_Blueprint_C) == 0x000010, "Wrong alinment on ALoginCamera_Blueprint_C");
