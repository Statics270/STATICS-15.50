...
public:
	...
	uint8                                         Pad_539A[0x1];                                     // 0x0001(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_539B[0x1];                                     // 0x0011(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FStructSerializerNumericTestStruct) == 0x000008, "Wrong alinment on FStructSerializerNumericTestStruct");
...
static_assert(alignof(FStructSerializerBooleanTestStruct) == 0x000001, "Wrong alinment on FStructSerializerBooleanTestStruct");
...
static_assert(alignof(FStructSerializerObjectTestStruct) == 0x000008, "Wrong alinment on FStructSerializerObjectTestStruct");
...
public:
	...
	uint8                                         Pad_539D[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_539E[0x4];                                     // 0x006C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_539F[0xC];                                     // 0x0084(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FStructSerializerBuiltinTestStruct) == 0x000010, "Wrong alinment on FStructSerializerBuiltinTestStruct");
...
static_assert(alignof(FStructSerializerArrayTestStruct) == 0x000008, "Wrong alinment on FStructSerializerArrayTestStruct");
...
static_assert(alignof(FStructSerializerMapTestStruct) == 0x000008, "Wrong alinment on FStructSerializerMapTestStruct");
...
static_assert(alignof(FStructSerializerSetTestStruct) == 0x000008, "Wrong alinment on FStructSerializerSetTestStruct");
...
public:
	...
	uint8                                         Pad_53A1[0x5];                                     // 0x0033(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FStructSerializerObjectTestStruct      Objects;                                           // 0x0038(0x00A0)(NativeAccessSpecifierPublic)
	uint8                                         Pad_53A2[0x8];                                     // 0x00D8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FStructSerializerTestStruct) == 0x000010, "Wrong alinment on FStructSerializerTestStruct");
...
public:
	...
	uint8                                         Pad_53A3[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_53A5[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FStructSerializerByteArray) == 0x000008, "Wrong alinment on FStructSerializerByteArray");
