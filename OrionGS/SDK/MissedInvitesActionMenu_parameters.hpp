...
static_assert(alignof(MissedInvitesActionMenu_C_ExecuteUbergraph_MissedInvitesActionMenu) == 0x000008, "Wrong alinment on MissedInvitesActionMenu_C_ExecuteUbergraph_MissedInvitesActionMenu");
...
public:
	...
	uint8                                         Pad_5F3C[0x7];                                     // 0x01F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEventReply                            CallFunc_Handled_ReturnValue;                      // 0x0200(0x00B8)()
};
static_assert(alignof(MissedInvitesActionMenu_C_OnKeyUp) == 0x000008, "Wrong alinment on MissedInvitesActionMenu_C_OnKeyUp");
