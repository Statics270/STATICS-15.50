...
public:
	...
	uint8                                         Pad_7C40[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(TournamentModal_C_ExecuteUbergraph_TournamentModal) == 0x000008, "Wrong alinment on TournamentModal_C_ExecuteUbergraph_TournamentModal");
...
static_assert(alignof(TournamentModal_C_OnTournamentSet) == 0x000004, "Wrong alinment on TournamentModal_C_OnTournamentSet");
