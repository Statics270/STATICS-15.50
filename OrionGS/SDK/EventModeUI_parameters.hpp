...
static_assert(alignof(FocusButton_HandleCanUseEventModeFocusChanged) == 0x000001, "Wrong alinment on FocusButton_HandleCanUseEventModeFocusChanged");
...
static_assert(alignof(FocusButton_HandleEventModeFocusingChanged) == 0x000001, "Wrong alinment on FocusButton_HandleEventModeFocusingChanged");
...
static_assert(alignof(FortEventModeEmotesWidget_OnFocusAvailableChanged) == 0x000001, "Wrong alinment on FortEventModeEmotesWidget_OnFocusAvailableChanged");
...
static_assert(alignof(FortEventModeEmotesWidget_OnFocusStateChanged) == 0x000001, "Wrong alinment on FortEventModeEmotesWidget_OnFocusStateChanged");
...
static_assert(alignof(FortMobileActionButtonBehavior_Focus_HandleCanUseEventModeFocusChanged) == 0x000001, "Wrong alinment on FortMobileActionButtonBehavior_Focus_HandleCanUseEventModeFocusChanged");
...
static_assert(alignof(FortMobileActionButtonBehavior_Focus_HandleEventModeFocusingChanged) == 0x000001, "Wrong alinment on FortMobileActionButtonBehavior_Focus_HandleEventModeFocusingChanged");
