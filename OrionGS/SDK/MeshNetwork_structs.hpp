...
static_assert(alignof(FNoAggregationParameters) == 0x000008, "Wrong alinment on FNoAggregationParameters");
...
public:
	...
	uint8                                         Pad_4BC8[0x20];                                    // 0x0008(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAggregatedFunction) == 0x000008, "Wrong alinment on FAggregatedFunction");
...
{
public:
	uint8                                         Pad_4BC9[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMeshMetaDataStruct) == 0x000001, "Wrong alinment on FMeshMetaDataStruct");
