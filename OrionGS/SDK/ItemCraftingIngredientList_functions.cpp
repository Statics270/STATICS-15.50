...
// TDelegate<void(EFortCraftFailCause FailureCause)>K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor)
...
// TDelegate<void(TArray<class UFortWorldItem*>& ItemsAdded, TArray<class UFortWorldItem*>& ItemsRemoved)>K2Node_CreateDelegate_OutputDelegate_4                 (ZeroConstructor, NoDestructor)
...
void UItemCraftingIngredientList_C::Bind_Delegates(class UFortInventoryContext* CallFunc_GetContext_ReturnValue, class UFortInventoryContext* CallFunc_GetContext_ReturnValue_1, TDelegate<void(bool bItemChanged, bool bAmmoChanged, bool bIngredientsChanged)> K2Node_CreateDelegate_OutputDelegate, TDelegate<void(EFortCraftFailCause FailureCause)> K2Node_CreateDelegate_OutputDelegate_1, class UFortInventoryContext* CallFunc_GetContext_ReturnValue_2, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_2, class UFortInventoryContext* CallFunc_GetContext_ReturnValue_3, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_3, bool CallFunc_IsValid_ReturnValue, TDelegate<void(TArray<class UFortWorldItem*>& ItemsAdded, TArray<class UFortWorldItem*>& ItemsRemoved)> K2Node_CreateDelegate_OutputDelegate_4)
{
	...
	Params::ItemCraftingIngredientList_C_Bind_Delegates Parms{};
...
void UItemCraftingIngredientList_C::UnbindDelegates(class UFortInventoryContext* CallFunc_GetContext_ReturnValue, TDelegate<void(bool bItemChanged, bool bAmmoChanged, bool bIngredientsChanged)> K2Node_CreateDelegate_OutputDelegate, TDelegate<void(EFortCraftFailCause FailureCause)> K2Node_CreateDelegate_OutputDelegate_1, class UFortInventoryContext* CallFunc_GetContext_ReturnValue_1, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_2, class UFortInventoryContext* CallFunc_GetContext_ReturnValue_2, class UFortInventoryContext* CallFunc_GetContext_ReturnValue_3, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_3, bool CallFunc_IsValid_ReturnValue, TDelegate<void(TArray<class UFortWorldItem*>& ItemsAdded, TArray<class UFortWorldItem*>& ItemsRemoved)> K2Node_CreateDelegate_OutputDelegate_4)
{
	...
	Params::ItemCraftingIngredientList_C_UnbindDelegates Parms{};
...
// TArray<struct FFortItemQuantityPair>    Ingredients                                            (Edit, BlueprintVisible, HasGetValueTypeHash)
...
// TArray<struct FFortItemQuantityPair>    CallFunc_GetIngredients_ReturnIngredients              (ReferenceParm, HasGetValueTypeHash)
...
void UItemCraftingIngredientList_C::ItemNeedsInventoryTracking(class UFortItem* Item, bool* NeedsTracking, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	...
	if (NeedsTracking != nullptr)
		*NeedsTracking = std::move(Parms.NeedsTracking);
}
