...
static_assert(alignof(EventTeamMatchHistoryModal_C_Set_Up_Match_History_Style) == 0x000008, "Wrong alinment on EventTeamMatchHistoryModal_C_Set_Up_Match_History_Style");
...
static_assert(alignof(EventTeamMatchHistoryModal_C_BndEvt__CloseMainPanel_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature) == 0x000008, "Wrong alinment on EventTeamMatchHistoryModal_C_BndEvt__CloseMainPanel_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
static_assert(alignof(EventTeamMatchHistoryModal_C_OnSetupMatchHistory) == 0x000008, "Wrong alinment on EventTeamMatchHistoryModal_C_OnSetupMatchHistory");
...
static_assert(alignof(EventTeamMatchHistoryModal_C_ExecuteUbergraph_EventTeamMatchHistoryModal) == 0x000008, "Wrong alinment on EventTeamMatchHistoryModal_C_ExecuteUbergraph_EventTeamMatchHistoryModal");
