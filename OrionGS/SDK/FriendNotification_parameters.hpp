...
static_assert(alignof(FriendNotification_C_ExecuteUbergraph_FriendNotification) == 0x000004, "Wrong alinment on FriendNotification_C_ExecuteUbergraph_FriendNotification");
