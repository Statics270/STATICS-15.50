...
static_assert(alignof(FActiveGameplayStateData) == 0x000008, "Wrong alinment on FActiveGameplayStateData");
...
static_assert(alignof(FGameplayStateTransition) == 0x000008, "Wrong alinment on FGameplayStateTransition");
...
static_assert(alignof(FGameplayStateSettings) == 0x000008, "Wrong alinment on FGameplayStateSettings");
...
{
public:
	uint8                                         Pad_4C09[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FGameplayStateMachineItem) == 0x000008, "Wrong alinment on FGameplayStateMachineItem");
...
static_assert(alignof(FGameplayStateMachineArray) == 0x000008, "Wrong alinment on FGameplayStateMachineArray");
...
public:
	...
	uint8                                         Pad_4C0A[0xB0];                                    // 0x0008(0x00B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayStateMachineData) == 0x000008, "Wrong alinment on FGameplayStateMachineData");
