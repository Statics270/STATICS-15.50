...
static_assert(alignof(FMediaCaptureDevice) == 0x000008, "Wrong alinment on FMediaCaptureDevice");
...
static_assert(alignof(FMediaSoundComponentSpectralData) == 0x000004, "Wrong alinment on FMediaSoundComponentSpectralData");
