...
static_assert(alignof(AthenaStatsRow_C_SetStatValueAsText) == 0x000008, "Wrong alinment on AthenaStatsRow_C_SetStatValueAsText");
...
static_assert(alignof(AthenaStatsRow_C_PreConstruct) == 0x000001, "Wrong alinment on AthenaStatsRow_C_PreConstruct");
...
static_assert(alignof(AthenaStatsRow_C_ExecuteUbergraph_AthenaStatsRow) == 0x000004, "Wrong alinment on AthenaStatsRow_C_ExecuteUbergraph_AthenaStatsRow");
