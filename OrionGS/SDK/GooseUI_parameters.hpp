...
public:
	...
	class UFortWorldItemDefinition*               ItemDef;                                           // 0x0008(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GooseInventoryWidget_OpenWidget) == 0x000008, "Wrong alinment on GooseInventoryWidget_OpenWidget");
...
static_assert(alignof(GooseWidgetBase_OnUpdateNumberOfPlanes) == 0x000004, "Wrong alinment on GooseWidgetBase_OnUpdateNumberOfPlanes");
...
static_assert(alignof(GooseLeaderboardWidget_UpdateLeaderboardUI) == 0x000008, "Wrong alinment on GooseLeaderboardWidget_UpdateLeaderboardUI");
...
public:
	...
	uint8                                         Pad_466A[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   DisplayText;                                       // 0x0010(0x0018)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(GoosePlanePickupWidget_OpenWidget) == 0x000008, "Wrong alinment on GoosePlanePickupWidget_OpenWidget");
...
static_assert(alignof(GoosePlaneWeaponWidget_OpenWidget) == 0x000008, "Wrong alinment on GoosePlaneWeaponWidget_OpenWidget");
...
static_assert(alignof(GooseRadarIconWidget_OnNewIconState) == 0x000001, "Wrong alinment on GooseRadarIconWidget_OnNewIconState");
...
static_assert(alignof(GooseRadarWidgetBase_OnPlaneRep) == 0x000008, "Wrong alinment on GooseRadarWidgetBase_OnPlaneRep");
...
static_assert(alignof(GooseTargetLeadingWidget_OnPlayerControllerPawnChanged) == 0x000008, "Wrong alinment on GooseTargetLeadingWidget_OnPlayerControllerPawnChanged");
...
static_assert(alignof(GooseTargetLeadingWidget_OnPlayerWeaponChanged) == 0x000008, "Wrong alinment on GooseTargetLeadingWidget_OnPlayerWeaponChanged");
...
static_assert(alignof(GooseTargetLeadingWidget_ShowLeadingReticle) == 0x000001, "Wrong alinment on GooseTargetLeadingWidget_ShowLeadingReticle");
...
static_assert(alignof(GooseTargetLeadingWidget_UpdateLeadingReticlePosition) == 0x000004, "Wrong alinment on GooseTargetLeadingWidget_UpdateLeadingReticlePosition");
