...
public:
	...
	uint8                                         Pad_5258[0x10];                                    // 0x0010(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FJsonObjectWrapper) == 0x000008, "Wrong alinment on FJsonObjectWrapper");
