...
static_assert(alignof(UButtonStyleMinusTextOnlyBase_SMinusB_C) == 0x000008, "Wrong alinment on UButtonStyleMinusTextOnlyBase_SMinusB_C");
static_assert(sizeof(UButtonStyleMinusTextOnlyBase_SMinusB_C) == 0x000570, "Wrong size on UButtonStyleMinusTextOnlyBase_SMinusB_C");
