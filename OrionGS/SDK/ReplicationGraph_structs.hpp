...
static_assert(alignof(FConnectionAlwaysRelevantNodePair) == 0x000008, "Wrong alinment on FConnectionAlwaysRelevantNodePair");
...
static_assert(alignof(FLastLocationGatherInfo) == 0x000008, "Wrong alinment on FLastLocationGatherInfo");
...
{
public:
	uint8                                         Pad_4BDD[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4BDE[0x8];                                     // 0x0010(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTearOffActorInfo) == 0x000008, "Wrong alinment on FTearOffActorInfo");
...
static_assert(alignof(FAlwaysRelevantActorInfo) == 0x000008, "Wrong alinment on FAlwaysRelevantActorInfo");
...
public:
	...
	uint8                                         Pad_4BDF[0x56];                                    // 0x0012(0x0056)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FClassReplicationInfo) == 0x000010, "Wrong alinment on FClassReplicationInfo");
