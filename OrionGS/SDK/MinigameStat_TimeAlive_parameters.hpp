...
public:
	...
	uint8                                         Pad_6BCB[0x1];                                     // 0x0013(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(MinigameStat_TimeAlive_C_Compare) == 0x000004, "Wrong alinment on MinigameStat_TimeAlive_C_Compare");
