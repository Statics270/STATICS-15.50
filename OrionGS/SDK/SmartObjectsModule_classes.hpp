...
{
public:
	static bool K2_AddLooseGameplayTags(class AActor* Actor, struct FGameplayTagContainer& GameplayTags);
	static bool K2_RemoveLooseGameplayTags(class AActor* Actor, struct FGameplayTagContainer& GameplayTags);
	static bool K2_SetSmartObjectEnabled(class AActor* SmartObject, bool bEnabled);
	static bool K2_UseSmartObject(class AActor* Avatar, class AActor* SmartObject);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SmartObjectBlueprintFunctionLibrary">();
	}
...
static_assert(alignof(USmartObjectBlueprintFunctionLibrary) == 0x000008, "Wrong alinment on USmartObjectBlueprintFunctionLibrary");
...
public:
	...
	uint8                                         Pad_4E0D[0x20];                                    // 0x0090(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AITask_UseSmartObject">();
	}
...
static_assert(alignof(UAITask_UseSmartObject) == 0x000008, "Wrong alinment on UAITask_UseSmartObject");
...
public:
	...
	uint8                                         Pad_4E0F[0x4];                                     // 0x00BC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"BTTask_FindAndUseSmartObject">();
	}
...
static_assert(alignof(UBTTask_FindAndUseSmartObject) == 0x000008, "Wrong alinment on UBTTask_FindAndUseSmartObject");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"BTTask_UseSmartObject">();
	}
...
static_assert(alignof(UBTTask_UseSmartObject) == 0x000008, "Wrong alinment on UBTTask_UseSmartObject");
...
{
public:
	uint8                                         Pad_4E10[0x8];                                     // 0x0220(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GenericSmartObject">();
	}
...
static_assert(alignof(AGenericSmartObject) == 0x000008, "Wrong alinment on AGenericSmartObject");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"RichSmartObjectInterface">();
	}
...
static_assert(alignof(IRichSmartObjectInterface) == 0x000008, "Wrong alinment on IRichSmartObjectInterface");
...
{
public:
	uint8                                         Pad_4E11[0x8];                                     // 0x00B0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E12[0xF];                                     // 0x00F9(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SmartObjectComponent">();
	}
...
static_assert(alignof(USmartObjectComponent) == 0x000008, "Wrong alinment on USmartObjectComponent");
...
public:
	...
	uint8                                         Pad_4E13[0x4];                                     // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SmartObjectConfig">();
	}
...
static_assert(alignof(USmartObjectConfig) == 0x000008, "Wrong alinment on USmartObjectConfig");
...
public:
	...
	uint8                                         Pad_4E14[0xA8];                                    // 0x0078(0x00A8)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_86 : 1;                                     // 0x0120(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	...
	uint8                                         Pad_4E15[0x3];                                     // 0x0121(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E16[0x8];                                     // 0x0128(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SmartObjectManager">();
	}
...
static_assert(alignof(USmartObjectManager) == 0x000010, "Wrong alinment on USmartObjectManager");
...
public:
	...
	uint8                                         Pad_4E17[0x7];                                     // 0x0449(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SmartObjectRenderingComponent">();
	}
...
static_assert(alignof(USmartObjectRenderingComponent) == 0x000010, "Wrong alinment on USmartObjectRenderingComponent");
