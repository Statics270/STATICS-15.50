...
public:
	...
	uint8                                         Pad_4CB0[0x3];                                     // 0x000D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FProcMeshTangent) == 0x000004, "Wrong alinment on FProcMeshTangent");
...
static_assert(alignof(FProcMeshVertex) == 0x000004, "Wrong alinment on FProcMeshVertex");
...
public:
	...
	uint8                                         Pad_4CB1[0x2];                                     // 0x003E(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FProcMeshSection) == 0x000008, "Wrong alinment on FProcMeshSection");
