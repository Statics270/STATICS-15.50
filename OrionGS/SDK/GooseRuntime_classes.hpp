...
// 0x0258 (0x0A28 - 0x07D0)
class AAthenaGoosePickup final  : public ABuildingGameplayActor
{
public:
	EGoosePickupState                             PickupState;                                       // 0x07D0(0x0001)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsDespawning;                                     // 0x07D1(0x0001)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4646[0x6];                                     // 0x07D2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         DeployedLifetime;                                  // 0x07D8(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         DespawnWarningTime;                                // 0x0800(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         InStormLifetime;                                   // 0x0828(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         DropGravityScale;                                  // 0x0850(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	int32                                         DisplayIndex;                                      // 0x0878(0x0004)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4647[0xC];                                     // 0x087C(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, TSubclassOf<class UGameplayEffect>> Loot_To_Health_GE_Map;                             // 0x0888(0x0050)(Edit, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TMap<class FName, TSubclassOf<class UGameplayEffect>> Loot_To_Boost_GE_Map;                              // 0x08D8(0x0050)(Edit, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TMap<class FName, TSubclassOf<class UGameplayEffect>> Loot_To_Passengers_GE_Map;                         // 0x0928(0x0050)(Edit, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TMap<class FName, TSubclassOf<class UGameplayEffect>> Loot_to_Driver_GE_Map;                             // 0x0978(0x0050)(Edit, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class FName                                   ForcedLootTableName;                               // 0x09C8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FGooseDisplayData>              DisplayData;                                       // 0x09D0(0x0010)(Edit, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4648[0x8];                                     // 0x09E0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DeployHeight;                                      // 0x09E8(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4649[0x3C];                                    // 0x09EC(0x003C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetStaticMesh(class UStaticMesh* NewStaticMesh, TArray<class UMaterialInterface*>& MaterialsToSwap, int32 InDisplayIndex);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AthenaGoosePickup">();
	}
...
static_assert(alignof(AAthenaGoosePickup) == 0x000008, "Wrong alinment on AAthenaGoosePickup");
static_assert(sizeof(AAthenaGoosePickup) == 0x000A28, "Wrong size on AAthenaGoosePickup");
static_assert(offsetof(AAthenaGoosePickup, PickupState) == 0x0007D0, "Member 'AAthenaGoosePickup::PickupState' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, bIsDespawning) == 0x0007D1, "Member 'AAthenaGoosePickup::bIsDespawning' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, DeployedLifetime) == 0x0007D8, "Member 'AAthenaGoosePickup::DeployedLifetime' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, DespawnWarningTime) == 0x000800, "Member 'AAthenaGoosePickup::DespawnWarningTime' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, InStormLifetime) == 0x000828, "Member 'AAthenaGoosePickup::InStormLifetime' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, DropGravityScale) == 0x000850, "Member 'AAthenaGoosePickup::DropGravityScale' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, DisplayIndex) == 0x000878, "Member 'AAthenaGoosePickup::DisplayIndex' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, Loot_To_Health_GE_Map) == 0x000888, "Member 'AAthenaGoosePickup::Loot_To_Health_GE_Map' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, Loot_To_Boost_GE_Map) == 0x0008D8, "Member 'AAthenaGoosePickup::Loot_To_Boost_GE_Map' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, Loot_To_Passengers_GE_Map) == 0x000928, "Member 'AAthenaGoosePickup::Loot_To_Passengers_GE_Map' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, Loot_to_Driver_GE_Map) == 0x000978, "Member 'AAthenaGoosePickup::Loot_to_Driver_GE_Map' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, ForcedLootTableName) == 0x0009C8, "Member 'AAthenaGoosePickup::ForcedLootTableName' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, DisplayData) == 0x0009D0, "Member 'AAthenaGoosePickup::DisplayData' has a wrong offset!");
static_assert(offsetof(AAthenaGoosePickup, DeployHeight) == 0x0009E8, "Member 'AAthenaGoosePickup::DeployHeight' has a wrong offset!");

// Class GooseRuntime.FortAthenaMutator_Goose
// 0x0508 (0x08D8 - 0x03D0)
...
public:
	...
	uint8                                         Pad_464B[0x8];                                     // 0x03E0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_464C[0x4];                                     // 0x046C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_464D[0x20];                                    // 0x05C8(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_464E[0x10];                                    // 0x0688(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class AFortAthenaMutator_MarkerUtilities*     MarkerUtilitiesMutator;                            // 0x08B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_464F[0x10];                                    // 0x08C0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortPlayerPawnAthena*                  LocalControlledPlayerPawn;                         // 0x08D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)

public:
	void HandleClientPawnEnteredVehicle(TScriptInterface<class IFortVehicleInterface>& Vehicle, class AFortPawn* Pawn, int32 SeatIndex);
	void HandleClientPawnExitedVehicle(TScriptInterface<class IFortVehicleInterface>& Vehicle, class AFortPawn* Pawn, int32 SeatIndex);
	void HandleClientVehicleDestroyed(class AActor* VehicleActor);
	void KillPlayerPawns(TArray<TWeakObjectPtr<class AFortPlayerPawn>>& PawnsToKill, struct FGameplayTagContainer& DeathReasonTags, class AController* EventInstigator, class AActor* DamageCauser);
	void OnPawnDied(class AFortPlayerPawnAthena* PlayerPawn);
	void OnVehicleDied(class AFortAthenaVehicle* DestroyedVehicle, struct FGameplayTagContainer& InTags, class AController* EventInstigator, class AActor* DamageCauser);
	void OnVehicleStolen(uint8 OldID, uint8 NewID);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortAthenaMutator_Goose">();
	}
...
static_assert(alignof(AFortAthenaMutator_Goose) == 0x000008, "Wrong alinment on AFortAthenaMutator_Goose");
static_assert(sizeof(AFortAthenaMutator_Goose) == 0x0008D8, "Wrong size on AFortAthenaMutator_Goose");
...
static_assert(offsetof(AFortAthenaMutator_Goose, MarkerUtilitiesMutator) == 0x0008B8, "Member 'AFortAthenaMutator_Goose::MarkerUtilitiesMutator' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_Goose, LocalControlledPlayerPawn) == 0x0008D0, "Member 'AFortAthenaMutator_Goose::LocalControlledPlayerPawn' has a wrong offset!");
...
{
public:
	void GooseGivePlaneBoostGE(int32 Param_Index);
	void GooseGivePlaneEffect(int32 Param_Index);
	void GooseGivePlaneHealthGE(int32 Param_Index);
	void GooseKillPlaneSquad();
	void GooseSetPlaneHealthPercent(float Percent);
	void GooseSetPlaneLives(int32 NewLives);
	void GooseStealPlane();
	void GooseToggleDrops(bool bToggleValue);
	void GooseUpgradePlaneGuns(int32 Param_Index);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"FortCheatManager_Goose">();
	}
...
static_assert(alignof(UFortCheatManager_Goose) == 0x000008, "Wrong alinment on UFortCheatManager_Goose");
