...
static_assert(alignof(FValkyrieContentServiceListInfoMeta) == 0x000008, "Wrong alinment on FValkyrieContentServiceListInfoMeta");
...
static_assert(alignof(FValkyrieContentServiceListInfo) == 0x000008, "Wrong alinment on FValkyrieContentServiceListInfo");
...
public:
	...
	uint8                                         Pad_5414[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FValkyrieContentServiceListResults) == 0x000008, "Wrong alinment on FValkyrieContentServiceListResults");
