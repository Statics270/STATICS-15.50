...
public:
	...
	uint8                                         Pad_60F5[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FCreative_EnabledState) == 0x000004, "Wrong alinment on FCreative_EnabledState");
