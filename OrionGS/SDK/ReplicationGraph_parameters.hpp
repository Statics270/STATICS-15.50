...
static_assert(alignof(ReplicationGraphDebugActor_ClientCellInfo) == 0x000008, "Wrong alinment on ReplicationGraphDebugActor_ClientCellInfo");
...
static_assert(alignof(ReplicationGraphDebugActor_ServerPrintAllActorInfo) == 0x000008, "Wrong alinment on ReplicationGraphDebugActor_ServerPrintAllActorInfo");
...
static_assert(alignof(ReplicationGraphDebugActor_ServerSetConditionalActorBreakpoint) == 0x000008, "Wrong alinment on ReplicationGraphDebugActor_ServerSetConditionalActorBreakpoint");
...
public:
	...
	uint8                                         Pad_4BF2[0x4];                                     // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(ReplicationGraphDebugActor_ServerSetCullDistanceForClass) == 0x000008, "Wrong alinment on ReplicationGraphDebugActor_ServerSetCullDistanceForClass");
...
public:
	...
	uint8                                         Pad_4BF3[0x4];                                     // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(ReplicationGraphDebugActor_ServerSetPeriodFrameForClass) == 0x000008, "Wrong alinment on ReplicationGraphDebugActor_ServerSetPeriodFrameForClass");
