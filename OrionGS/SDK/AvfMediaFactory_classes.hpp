...
public:
	...
	uint8                                         Pad_4F5D[0x7];                                     // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AvfMediaSettings">();
	}
...
static_assert(alignof(UAvfMediaSettings) == 0x000008, "Wrong alinment on UAvfMediaSettings");
