...
static_assert(alignof(Flopper_Gadget_AnimBP_C_ExecuteUbergraph_Flopper_Gadget_AnimBP) == 0x000004, "Wrong alinment on Flopper_Gadget_AnimBP_C_ExecuteUbergraph_Flopper_Gadget_AnimBP");
...
static_assert(alignof(Flopper_Gadget_AnimBP_C_AnimGraph) == 0x000008, "Wrong alinment on Flopper_Gadget_AnimBP_C_AnimGraph");
static_assert(sizeof(Flopper_Gadget_AnimBP_C_AnimGraph) == 0x000010, "Wrong size on Flopper_Gadget_AnimBP_C_AnimGraph");
static_assert(offsetof(Flopper_Gadget_AnimBP_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'Flopper_Gadget_AnimBP_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
