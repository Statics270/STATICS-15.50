...
static_assert(alignof(TVPostProcessBPAthena_C_IsEnabledForCurrentSubgame) == 0x000001, "Wrong alinment on TVPostProcessBPAthena_C_IsEnabledForCurrentSubgame");
...
static_assert(alignof(TVPostProcessBPAthena_C_ExecuteUbergraph_TVPostProcessBPAthena) == 0x000004, "Wrong alinment on TVPostProcessBPAthena_C_ExecuteUbergraph_TVPostProcessBPAthena");
