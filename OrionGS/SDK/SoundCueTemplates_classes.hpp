...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"SoundCueTemplate">();
	}
...
static_assert(alignof(USoundCueTemplate) == 0x000008, "Wrong alinment on USoundCueTemplate");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SoundCueContainer">();
	}
...
static_assert(alignof(USoundCueContainer) == 0x000008, "Wrong alinment on USoundCueContainer");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SoundCueDistanceCrossfade">();
	}
...
static_assert(alignof(USoundCueDistanceCrossfade) == 0x000008, "Wrong alinment on USoundCueDistanceCrossfade");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"SoundCueTemplateSettings">();
	}
...
static_assert(alignof(USoundCueTemplateSettings) == 0x000008, "Wrong alinment on USoundCueTemplateSettings");
