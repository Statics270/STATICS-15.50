...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AnimationDataSourceRegistry">();
	}
...
static_assert(alignof(UAnimationDataSourceRegistry) == 0x000008, "Wrong alinment on UAnimationDataSourceRegistry");
