...
static_assert(alignof(TournamentLiveGamesEntry_C_OnEntrySet) == 0x000004, "Wrong alinment on TournamentLiveGamesEntry_C_OnEntrySet");
...
public:
	...
	uint8                                         Pad_6974[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6975[0x3];                                     // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           K2Node_Select_Default;                             // 0x0044(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(TournamentLiveGamesEntry_C_ExecuteUbergraph_TournamentLiveGamesEntry) == 0x000008, "Wrong alinment on TournamentLiveGamesEntry_C_ExecuteUbergraph_TournamentLiveGamesEntry");
