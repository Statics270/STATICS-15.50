...
public:
	...
	uint8                                         Pad_4A59[0x10];                                    // 0x0038(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AndroidPermissionCallbackProxy">();
	}
...
static_assert(alignof(UAndroidPermissionCallbackProxy) == 0x000008, "Wrong alinment on UAndroidPermissionCallbackProxy");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"AndroidPermissionFunctionLibrary">();
	}
...
static_assert(alignof(UAndroidPermissionFunctionLibrary) == 0x000008, "Wrong alinment on UAndroidPermissionFunctionLibrary");
