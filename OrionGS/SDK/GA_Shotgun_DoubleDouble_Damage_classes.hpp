...
public:
	void ExecuteUbergraph_GA_Shotgun_DoubleDouble_Damage(int32 EntryPoint, const struct FActiveGameplayEffectHandle& CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue);
...
static_assert(alignof(UGA_Shotgun_DoubleDouble_Damage_C) == 0x000008, "Wrong alinment on UGA_Shotgun_DoubleDouble_Damage_C");
