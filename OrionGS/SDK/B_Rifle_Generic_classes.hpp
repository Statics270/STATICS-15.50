...
static_assert(alignof(AB_Rifle_Generic_C) == 0x000008, "Wrong alinment on AB_Rifle_Generic_C");
static_assert(sizeof(AB_Rifle_Generic_C) == 0x0012C8, "Wrong size on AB_Rifle_Generic_C");
