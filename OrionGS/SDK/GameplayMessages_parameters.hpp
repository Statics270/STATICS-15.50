...
public:
	...
	uint8                                         Pad_4EDE[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(AsyncAction_RegisterGameplayMessageReceiver_RegisterGameplayMessageReceiver) == 0x000008, "Wrong alinment on AsyncAction_RegisterGameplayMessageReceiver_RegisterGameplayMessageReceiver");
...
public:
	...
	uint8                                         Pad_4EDF[0x3];                                     // 0x0005(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AsyncAction_RegisterGameplayMessageReceiver_GetPayload) == 0x000004, "Wrong alinment on AsyncAction_RegisterGameplayMessageReceiver_GetPayload");
...
static_assert(alignof(GameplayMessageReplicator_Multicast_ServerMessageTriggered) == 0x000008, "Wrong alinment on GameplayMessageReplicator_Multicast_ServerMessageTriggered");
...
static_assert(alignof(GameplayMessageRouter_ClearSavedMessage) == 0x000004, "Wrong alinment on GameplayMessageRouter_ClearSavedMessage");
...
public:
	...
	uint8                                         Pad_4EE1[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(GameplayMessageRouter_K2_BroadcastMessage) == 0x000008, "Wrong alinment on GameplayMessageRouter_K2_BroadcastMessage");
...
static_assert(offsetof(GameplayMessageRouter_K2_BroadcastMessage, bSaveToChannel) == 0x00000C, "Member 'GameplayMessageRouter_K2_BroadcastMessage::bSaveToChannel' has a wrong offset!");
...
static_assert(alignof(BlueprintEventMessageTagLibrary_GetEventMessageTagFromGameplayTag) == 0x000004, "Wrong alinment on BlueprintEventMessageTagLibrary_GetEventMessageTagFromGameplayTag");
static_assert(sizeof(BlueprintEventMessageTagLibrary_GetEventMessageTagFromGameplayTag) == 0x000010, "Wrong size on BlueprintEventMessageTagLibrary_GetEventMessageTagFromGameplayTag");
...
static_assert(offsetof(BlueprintEventMessageTagLibrary_GetEventMessageTagFromGameplayTag, ReturnValue) == 0x000008, "Member 'BlueprintEventMessageTagLibrary_GetEventMessageTagFromGameplayTag::ReturnValue' has a wrong offset!");
