...
{
public:
	uint8                                         Pad_7A3E[0x8];                                     // 0x07D8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(AFrontendCamera_Main_C) == 0x000010, "Wrong alinment on AFrontendCamera_Main_C");
