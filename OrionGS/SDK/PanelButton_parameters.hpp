...
public:
	...
	uint8                                         Pad_675D[0x5];                                     // 0x000B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(PanelButton_C_ExecuteUbergraph_PanelButton) == 0x000008, "Wrong alinment on PanelButton_C_ExecuteUbergraph_PanelButton");
...
static_assert(alignof(PanelButton_C_OnActionProgress) == 0x000004, "Wrong alinment on PanelButton_C_OnActionProgress");
...
static_assert(alignof(PanelButton_C_OnTriggeredInputActionChanged) == 0x000008, "Wrong alinment on PanelButton_C_OnTriggeredInputActionChanged");
...
static_assert(alignof(PanelButton_C_BndEvt__CommonActionWidgetAction_K2Node_ComponentBoundEvent_0_OnInputMethodChanged__DelegateSignature) == 0x000001, "Wrong alinment on PanelButton_C_BndEvt__CommonActionWidgetAction_K2Node_ComponentBoundEvent_0_OnInputMethodChanged__DelegateSignature");
...
static_assert(alignof(PanelButton_C_PreConstruct) == 0x000001, "Wrong alinment on PanelButton_C_PreConstruct");
...
static_assert(alignof(PanelButton_C_UpdateTextAndStyle) == 0x000008, "Wrong alinment on PanelButton_C_UpdateTextAndStyle");
...
public:
	bool                                          bUsingGamepad;                                     // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_675E[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   ActionText;                                        // 0x0008(0x0018)(Edit, BlueprintVisible)
};
static_assert(alignof(PanelButton_C_UpdateStyle) == 0x000008, "Wrong alinment on PanelButton_C_UpdateStyle");
...
static_assert(alignof(PanelButton_C_UpdateInputActionLayout) == 0x000008, "Wrong alinment on PanelButton_C_UpdateInputActionLayout");
