...
public:
	...
	uint8                                         Pad_4A5F[0x7];                                     // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AnimationBudgetBlueprintLibrary_EnableAnimationBudget) == 0x000008, "Wrong alinment on AnimationBudgetBlueprintLibrary_EnableAnimationBudget");
...
static_assert(alignof(AnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters) == 0x000008, "Wrong alinment on AnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters");
...
static_assert(alignof(SkeletalMeshComponentBudgeted_SetAutoRegisterWithBudgetAllocator) == 0x000001, "Wrong alinment on SkeletalMeshComponentBudgeted_SetAutoRegisterWithBudgetAllocator");
