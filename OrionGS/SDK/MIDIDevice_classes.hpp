...
public:
	...
	uint8                                         Pad_4D5A[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4D5B[0x10];                                    // 0x0050(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MIDIDeviceController">();
	}
...
static_assert(alignof(UMIDIDeviceController) == 0x000008, "Wrong alinment on UMIDIDeviceController");
...
public:
	...
	uint8                                         Pad_4D5C[0x4];                                     // 0x009C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4D5D[0x10];                                    // 0x00B0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MIDIDeviceInputController">();
	}
...
static_assert(alignof(UMIDIDeviceInputController) == 0x000008, "Wrong alinment on UMIDIDeviceInputController");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MIDIDeviceManager">();
	}
...
static_assert(alignof(UMIDIDeviceManager) == 0x000008, "Wrong alinment on UMIDIDeviceManager");
...
public:
	...
	uint8                                         Pad_4D61[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4D62[0x8];                                     // 0x0040(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"MIDIDeviceOutputController">();
	}
...
static_assert(alignof(UMIDIDeviceOutputController) == 0x000008, "Wrong alinment on UMIDIDeviceOutputController");
