...
static_assert(alignof(MiniCraftingIngredientList_C_AddListEntry) == 0x000008, "Wrong alinment on MiniCraftingIngredientList_C_AddListEntry");
...
public:
	...
	uint8                                         Pad_77DF[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(MiniCraftingIngredientList_C_ExecuteUbergraph_MiniCraftingIngredientList) == 0x000008, "Wrong alinment on MiniCraftingIngredientList_C_ExecuteUbergraph_MiniCraftingIngredientList");
