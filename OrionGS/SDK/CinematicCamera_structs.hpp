...
static_assert(alignof(FCameraLensSettings) == 0x000004, "Wrong alinment on FCameraLensSettings");
...
static_assert(alignof(FNamedLensPreset) == 0x000008, "Wrong alinment on FNamedLensPreset");
...
public:
	...
	uint8                                         Pad_4FBF[0x3];                                     // 0x0035(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCameraTrackingFocusSettings) == 0x000008, "Wrong alinment on FCameraTrackingFocusSettings");
...
public:
	...
	uint8                                         Pad_4FC0[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FC1[0x3];                                     // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FC2[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FC3[0x4];                                     // 0x0054(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCameraFocusSettings) == 0x000008, "Wrong alinment on FCameraFocusSettings");
...
static_assert(alignof(FCameraFilmbackSettings) == 0x000004, "Wrong alinment on FCameraFilmbackSettings");
...
public:
	...
	uint8                                         Pad_4FC4[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FC5[0x10];                                    // 0x0008(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FC6[0x3];                                     // 0x004D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCameraLookatTrackingSettings) == 0x000008, "Wrong alinment on FCameraLookatTrackingSettings");
...
public:
	...
	uint8                                         Pad_4FC7[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNamedFilmbackPreset) == 0x000008, "Wrong alinment on FNamedFilmbackPreset");
