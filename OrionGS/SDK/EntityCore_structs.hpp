...
#pragma pack(pop)
static_assert(alignof(FComponentData) == 0x000001, "Wrong alinment on FComponentData");
...
{
public:
	uint8                                         Pad_4DEC[0x10];                                    // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEntityCoreSystemRelativePositionComponentData) == 0x000004, "Wrong alinment on FEntityCoreSystemRelativePositionComponentData");
...
static_assert(alignof(FEntityScaleComponentData) == 0x000004, "Wrong alinment on FEntityScaleComponentData");
...
static_assert(alignof(FEntityRotationComponentData) == 0x000004, "Wrong alinment on FEntityRotationComponentData");
...
static_assert(alignof(FEntityPositionComponentData) == 0x000004, "Wrong alinment on FEntityPositionComponentData");
...
static_assert(alignof(FEntityTickFunction) == 0x000008, "Wrong alinment on FEntityTickFunction");
