...
public:
	...
	uint8                                         Pad_66C3[0x3];                                     // 0x0009(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(Lightbox_C_ExecuteUbergraph_Lightbox) == 0x000004, "Wrong alinment on Lightbox_C_ExecuteUbergraph_Lightbox");
...
static_assert(alignof(Lightbox_C_PreConstruct) == 0x000001, "Wrong alinment on Lightbox_C_PreConstruct");
...
static_assert(alignof(Lightbox_C_Intro) == 0x000008, "Wrong alinment on Lightbox_C_Intro");
...
static_assert(alignof(Lightbox_C_Outro) == 0x000008, "Wrong alinment on Lightbox_C_Outro");
...
static_assert(alignof(Lightbox_C_AddContent) == 0x000008, "Wrong alinment on Lightbox_C_AddContent");
...
static_assert(alignof(Lightbox_C_RemoveContent) == 0x000001, "Wrong alinment on Lightbox_C_RemoveContent");
