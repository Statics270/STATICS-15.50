...
public:
	void ExecuteUbergraph_LockerBuiltInEmoteWidget(int32 EntryPoint, bool Temp_bool_Variable, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable_1, bool K2Node_Event_bLocked, ESlateVisibility K2Node_Select_Default);
...
static_assert(alignof(ULockerBuiltInEmoteWidget_C) == 0x000008, "Wrong alinment on ULockerBuiltInEmoteWidget_C");
