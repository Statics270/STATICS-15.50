...
public:
	...
	uint8                                         Pad_4770[0x4];                                     // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortMantisPawnComponent_OnCharacterMovementPreUpdate) == 0x000008, "Wrong alinment on FortMantisPawnComponent_OnCharacterMovementPreUpdate");
...
public:
	class UCharacterMovementComponent*            CharMoveComp;                                      // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DeltaSeconds;                                      // 0x0008(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4771[0x4];                                     // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortMantisPawnComponent_OnPostPhysicsRotation) == 0x000008, "Wrong alinment on FortMantisPawnComponent_OnPostPhysicsRotation");
...
static_assert(alignof(FortGameplayAbility_Mantis_BP_OnMantisTechniqueHit) == 0x000008, "Wrong alinment on FortGameplayAbility_Mantis_BP_OnMantisTechniqueHit");
...
public:
	...
	uint8                                         Pad_4778[0x5];                                     // 0x000B(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortGameplayAbility_Mantis_ConfigureRootMotionWarping) == 0x000008, "Wrong alinment on FortGameplayAbility_Mantis_ConfigureRootMotionWarping");
