...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BlueprintGameplayStatsLibrary">();
	}
...
static_assert(alignof(UBlueprintGameplayStatsLibrary) == 0x000008, "Wrong alinment on UBlueprintGameplayStatsLibrary");
...
public:
	...
	uint8                                         Pad_4EE7[0x58];                                    // 0x0040(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"GameplayTagTableManager">();
	}
...
static_assert(alignof(UGameplayTagTableManager) == 0x000008, "Wrong alinment on UGameplayTagTableManager");
