...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FortHoagieVehicleReticle">();
	}
...
static_assert(alignof(UFortHoagieVehicleReticle) == 0x000008, "Wrong alinment on UFortHoagieVehicleReticle");
