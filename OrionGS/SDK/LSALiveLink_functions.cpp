...
bool ULSALiveLinkDataHandler::StartTrackingLiveLinkSubject(class FName LiveLinkSubject, struct FLiveStreamAnimationHandleWrapper& RegisteredName, struct FLSALiveLinkSourceOptions& Options, struct FLiveStreamAnimationHandleWrapper& TranslationProfile)
{
...
void ULSALiveLinkDataHandler::StopTrackingLiveLinkSubject(struct FLiveStreamAnimationHandleWrapper& RegisteredName)
{
	static class UFunction* Func = nullptr;
