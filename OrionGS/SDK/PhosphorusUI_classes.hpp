...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"PhosphorusWidgetBase">();
	}
...
static_assert(alignof(UPhosphorusWidgetBase) == 0x000008, "Wrong alinment on UPhosphorusWidgetBase");
...
public:
	...
	uint8                                         Pad_4722[0x4];                                     // 0x034C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"PhosphorusEndOfRoundWidget">();
	}
...
static_assert(alignof(UPhosphorusEndOfRoundWidget) == 0x000008, "Wrong alinment on UPhosphorusEndOfRoundWidget");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"PhosphorusHUDWidget">();
	}
...
static_assert(alignof(UPhosphorusHUDWidget) == 0x000008, "Wrong alinment on UPhosphorusHUDWidget");
...
public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"PhosphorusSquadWipedWidget">();
	}
...
static_assert(alignof(UPhosphorusSquadWipedWidget) == 0x000008, "Wrong alinment on UPhosphorusSquadWipedWidget");
