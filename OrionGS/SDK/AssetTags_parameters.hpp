...
public:
	...
	uint8                                         Pad_4F60[0x3];                                     // 0x0009(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AssetTagsSubsystem_CollectionExists) == 0x000004, "Wrong alinment on AssetTagsSubsystem_CollectionExists");
...
static_assert(alignof(AssetTagsSubsystem_GetAssetsInCollection) == 0x000008, "Wrong alinment on AssetTagsSubsystem_GetAssetsInCollection");
...
static_assert(alignof(AssetTagsSubsystem_GetCollections) == 0x000008, "Wrong alinment on AssetTagsSubsystem_GetCollections");
...
static_assert(alignof(AssetTagsSubsystem_GetCollectionsContainingAsset) == 0x000008, "Wrong alinment on AssetTagsSubsystem_GetCollectionsContainingAsset");
...
public:
	...
	TArray<class FName>                           ReturnValue;                                       // 0x0060(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AssetTagsSubsystem_GetCollectionsContainingAssetData) == 0x000008, "Wrong alinment on AssetTagsSubsystem_GetCollectionsContainingAssetData");
...
static_assert(alignof(AssetTagsSubsystem_GetCollectionsContainingAssetPtr) == 0x000008, "Wrong alinment on AssetTagsSubsystem_GetCollectionsContainingAssetPtr");
