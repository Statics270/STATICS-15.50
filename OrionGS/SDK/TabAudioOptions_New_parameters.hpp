...
static_assert(alignof(TabAudioOptions_New_C_ExecuteUbergraph_TabAudioOptions_New) == 0x000004, "Wrong alinment on TabAudioOptions_New_C_ExecuteUbergraph_TabAudioOptions_New");
...
static_assert(alignof(TabAudioOptions_New_C_SettingValueChanged) == 0x000004, "Wrong alinment on TabAudioOptions_New_C_SettingValueChanged");
