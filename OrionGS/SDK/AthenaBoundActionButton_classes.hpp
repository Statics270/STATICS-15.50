...
public:
	void UpdateInputActionIconSize(float Temp_float_Variable, float Temp_float_Variable_1, class UCommonInputSubsystem* CallFunc_GetContext_ReturnValue, ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool Temp_bool_Variable, bool CallFunc_EqualEqual_ByteByte_ReturnValue, float K2Node_Select_Default);
	void Construct();
...
static_assert(alignof(UAthenaBoundActionButton_C) == 0x000008, "Wrong alinment on UAthenaBoundActionButton_C");
